...
[COMMERCIAL_GOAL_AGENT_REF · commercial_goal_specialist · COMMERCIAL_GOAL-REF-2026-06-11-DEMO-WORKER-025]

| agent_name | Commercial Goal Specialist |
| agent_id | `commercial_goal_specialist` |
| ref_tag | `COMMERCIAL_GOAL-REF-DEMO-WORKER-025` |
| trace_id | `COMMERCIAL_GOAL-REF-2026-06-11-DEMO-WORKER-025` |
| parent_trace | `COMMERCIAL_GOAL-REF-2026-06-11-100M-SIGNAL-6MO` |
| execution_authority | false — Worker implements on SourceA; Brain assigns `sa-*` |

# SOURCEA WORKER — Governance Demo (BLOCK / ALLOW / Tamper)

**Paste this entire file into a new Cursor chat on `/Users/sinakazemnezhad/Desktop/SourceA`.**  
**Sprint ID:** `DEMO-ENF-COPILOT-2026-06-11`  
**Authority:** Commercial Goal 6-month $100M signal plan — **W1 + W2 only** (not factory drain, not hub rewrite, not Noetfield product site).
...
1. **BLOCK** — invalid Copilot-governance intent stopped at gate  
...
1. `~/.sina/agent-workspaces/trustfield/commercial-goal/2026-06-11_100M-SIGNAL-6MO-EXECUTION-PLAN.md`
...
| **TAMPER** | (after ALLOW) | — | Human edits receipt on disk → run validator → **FAIL** |
...
## 8. OUT OF SCOPE (Commercial / other workers)

- Noetfield site changes  
- TrustField pricing  
- Hub “Run governance demo” button (Maintainer after S6)  
- Investor deck (Commercial)  
- NF-001 outreach (Commercial + ASF)  
...
> **Ship one Copilot policy path that BLOCKs, ALLOWs with receipt+spine, and FAILs on tamper — nothing else.**

**Parent plan:** `COMMERCIAL_GOAL-REF-2026-06-11-100M-SIGNAL-6MO`  
