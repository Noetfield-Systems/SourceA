# Repo agent notice — VIRLUX

**Last updated:** 2026-06-06 · **Repo id:** `virlux` · **Thread:** `THREAD-PORTFOLIO`
...
VIRLUX — live site & DNS

**Workspace:** `Virlux`  
**Root:** `/Users/sinakazemnezhad/Desktop/VIRLUX`  
**Plane:** DELIVERY
...
1. One ship-proof step: DNS, Vercel smoke, or public URL check (founder uses Actions, not Terminal)
2. Update os/plan.json next task when done — evidence path in reply
3. GTM/media tasks stay scoped to VIRLUX repo only
...
**Active focus:** vx-0001_verify_live
...
- `~/Desktop/SourceA`
- `MergePack thread work in this chat`
...
| Agent hub | Private agent loop for `virlux` if configured |
