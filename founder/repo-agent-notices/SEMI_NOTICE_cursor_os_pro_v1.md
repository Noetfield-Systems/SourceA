# Semi-separate lane notice — Cursor OS Pro

**Last updated:** 2026-06-06 · **Lane id:** `cursor_os_pro` · **Thread:** `THREAD-CURSOR-OS-PRO`  
...
Cursor OS Pro — App Store SKU (IDE For Cursor)

Separate program — paying customers, not internal orchestra.

**Workspace:** `Cursor OS Pro`  
**Root:** `/Users/sinakazemnezhad/Desktop/Cursor OS Pro`  
...
1. P-R/G-R: npm run check green + device regression on real iPhone
2. One outcome toward TestFlight / App Store — reference parity in mobile/ only
3. If user asks wire/RUN SYSTEM → redirect to AI Dev Bridge OS chat
...
Do not use portfolio Repos lane brief as SSOT — use SEMI_NOTICE_cursor_os_pro

---

## Session end

1. Line 1: `Active thread: THREAD-CURSOR-OS-PRO`  
