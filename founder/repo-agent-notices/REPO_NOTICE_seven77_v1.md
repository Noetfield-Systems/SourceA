# Repo agent notice — The 777 Foundation

**Last updated:** 2026-06-06 · **Repo id:** `seven77` · **Thread:** `THREAD-PORTFOLIO`
...
The 777 Foundation — web ops & cohort

**Workspace:** `The 777 Foundation`  
**Root:** `/Users/sinakazemnezhad/Desktop/The 777 Foundation`  
**Plane:** DELIVERY
...
1. One Gate 0 or web ops step with evidence (/api/health, deploy note, or ops doc update)
2. Supabase/migration work only with founder-approved scope
3. Ship lane proof via Actions when wired — no founder npm in Terminal
...
| Agent hub | Private agent loop for `seven77` if configured |
