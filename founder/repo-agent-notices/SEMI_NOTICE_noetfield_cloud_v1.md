# Semi-separate lane notice — Noetfield (cloud / GitHub ship)

**Last updated:** 2026-06-06 · **Lane id:** `noetfield_cloud` · **Thread:** `THREAD-PORTFOLIO`  
...
Noetfield cloud — GitHub ship repo (TLE, governance console, :13080)

Twin of noetfield **local** (All-Documents). This chat = **implementation SSOT** only.

**Workspace:** `Noetfield`  
**Root:** `/Users/sinakazemnezhad/Desktop/Noetfield`  
**Plane:** SHIP
...
1. One ship step from os/plan.json lane_a_sprint_map or sprint-trust-ledger-v1.2.md
2. Run verify: scripts/verify-local-dev.sh or tle-smoke — evidence in reply
3. Sync ops/private/sourceA from hub when EXECUTION_TRUTH drifts (founder Actions)
4. Never edit ~/Desktop/Noetfield-All-Documents from this workspace (noetfield_local chat)
...
Agent hub → noetfield_cloud pack · Live products · Actions

---

## Session end

1. Line 1: `Active thread: THREAD-PORTFOLIO`  
