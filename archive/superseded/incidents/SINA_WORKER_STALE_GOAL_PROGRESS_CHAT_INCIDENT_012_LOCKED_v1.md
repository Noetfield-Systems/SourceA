...
An executor agent later filed this topic under **INCIDENT-010**, which is **already assigned** to CIR-COSPRO (cross-lane edit). That created a **duplicate id collision** logged. **This report is INCIDENT-012** — use `sequence_id` SSOT, not reused numbers.
