...
| `essay_total` | 8 | same |
| Essays on disk | **9** rows · **8/8** agents | `~/.sina/essay-discourse/essays.jsonl` |
...
| **C — Script** | Maintainer on ASF order | `reconcile_task_orders_fleet_v1.py` (not on disk — **needs ASF yes**) |
