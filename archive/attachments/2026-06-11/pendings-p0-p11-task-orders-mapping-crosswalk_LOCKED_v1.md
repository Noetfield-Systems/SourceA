...
**Verdict:** **Semantic cousins** not strict duplicates. P11 `done` ≠ G3 on disk. TO-WIRE **open** may be correct until founder/repo records G3 in `WIRE_LANE_PROGRESS.md`. Document as **intentional lag** unless wire proof exists on disk.
