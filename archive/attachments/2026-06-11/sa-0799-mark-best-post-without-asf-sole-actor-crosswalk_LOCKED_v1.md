...
3. **OPEN-3:** ASF optional hub click **Mark best** when ready (8 agents · 9 essays on disk).
...
**ACT complete** — crosswalk on disk; hardening options documented; **no code diff** per T3 + FREEZE/repair-only. VERIFY blocked until global critical **0**.
