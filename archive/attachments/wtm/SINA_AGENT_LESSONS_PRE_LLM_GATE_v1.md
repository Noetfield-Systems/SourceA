...
- D1–D4 on disk (code, graph, deps, intent)  
...
**Today vs target:** W2 ~55% / W3 $0 / competitors $320M+ raised for control-plane · Target: CAD $2K deposit Week 4 per blueprint Stage 2.
...
**What we have / lack:** 300-plan library on disk · Lack: ASF FIVE-STEP lock (PLAN-300), north star dashboard (PLAN-291–296), 10-min scaffold (PLAN-201).
...
## Lesson 19 — SourceA competitor landscape (2026-06-15)

**Verdict:** SourceA competes at **L6 pre-execution governance**, not L3 orchestration or L0 models. Closest rivals: **Notenic, FuseGov, [external-design-benchmark], AgentPEP, Predicate, Microsoft Authorization Fabric**. Noetfield lane rivals: **Securiti, [external-design-benchmark], Credo AI, Purview, WitnessAI**.

**Today vs target:** Strong disk proof (`critic_boot`, validators, receipts) · weak enterprise SIEM/SaaS GTM vs funded players (Temporal $5B, WitnessAI $58M, [external-design-benchmark] Gartner TRiSM).
...
**Files:** `archive/attachments/commercial/SOURCEA_COMPETITOR_LANDSCAPE_RESEARCH_REPORT_v1.md` · `NOETFIELD_NW1_BATTLE_CARD_LOCKED_v1.md` · `SOURCEA_ORCHESTRATOR_PARTNER_INTEGRATION_LOCKED_v1.md` · `knowledge-library/fields/commercial-governance/02-gathered/GATHER_v2_SOURCEA_COMPETITOR_LANDSCAPE_2026-06-15.md`
