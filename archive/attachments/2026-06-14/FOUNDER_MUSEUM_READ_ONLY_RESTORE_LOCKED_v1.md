...
**Status:** **RESTORED ON DISK** — data never deleted · route live · agents must stop saying erased  
...
| **Also on disk** | `command-data-canonical.json` · `command-data-runtime.json` · `command-data-shell.json` |
...
| Mistake | Truth |
|---------|-------|
| "Museum erased" | **FALSE** — 10.7 MB on disk |
