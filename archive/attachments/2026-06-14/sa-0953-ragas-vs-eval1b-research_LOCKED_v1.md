...
|-------|-------------------|-------------------------|
| Purpose | Prove **packet beats raw** on governed tasks | Prove **RAG pipeline quality** on datasets |
...
|-----------|-------------------|-------------------------|-----------------|
| **What it measures** | Faithfulness, answer relevancy, context precision/recall | Task outcome: packet context vs raw prompt win rate | RAGAS = retrieval QA quality · Eval-1b = **governed context assembly** uplift |
