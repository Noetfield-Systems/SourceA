...
**Fixed on disk:** `h2_pending_registry_reconcile_v1.py` · honest counter in `machine_hub_v1.py`.
...
| **W1-FILM** | Demo film + write-path validator evidence | Worker | W1 film receipt on disk |
