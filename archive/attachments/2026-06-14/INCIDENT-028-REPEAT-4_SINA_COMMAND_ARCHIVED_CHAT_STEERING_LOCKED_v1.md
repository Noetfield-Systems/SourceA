...
**Law already correct logged:** `prompt-queue.mdc` v6 · `000-dead-law-stubs.mdc` · `SOURCEA_FOUNDER_MACHINE_TERMINOLOGY_DICTIONARY_LOCKED_v1.md` §3.
...
- **Daily glance (optional):** Super Fast Hub → **Next steps** — live next-10 logged
