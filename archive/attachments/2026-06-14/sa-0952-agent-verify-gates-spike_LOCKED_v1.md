...
**Cursor Worker is the only runtime wired to honest factory closeout today.** Devin/SWE-agent are **benchmark references** (constellation L4) — integrate only behind broker + receipt adapter, never parallel REGISTRY writers.
