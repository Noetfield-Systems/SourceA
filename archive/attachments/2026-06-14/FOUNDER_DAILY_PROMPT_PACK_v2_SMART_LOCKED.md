...
**054.** Light refresh hub (mode light) — then confirm H1 health pill fresh on disk.
...
**075.** Five-step SCAN→SAY→PICK→PROVE→SHIP: run SCAN on disk, propose one PICK for Form.
