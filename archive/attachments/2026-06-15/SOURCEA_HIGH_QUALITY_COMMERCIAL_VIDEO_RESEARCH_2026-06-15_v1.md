...
| Asset logged | What it is | Quality grade | Ship publicly? |
|---------------|------------|---------------|----------------|
...
| Screen Studio master take | **Does not exist logged** | — | **This is the gap** |
...
| **Stripe** | Infrastructure clarity · compound value | Verification + API hook |
...
- [ ] `w1-film-receipt-v1.json` logged
...
5. **SourceA wedge requires real BLOCK logged** — the video must show the same receipt buyers can curl.
