...
Ship founder commercial + factory health fixes on disk with validator proof — never hand off to Maintainer, never report-only.
...
| # | Action | Done when |
|---|--------|-----------|
| A1 | sa-0807 **VERIFY** closeout | Broker VERIFY PASS · receipt on disk |
