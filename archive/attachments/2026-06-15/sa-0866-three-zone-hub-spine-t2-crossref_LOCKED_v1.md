# sa-0866 — THREE_ZONE_HUB_SPINE H2 not nested under H1 T2 cross-ref (LOCKED v1)

**Saved:** 2026-06-15T12:00:00Z · **Retrofit:** doc-datetime-law batch retrofit
**Date:** 2026-06-15 · **SA:** sa-0866 (T2) · **Canonical:** sa-0816 (T0) · **T1 echo:** sa-0841
...
| Surfaces | H1 `/` · H2 `/machines/` sibling · `/legacy/` separate |
