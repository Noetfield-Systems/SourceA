...
| AEG proof URL | `inject_landing_aeg_proof_v1.py` | factory disk | `proof/live.html` |
...
## 3. Gemini Remotion stack — already on disk
...
| Lane | Consumer Instagram | Enterprise/agency governed automation |
...
1. **GPT and Gemini are describing the same company** — orchestration layer + programmatic artifacts — SourceA already started both on disk.  
...
4. **Human send gate is a feature**, not a bug, for governed commercial lane.  
