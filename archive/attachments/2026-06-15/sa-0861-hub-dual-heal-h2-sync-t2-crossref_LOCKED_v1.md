# sa-0861 — hub_dual_heal_v1 H2 sync after H1 light refresh T2 cross-ref (LOCKED v1)

**Saved:** 2026-06-15T12:00:00Z · **Retrofit:** doc-datetime-law batch retrofit
**Date:** 2026-06-15 · **SA:** sa-0861 (T2) · **Canonical:** sa-0811 (T0) · **T1 echo:** sa-0836
...
| T2 echo | sa-0861 · `scripts/validate-hub-dual-heal-h2-sync-t2-crossref-v1.sh` |
