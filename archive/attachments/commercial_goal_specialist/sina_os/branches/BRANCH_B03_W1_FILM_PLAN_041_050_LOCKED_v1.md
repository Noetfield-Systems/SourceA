...
|-------|-------|
| **P** | P0 · **Owner** ASF · **Repo** other |
| **Objective** | Hand-edit receipt file on disk → validator FAIL on read |
| **Acceptance** | FAIL message legible · no cut before outcome |
| **Depends** | PLAN-026 · PLAN-038 |
| **Competitor** | **Primary differentiator** vs observability-only (LangSmith, Datadog) |
...
| **Competitor** | vs Microsoft Auth Fabric DIY — show disk PASS/BLOCK in minutes |
