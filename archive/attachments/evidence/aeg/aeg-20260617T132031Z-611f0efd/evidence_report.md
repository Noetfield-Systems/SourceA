...
**Header:** System Blocked: 2026-06-17T13:20:31Z | Reason: run-inbox truth_match=false — queue/inbox mismatch

**Evidence ID:** `aeg-20260617T132031Z-611f0efd`
...
- UI capture skipped: BrowserType.launch: Executable doesn't exist at /var/folders/5g/rd684wbd1q52sngycytqr5n00000gn/T/cursor-sandbox-cache/e1c822a18cc9f37cbae7a2aa6ec0590b/playwright/chromium_headless_shell-1223/chrome-headless-shell-mac-arm64/chrome-headless-shell
╔════════════════════════════════════════════════════════════╗
...
```json
{
  ...
  "founder_line": "CRITIC BOOT BLOCK \u2014 run-inbox truth_match=false \u2014 queue/inbox mismatch \u00b7 last session gate receipt ok=false",
