...
| **SourceA** | Controlled execution engine | Infra buyers + powers portfolio |
...
| SourceA verification built in | **Bridge receipt** into DevBridge UI |
...
**Analog:** Replit “Agent workflows” but **local-first + controlled receipts**.
...
│   Tap: "Run controlled demo" · "Ship pilot export" · "Wire smoke"   │
├─────────────────────────────────────────────────────────────────┤
...
7. **Do not rebuild Replit** — local-first + controlled is the moat.  
