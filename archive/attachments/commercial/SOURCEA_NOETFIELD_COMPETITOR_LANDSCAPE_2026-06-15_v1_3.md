# SourceA / Noetfield —  Landscape & Revenue View
...
| 28 | **[agent-aispm-vendor]** | Governance for Copilot Studio / low-code agent sprawl | Targets low-code/copilot surface, not infra-level enforcement | VC-funded startup |
...
- **Disk SKUs (Asset B DFY):** `SOURCEA_ASSET_B_CONTROLLED_AGENTIC_AUTOMATION_LOCKED_v1.md` — $3–10K project · $2–5K/mo retainer · AB1 fastest cash.
...
**Supersedes:** `SOURCEA_NOETFIELD__LANDSCAPE_2026-06-15_v1_1.md` (intake tables unchanged · disk SKU rows added v1.3)
