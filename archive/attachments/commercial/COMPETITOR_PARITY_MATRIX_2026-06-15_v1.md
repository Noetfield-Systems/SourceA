...
| Capability | **A Gateways** (Portkey · Kong · Cloudflare) | **B GRC / Mgmt** (Credo · OneTrust · watsonx · ServiceNow) | **C AI Security** (Lakera · Cisco · Straiker · ) | **D Observability** (AgentOps · Arize · Langfuse) | **SA / NF** |
|------------|---------------------------------------------|-------------------------------------------------------------|--------------------------------------------------------|---------------------------------------------------|-------------|
...
| **Copilot / M365 board-grade export** | — | ◐ Purview native · Securiti readiness | **✔️**  Studio focus | — | **✔️ NF** TLE · board PDF · proc ZIP |
...
| Capability | Securiti Copilot |  | Microsoft Purview | Credo AI GAIA | **Noetfield NF-RD** |
|------------|------------------|--------|-------------------|---------------|---------------------|
...
| C Security | Threat detect · MCP scan · Copilot surface () | Tamper-evident ledger | Live demo · receipt artifact |
