...
| Capability | **A Gateways** (Portkey · Kong · Cloudflare) | **B GRC / Mgmt** (Credo · OneTrust · watsonx · ServiceNow) | **C AI Security** (Lakera · Cisco · Straiker · SourceA) | **D Observability** (AgentOps · Arize · Langfuse) | **SA / NF** |
|------------|---------------------------------------------|-------------------------------------------------------------|--------------------------------------------------------|---------------------------------------------------|-------------|
...
| **Copilot / M365 board-grade export** | — | ◐ Purview native · Securiti readiness | **✔️** SourceA Studio focus | — | **✔️ NF** TLE · board PDF · proc ZIP |
...
| Capability | Securiti Copilot | SourceA | Microsoft Purview | Credo AI GAIA | **Noetfield NF-RD** |
|------------|------------------|--------|-------------------|---------------|---------------------|
...
| C Security | Threat detect · MCP scan · Copilot surface (SourceA) | Tamper-evident ledger | Live demo · receipt artifact |
