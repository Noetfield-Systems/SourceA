...
- **Site is ahead of execution** — SW1–SW4, AB1, NW1 all ❌ logged; self-score 90/A is internal marketing, not market truth.
...
- **Compare matrix is your marketing** — Naming light/dark layout themes without rows or methodology is outbound ammo, not evidence.
...
| 0.5 | Soften compare: “Capability map (illustrative)” + footnote to benchmark | [`compare.html`](SourceA-landing/green-unified/compare.html), home `#compare` | Legal safety |
...
| 1.5 | Honest rescore | Update benchmark addendum: visual B+/A−; trust C+ until AB1/NW1; drop self-graded A |
...
| **AB1** | Send agency one-pager + outreach snippet · log W3 via `controlled_agentic_automation_offer_v1.py` | AB1 ❌→✅ |
...
| Outbound receipts | ❌ | ab1 or nw1 send receipt logged |
...
Honest edge logged remains: **tamper-evident receipts · critic_boot BLOCK · live replay · self-hosted law**. Site sells it; eval path and hub spine do not fully prove it yet.
