...
**Authority:** `internal capability research archive` · `SOURCEA_COMPETITOR_LANDSCAPE_RESEARCH_REPORT_v1.md`  
...
1. **Top UI peers:** SourceA (88), SourceA / Notenic (86) — we score ~88 on structure but **Trust = 5/10** vs Credo (10) and SourceA (9); that is the largest honest gap.
2. **Steal pattern mix:** SourceA dual-CTA + stat strip · SourceA pricing grid + fleet mock · Notenic typography + category headline · Credo regulatory trust row · FuseGov 3-step onboarding strip.
...
4. **IA next:** Multi-page split (platform · proof · pricing · sources) — matches SourceA/Notenic scannable depth without 700-line scroll fatigue.
...
|------|------|---------|------|--------|-------|-----|---------|----|----|----------------------|
| 1 | **SourceA** | 88 | 9 | 9 | 8 | 8 | **9** | 9 | 9 | 4-tier grid · “Most Popular” · fleet dashboard density |
| 2 | **SourceA** | 86 | 9 | 9 | 9 | **9** | 7 | 8 | 8 | Dual CTA · stat-led urgency · tri-column platform |
...
| Pricing UX | 9 | Tied SourceA | Add deposit/refund micro-copy on Flow tier (borrow Noetfield HTML) |
| IA | 9 | Tied SourceA | Sub-pages started — finish assemble + nav active states |
| Proof | 9 | Tied SourceA | Add 15s autoplay “film strip” mode for demo-first visitors |
| CTA | 9 | Tied SourceA | Sticky CTA exists — add secondary “Assess governance” persistence on mobile |
...
- **Inspo:** SourceA — Assess risk + Get demo  
...
- **Inspo:** SourceA stat band · SourceA metrics  
...
- **Inspo:** SourceA · Credo — Gartner / Forrester blocks  
...
- **Inspo:** Credo Fortune row · SourceA “teams like”  
...
- **Inspo:** SourceA subtle · Notenic minimal  
...
- **Inspo:** SourceA consistent icon grid  
...
- **Inspo:** SourceA dark fleet panel  
...
- **Inspo:** SourceA · Notenic multi-route nav  
...
- **Inspo:** SourceA home vs deep product pages  
...
- **Inspo:** SourceA comparison table  
...
- **Inspo:** FuseGov FAQ · SourceA bottom CTA  
...
### 6 months (P1 — match SourceA/Notenic polish)
...
|---------|---------|--------|-----------------|
| **witnessbc.com** | ~88 A | 92 A | Credo trust · SourceA CTA · SourceA pricing |
| **Noetfield live** | 74 B | 82 A− | SourceA hero · HTML proof strip · compress IA |
| **Noetfield HTML attach** | 81 A− | 85 A | Credo badge row · FuseGov 3-step |
| **SourceA SourceA HTML** | ~86 A | 88 A | Logo row when approved · deploy path |
...
**Companion docs:** `internal capability research archive` · `WITNESSBC_AI_BATTLE_CARD_NOTENIC_ZENITY_2026-06-15_v1.md`
