...
**Authority:** `_2026-06-15_v1.md` · `SOURCEA__LANDSCAPE_RESEARCH_REPORT_v1.md`  
...
1. **Top UI peers:**  (88),  / Notenic (86) — we score ~88 on structure but **Trust = 5/10** vs Credo (10) and  (9); that is the largest honest gap.
2. **Steal pattern mix:**  dual-CTA + stat strip ·  pricing grid + fleet mock · Notenic typography + category headline · Credo regulatory trust row · FuseGov 3-step onboarding strip.
...
4. **IA next:** Multi-page split (platform · proof · pricing · sources) — matches /Notenic scannable depth without 700-line scroll fatigue.
...
|------|------|---------|------|--------|-------|-----|---------|----|----|----------------------|
| 1 | **** | 88 | 9 | 9 | 8 | 8 | **9** | 9 | 9 | 4-tier grid · “Most Popular” · fleet dashboard density |
| 2 | **** | 86 | 9 | 9 | 9 | **9** | 7 | 8 | 8 | Dual CTA · stat-led urgency · tri-column platform |
...
| Pricing UX | 9 | Tied  | Add deposit/refund micro-copy on Flow tier (borrow Noetfield HTML) |
| IA | 9 | Tied  | Sub-pages started — finish assemble + nav active states |
| Proof | 9 | Tied  | Add 15s autoplay “film strip” mode for demo-first visitors |
| CTA | 9 | Tied  | Sticky CTA exists — add secondary “Assess governance” persistence on mobile |
...
- **Inspo:**  · Credo — Gartner / Forrester blocks  
...
- **Inspo:** Credo Fortune row ·  “teams like”  
...
- **Inspo:**  home vs deep product pages  
...
### 6 months (P1 — match /Notenic polish)
...
|---------|---------|--------|-----------------|
| **witnessbc.com** | ~88 A | 92 A | Credo trust ·  CTA ·  pricing |
| **Noetfield live** | 74 B | 82 A− |  hero · HTML proof strip · compress IA |
| **Noetfield HTML attach** | 81 A− | 85 A | Credo badge row · FuseGov 3-step |
| **SourceA  HTML** | ~86 A | 88 A | Logo row when approved · deploy path |
...
**Companion docs:** `_2026-06-15_v1.md` · `WITNESSBC_AI_BATTLE_CARD_NOTENIC__2026-06-15_v1.md`
