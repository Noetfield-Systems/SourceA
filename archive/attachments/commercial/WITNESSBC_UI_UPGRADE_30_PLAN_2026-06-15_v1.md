# Witness AI — 30-Point UI Upgrade Plan (-Informed)
...
**Authority:** `EXTERNAL_DESIGN_BENCHMARK_2026-06-15_v1.md` · `SOURCEA__LANDSCAPE_RESEARCH_REPORT_v1.md`  
...
1. **Top UI peers:** [agent-aispm-vendor] (88), [agent-aispm-vendor] / Notenic (86) — we score ~88 on structure but **Trust = 5/10** vs Credo (10) and [agent-aispm-vendor] (9); that is the largest honest gap.
2. **Steal pattern mix:** [agent-aispm-vendor] dual-CTA + stat strip · [agent-aispm-vendor] pricing grid + fleet mock · Notenic typography + category headline · Credo regulatory trust row · FuseGov 3-step onboarding strip.
3. **Our edge to preserve:** Verification terminal, lifecycle stepper, crosswalk table, control-plane hero — already A-grade; upgrade around them, do not replace.
4. **IA next:** Multi-page split (platform · proof · pricing · sources) — matches [agent-aispm-vendor]/Notenic scannable depth without 700-line scroll fatigue.
...
|------|------|---------|------|--------|-------|-----|---------|----|----|----------------------|
| 1 | **[agent-aispm-vendor]** | 88 | 9 | 9 | 8 | 8 | **9** | 9 | 9 | 4-tier grid · “Most Popular” · fleet dashboard density |
| 2 | **[agent-aispm-vendor]** | 86 | 9 | 9 | 9 | **9** | 7 | 8 | 8 | Dual CTA · stat-led urgency · tri-column platform |
...
**Scoring method:** Same 8 dimensions as  doc · 1–10 each · overall = average × 10.
...
| Pricing UX | 9 | Tied [agent-aispm-vendor] | Add deposit/refund micro-copy on Flow tier (borrow Noetfield HTML) |
| IA | 9 | Tied [agent-aispm-vendor] | Sub-pages started — finish assemble + nav active states |
| Proof | 9 | Tied [agent-aispm-vendor] | Add 15s autoplay “film strip” mode for demo-first visitors |
| CTA | 9 | Tied [agent-aispm-vendor] | Sticky CTA exists — add secondary “Assess governance” persistence on mobile |
...
- **Inspo:** [agent-aispm-vendor] — Assess risk + Get demo  
...
- **Inspo:** [agent-aispm-vendor] stat band · [agent-aispm-vendor] metrics  
...
- **Inspo:** [agent-aispm-vendor] · Credo — Gartner / Forrester blocks  
...
- **Inspo:** Credo Fortune row · [agent-aispm-vendor] “teams like”  
...
- **Inspo:** [agent-aispm-vendor] subtle · Notenic minimal  
...
- **Inspo:** [agent-aispm-vendor] consistent icon grid  
...
- **Inspo:** [agent-aispm-vendor] dark fleet panel  
...
- **Inspo:** [agent-aispm-vendor] share cards  
...
- **Inspo:** [agent-aispm-vendor] · Notenic multi-route nav  
...
- **Inspo:** [agent-aispm-vendor] home vs deep product pages  
...
- **Inspo:** [agent-aispm-vendor] pillar cards  
...
- **Inspo:** [agent-aispm-vendor] footer columns  
...
**21. Verification “film strip” autoplay**  
...
- **Inspo:** [agent-aispm-vendor] eval dimensions  
...
- **Inspo:** [agent-aispm-vendor] fleet dashboard  
...
- **Inspo:** [agent-aispm-vendor] comparison table  
...
- **Inspo:** [agent-aispm-vendor] featured tier  
...
- **Inspo:** [agent-aispm-vendor] persistent demo  
...
- **Inspo:** FuseGov FAQ · [agent-aispm-vendor] bottom CTA  
...
### 6 months (P1 — match [agent-aispm-vendor]/Notenic polish)
...
|---------|---------|--------|-----------------|
| **witnessbc.com** | ~88 A | 92 A | Credo trust · [agent-aispm-vendor] CTA · [agent-aispm-vendor] pricing |
| **Noetfield live** | 74 B | 82 A− | [agent-aispm-vendor] hero · HTML proof strip · compress IA |
| **Noetfield HTML attach** | 81 A− | 85 A | Credo badge row · FuseGov 3-step |
| **SourceA [agent-aispm-vendor] HTML** | ~86 A | 88 A | Logo row when approved · deploy path |
...
- ** names** on customer-facing pages ( law)  
...
**Companion docs:** `EXTERNAL_DESIGN_BENCHMARK_2026-06-15_v1.md` · `WITNESSBC_AI_BATTLE_CARD_NOTENIC_EXTERNAL_DESIGN_REF_2026-06-15_v1.md`
