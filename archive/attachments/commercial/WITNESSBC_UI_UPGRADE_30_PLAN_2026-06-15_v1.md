...
**Authority:** `EXTERNAL_DESIGN_BENCHMARK_2026-06-15_v1.md` · `SOURCEA_COMPETITOR_LANDSCAPE_RESEARCH_REPORT_v1.md`  
...
1. **Top UI peers:** [external-design-benchmark] (88), [external-design-benchmark] / Notenic (86) — we score ~88 on structure but **Trust = 5/10** vs Credo (10) and [external-design-benchmark] (9); that is the largest honest gap.
2. **Steal pattern mix:** [external-design-benchmark] dual-CTA + stat strip · [external-design-benchmark] pricing grid + fleet mock · Notenic typography + category headline · Credo regulatory trust row · FuseGov 3-step onboarding strip.
...
4. **IA next:** Multi-page split (platform · proof · pricing · sources) — matches [external-design-benchmark]/Notenic scannable depth without 700-line scroll fatigue.
...
|------|------|---------|------|--------|-------|-----|---------|----|----|----------------------|
| 1 | **[external-design-benchmark]** | 88 | 9 | 9 | 8 | 8 | **9** | 9 | 9 | 4-tier grid · “Most Popular” · fleet dashboard density |
| 2 | **[external-design-benchmark]** | 86 | 9 | 9 | 9 | **9** | 7 | 8 | 8 | Dual CTA · stat-led urgency · tri-column platform |
...
| Pricing UX | 9 | Tied [external-design-benchmark] | Add deposit/refund micro-copy on Flow tier (borrow Noetfield HTML) |
| IA | 9 | Tied [external-design-benchmark] | Sub-pages started — finish assemble + nav active states |
| Proof | 9 | Tied [external-design-benchmark] | Add 15s autoplay “film strip” mode for demo-first visitors |
| CTA | 9 | Tied [external-design-benchmark] | Sticky CTA exists — add secondary “Assess governance” persistence on mobile |
...
- **Inspo:** [external-design-benchmark] — Assess risk + Get demo  
...
- **Inspo:** [external-design-benchmark] stat band · [external-design-benchmark] metrics  
...
- **Inspo:** [external-design-benchmark] · Credo — Gartner / Forrester blocks  
...
- **Inspo:** Credo Fortune row · [external-design-benchmark] “teams like”  
...
- **Inspo:** [external-design-benchmark] subtle · Notenic minimal  
...
- **Inspo:** [external-design-benchmark] consistent icon grid  
...
- **Inspo:** [external-design-benchmark] dark fleet panel  
...
- **Inspo:** [external-design-benchmark] share cards  
...
- **Inspo:** [external-design-benchmark] · Notenic multi-route nav  
...
- **Inspo:** [external-design-benchmark] home vs deep product pages  
...
- **Inspo:** [external-design-benchmark] pillar cards  
...
- **Inspo:** [external-design-benchmark] footer columns  
...
- **Inspo:** [external-design-benchmark] eval dimensions  
...
- **Inspo:** [external-design-benchmark] fleet dashboard  
...
- **Inspo:** [external-design-benchmark] comparison table  
...
- **Inspo:** [external-design-benchmark] featured tier  
...
- **Inspo:** [external-design-benchmark] persistent demo  
...
- **Inspo:** FuseGov FAQ · [external-design-benchmark] bottom CTA  
...
### 6 months (P1 — match [external-design-benchmark]/Notenic polish)
...
|---------|---------|--------|-----------------|
| **witnessbc.com** | ~88 A | 92 A | Credo trust · [external-design-benchmark] CTA · [external-design-benchmark] pricing |
| **Noetfield live** | 74 B | 82 A− | [external-design-benchmark] hero · HTML proof strip · compress IA |
| **Noetfield HTML attach** | 81 A− | 85 A | Credo badge row · FuseGov 3-step |
| **SourceA [external-design-benchmark] HTML** | ~86 A | 88 A | Logo row when approved · deploy path |
