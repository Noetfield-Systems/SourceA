# SourceA  Landscape — Research Report v1.2
...
**Intake merged:** `archive/attachments/commercial/SOURCEA_NOETFIELD__LANDSCAPE_2026-06-15_v1_3.md` (external-eye 30-company map · Jun 2026)  
...
SourceA competes in **L6 controlled execution** — not L0 models, not L7 chat UI, not L3 orchestration alone.

**Closest direct  (2025–2026):** Notenic, FuseGov, [agent-aispm-vendor], ThinkNEO, AgentPEP, Predicate Authority, [agent-aispm-vendor], WitnessAI, Credo AI GAIA, Securiti, Microsoft Authorization Fabric + Purview. *(Tier 1 below — tighter architectural fit than gateway/GRC names in the 30-map.)*

**Noetfield lane :** Securiti Copilot Readiness, [agent-aispm-vendor] (Copilot Studio), Microsoft Purview (native), Credo AI, IBM watsonx.governance, Vanta/Drata (evidence posture).
...
## Market map — 30  (external-eye · Jun 2026)
...
| **C. AI security / runtime** | 8 | Lakera, Cisco AI Defense, Straiker, [agent-aispm-vendor], WitnessAI | Detection / prompt firewall — not signed replayable ledger |
...
**Use in raise/deck:** enforcement-receipt layer has **strategic value** beyond near-term ARR. **Do not** quote  revenue. Label **HYPOTHESIS** in outbound.
...
| **Services bridge** | $3–10K project or $2–5K/mo retainer *(illustrative)* | **Disk SKUs:** Asset B DFY `SOURCEA_ASSET_B_CONTROLLED_AGENTIC_AUTOMATION_LOCKED_v1.md` · agency $750/$299 `SOURCEA_AGENCY_PRODUCT_DEMO_SCRIPT_LOCKED_v1.md` · Buyer 1 $200–$2K/mo — SSOT §10 |
...
| Layer | Job | Key  | SourceA / portfolio |
|-------|-----|-----------------|---------------------|
...
| **L6 Governance PEP/PDP** | Block before action | Notenic, FuseGov, [agent-aispm-vendor], AgentPEP, Predicate, ThinkNEO, Microsoft Auth Fabric | **Wedge** — ENFORCE, critic_boot, trust ledger |
| **L6 Compliance GRC** | Policy lifecycle, board packs | Credo AI, IBM watsonx, OneTrust, Holistic AI, Monitaur | **Noetfield** face |
| **L6 Copilot-specific** | M365 agent governance | Securiti, [agent-aispm-vendor], Purview, WitnessAI | **Noetfield NF-RD** |
...
| **[agent-aispm-vendor]** | https://[agent-aispm-vendor].ai/ | Full agent management — identity, lifecycle, governance, orchestration | High — 20-dim eval before every action | Fleet dashboard · OSS SDK tier | Narrower wedge — compliance latency + re-brief |
...
| **AgentPEP** | https://github.com/Shivapas/AgentPEP | Open-source PEP — OPA/Rego, intercept every tool call | High on PEP pattern | SOC2 narrative · 14.8K dec/s  | Integrated briefing + SSOT fingerprint |
...
| **ThinkFleet Shield** | https://www.thinkfleet.ai/products/shield | Proxy governance — shadow AI, SIEM, evidence | Medium — tone + ops console reference logged | Product maturity | Anti-staleness latches · maintainer audit |
...
| **[agent-aispm-vendor]** | https://[agent-aispm-vendor].io/ | AISPM + AIDR — Copilot Studio, Bedrock, Vertex agent discovery | Gartner Cool Vendor TRiSM 2025 | Build-time + runtime agent security — we sell **governance latency** + evidence export |
...
| **WitnessAI** | https://witness.ai/ | Network-layer AI traffic capture · shadow AI · intent ML | $58M raise Jan 2026 | Network observe — we enforce **pre-execution logged state** |
...
**Production pattern 2026:** Temporal (outer) + LangGraph (inner). SourceA should **not** pitch as Temporal  — pitch as **policy layer above any orchestrator**.
...
##  matrix — feature level

| Capability | Notenic | [agent-aispm-vendor] | Securiti | Credo AI | Microsoft | **SourceA** |
|------------|---------|--------|----------|----------|-----------|-------------|
...
### For Noetfield (NW1)
- **Primary rivals in room:** Securiti + [agent-aispm-vendor] + Microsoft "good enough" Purview story.
...
- [agent-aispm-vendor] fleet management · ThinkNEO gateway — agency ops, not compliance board.
...
| [agent-aispm-vendor] | https://[agent-aispm-vendor].ai/ |
...
| [agent-aispm-vendor] platform | https://[agent-aispm-vendor].io/platform |
...
| In-repo constellation | `SOURCEA_REFERENCE_ARCHITECTURE_CONSTELLATION_LOCKED_v1.md` |
...
5. ~~**30-company market map + consolidation**~~ — intake `SOURCEA_NOETFIELD__LANDSCAPE_2026-06-15_v1_3.md` merged v1.2

## Attachments index:** intake v1.3 · strategy pack · one-pager MERGED EXTERNAL · merge checklist · `validate--landscape-v1_3.sh` · **UI ** `EXTERNAL_DESIGN_BENCHMARK_2026-06-15_v1.md` · HTML `generate_commercial_onepager_html_v1.py`
