...
**Closest direct competitors (2025–2026):** Notenic, FuseGov, [external-design-benchmark], ThinkNEO, AgentPEP, Predicate Authority, [external-design-benchmark], WitnessAI, Credo AI GAIA, Securiti, Microsoft Authorization Fabric + Purview. *(Tier 1 below — tighter architectural fit than gateway/GRC names in the 30-map.)*

**Noetfield lane competitors:** Securiti Copilot Readiness, [external-design-benchmark] (Copilot Studio), Microsoft Purview (native), Credo AI, IBM watsonx.governance, Vanta/Drata (evidence posture).
...
| **C. AI security / runtime** | 8 | Lakera, Cisco AI Defense, Straiker, [external-design-benchmark], WitnessAI | Detection / prompt firewall — not signed replayable ledger |
...
| **L6 Governance PEP/PDP** | Block before action | Notenic, FuseGov, [external-design-benchmark], AgentPEP, Predicate, ThinkNEO, Microsoft Auth Fabric | **Wedge** — ENFORCE, critic_boot, trust ledger |
| **L6 Compliance GRC** | Policy lifecycle, board packs | Credo AI, IBM watsonx, OneTrust, Holistic AI, Monitaur | **Noetfield** face |
| **L6 Copilot-specific** | M365 agent governance | Securiti, [external-design-benchmark], Purview, WitnessAI | **Noetfield NF-RD** |
...
| **[external-design-benchmark]** | https://[external-design-benchmark].ai/ | Full agent management — identity, lifecycle, governance, orchestration | High — 20-dim eval before every action | Fleet dashboard · OSS SDK tier | Narrower wedge — compliance latency + re-brief |
...
| **[external-design-benchmark]** | https://[external-design-benchmark].io/ | AISPM + AIDR — Copilot Studio, Bedrock, Vertex agent discovery | Gartner Cool Vendor TRiSM 2025 | Build-time + runtime agent security — we sell **governance latency** + evidence export |
...
| Capability | Notenic | [external-design-benchmark] | Securiti | Credo AI | Microsoft | **SourceA** |
|------------|---------|--------|----------|----------|-----------|-------------|
...
### For Noetfield (NW1)
- **Primary rivals in room:** Securiti + [external-design-benchmark] + Microsoft "good enough" Purview story.
...
- [external-design-benchmark] fleet management · ThinkNEO gateway — agency ops, not compliance board.
...
| [external-design-benchmark] | https://[external-design-benchmark].ai/ |
...
| [external-design-benchmark] platform | https://[external-design-benchmark].io/platform |
...
## Attachments index:** intake v1.3 · strategy pack · one-pager MERGED EXTERNAL · merge checklist · `validate-competitor-landscape-v1_3.sh` · **UI benchmark** `EXTERNAL_DESIGN_BENCHMARK_2026-06-15_v1.md` · HTML `generate_commercial_onepager_html_v1.py`
