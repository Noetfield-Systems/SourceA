...
**Closest direct  (2025–2026):** Notenic, FuseGov, , ThinkNEO, AgentPEP, Predicate Authority, , WitnessAI, Credo AI GAIA, Securiti, Microsoft Authorization Fabric + Purview. *(Tier 1 below — tighter architectural fit than gateway/GRC names in the 30-map.)*

**Noetfield lane :** Securiti Copilot Readiness,  (Copilot Studio), Microsoft Purview (native), Credo AI, IBM watsonx.governance, Vanta/Drata (evidence posture).
...
## Attachments index:** intake v1.3 · strategy pack · one-pager MERGED EXTERNAL · merge checklist · `validate--landscape-v1_3.sh` · **UI ** `_2026-06-15_v1.md` · HTML `generate_commercial_onepager_html_v1.py`
