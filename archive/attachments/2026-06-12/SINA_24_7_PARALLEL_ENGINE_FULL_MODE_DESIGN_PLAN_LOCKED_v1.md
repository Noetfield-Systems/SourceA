...
**Note:** Disk says **Railway** (MergePack API deploy). **Raygun** (error monitoring) is optional observability — not present locally as primary SSOT.
...
| Class | Tools logged | Role in engine | SSOT? |
|-------|---------------|----------------|-------|
...
| **Reference models** | `SINA_COMPETITION_AND_REFERENCE_MATRIX_v1.yaml` | Precedent · not build order | Research |
...
**Week 1 exit:** 5 workflows designed · 3 running in **test mode** · health receipt every 15m logged.
