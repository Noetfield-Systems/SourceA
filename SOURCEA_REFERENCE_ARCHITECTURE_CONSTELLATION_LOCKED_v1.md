...
│   Datadog · Paid.ai · AgentMarketCap ( map)           │
├─────────────────────────────────────────────────────────────────┤
...
| **OpenAI Frontier** | https://openai.com/business/frontier/ | AI coworkers — business context, agent IAM, eval loops, auditable actions | External  for “agent as employee” — SourceA is self-hosted + law-first |
