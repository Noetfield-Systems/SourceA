...
**Canonical worker packs** moved to `brain-os/law/enforcement/` and `brain-os/handoffs/`.

| Legacy path under `os/chat-handoffs/` | Use instead |
|---------------------------------------|-------------|
| `MANDATORY_SOURCEA_WORKER_CHAT_*` | `brain-os/law/enforcement/MANDATORY_SOURCEA_WORKER_CHAT_LOCKED_v1.md` |
