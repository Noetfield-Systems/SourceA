# Canada Priority A Send-Ready Emails — LOCKED

**Version:** 1.0.1 · **Saved:** 2026-06-18T10:23:55Z · **Status:** LOCKED
**Path:** `/Users/sinakazemnezhad/Desktop/1 PAGER/CANADA_PRIORITY_A_SEND_READY_EMAILS_LOCKED_v1.md`

---


**Version:** 1.0.0 · **Saved:** 2026-06-17T23:52:48Z
...
## W3 Hub approvals (founder · 2026-06-18T10:23:55Z)

| Account | Lane | SKU | hub_approve_slot |
|---------|------|-----|------------------|
| **Ocree Capital** | TrustField | T-P6 | **approved** |
| **Fundmore.ai** | Noetfield | NF-RD | **approved** |

**Receipt:** `SourceA/data/commercial/w3-canada-send-approvals-v1.json`  
**Send policy:** approved_not_sent — fill champion + CASL relationship basis · founder sends manually · no auto-send.
...
|---------|------|-----|--------|
| Ocree Capital | **TrustField** | T-P6 | 1 |
| Fractionvest | **TrustField** | T-P6, TF-P1-DP | 2 |
| Tetra Digital Group | **TrustField** | TF-001, T-P6 | 3 |
| Stablecorp | **TrustField** | TF-001 | 4 |
| Atlas One Digital Securities / Parvis Invest | **TrustField** | T-P6 | 5 |
| Aquanow | **TrustField** | T-P6 | 6 |
| Bitbuy | **TrustField** | TF-P1-DP | 7 |
| NDAX | **TrustField** | TF-P1-DP | 8 |
| Newton Crypto | **TrustField** | TF-P1-DP | 9 |
| Fundmore.ai | **Noetfield** | NF-RD | 10 |
| Pineapple Financial | **TrustField** | T-P6 | 11 |
| Pineapple Financial | **Noetfield** | NF-RD | 12 |

**Dual:** Pineapple = Email 11 (TrustField) then Email 12 (Noetfield) · 2 weeks apart.

---

## 01. Ocree Capital · TrustField · T-P6

**Champion:** CCO · Platform · CEO  
**Signal (Jun 2026):** OSC-registered EMD · $51.9M Winnipeg CRE on Polymesh · CSA Project Tokenization  
**Verify:** OSC EMD — verify exempt market dealer registration  
...
[Full name] · TrustField Technologies
...
## 02. Fractionvest · TrustField · T-P6, TF-P1-DP

**Champion:** Founder · CCO  
**Signal (Jun 2026):** OSC sandbox RE tokenization pilot · Polymesh · dealer registration path  
**Verify:** Verify OSC sandbox status before citing  
...
## 03. Tetra Digital Group · TrustField · TF-001, T-P6

**Champion:** Chief Compliance · Product · Institutional sales  
**Signal (Jun 2026):** CADD live May 2026 · regulated CAD stablecoin · ETF custody  
**Verify:** FINTRAC MSB verify required — fintrac-canafe.canada.ca  
...
## 04. Stablecorp · TrustField · TF-001

**Champion:** CEO · Partnerships · Compliance  
**Signal (Jun 2026):** QCAD FI infrastructure · Deloitte alliance Mar 2026 · Bill C-15  
**Verify:** FINTRAC MSB verify · Stablecorp/QCAD public disclosures  
...
## 05. Atlas One Digital Securities / Parvis Invest · TrustField · T-P6

**Champion:** CEO · Head of Platform · CCO · Digital strategy  
**Signal (Jun 2026):** Parvis LOI May 2026 · $110M+ raised · EMD consolidation  
**Verify:** OSC/CSA EMD verify · single worksheet row for both entities  
...
## 06. Aquanow · TrustField · T-P6

**Champion:** CEO · Institutional sales · Compliance  
**Signal (Jun 2026):** B2B plumbing for majority of Canadian crypto · Visa stablecoin settlement  
**Verify:** FINTRAC MSB verify · B2B — champion may be institutional sales  
...
## 07. Bitbuy · TrustField · TF-P1-DP

**Champion:** Head of Risk · Compliance · Engineering  
**Signal (Jun 2026):** CIRO Investment Dealer + FINTRAC · WonderFi platform  
**Verify:** CIRO dealer + FINTRAC MSB — verify before send  
...
## 08. NDAX · TrustField · TF-P1-DP

**Champion:** Compliance · Product  
**Signal (Jun 2026):** CIRO Investment Dealer Dec 2024 · Calgary · custody  
**Verify:** CIRO + FINTRAC verify  
...
## 09. Newton Crypto · TrustField · TF-P1-DP

**Champion:** Product · Risk · Compliance  
**Signal (Jun 2026):** CSA Restricted Dealer · Mar 2025 registration · retail spread model  
**Verify:** CSA restricted dealer verify  
...
## 10. Fundmore.ai · Noetfield · NF-RD

**Champion:** CEO · Product · Compliance  
**Signal (Jun 2026):** AI mortgage platform · CSA tokenization + lending convergence  
**Verify:** Noetfield lane only — never lead with TrustField FINTRAC pack  
...
## 11. Pineapple Financial · TrustField · T-P6

**Champion:** CTO · Compliance · Product  
**Signal (Jun 2026):** $13.7B CAD mortgage book on-chain migration · PAPL NYSE  
**Verify:** Dual account — send Noetfield email 2 weeks later · separate SOW  
...
## 12. Pineapple Financial · Noetfield · NF-RD

**Champion:** CTO · Product (AI broker ops)  
**Signal (Jun 2026):** AI broker ops on mortgage platform · separate from tokenization story  
**Verify:** Send 2 weeks after pineapple-tf · never blend SOWs  
