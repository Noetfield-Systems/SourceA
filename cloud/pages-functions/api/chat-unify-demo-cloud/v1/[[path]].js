/** Demo Chat Unify cloud proxy — /api/chat-unify-demo-cloud/v1/* → CHAT_UNIFY_UPSTREAM_URL */
...
export async function onRequest(context) {
  ...
  const sub = url.pathname.replace(/^\/api\/chat-unify-demo-cloud\/v1\/?/, "") || "";
  ...
  headers.set("X-Chat-Unify-Mode", "demo-proxy");
