# wb-mkt-0972 — Maven AGI · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Escalation + action log per ticket pattern)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0972`
