# wb-mkt-0991 — Maven AGI · Integrations & API
...
List Maven AGI integrations/APIs from https://www.mavenagi.com or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `wb-mkt-0991`
