# wb-mkt-0967 — Maven AGI · Pricing & packaging
...
Add upgrade CTA path: sandbox/free → paid bay matching Maven AGI upgrade pattern where applicable
...
1. `status: done` in REGISTRY.json for `wb-mkt-0967`
