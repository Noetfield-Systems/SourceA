# wb-mkt-0966 — Maven AGI · Pricing & packaging
...
Document why buyers pay per Maven AGI: Support volume exceeds headcount — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `wb-mkt-0966`
