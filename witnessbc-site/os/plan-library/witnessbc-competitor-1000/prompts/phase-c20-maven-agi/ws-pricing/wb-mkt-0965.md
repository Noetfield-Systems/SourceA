# wb-mkt-0965 — Maven AGI · Pricing & packaging
...
Compare Maven AGI PLG motion (Support AI enterprise sales) vs our onboarding — one adoption fix on `Founding cohort shadow parallel install SOW`
...
1. `status: done` in REGISTRY.json for `wb-mkt-0965`
