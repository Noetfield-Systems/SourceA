# wb-mkt-0969 — Maven AGI · Pricing & packaging
...
Write competitor row evidence: Maven AGI pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `wb-mkt-0969`
