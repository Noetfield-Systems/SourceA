# wb-mkt-0963 — Maven AGI · Pricing & packaging
...
Add or update one public price card on `witnessbc.com pricing + toolkits hub` inspired by Maven AGI packaging motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0963`
