# wb-mkt-0970 — Maven AGI · Pricing & packaging
...
Close wb-mkt-0970: PRIORITY row + verify PASS + link https://www.mavenagi.com
...
1. `status: done` in REGISTRY.json for `wb-mkt-0970`
