# wb-mkt-0956 — Maven AGI · Buyer-visible UX
...
Add `Witness AI Flow install replay demo + 6 receipt types` mock row labeled mock_only until live — match Maven AGI run/history metaphor not invented name
...
1. `status: done` in REGISTRY.json for `wb-mkt-0956`
