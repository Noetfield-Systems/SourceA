# wb-mkt-0957 — Maven AGI · Buyer-visible UX
...
Document who buys (Support leaders at mid-market+) vs our ICP one sentence on `witnessbc-site/content/pricing.html` row for Maven AGI
...
1. `status: done` in REGISTRY.json for `wb-mkt-0957`
