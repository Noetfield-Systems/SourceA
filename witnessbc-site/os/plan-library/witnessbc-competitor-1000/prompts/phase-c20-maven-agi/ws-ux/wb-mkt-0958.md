# wb-mkt-0958 — Maven AGI · Buyer-visible UX
...
Reject abstract rename — keep market words buyers know from Maven AGI (Enterprise support agents)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0958`
