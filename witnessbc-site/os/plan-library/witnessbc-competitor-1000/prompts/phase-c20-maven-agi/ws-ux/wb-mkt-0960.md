# wb-mkt-0960 — Maven AGI · Buyer-visible UX
...
Mark wb-mkt-0960 done in REGISTRY with evidence path + https://www.mavenagi.com after verify PASS
...
1. `status: done` in REGISTRY.json for `wb-mkt-0960`
