# wb-mkt-0989 — Maven AGI · Onboarding & PLG
...
Docs: onboarding section cites Maven AGI as market analog with https://www.mavenagi.com
...
1. `status: done` in REGISTRY.json for `wb-mkt-0989`
