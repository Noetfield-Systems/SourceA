# wb-mkt-0982 — Maven AGI · Onboarding & PLG
...
Define ≤30s-to-value step on `Founding cohort shadow parallel install SOW` copied from Maven AGI motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0982`
