# wb-mkt-0981 — Maven AGI · Onboarding & PLG
...
Document Maven AGI onboarding path (Support AI enterprise sales): who runs (Vendor SaaS enterprise) → first value moment
...
1. `status: done` in REGISTRY.json for `wb-mkt-0981`
