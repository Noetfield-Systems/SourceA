# wb-mkt-0481 — Gumloop · Onboarding & PLG
...
Document Gumloop onboarding path (PLG free tier → Pro $37): who runs (Vendor SaaS) → first value moment
...
1. `status: done` in REGISTRY.json for `wb-mkt-0481`
