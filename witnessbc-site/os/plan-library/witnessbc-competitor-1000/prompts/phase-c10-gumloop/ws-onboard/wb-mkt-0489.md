# wb-mkt-0489 — Gumloop · Onboarding & PLG
...
Docs: onboarding section cites Gumloop as market analog with https://www.gumloop.com/pricing
...
1. `status: done` in REGISTRY.json for `wb-mkt-0489`
