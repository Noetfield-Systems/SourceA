# wb-mkt-0482 — Gumloop · Onboarding & PLG
...
Define ≤30s-to-value step on `Founding cohort shadow parallel install SOW` copied from Gumloop motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0482`
