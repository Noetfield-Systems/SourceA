# wb-mkt-0457 — Gumloop · Buyer-visible UX
...
Document who buys (Business and ops teams) vs our ICP one sentence on `witnessbc-site/content/pricing.html` row for Gumloop
...
1. `status: done` in REGISTRY.json for `wb-mkt-0457`
