# wb-mkt-0497 — Gumloop · Integrations & API
...
Rate-limit + retry policy copied from Gumloop operating model (Visual canvas; agent interactions; policy guardrails)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0497`
