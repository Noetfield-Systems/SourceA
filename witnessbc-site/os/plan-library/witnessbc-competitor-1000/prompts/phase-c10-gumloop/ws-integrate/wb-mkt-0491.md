# wb-mkt-0491 — Gumloop · Integrations & API
...
List Gumloop integrations/APIs from https://www.gumloop.com/pricing or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `wb-mkt-0491`
