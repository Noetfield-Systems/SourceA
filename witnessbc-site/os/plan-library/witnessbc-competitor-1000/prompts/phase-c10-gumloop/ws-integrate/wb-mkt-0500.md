# wb-mkt-0500 — Gumloop · Integrations & API
...
Close wb-mkt-0500: integration receipt + verify PASS + https://www.gumloop.com/pricing
...
1. `status: done` in REGISTRY.json for `wb-mkt-0500`
