# wb-mkt-0470 — Gumloop · Pricing & packaging
...
Close wb-mkt-0470: PRIORITY row + verify PASS + link https://www.gumloop.com/pricing
...
1. `status: done` in REGISTRY.json for `wb-mkt-0470`
