# wb-mkt-0465 — Gumloop · Pricing & packaging
...
Compare Gumloop PLG motion (PLG free tier → Pro $37) vs our onboarding — one adoption fix on `Founding cohort shadow parallel install SOW`
...
1. `status: done` in REGISTRY.json for `wb-mkt-0465`
