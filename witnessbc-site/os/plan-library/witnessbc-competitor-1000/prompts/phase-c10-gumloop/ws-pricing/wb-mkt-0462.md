# wb-mkt-0462 — Gumloop · Pricing & packaging
...
Map Gumloop revenue model (Credit-based subscription) to our `Free toolkits → Pro packs → Flow install → Ops retainer` tier names — no hidden fees theater
...
1. `status: done` in REGISTRY.json for `wb-mkt-0462`
