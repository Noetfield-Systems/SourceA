# wb-mkt-0472 — Gumloop · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: App policies + guardrails UI on agent dispatch)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0472`
