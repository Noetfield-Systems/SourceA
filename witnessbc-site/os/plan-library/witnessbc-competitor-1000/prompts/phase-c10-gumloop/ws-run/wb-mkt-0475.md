# wb-mkt-0475 — Gumloop · Run history & proof
...
Add retention note: how long run history kept vs Gumloop (Free 5k credits/mo; Pro $37/mo — https://www.gumloop.com/pricing tier hints)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0475`
