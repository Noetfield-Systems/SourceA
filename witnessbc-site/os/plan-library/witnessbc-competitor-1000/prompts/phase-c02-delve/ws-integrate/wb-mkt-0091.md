# wb-mkt-0091 — Delve · Integrations & API
...
List Delve integrations/APIs from https://delve.co or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `wb-mkt-0091`
