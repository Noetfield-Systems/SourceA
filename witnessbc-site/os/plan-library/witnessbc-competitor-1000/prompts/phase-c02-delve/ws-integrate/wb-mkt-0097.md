# wb-mkt-0097 — Delve · Integrations & API
...
Rate-limit + retry policy copied from Delve operating model (AI agents integrate tools; collect screenshots and logs)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0097`
