# wb-mkt-0081 — Delve · Onboarding & PLG
...
Document Delve onboarding path (YC 2023 → $32M Series A 2025): who runs (Vendor SaaS + expert Slack support) → first value moment
...
1. `status: done` in REGISTRY.json for `wb-mkt-0081`
