# wb-mkt-0086 — Delve · Onboarding & PLG
...
Write founder-facing SOW snippet if Delve uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `wb-mkt-0086`
