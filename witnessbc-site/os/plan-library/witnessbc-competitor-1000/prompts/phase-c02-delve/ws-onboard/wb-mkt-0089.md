# wb-mkt-0089 — Delve · Onboarding & PLG
...
Docs: onboarding section cites Delve as market analog with https://delve.co
...
1. `status: done` in REGISTRY.json for `wb-mkt-0089`
