# wb-mkt-0082 — Delve · Onboarding & PLG
...
Define ≤30s-to-value step on `Founding cohort shadow parallel install SOW` copied from Delve motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0082`
