# wb-mkt-0072 — Delve · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Fast install motion — always verify independent auditor (lesson from 2026 controversy))
...
1. `status: done` in REGISTRY.json for `wb-mkt-0072`
