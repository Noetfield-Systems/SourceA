# wb-mkt-0075 — Delve · Run history & proof
...
Add retention note: how long run history kept vs Delve (~$18,000–30,000+/yr (market); contact sales — note Mar 2026 audit controversy tier hints)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0075`
