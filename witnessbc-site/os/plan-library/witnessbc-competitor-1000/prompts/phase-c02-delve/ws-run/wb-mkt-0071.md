# wb-mkt-0071 — Delve · Run history & proof
...
From https://delve.co document Delve run/history UX: AI agents integrate tools; collect screenshots and logs — map to `Witness AI Flow install replay demo + 6 receipt types`

## Implementation extraction

`Delve · Run history & proof` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `wb-mkt-0071`
