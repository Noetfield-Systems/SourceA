# wb-mkt-0060 — Delve · Buyer-visible UX
...
Mark wb-mkt-0060 done in REGISTRY with evidence path + https://delve.co after verify PASS
...
1. `status: done` in REGISTRY.json for `wb-mkt-0060`
