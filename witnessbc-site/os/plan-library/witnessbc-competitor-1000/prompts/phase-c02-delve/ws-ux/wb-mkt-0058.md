# wb-mkt-0058 — Delve · Buyer-visible UX
...
Reject abstract rename — keep market words buyers know from Delve (AI compliance automation)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0058`
