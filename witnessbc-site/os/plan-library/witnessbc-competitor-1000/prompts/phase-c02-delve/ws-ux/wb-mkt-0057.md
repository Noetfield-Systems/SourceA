# wb-mkt-0057 — Delve · Buyer-visible UX
...
Document who buys (AI startups needing fast SOC 2) vs our ICP one sentence on `witnessbc-site/content/pricing.html` row for Delve
...
1. `status: done` in REGISTRY.json for `wb-mkt-0057`
