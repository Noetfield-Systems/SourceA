# wb-mkt-0051 — Delve · Buyer-visible UX
...
Open https://delve.co — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Delve uses; paste into plan evidence (vendor says: AI agents auto-collect evidence for SOC 2, HIPAA, GDPR, ISO)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0051`
