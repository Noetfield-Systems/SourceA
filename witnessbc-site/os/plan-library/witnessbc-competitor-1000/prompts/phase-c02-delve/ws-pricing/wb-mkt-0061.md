# wb-mkt-0061 — Delve · Pricing & packaging
...
Capture Delve public pricing evidence: ~$18,000–30,000+/yr (market); contact sales — note Mar 2026 audit controversy — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `wb-mkt-0061`
