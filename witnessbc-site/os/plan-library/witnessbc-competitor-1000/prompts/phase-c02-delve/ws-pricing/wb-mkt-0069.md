# wb-mkt-0069 — Delve · Pricing & packaging
...
Write competitor row evidence: Delve pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `wb-mkt-0069`
