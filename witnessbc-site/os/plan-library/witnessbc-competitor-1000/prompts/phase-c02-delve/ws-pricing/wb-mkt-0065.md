# wb-mkt-0065 — Delve · Pricing & packaging
...
Compare Delve PLG motion (YC 2023 → $32M Series A 2025) vs our onboarding — one adoption fix on `Founding cohort shadow parallel install SOW`
...
1. `status: done` in REGISTRY.json for `wb-mkt-0065`
