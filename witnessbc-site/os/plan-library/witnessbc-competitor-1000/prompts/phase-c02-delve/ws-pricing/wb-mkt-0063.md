# wb-mkt-0063 — Delve · Pricing & packaging
...
Add or update one public price card on `witnessbc.com pricing + toolkits hub` inspired by Delve packaging motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0063`
