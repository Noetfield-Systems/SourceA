# wb-mkt-0066 — Delve · Pricing & packaging
...
Document why buyers pay per Delve: 200–400 hours manual compliance → promised 50–100 hours — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `wb-mkt-0066`
