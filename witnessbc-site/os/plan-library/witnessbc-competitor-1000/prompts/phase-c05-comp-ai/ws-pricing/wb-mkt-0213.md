# wb-mkt-0213 — Comp AI · Pricing & packaging
...
Add or update one public price card on `witnessbc.com pricing + toolkits hub` inspired by Comp AI packaging motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0213`
