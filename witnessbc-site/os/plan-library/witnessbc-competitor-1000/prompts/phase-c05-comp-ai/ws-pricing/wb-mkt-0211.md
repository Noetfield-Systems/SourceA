# wb-mkt-0211 — Comp AI · Pricing & packaging
...
Capture Comp AI public pricing evidence: Startup tiers (market) — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `wb-mkt-0211`
