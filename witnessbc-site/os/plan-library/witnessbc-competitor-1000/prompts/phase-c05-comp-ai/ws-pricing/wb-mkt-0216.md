# wb-mkt-0216 — Comp AI · Pricing & packaging
...
Document why buyers pay per Comp AI: Need SOC 2 to close enterprise deals fast — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `wb-mkt-0216`
