# wb-mkt-0215 — Comp AI · Pricing & packaging
...
Compare Comp AI PLG motion (Startup compliance PLG) vs our onboarding — one adoption fix on `Founding cohort shadow parallel install SOW`
...
1. `status: done` in REGISTRY.json for `wb-mkt-0215`
