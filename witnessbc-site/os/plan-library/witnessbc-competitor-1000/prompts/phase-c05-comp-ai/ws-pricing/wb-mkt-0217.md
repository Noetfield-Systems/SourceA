# wb-mkt-0217 — Comp AI · Pricing & packaging
...
Add upgrade CTA path: sandbox/free → paid bay matching Comp AI upgrade pattern where applicable
...
1. `status: done` in REGISTRY.json for `wb-mkt-0217`
