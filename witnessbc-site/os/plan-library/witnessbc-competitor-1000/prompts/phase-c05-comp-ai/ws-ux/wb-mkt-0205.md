# wb-mkt-0205 — Comp AI · Buyer-visible UX
...
Diff our public copy vs Comp AI pricing/product page — list 3 concrete gaps; fix highest P0 gap only
...
1. `status: done` in REGISTRY.json for `wb-mkt-0205`
