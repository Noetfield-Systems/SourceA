# wb-mkt-0201 — Comp AI · Buyer-visible UX
...
Open https://comp.ai — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Comp AI uses; paste into plan evidence (vendor says: Get SOC 2 compliant quickly with AI-assisted automation)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0201`
