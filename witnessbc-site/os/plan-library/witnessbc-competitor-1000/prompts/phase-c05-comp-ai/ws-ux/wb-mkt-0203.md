# wb-mkt-0203 — Comp AI · Buyer-visible UX
...
Add `witnessbc.com pricing + toolkits hub` UI field or copy block implementing smallest slice of `≤30-day install promise on Witness AI Flow SOW`; preserve honest tier label
...
1. `status: done` in REGISTRY.json for `wb-mkt-0203`
