# wb-mkt-0208 — Comp AI · Buyer-visible UX
...
Reject abstract rename — keep market words buyers know from Comp AI (SOC 2 in a box)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0208`
