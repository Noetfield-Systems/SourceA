# wb-mkt-0210 — Comp AI · Buyer-visible UX
...
Mark wb-mkt-0210 done in REGISTRY with evidence path + https://comp.ai after verify PASS
...
1. `status: done` in REGISTRY.json for `wb-mkt-0210`
