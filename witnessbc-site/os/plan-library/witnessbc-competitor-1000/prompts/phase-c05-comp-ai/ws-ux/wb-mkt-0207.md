# wb-mkt-0207 — Comp AI · Buyer-visible UX
...
Document who buys (Early-stage SaaS) vs our ICP one sentence on `witnessbc-site/content/pricing.html` row for Comp AI
...
1. `status: done` in REGISTRY.json for `wb-mkt-0207`
