# wb-mkt-0231 — Comp AI · Onboarding & PLG
...
Document Comp AI onboarding path (Startup compliance PLG): who runs (Vendor SaaS) → first value moment
...
1. `status: done` in REGISTRY.json for `wb-mkt-0231`
