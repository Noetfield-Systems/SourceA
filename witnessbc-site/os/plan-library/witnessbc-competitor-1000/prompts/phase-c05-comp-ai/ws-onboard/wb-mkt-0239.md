# wb-mkt-0239 — Comp AI · Onboarding & PLG
...
Docs: onboarding section cites Comp AI as market analog with https://comp.ai
...
1. `status: done` in REGISTRY.json for `wb-mkt-0239`
