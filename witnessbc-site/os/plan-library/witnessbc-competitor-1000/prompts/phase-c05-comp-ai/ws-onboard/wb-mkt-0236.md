# wb-mkt-0236 — Comp AI · Onboarding & PLG
...
Write founder-facing SOW snippet if Comp AI uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `wb-mkt-0236`
