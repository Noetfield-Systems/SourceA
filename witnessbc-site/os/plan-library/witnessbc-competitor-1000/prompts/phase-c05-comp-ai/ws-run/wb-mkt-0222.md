# wb-mkt-0222 — Comp AI · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: ≤30-day install promise on Witness AI Flow SOW)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0222`
