# wb-mkt-0241 — Comp AI · Integrations & API
...
List Comp AI integrations/APIs from https://comp.ai or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `wb-mkt-0241`
