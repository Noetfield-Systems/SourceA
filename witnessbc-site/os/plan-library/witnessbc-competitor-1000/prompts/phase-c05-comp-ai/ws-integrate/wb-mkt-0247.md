# wb-mkt-0247 — Comp AI · Integrations & API
...
Rate-limit + retry policy copied from Comp AI operating model (Guided setup; automated evidence; auditor handoff)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0247`
