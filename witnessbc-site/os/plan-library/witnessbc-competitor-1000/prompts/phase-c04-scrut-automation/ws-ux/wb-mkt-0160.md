# wb-mkt-0160 — Scrut Automation · Buyer-visible UX
...
Mark wb-mkt-0160 done in REGISTRY with evidence path + https://scrut.io after verify PASS
...
1. `status: done` in REGISTRY.json for `wb-mkt-0160`
