# wb-mkt-0157 — Scrut Automation · Buyer-visible UX
...
Document who buys (Mid-market compliance leads) vs our ICP one sentence on `witnessbc-site/content/pricing.html` row for Scrut Automation
...
1. `status: done` in REGISTRY.json for `wb-mkt-0157`
