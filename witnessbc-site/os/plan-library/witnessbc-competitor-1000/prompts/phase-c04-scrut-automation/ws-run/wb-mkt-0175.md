# wb-mkt-0175 — Scrut Automation · Run history & proof
...
Add retention note: how long run history kept vs Scrut Automation (Custom mid-market pricing tier hints)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0175`
