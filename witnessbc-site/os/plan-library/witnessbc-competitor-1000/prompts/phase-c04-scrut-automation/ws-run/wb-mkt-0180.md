# wb-mkt-0180 — Scrut Automation · Run history & proof
...
Mark wb-mkt-0180 done with run page screenshot or receipt path
...
1. `status: done` in REGISTRY.json for `wb-mkt-0180`
