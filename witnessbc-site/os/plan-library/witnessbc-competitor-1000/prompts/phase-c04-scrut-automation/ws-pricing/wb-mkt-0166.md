# wb-mkt-0166 — Scrut Automation · Pricing & packaging
...
Document why buyers pay per Scrut Automation: GRC spreadsheets fail audits — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `wb-mkt-0166`
