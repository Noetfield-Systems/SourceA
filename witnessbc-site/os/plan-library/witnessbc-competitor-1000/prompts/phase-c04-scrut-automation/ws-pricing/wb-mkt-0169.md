# wb-mkt-0169 — Scrut Automation · Pricing & packaging
...
Write competitor row evidence: Scrut Automation pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `wb-mkt-0169`
