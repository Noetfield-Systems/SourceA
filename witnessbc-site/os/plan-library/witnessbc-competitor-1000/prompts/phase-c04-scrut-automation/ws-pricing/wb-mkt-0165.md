# wb-mkt-0165 — Scrut Automation · Pricing & packaging
...
Compare Scrut Automation PLG motion (Mid-market compliance sales) vs our onboarding — one adoption fix on `Founding cohort shadow parallel install SOW`
...
1. `status: done` in REGISTRY.json for `wb-mkt-0165`
