# wb-mkt-0163 — Scrut Automation · Pricing & packaging
...
Add or update one public price card on `witnessbc.com pricing + toolkits hub` inspired by Scrut Automation packaging motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0163`
