# wb-mkt-0161 — Scrut Automation · Pricing & packaging
...
Capture Scrut Automation public pricing evidence: Custom mid-market pricing — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `wb-mkt-0161`
