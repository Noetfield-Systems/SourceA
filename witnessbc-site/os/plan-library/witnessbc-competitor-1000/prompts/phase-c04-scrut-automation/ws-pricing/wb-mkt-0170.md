# wb-mkt-0170 — Scrut Automation · Pricing & packaging
...
Close wb-mkt-0170: PRIORITY row + verify PASS + link https://scrut.io
...
1. `status: done` in REGISTRY.json for `wb-mkt-0170`
