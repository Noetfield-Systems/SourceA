# wb-mkt-0200 — Scrut Automation · Integrations & API
...
Close wb-mkt-0200: integration receipt + verify PASS + https://scrut.io
...
1. `status: done` in REGISTRY.json for `wb-mkt-0200`
