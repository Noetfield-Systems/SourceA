# wb-mkt-0199 — Scrut Automation · Integrations & API
...
Update catalog/registry row for integration — Scrut Automation row 24
...
1. `status: done` in REGISTRY.json for `wb-mkt-0199`
