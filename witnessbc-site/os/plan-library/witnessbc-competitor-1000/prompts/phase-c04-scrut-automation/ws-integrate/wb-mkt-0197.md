# wb-mkt-0197 — Scrut Automation · Integrations & API
...
Rate-limit + retry policy copied from Scrut Automation operating model (Control monitoring; evidence vault; audit readiness)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0197`
