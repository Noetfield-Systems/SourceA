# wb-mkt-0191 — Scrut Automation · Integrations & API
...
List Scrut Automation integrations/APIs from https://scrut.io or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `wb-mkt-0191`
