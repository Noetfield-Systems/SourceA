# wb-mkt-0182 — Scrut Automation · Onboarding & PLG
...
Define ≤30s-to-value step on `Founding cohort shadow parallel install SOW` copied from Scrut Automation motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0182`
