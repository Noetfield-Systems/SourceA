# wb-mkt-0189 — Scrut Automation · Onboarding & PLG
...
Docs: onboarding section cites Scrut Automation as market analog with https://scrut.io
...
1. `status: done` in REGISTRY.json for `wb-mkt-0189`
