# wb-mkt-0187 — Scrut Automation · Onboarding & PLG
...
Measure drop-off: list one friction point vs Scrut Automation and fix
...
1. `status: done` in REGISTRY.json for `wb-mkt-0187`
