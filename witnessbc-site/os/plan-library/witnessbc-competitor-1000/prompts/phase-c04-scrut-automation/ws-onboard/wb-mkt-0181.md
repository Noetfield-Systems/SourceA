# wb-mkt-0181 — Scrut Automation · Onboarding & PLG
...
Document Scrut Automation onboarding path (Mid-market compliance sales): who runs (Vendor SaaS) → first value moment
...
1. `status: done` in REGISTRY.json for `wb-mkt-0181`
