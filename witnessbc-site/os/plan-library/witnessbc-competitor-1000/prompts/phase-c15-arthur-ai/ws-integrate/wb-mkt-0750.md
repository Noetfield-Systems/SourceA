# wb-mkt-0750 — Arthur AI · Integrations & API
...
Close wb-mkt-0750: integration receipt + verify PASS + https://www.arthur.ai
...
1. `status: done` in REGISTRY.json for `wb-mkt-0750`
