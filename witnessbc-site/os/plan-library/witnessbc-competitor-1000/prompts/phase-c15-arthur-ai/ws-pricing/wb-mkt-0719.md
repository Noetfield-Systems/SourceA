# wb-mkt-0719 — Arthur AI · Pricing & packaging
...
Write competitor row evidence: Arthur AI pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `wb-mkt-0719`
