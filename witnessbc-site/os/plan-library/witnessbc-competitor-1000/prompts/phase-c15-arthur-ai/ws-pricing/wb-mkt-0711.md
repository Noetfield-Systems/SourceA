# wb-mkt-0711 — Arthur AI · Pricing & packaging
...
Capture Arthur AI public pricing evidence: Enterprise custom — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `wb-mkt-0711`
