# wb-mkt-0715 — Arthur AI · Pricing & packaging
...
Compare Arthur AI PLG motion (ML monitoring incumbents extend to LLM) vs our onboarding — one adoption fix on `Founding cohort shadow parallel install SOW`
...
1. `status: done` in REGISTRY.json for `wb-mkt-0715`
