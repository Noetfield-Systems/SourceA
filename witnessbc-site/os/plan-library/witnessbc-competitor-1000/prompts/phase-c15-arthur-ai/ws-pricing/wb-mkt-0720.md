# wb-mkt-0720 — Arthur AI · Pricing & packaging
...
Close wb-mkt-0720: PRIORITY row + verify PASS + link https://www.arthur.ai
...
1. `status: done` in REGISTRY.json for `wb-mkt-0720`
