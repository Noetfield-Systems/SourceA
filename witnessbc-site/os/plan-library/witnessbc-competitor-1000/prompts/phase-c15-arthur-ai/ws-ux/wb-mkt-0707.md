# wb-mkt-0707 — Arthur AI · Buyer-visible UX
...
Document who buys (ML platform owners) vs our ICP one sentence on `witnessbc-site/content/pricing.html` row for Arthur AI
...
1. `status: done` in REGISTRY.json for `wb-mkt-0707`
