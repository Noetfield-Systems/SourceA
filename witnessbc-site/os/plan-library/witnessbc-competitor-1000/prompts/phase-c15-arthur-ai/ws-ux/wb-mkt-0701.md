# wb-mkt-0701 — Arthur AI · Buyer-visible UX
...
Open https://www.arthur.ai — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Arthur AI uses; paste into plan evidence (vendor says: Monitor ML and LLM performance, drift, and quality)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0701`
