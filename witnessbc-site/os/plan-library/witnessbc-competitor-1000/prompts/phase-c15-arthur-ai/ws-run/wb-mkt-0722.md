# wb-mkt-0722 — Arthur AI · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Drift/quality alerts on Witness AI Ops)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0722`
