# wb-mkt-0721 — Arthur AI · Run history & proof
...
From https://www.arthur.ai document Arthur AI run/history UX: Ingest predictions; detect drift; alert — map to `Witness AI Flow install replay demo + 6 receipt types`
...
1. `status: done` in REGISTRY.json for `wb-mkt-0721`
