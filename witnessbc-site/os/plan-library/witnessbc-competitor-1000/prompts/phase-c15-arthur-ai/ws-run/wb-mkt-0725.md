# wb-mkt-0725 — Arthur AI · Run history & proof
...
Add retention note: how long run history kept vs Arthur AI (Enterprise custom tier hints)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0725`
