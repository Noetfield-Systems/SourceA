# wb-mkt-0736 — Arthur AI · Onboarding & PLG
...
Write founder-facing SOW snippet if Arthur AI uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `wb-mkt-0736`
