# wb-mkt-0731 — Arthur AI · Onboarding & PLG
...
Document Arthur AI onboarding path (ML monitoring incumbents extend to LLM): who runs (Vendor SaaS) → first value moment
...
1. `status: done` in REGISTRY.json for `wb-mkt-0731`
