# wb-mkt-0386 — Vanta · Onboarding & PLG
...
Write founder-facing SOW snippet if Vanta uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `wb-mkt-0386`
