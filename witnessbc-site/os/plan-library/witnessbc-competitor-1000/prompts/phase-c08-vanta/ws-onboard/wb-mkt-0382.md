# wb-mkt-0382 — Vanta · Onboarding & PLG
...
Define ≤30s-to-value step on `Founding cohort shadow parallel install SOW` copied from Vanta motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0382`
