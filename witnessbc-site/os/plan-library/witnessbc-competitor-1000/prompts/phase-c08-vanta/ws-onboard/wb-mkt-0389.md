# wb-mkt-0389 — Vanta · Onboarding & PLG
...
Docs: onboarding section cites Vanta as market analog with https://www.vanta.com
...
1. `status: done` in REGISTRY.json for `wb-mkt-0389`
