# wb-mkt-0381 — Vanta · Onboarding & PLG
...
Document Vanta onboarding path (Category leader PLG → enterprise): who runs (Vendor SaaS (pattern reference)) → first value moment
...
1. `status: done` in REGISTRY.json for `wb-mkt-0381`
