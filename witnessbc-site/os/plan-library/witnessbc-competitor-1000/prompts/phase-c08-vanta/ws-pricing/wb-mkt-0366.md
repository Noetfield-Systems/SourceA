# wb-mkt-0366 — Vanta · Pricing & packaging
...
Document why buyers pay per Vanta: Buyers require SOC 2 proof before contract — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `wb-mkt-0366`
