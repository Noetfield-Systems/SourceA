# wb-mkt-0369 — Vanta · Pricing & packaging
...
Write competitor row evidence: Vanta pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `wb-mkt-0369`
