# wb-mkt-0362 — Vanta · Pricing & packaging
...
Map Vanta revenue model (Annual SaaS + add-ons) to our `Free toolkits → Pro packs → Flow install → Ops retainer` tier names — no hidden fees theater
...
1. `status: done` in REGISTRY.json for `wb-mkt-0362`
