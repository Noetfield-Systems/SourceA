# wb-mkt-0365 — Vanta · Pricing & packaging
...
Compare Vanta PLG motion (Category leader PLG → enterprise) vs our onboarding — one adoption fix on `Founding cohort shadow parallel install SOW`
...
1. `status: done` in REGISTRY.json for `wb-mkt-0365`
