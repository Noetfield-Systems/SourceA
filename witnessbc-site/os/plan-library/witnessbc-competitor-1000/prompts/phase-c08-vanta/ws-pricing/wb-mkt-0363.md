# wb-mkt-0363 — Vanta · Pricing & packaging
...
Add or update one public price card on `witnessbc.com pricing + toolkits hub` inspired by Vanta packaging motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0363`
