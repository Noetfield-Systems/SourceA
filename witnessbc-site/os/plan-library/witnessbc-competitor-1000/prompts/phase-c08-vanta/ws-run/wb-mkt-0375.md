# wb-mkt-0375 — Vanta · Run history & proof
...
Add retention note: how long run history kept vs Vanta (Custom; often $10k–50k/yr (market) tier hints)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0375`
