# wb-mkt-0372 — Vanta · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Control → linked proof artifact (pattern only))
...
1. `status: done` in REGISTRY.json for `wb-mkt-0372`
