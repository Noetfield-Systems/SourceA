# wb-mkt-0397 — Vanta · Integrations & API
...
Rate-limit + retry policy copied from Vanta operating model (Connect stack; continuous monitoring; trust center)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0397`
