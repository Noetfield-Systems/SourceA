# wb-mkt-0391 — Vanta · Integrations & API
...
List Vanta integrations/APIs from https://www.vanta.com or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `wb-mkt-0391`
