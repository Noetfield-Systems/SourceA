# wb-mkt-0357 — Vanta · Buyer-visible UX
...
Document who buys (Startups to mid-market) vs our ICP one sentence on `witnessbc-site/content/pricing.html` row for Vanta
...
1. `status: done` in REGISTRY.json for `wb-mkt-0357`
