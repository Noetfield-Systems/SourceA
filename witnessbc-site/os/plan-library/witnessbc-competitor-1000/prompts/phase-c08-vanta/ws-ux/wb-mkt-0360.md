# wb-mkt-0360 — Vanta · Buyer-visible UX
...
Mark wb-mkt-0360 done in REGISTRY with evidence path + https://www.vanta.com after verify PASS
...
1. `status: done` in REGISTRY.json for `wb-mkt-0360`
