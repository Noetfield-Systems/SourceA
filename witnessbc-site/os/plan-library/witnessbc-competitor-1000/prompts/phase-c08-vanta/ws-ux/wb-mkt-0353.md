# wb-mkt-0353 — Vanta · Buyer-visible UX
...
Add `witnessbc.com pricing + toolkits hub` UI field or copy block implementing smallest slice of `Control → linked proof artifact (pattern only)`; preserve honest tier label
...
1. `status: done` in REGISTRY.json for `wb-mkt-0353`
