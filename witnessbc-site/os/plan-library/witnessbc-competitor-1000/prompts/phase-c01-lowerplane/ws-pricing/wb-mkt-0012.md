# wb-mkt-0012 — LowerPlane · Pricing & packaging
...
Map LowerPlane revenue model (Annual subscription transparent tiers) to our `Free toolkits → Pro packs → Flow install → Ops retainer` tier names — no hidden fees theater
...
1. `status: done` in REGISTRY.json for `wb-mkt-0012`
