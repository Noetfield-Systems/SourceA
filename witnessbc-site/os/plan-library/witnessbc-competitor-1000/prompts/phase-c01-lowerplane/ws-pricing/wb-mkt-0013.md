# wb-mkt-0013 — LowerPlane · Pricing & packaging
...
Add or update one public price card on `witnessbc.com pricing + toolkits hub` inspired by LowerPlane packaging motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0013`
