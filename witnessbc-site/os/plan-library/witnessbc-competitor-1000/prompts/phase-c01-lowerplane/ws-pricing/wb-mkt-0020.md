# wb-mkt-0020 — LowerPlane · Pricing & packaging
...
Close wb-mkt-0020: PRIORITY row + verify PASS + link https://lowerplane.com · https://lowerplane.com/pricing
...
1. `status: done` in REGISTRY.json for `wb-mkt-0020`
