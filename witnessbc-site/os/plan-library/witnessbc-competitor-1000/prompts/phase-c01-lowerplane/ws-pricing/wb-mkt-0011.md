# wb-mkt-0011 — LowerPlane · Pricing & packaging
...
Capture LowerPlane public pricing evidence: From $4,995/yr SOC2; bundles up to $15,995 — https://lowerplane.com/pricing — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `wb-mkt-0011`
