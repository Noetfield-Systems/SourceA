# wb-mkt-0017 — LowerPlane · Pricing & packaging
...
Add upgrade CTA path: sandbox/free → paid bay matching LowerPlane upgrade pattern where applicable
...
1. `status: done` in REGISTRY.json for `wb-mkt-0017`
