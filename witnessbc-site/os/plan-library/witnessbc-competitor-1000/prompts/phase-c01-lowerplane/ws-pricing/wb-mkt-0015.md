# wb-mkt-0015 — LowerPlane · Pricing & packaging
...
Compare LowerPlane PLG motion (Public price cards vs Delve sales-led) vs our onboarding — one adoption fix on `Founding cohort shadow parallel install SOW`
...
1. `status: done` in REGISTRY.json for `wb-mkt-0015`
