# wb-mkt-0001 — LowerPlane · Buyer-visible UX
...
Open https://lowerplane.com · https://lowerplane.com/pricing — screenshot or quote the exact buyer-facing Buyer-visible UX sentence LowerPlane uses; paste into plan evidence (vendor says: AI-powered SOC 2, ISO 27001, HIPAA compliance with public pricing)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0001`
