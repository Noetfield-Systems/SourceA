# wb-mkt-0003 — LowerPlane · Buyer-visible UX
...
Add `witnessbc.com pricing + toolkits hub` UI field or copy block implementing smallest slice of `Public pricing ladder like WitnessBC toolkits → install tiers`; preserve honest tier label
...
1. `status: done` in REGISTRY.json for `wb-mkt-0003`
