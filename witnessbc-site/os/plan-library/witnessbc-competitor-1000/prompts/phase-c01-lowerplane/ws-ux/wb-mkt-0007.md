# wb-mkt-0007 — LowerPlane · Buyer-visible UX
...
Document who buys (Startups needing first SOC 2) vs our ICP one sentence on `witnessbc-site/content/pricing.html` row for LowerPlane
...
1. `status: done` in REGISTRY.json for `wb-mkt-0007`
