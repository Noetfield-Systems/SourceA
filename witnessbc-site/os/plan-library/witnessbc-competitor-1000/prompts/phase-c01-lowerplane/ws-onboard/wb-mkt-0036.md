# wb-mkt-0036 — LowerPlane · Onboarding & PLG
...
Write founder-facing SOW snippet if LowerPlane uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `wb-mkt-0036`
