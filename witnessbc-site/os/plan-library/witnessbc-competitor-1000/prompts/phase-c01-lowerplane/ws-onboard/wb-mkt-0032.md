# wb-mkt-0032 — LowerPlane · Onboarding & PLG
...
Define ≤30s-to-value step on `Founding cohort shadow parallel install SOW` copied from LowerPlane motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0032`
