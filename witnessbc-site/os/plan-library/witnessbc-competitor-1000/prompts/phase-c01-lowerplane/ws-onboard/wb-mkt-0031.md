# wb-mkt-0031 — LowerPlane · Onboarding & PLG
...
Document LowerPlane onboarding path (Public price cards vs Delve sales-led): who runs (Vendor-managed SaaS) → first value moment
...
1. `status: done` in REGISTRY.json for `wb-mkt-0031`
