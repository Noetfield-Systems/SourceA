# wb-mkt-0039 — LowerPlane · Onboarding & PLG
...
Docs: onboarding section cites LowerPlane as market analog with https://lowerplane.com · https://lowerplane.com/pricing
...
1. `status: done` in REGISTRY.json for `wb-mkt-0039`
