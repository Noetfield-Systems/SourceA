# wb-mkt-0025 — LowerPlane · Run history & proof
...
Add retention note: how long run history kept vs LowerPlane (From $4,995/yr SOC2; bundles up to $15,995 — https://lowerplane.com/pricing tier hints)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0025`
