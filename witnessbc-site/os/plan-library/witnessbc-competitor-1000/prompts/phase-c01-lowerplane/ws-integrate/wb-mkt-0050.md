# wb-mkt-0050 — LowerPlane · Integrations & API
...
Close wb-mkt-0050: integration receipt + verify PASS + https://lowerplane.com · https://lowerplane.com/pricing
...
1. `status: done` in REGISTRY.json for `wb-mkt-0050`
