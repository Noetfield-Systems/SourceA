# wb-mkt-0041 — LowerPlane · Integrations & API
...
List LowerPlane integrations/APIs from https://lowerplane.com · https://lowerplane.com/pricing or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `wb-mkt-0041`
