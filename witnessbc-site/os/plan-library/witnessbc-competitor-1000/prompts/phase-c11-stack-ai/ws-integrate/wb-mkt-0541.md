# wb-mkt-0541 — Stack AI · Integrations & API
...
List Stack AI integrations/APIs from https://www.stack-ai.com or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `wb-mkt-0541`
