# wb-mkt-0547 — Stack AI · Integrations & API
...
Rate-limit + retry policy copied from Stack AI operating model (Build agent workflows; deploy with access control)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0547`
