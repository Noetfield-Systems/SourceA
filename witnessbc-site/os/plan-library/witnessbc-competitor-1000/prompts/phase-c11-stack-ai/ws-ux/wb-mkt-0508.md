# wb-mkt-0508 — Stack AI · Buyer-visible UX
...
Reject abstract rename — keep market words buyers know from Stack AI (Enterprise AI agents)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0508`
