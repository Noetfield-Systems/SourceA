# wb-mkt-0501 — Stack AI · Buyer-visible UX
...
Open https://www.stack-ai.com — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Stack AI uses; paste into plan evidence (vendor says: No-code enterprise AI agents with SOC2/HIPAA compliance)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0501`
