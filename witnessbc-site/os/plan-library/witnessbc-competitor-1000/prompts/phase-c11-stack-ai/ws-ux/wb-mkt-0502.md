# wb-mkt-0502 — Stack AI · Buyer-visible UX
...
Write one-line UX spec: `Stack AI Buyer-visible UX` → buyer sees X → we show on `witnessbc.com pricing + toolkits hub` (lesson: SOC2/HIPAA lane packaging for Witness AI Ops retainer)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0502`
