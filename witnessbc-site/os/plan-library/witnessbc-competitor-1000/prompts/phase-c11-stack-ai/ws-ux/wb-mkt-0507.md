# wb-mkt-0507 — Stack AI · Buyer-visible UX
...
Document who buys (Regulated enterprise IT) vs our ICP one sentence on `witnessbc-site/content/pricing.html` row for Stack AI
...
1. `status: done` in REGISTRY.json for `wb-mkt-0507`
