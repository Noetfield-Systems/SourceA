# wb-mkt-0525 — Stack AI · Run history & proof
...
Add retention note: how long run history kept vs Stack AI (Free 500 runs/mo; enterprise custom tier hints)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0525`
