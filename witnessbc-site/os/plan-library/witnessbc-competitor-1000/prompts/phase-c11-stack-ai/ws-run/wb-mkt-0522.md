# wb-mkt-0522 — Stack AI · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: SOC2/HIPAA lane packaging for Witness AI Ops retainer)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0522`
