# wb-mkt-0519 — Stack AI · Pricing & packaging
...
Write competitor row evidence: Stack AI pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `wb-mkt-0519`
