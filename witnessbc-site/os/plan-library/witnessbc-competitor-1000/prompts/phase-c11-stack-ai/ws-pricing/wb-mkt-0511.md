# wb-mkt-0511 — Stack AI · Pricing & packaging
...
Capture Stack AI public pricing evidence: Free 500 runs/mo; enterprise custom — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `wb-mkt-0511`
