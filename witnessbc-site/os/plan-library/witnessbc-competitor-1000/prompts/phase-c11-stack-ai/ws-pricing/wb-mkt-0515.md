# wb-mkt-0515 — Stack AI · Pricing & packaging
...
Compare Stack AI PLG motion (Enterprise compliance positioning) vs our onboarding — one adoption fix on `Founding cohort shadow parallel install SOW`
...
1. `status: done` in REGISTRY.json for `wb-mkt-0515`
