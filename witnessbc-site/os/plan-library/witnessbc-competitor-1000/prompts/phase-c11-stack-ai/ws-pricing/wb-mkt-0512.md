# wb-mkt-0512 — Stack AI · Pricing & packaging
...
Map Stack AI revenue model (Enterprise annual contracts) to our `Free toolkits → Pro packs → Flow install → Ops retainer` tier names — no hidden fees theater
...
1. `status: done` in REGISTRY.json for `wb-mkt-0512`
