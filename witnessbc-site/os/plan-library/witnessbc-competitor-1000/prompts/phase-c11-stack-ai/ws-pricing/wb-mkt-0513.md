# wb-mkt-0513 — Stack AI · Pricing & packaging
...
Add or update one public price card on `witnessbc.com pricing + toolkits hub` inspired by Stack AI packaging motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0513`
