# wb-mkt-0520 — Stack AI · Pricing & packaging
...
Close wb-mkt-0520: PRIORITY row + verify PASS + link https://www.stack-ai.com
...
1. `status: done` in REGISTRY.json for `wb-mkt-0520`
