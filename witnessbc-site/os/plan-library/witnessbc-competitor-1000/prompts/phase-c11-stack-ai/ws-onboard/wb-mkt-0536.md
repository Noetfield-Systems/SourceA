# wb-mkt-0536 — Stack AI · Onboarding & PLG
...
Write founder-facing SOW snippet if Stack AI uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `wb-mkt-0536`
