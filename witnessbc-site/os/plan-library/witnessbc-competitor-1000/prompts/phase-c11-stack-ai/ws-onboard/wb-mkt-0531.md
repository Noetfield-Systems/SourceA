# wb-mkt-0531 — Stack AI · Onboarding & PLG
...
Document Stack AI onboarding path (Enterprise compliance positioning): who runs (Vendor SaaS) → first value moment
...
1. `status: done` in REGISTRY.json for `wb-mkt-0531`
