# wb-mkt-0539 — Stack AI · Onboarding & PLG
...
Docs: onboarding section cites Stack AI as market analog with https://www.stack-ai.com
...
1. `status: done` in REGISTRY.json for `wb-mkt-0539`
