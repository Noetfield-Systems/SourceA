# wb-mkt-0657 — Holistic AI · Buyer-visible UX
...
Document who buys (Risk officers and compliance) vs our ICP one sentence on `witnessbc-site/content/pricing.html` row for Holistic AI
...
1. `status: done` in REGISTRY.json for `wb-mkt-0657`
