# wb-mkt-0691 — Holistic AI · Integrations & API
...
List Holistic AI integrations/APIs from https://www.holisticai.com or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `wb-mkt-0691`
