# wb-mkt-0675 — Holistic AI · Run history & proof
...
Add retention note: how long run history kept vs Holistic AI (Enterprise custom tier hints)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0675`
