# wb-mkt-0672 — Holistic AI · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Risk score on each agent action for ops retainer)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0672`
