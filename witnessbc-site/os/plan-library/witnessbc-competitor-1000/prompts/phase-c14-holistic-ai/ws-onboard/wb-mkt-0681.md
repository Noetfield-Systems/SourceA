# wb-mkt-0681 — Holistic AI · Onboarding & PLG
...
Document Holistic AI onboarding path (Enterprise AI governance sales): who runs (Vendor SaaS) → first value moment
...
1. `status: done` in REGISTRY.json for `wb-mkt-0681`
