# wb-mkt-0682 — Holistic AI · Onboarding & PLG
...
Define ≤30s-to-value step on `Founding cohort shadow parallel install SOW` copied from Holistic AI motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0682`
