# wb-mkt-0684 — Holistic AI · Onboarding & PLG
...
Freemium cap or trial label visible before first run (AI policy + first agentic install — site independence law)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0684`
