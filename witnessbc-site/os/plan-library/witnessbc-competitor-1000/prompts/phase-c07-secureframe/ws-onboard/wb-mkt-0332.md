# wb-mkt-0332 — Secureframe · Onboarding & PLG
...
Define ≤30s-to-value step on `Founding cohort shadow parallel install SOW` copied from Secureframe motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0332`
