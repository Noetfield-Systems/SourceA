# wb-mkt-0331 — Secureframe · Onboarding & PLG
...
Document Secureframe onboarding path (Enterprise-leaning startup compliance): who runs (Vendor SaaS) → first value moment
...
1. `status: done` in REGISTRY.json for `wb-mkt-0331`
