# wb-mkt-0339 — Secureframe · Onboarding & PLG
...
Docs: onboarding section cites Secureframe as market analog with https://secureframe.com
...
1. `status: done` in REGISTRY.json for `wb-mkt-0339`
