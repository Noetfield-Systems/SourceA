# wb-mkt-0302 — Secureframe · Buyer-visible UX
...
Write one-line UX spec: `Secureframe Buyer-visible UX` → buyer sees X → we show on `witnessbc.com pricing + toolkits hub` (lesson: Export bundle buyer can hand to auditor)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0302`
