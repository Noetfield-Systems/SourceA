# wb-mkt-0307 — Secureframe · Buyer-visible UX
...
Document who buys (Mid-market SaaS) vs our ICP one sentence on `witnessbc-site/content/pricing.html` row for Secureframe
...
1. `status: done` in REGISTRY.json for `wb-mkt-0307`
