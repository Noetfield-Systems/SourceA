# wb-mkt-0350 — Secureframe · Integrations & API
...
Close wb-mkt-0350: integration receipt + verify PASS + https://secureframe.com
...
1. `status: done` in REGISTRY.json for `wb-mkt-0350`
