# wb-mkt-0341 — Secureframe · Integrations & API
...
List Secureframe integrations/APIs from https://secureframe.com or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `wb-mkt-0341`
