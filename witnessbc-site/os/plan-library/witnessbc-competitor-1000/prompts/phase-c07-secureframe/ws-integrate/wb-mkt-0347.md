# wb-mkt-0347 — Secureframe · Integrations & API
...
Rate-limit + retry policy copied from Secureframe operating model (Integrations → continuous monitoring → audit export)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0347`
