# wb-mkt-0322 — Secureframe · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Export bundle buyer can hand to auditor)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0322`
