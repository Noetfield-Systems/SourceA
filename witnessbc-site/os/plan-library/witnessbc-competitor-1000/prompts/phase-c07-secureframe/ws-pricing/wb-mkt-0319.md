# wb-mkt-0319 — Secureframe · Pricing & packaging
...
Write competitor row evidence: Secureframe pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `wb-mkt-0319`
