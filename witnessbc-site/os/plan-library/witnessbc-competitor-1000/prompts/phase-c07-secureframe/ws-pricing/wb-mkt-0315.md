# wb-mkt-0315 — Secureframe · Pricing & packaging
...
Compare Secureframe PLG motion (Enterprise-leaning startup compliance) vs our onboarding — one adoption fix on `Founding cohort shadow parallel install SOW`
...
1. `status: done` in REGISTRY.json for `wb-mkt-0315`
