# wb-mkt-0312 — Secureframe · Pricing & packaging
...
Map Secureframe revenue model (Annual SaaS) to our `Free toolkits → Pro packs → Flow install → Ops retainer` tier names — no hidden fees theater
...
1. `status: done` in REGISTRY.json for `wb-mkt-0312`
