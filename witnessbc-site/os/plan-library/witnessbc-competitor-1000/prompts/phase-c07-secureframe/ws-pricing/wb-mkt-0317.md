# wb-mkt-0317 — Secureframe · Pricing & packaging
...
Add upgrade CTA path: sandbox/free → paid bay matching Secureframe upgrade pattern where applicable
...
1. `status: done` in REGISTRY.json for `wb-mkt-0317`
