# wb-mkt-0313 — Secureframe · Pricing & packaging
...
Add or update one public price card on `witnessbc.com pricing + toolkits hub` inspired by Secureframe packaging motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0313`
