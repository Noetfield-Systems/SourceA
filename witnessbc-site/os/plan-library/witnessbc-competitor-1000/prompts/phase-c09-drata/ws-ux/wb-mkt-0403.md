# wb-mkt-0403 — Drata · Buyer-visible UX
...
Add `witnessbc.com pricing + toolkits hub` UI field or copy block implementing smallest slice of `Live control status page pattern`; preserve honest tier label
...
1. `status: done` in REGISTRY.json for `wb-mkt-0403`
