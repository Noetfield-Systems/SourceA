# wb-mkt-0402 — Drata · Buyer-visible UX
...
Write one-line UX spec: `Drata Buyer-visible UX` → buyer sees X → we show on `witnessbc.com pricing + toolkits hub` (lesson: Live control status page pattern)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0402`
