# wb-mkt-0410 — Drata · Buyer-visible UX
...
Mark wb-mkt-0410 done in REGISTRY with evidence path + https://drata.com after verify PASS
...
1. `status: done` in REGISTRY.json for `wb-mkt-0410`
