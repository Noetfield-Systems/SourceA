# wb-mkt-0401 — Drata · Buyer-visible UX
...
Open https://drata.com — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Drata uses; paste into plan evidence (vendor says: Continuous compliance monitoring and audit readiness)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0401`
