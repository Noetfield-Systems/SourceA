# wb-mkt-0405 — Drata · Buyer-visible UX
...
Diff our public copy vs Drata pricing/product page — list 3 concrete gaps; fix highest P0 gap only
...
1. `status: done` in REGISTRY.json for `wb-mkt-0405`
