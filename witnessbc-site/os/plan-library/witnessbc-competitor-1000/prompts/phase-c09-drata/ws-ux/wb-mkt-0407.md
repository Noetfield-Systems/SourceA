# wb-mkt-0407 — Drata · Buyer-visible UX
...
Document who buys (SaaS companies) vs our ICP one sentence on `witnessbc-site/content/pricing.html` row for Drata
...
1. `status: done` in REGISTRY.json for `wb-mkt-0407`
