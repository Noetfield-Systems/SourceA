# wb-mkt-0431 — Drata · Onboarding & PLG
...
Document Drata onboarding path (Vanta competitor; strong PLG): who runs (Vendor SaaS (pattern reference)) → first value moment
...
1. `status: done` in REGISTRY.json for `wb-mkt-0431`
