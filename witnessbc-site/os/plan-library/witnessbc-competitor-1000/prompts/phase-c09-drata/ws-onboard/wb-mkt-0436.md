# wb-mkt-0436 — Drata · Onboarding & PLG
...
Write founder-facing SOW snippet if Drata uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `wb-mkt-0436`
