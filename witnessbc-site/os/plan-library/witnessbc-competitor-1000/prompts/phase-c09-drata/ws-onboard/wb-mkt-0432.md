# wb-mkt-0432 — Drata · Onboarding & PLG
...
Define ≤30s-to-value step on `Founding cohort shadow parallel install SOW` copied from Drata motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0432`
