# wb-mkt-0415 — Drata · Pricing & packaging
...
Compare Drata PLG motion (Vanta competitor; strong PLG) vs our onboarding — one adoption fix on `Founding cohort shadow parallel install SOW`
...
1. `status: done` in REGISTRY.json for `wb-mkt-0415`
