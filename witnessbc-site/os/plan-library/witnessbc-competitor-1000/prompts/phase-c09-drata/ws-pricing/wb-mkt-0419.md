# wb-mkt-0419 — Drata · Pricing & packaging
...
Write competitor row evidence: Drata pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `wb-mkt-0419`
