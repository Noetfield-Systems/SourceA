# wb-mkt-0413 — Drata · Pricing & packaging
...
Add or update one public price card on `witnessbc.com pricing + toolkits hub` inspired by Drata packaging motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0413`
