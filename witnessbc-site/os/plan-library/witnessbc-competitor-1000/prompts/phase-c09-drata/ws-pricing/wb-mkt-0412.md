# wb-mkt-0412 — Drata · Pricing & packaging
...
Map Drata revenue model (Annual SaaS) to our `Free toolkits → Pro packs → Flow install → Ops retainer` tier names — no hidden fees theater
...
1. `status: done` in REGISTRY.json for `wb-mkt-0412`
