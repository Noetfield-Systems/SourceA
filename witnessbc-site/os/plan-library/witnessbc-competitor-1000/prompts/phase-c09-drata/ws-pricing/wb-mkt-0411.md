# wb-mkt-0411 — Drata · Pricing & packaging
...
Capture Drata public pricing evidence: Custom annual contracts — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `wb-mkt-0411`
