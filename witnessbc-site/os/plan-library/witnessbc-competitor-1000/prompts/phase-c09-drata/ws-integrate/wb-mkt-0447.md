# wb-mkt-0447 — Drata · Integrations & API
...
Rate-limit + retry policy copied from Drata operating model (Automated evidence; policy templates; auditor portal)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0447`
