# wb-mkt-0422 — Drata · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Live control status page pattern)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0422`
