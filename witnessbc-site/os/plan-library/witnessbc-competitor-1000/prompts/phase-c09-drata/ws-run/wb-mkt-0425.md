# wb-mkt-0425 — Drata · Run history & proof
...
Add retention note: how long run history kept vs Drata (Custom annual contracts tier hints)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0425`
