# wb-mkt-0922 — Voiceflow · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Conversation run history on agent loops)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0922`
