# wb-mkt-0907 — Voiceflow · Buyer-visible UX
...
Document who buys (CX and product teams) vs our ICP one sentence on `witnessbc-site/content/pricing.html` row for Voiceflow
...
1. `status: done` in REGISTRY.json for `wb-mkt-0907`
