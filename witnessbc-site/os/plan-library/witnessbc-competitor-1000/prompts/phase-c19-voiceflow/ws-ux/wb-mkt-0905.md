# wb-mkt-0905 — Voiceflow · Buyer-visible UX
...
Diff our public copy vs Voiceflow pricing/product page — list 3 concrete gaps; fix highest P0 gap only
...
1. `status: done` in REGISTRY.json for `wb-mkt-0905`
