# wb-mkt-0919 — Voiceflow · Pricing & packaging
...
Write competitor row evidence: Voiceflow pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `wb-mkt-0919`
