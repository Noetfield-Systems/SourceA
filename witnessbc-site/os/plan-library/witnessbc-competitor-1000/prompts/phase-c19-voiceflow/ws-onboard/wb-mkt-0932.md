# wb-mkt-0932 — Voiceflow · Onboarding & PLG
...
Define ≤30s-to-value step on `Founding cohort shadow parallel install SOW` copied from Voiceflow motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0932`
