# wb-mkt-0950 — Voiceflow · Integrations & API
...
Close wb-mkt-0950: integration receipt + verify PASS + https://www.voiceflow.com
...
1. `status: done` in REGISTRY.json for `wb-mkt-0950`
