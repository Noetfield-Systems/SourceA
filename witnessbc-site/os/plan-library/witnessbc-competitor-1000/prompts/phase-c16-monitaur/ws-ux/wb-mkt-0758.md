# wb-mkt-0758 — Monitaur · Buyer-visible UX
...
Reject abstract rename — keep market words buyers know from Monitaur (ML governance lifecycle)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0758`
