# wb-mkt-0757 — Monitaur · Buyer-visible UX
...
Document who buys (Regulated ML teams) vs our ICP one sentence on `witnessbc-site/content/pricing.html` row for Monitaur
...
1. `status: done` in REGISTRY.json for `wb-mkt-0757`
