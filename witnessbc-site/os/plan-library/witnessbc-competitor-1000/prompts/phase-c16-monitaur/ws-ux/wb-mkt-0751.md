# wb-mkt-0751 — Monitaur · Buyer-visible UX
...
Open https://www.monitaur.ai — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Monitaur uses; paste into plan evidence (vendor says: Governance for ML models from development to production)

## Implementation extraction

`Monitaur · Buyer-visible UX` → what buyer sees at vendor → what we ship logged with receipt.
...
1. `status: done` in REGISTRY.json for `wb-mkt-0751`
