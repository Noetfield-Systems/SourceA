# wb-mkt-0781 — Monitaur · Onboarding & PLG
...
Document Monitaur onboarding path (Regulated industry ML governance): who runs (Vendor SaaS) → first value moment
...
1. `status: done` in REGISTRY.json for `wb-mkt-0781`
