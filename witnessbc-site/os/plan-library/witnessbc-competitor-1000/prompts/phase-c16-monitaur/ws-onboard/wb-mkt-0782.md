# wb-mkt-0782 — Monitaur · Onboarding & PLG
...
Define ≤30s-to-value step on `Founding cohort shadow parallel install SOW` copied from Monitaur motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0782`
