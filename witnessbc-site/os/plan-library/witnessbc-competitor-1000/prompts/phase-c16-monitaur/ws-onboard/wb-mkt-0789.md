# wb-mkt-0789 — Monitaur · Onboarding & PLG
...
Docs: onboarding section cites Monitaur as market analog with https://www.monitaur.ai
...
1. `status: done` in REGISTRY.json for `wb-mkt-0789`
