# wb-mkt-0791 — Monitaur · Integrations & API
...
List Monitaur integrations/APIs from https://www.monitaur.ai or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `wb-mkt-0791`
