# wb-mkt-0800 — Monitaur · Integrations & API
...
Close wb-mkt-0800: integration receipt + verify PASS + https://www.monitaur.ai
...
1. `status: done` in REGISTRY.json for `wb-mkt-0800`
