# wb-mkt-0797 — Monitaur · Integrations & API
...
Rate-limit + retry policy copied from Monitaur operating model (Policy workflows; model documentation; audit trail)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0797`
