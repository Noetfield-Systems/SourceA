# wb-mkt-0769 — Monitaur · Pricing & packaging
...
Write competitor row evidence: Monitaur pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `wb-mkt-0769`
