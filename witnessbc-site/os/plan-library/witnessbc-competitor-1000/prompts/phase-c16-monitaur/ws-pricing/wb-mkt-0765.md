# wb-mkt-0765 — Monitaur · Pricing & packaging
...
Compare Monitaur PLG motion (Regulated industry ML governance) vs our onboarding — one adoption fix on `Founding cohort shadow parallel install SOW`
...
1. `status: done` in REGISTRY.json for `wb-mkt-0765`
