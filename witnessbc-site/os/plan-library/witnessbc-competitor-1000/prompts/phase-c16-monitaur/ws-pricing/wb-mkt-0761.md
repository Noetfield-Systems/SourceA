# wb-mkt-0761 — Monitaur · Pricing & packaging
...
Capture Monitaur public pricing evidence: Enterprise custom — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `wb-mkt-0761`
