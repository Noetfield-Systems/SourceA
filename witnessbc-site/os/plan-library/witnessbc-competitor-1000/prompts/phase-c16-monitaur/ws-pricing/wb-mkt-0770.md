# wb-mkt-0770 — Monitaur · Pricing & packaging
...
Close wb-mkt-0770: PRIORITY row + verify PASS + link https://www.monitaur.ai
...
1. `status: done` in REGISTRY.json for `wb-mkt-0770`
