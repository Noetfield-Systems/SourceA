# wb-mkt-0775 — Monitaur · Run history & proof
...
Add retention note: how long run history kept vs Monitaur (Enterprise custom tier hints)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0775`
