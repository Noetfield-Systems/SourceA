# wb-mkt-0772 — Monitaur · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Model/agent inventory for policy packs)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0772`
