# wb-mkt-0771 — Monitaur · Run history & proof
...
From https://www.monitaur.ai document Monitaur run/history UX: Policy workflows; model documentation; audit trail — map to `Witness AI Flow install replay demo + 6 receipt types`
...
1. `status: done` in REGISTRY.json for `wb-mkt-0771`
