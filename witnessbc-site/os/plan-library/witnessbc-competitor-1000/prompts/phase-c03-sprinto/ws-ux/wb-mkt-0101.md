# wb-mkt-0101 — Sprinto · Buyer-visible UX
...
Open https://sprinto.com — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Sprinto uses; paste into plan evidence (vendor says: Automate SOC 2, ISO, GDPR evidence collection and monitoring)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0101`
