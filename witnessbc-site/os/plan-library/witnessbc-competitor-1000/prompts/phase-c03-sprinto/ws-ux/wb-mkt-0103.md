# wb-mkt-0103 — Sprinto · Buyer-visible UX
...
Add `witnessbc.com pricing + toolkits hub` UI field or copy block implementing smallest slice of `Policy pack → control checklist → export bundle`; preserve honest tier label
...
1. `status: done` in REGISTRY.json for `wb-mkt-0103`
