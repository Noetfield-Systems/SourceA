# wb-mkt-0107 — Sprinto · Buyer-visible UX
...
Document who buys (SaaS startups) vs our ICP one sentence on `witnessbc-site/content/pricing.html` row for Sprinto
...
1. `status: done` in REGISTRY.json for `wb-mkt-0107`
