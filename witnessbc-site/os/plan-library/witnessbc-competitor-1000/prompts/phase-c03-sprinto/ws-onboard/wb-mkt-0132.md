# wb-mkt-0132 — Sprinto · Onboarding & PLG
...
Define ≤30s-to-value step on `Founding cohort shadow parallel install SOW` copied from Sprinto motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0132`
