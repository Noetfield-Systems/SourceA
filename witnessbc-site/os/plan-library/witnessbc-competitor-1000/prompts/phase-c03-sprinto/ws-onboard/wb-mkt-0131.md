# wb-mkt-0131 — Sprinto · Onboarding & PLG
...
Document Sprinto onboarding path (Compliance wedge for SaaS PLG): who runs (Vendor SaaS) → first value moment
...
1. `status: done` in REGISTRY.json for `wb-mkt-0131`
