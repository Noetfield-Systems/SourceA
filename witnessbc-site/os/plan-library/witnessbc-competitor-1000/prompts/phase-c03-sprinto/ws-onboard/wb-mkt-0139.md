# wb-mkt-0139 — Sprinto · Onboarding & PLG
...
Docs: onboarding section cites Sprinto as market analog with https://sprinto.com
...
1. `status: done` in REGISTRY.json for `wb-mkt-0139`
