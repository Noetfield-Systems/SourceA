# wb-mkt-0112 — Sprinto · Pricing & packaging
...
Map Sprinto revenue model (Annual SaaS by framework) to our `Free toolkits → Pro packs → Flow install → Ops retainer` tier names — no hidden fees theater
...
1. `status: done` in REGISTRY.json for `wb-mkt-0112`
