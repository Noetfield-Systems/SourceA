# wb-mkt-0113 — Sprinto · Pricing & packaging
...
Add or update one public price card on `witnessbc.com pricing + toolkits hub` inspired by Sprinto packaging motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0113`
