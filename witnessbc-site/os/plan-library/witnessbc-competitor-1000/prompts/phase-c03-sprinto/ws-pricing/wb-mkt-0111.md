# wb-mkt-0111 — Sprinto · Pricing & packaging
...
Capture Sprinto public pricing evidence: From ~$6,000/yr (market); custom enterprise — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `wb-mkt-0111`
