# wb-mkt-0115 — Sprinto · Pricing & packaging
...
Compare Sprinto PLG motion (Compliance wedge for SaaS PLG) vs our onboarding — one adoption fix on `Founding cohort shadow parallel install SOW`
...
1. `status: done` in REGISTRY.json for `wb-mkt-0115`
