# wb-mkt-0141 — Sprinto · Integrations & API
...
List Sprinto integrations/APIs from https://sprinto.com or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `wb-mkt-0141`
