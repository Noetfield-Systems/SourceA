# wb-mkt-0147 — Sprinto · Integrations & API
...
Rate-limit + retry policy copied from Sprinto operating model (Connect infra; continuous control monitoring; audit export)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0147`
