# wb-mkt-0123 — Sprinto · Run history & proof
...
`Sprinto · Run history & proof` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `wb-mkt-0123`
