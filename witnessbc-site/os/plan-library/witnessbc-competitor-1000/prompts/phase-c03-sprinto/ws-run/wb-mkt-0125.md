# wb-mkt-0125 — Sprinto · Run history & proof
...
Add retention note: how long run history kept vs Sprinto (From ~$6,000/yr (market); custom enterprise tier hints)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0125`
