# wb-mkt-0622 — Lakera Guard · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Policy at dispatch allow/block log)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0622`
