# wb-mkt-0630 — Lakera Guard · Run history & proof
...
Mark wb-mkt-0630 done with run page screenshot or receipt path
...
1. `status: done` in REGISTRY.json for `wb-mkt-0630`
