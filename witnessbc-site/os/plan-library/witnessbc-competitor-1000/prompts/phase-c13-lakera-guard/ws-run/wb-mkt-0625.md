# wb-mkt-0625 — Lakera Guard · Run history & proof
...
Add retention note: how long run history kept vs Lakera Guard (Enterprise custom tier hints)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0625`
