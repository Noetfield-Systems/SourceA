# wb-mkt-0647 — Lakera Guard · Integrations & API
...
Rate-limit + retry policy copied from Lakera Guard operating model (API middleware scans prompts/responses; logs decisions)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0647`
