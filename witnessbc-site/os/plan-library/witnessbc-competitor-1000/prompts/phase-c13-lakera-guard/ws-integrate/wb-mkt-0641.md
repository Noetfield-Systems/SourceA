# wb-mkt-0641 — Lakera Guard · Integrations & API
...
List Lakera Guard integrations/APIs from https://www.lakera.ai or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `wb-mkt-0641`
