# wb-mkt-0649 — Lakera Guard · Integrations & API
...
Update catalog/registry row for integration — Lakera Guard row 33
...
1. `status: done` in REGISTRY.json for `wb-mkt-0649`
