# wb-mkt-0650 — Lakera Guard · Integrations & API
...
Close wb-mkt-0650: integration receipt + verify PASS + https://www.lakera.ai
...
1. `status: done` in REGISTRY.json for `wb-mkt-0650`
