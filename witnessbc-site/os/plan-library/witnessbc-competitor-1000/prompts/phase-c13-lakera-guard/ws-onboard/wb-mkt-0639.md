# wb-mkt-0639 — Lakera Guard · Onboarding & PLG
...
Docs: onboarding section cites Lakera Guard as market analog with https://www.lakera.ai
...
1. `status: done` in REGISTRY.json for `wb-mkt-0639`
