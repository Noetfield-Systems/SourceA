# wb-mkt-0631 — Lakera Guard · Onboarding & PLG
...
Document Lakera Guard onboarding path (Security wedge for GenAI): who runs (Vendor SaaS enterprise) → first value moment
...
1. `status: done` in REGISTRY.json for `wb-mkt-0631`
