# wb-mkt-0632 — Lakera Guard · Onboarding & PLG
...
Define ≤30s-to-value step on `Founding cohort shadow parallel install SOW` copied from Lakera Guard motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0632`
