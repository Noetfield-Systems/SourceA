# wb-mkt-0616 — Lakera Guard · Pricing & packaging
...
Document why buyers pay per Lakera Guard: Prompt injection and data leakage in production — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `wb-mkt-0616`
