# wb-mkt-0619 — Lakera Guard · Pricing & packaging
...
Write competitor row evidence: Lakera Guard pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `wb-mkt-0619`
