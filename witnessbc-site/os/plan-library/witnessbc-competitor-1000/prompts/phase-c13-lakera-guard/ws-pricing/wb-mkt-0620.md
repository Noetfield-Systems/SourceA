# wb-mkt-0620 — Lakera Guard · Pricing & packaging
...
Close wb-mkt-0620: PRIORITY row + verify PASS + link https://www.lakera.ai
...
1. `status: done` in REGISTRY.json for `wb-mkt-0620`
