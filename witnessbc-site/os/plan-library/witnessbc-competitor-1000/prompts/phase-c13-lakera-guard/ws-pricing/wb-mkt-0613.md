# wb-mkt-0613 — Lakera Guard · Pricing & packaging
...
Add or update one public price card on `witnessbc.com pricing + toolkits hub` inspired by Lakera Guard packaging motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0613`
