# wb-mkt-0612 — Lakera Guard · Pricing & packaging
...
Map Lakera Guard revenue model (API usage + enterprise) to our `Free toolkits → Pro packs → Flow install → Ops retainer` tier names — no hidden fees theater
...
1. `status: done` in REGISTRY.json for `wb-mkt-0612`
