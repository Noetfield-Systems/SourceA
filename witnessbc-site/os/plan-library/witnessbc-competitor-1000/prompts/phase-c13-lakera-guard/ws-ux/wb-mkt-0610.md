# wb-mkt-0610 — Lakera Guard · Buyer-visible UX
...
Mark wb-mkt-0610 done in REGISTRY with evidence path + https://www.lakera.ai after verify PASS
...
1. `status: done` in REGISTRY.json for `wb-mkt-0610`
