# wb-mkt-0602 — Lakera Guard · Buyer-visible UX
...
Write one-line UX spec: `Lakera Guard Buyer-visible UX` → buyer sees X → we show on `witnessbc.com pricing + toolkits hub` (lesson: Policy at dispatch allow/block log)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0602`
