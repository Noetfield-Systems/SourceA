# wb-mkt-0608 — Lakera Guard · Buyer-visible UX
...
Reject abstract rename — keep market words buyers know from Lakera Guard (GenAI security)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0608`
