# wb-mkt-0837 — Lasso Security · Onboarding & PLG
...
Measure drop-off: list one friction point vs Lasso Security and fix
...
1. `status: done` in REGISTRY.json for `wb-mkt-0837`
