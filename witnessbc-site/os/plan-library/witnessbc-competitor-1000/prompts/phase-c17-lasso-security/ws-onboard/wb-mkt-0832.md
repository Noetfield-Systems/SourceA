# wb-mkt-0832 — Lasso Security · Onboarding & PLG
...
Define ≤30s-to-value step on `Founding cohort shadow parallel install SOW` copied from Lasso Security motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0832`
