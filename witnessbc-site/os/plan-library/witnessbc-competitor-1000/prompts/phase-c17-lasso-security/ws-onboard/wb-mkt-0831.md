# wb-mkt-0831 — Lasso Security · Onboarding & PLG
...
Document Lasso Security onboarding path (GenAI security startup wedge): who runs (Vendor SaaS) → first value moment
...
1. `status: done` in REGISTRY.json for `wb-mkt-0831`
