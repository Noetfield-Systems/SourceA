# wb-mkt-0836 — Lasso Security · Onboarding & PLG
...
Write founder-facing SOW snippet if Lasso Security uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `wb-mkt-0836`
