# wb-mkt-0839 — Lasso Security · Onboarding & PLG
...
Docs: onboarding section cites Lasso Security as market analog with https://www.lasso.security
...
1. `status: done` in REGISTRY.json for `wb-mkt-0839`
