# wb-mkt-0847 — Lasso Security · Integrations & API
...
Rate-limit + retry policy copied from Lasso Security operating model (Scan for shadow AI; enforce policies)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0847`
