# wb-mkt-0850 — Lasso Security · Integrations & API
...
Close wb-mkt-0850: integration receipt + verify PASS + https://www.lasso.security
...
1. `status: done` in REGISTRY.json for `wb-mkt-0850`
