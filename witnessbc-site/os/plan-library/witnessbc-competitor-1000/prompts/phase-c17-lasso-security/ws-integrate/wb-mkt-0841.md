# wb-mkt-0841 — Lasso Security · Integrations & API
...
List Lasso Security integrations/APIs from https://www.lasso.security or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `wb-mkt-0841`
