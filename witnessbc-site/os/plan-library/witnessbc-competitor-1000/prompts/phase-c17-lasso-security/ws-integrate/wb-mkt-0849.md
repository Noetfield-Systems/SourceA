# wb-mkt-0849 — Lasso Security · Integrations & API
...
Update catalog/registry row for integration — Lasso Security row 37
...
1. `status: done` in REGISTRY.json for `wb-mkt-0849`
