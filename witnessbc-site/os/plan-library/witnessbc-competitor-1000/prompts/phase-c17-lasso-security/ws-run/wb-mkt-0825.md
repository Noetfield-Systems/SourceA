# wb-mkt-0825 — Lasso Security · Run history & proof
...
Add retention note: how long run history kept vs Lasso Security (Startup and enterprise tiers tier hints)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0825`
