# wb-mkt-0822 — Lasso Security · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Shadow AI discovery in policy starter kits)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0822`
