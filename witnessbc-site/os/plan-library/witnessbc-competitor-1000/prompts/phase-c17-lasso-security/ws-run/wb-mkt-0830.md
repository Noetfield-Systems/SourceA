# wb-mkt-0830 — Lasso Security · Run history & proof
...
Mark wb-mkt-0830 done with run page screenshot or receipt path
...
1. `status: done` in REGISTRY.json for `wb-mkt-0830`
