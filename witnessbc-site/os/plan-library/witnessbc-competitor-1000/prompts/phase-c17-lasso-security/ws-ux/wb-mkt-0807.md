# wb-mkt-0807 — Lasso Security · Buyer-visible UX
...
Document who buys (CISO teams) vs our ICP one sentence on `witnessbc-site/content/pricing.html` row for Lasso Security
...
1. `status: done` in REGISTRY.json for `wb-mkt-0807`
