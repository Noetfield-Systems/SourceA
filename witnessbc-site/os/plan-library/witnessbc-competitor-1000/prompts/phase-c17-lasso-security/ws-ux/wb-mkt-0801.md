# wb-mkt-0801 — Lasso Security · Buyer-visible UX
...
Open https://www.lasso.security — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Lasso Security uses; paste into plan evidence (vendor says: Discover shadow AI; protect GenAI apps)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0801`
