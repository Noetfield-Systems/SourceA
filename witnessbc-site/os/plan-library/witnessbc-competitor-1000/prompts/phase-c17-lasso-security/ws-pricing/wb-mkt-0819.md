# wb-mkt-0819 — Lasso Security · Pricing & packaging
...
Write competitor row evidence: Lasso Security pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `wb-mkt-0819`
