# wb-mkt-0820 — Lasso Security · Pricing & packaging
...
Close wb-mkt-0820: PRIORITY row + verify PASS + link https://www.lasso.security
...
1. `status: done` in REGISTRY.json for `wb-mkt-0820`
