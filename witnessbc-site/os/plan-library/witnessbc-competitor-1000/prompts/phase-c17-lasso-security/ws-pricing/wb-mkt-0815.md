# wb-mkt-0815 — Lasso Security · Pricing & packaging
...
Compare Lasso Security PLG motion (GenAI security startup wedge) vs our onboarding — one adoption fix on `Founding cohort shadow parallel install SOW`
...
1. `status: done` in REGISTRY.json for `wb-mkt-0815`
