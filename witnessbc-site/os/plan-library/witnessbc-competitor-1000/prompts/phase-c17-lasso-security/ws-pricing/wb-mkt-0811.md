# wb-mkt-0811 — Lasso Security · Pricing & packaging
...
Capture Lasso Security public pricing evidence: Startup and enterprise tiers — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `wb-mkt-0811`
