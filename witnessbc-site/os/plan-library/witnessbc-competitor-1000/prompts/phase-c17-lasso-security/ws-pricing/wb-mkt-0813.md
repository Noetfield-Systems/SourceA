# wb-mkt-0813 — Lasso Security · Pricing & packaging
...
Add or update one public price card on `witnessbc.com pricing + toolkits hub` inspired by Lasso Security packaging motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0813`
