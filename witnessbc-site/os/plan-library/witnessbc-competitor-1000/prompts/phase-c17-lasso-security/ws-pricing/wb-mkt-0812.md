# wb-mkt-0812 — Lasso Security · Pricing & packaging
...
Map Lasso Security revenue model (Annual SaaS) to our `Free toolkits → Pro packs → Flow install → Ops retainer` tier names — no hidden fees theater
...
1. `status: done` in REGISTRY.json for `wb-mkt-0812`
