# wb-mkt-0817 — Lasso Security · Pricing & packaging
...
Add upgrade CTA path: sandbox/free → paid bay matching Lasso Security upgrade pattern where applicable
...
1. `status: done` in REGISTRY.json for `wb-mkt-0817`
