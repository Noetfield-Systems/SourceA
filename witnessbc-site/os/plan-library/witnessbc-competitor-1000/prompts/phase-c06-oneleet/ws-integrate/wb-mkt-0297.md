# wb-mkt-0297 — Oneleet · Integrations & API
...
Rate-limit + retry policy copied from Oneleet operating model (Security controls + compliance evidence in one platform)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0297`
