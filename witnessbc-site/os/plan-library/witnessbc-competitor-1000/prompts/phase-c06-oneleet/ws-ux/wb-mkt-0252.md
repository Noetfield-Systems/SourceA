# wb-mkt-0252 — Oneleet · Buyer-visible UX
...
Write one-line UX spec: `Oneleet Buyer-visible UX` → buyer sees X → we show on `witnessbc.com pricing + toolkits hub` (lesson: Proof call + deposit SOW before signature)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0252`
