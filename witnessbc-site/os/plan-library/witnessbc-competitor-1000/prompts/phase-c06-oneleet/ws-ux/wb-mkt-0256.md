# wb-mkt-0256 — Oneleet · Buyer-visible UX
...
Add `Witness AI Flow install replay demo + 6 receipt types` mock row labeled mock_only until live — match Oneleet run/history metaphor not invented name
...
1. `status: done` in REGISTRY.json for `wb-mkt-0256`
