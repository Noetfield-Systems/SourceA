# wb-mkt-0275 — Oneleet · Run history & proof
...
Add retention note: how long run history kept vs Oneleet (Custom pricing tier hints)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0275`
