# wb-mkt-0272 — Oneleet · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Proof call + deposit SOW before signature)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0272`
