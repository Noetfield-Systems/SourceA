# wb-mkt-0281 — Oneleet · Onboarding & PLG
...
Document Oneleet onboarding path (Startup security/compliance bundle): who runs (Vendor SaaS) → first value moment
...
1. `status: done` in REGISTRY.json for `wb-mkt-0281`
