# wb-mkt-0282 — Oneleet · Onboarding & PLG
...
Define ≤30s-to-value step on `Founding cohort shadow parallel install SOW` copied from Oneleet motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0282`
