# wb-mkt-0261 — Oneleet · Pricing & packaging
...
Capture Oneleet public pricing evidence: Custom pricing — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `wb-mkt-0261`
