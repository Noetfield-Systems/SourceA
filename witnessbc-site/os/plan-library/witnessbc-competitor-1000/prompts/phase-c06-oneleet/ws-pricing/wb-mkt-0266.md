# wb-mkt-0266 — Oneleet · Pricing & packaging
...
Document why buyers pay per Oneleet: Separate security and compliance tools are expensive — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `wb-mkt-0266`
