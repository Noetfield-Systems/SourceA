# wb-mkt-0263 — Oneleet · Pricing & packaging
...
Add or update one public price card on `witnessbc.com pricing + toolkits hub` inspired by Oneleet packaging motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0263`
