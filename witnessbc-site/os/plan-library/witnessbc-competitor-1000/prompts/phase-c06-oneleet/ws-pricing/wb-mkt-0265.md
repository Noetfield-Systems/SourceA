# wb-mkt-0265 — Oneleet · Pricing & packaging
...
Compare Oneleet PLG motion (Startup security/compliance bundle) vs our onboarding — one adoption fix on `Founding cohort shadow parallel install SOW`
...
1. `status: done` in REGISTRY.json for `wb-mkt-0265`
