# wb-mkt-0269 — Oneleet · Pricing & packaging
...
Write competitor row evidence: Oneleet pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `wb-mkt-0269`
