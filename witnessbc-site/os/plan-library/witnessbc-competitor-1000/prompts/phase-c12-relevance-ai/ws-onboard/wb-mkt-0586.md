# wb-mkt-0586 — Relevance AI · Onboarding & PLG
...
Write founder-facing SOW snippet if Relevance AI uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `wb-mkt-0586`
