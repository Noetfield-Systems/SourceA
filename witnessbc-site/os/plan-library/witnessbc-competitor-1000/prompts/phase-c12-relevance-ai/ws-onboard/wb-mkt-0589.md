# wb-mkt-0589 — Relevance AI · Onboarding & PLG
...
Docs: onboarding section cites Relevance AI as market analog with https://relevanceai.com/docs/get-started/pricing
...
1. `status: done` in REGISTRY.json for `wb-mkt-0589`
