# wb-mkt-0581 — Relevance AI · Onboarding & PLG
...
Document Relevance AI onboarding path (Agent workforce PLG): who runs (Vendor SaaS) → first value moment
...
1. `status: done` in REGISTRY.json for `wb-mkt-0581`
