# wb-mkt-0582 — Relevance AI · Onboarding & PLG
...
Define ≤30s-to-value step on `Founding cohort shadow parallel install SOW` copied from Relevance AI motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0582`
