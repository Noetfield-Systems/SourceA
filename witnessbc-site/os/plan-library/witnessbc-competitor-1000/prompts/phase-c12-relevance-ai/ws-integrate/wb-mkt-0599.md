# wb-mkt-0599 — Relevance AI · Integrations & API
...
Update catalog/registry row for integration — Relevance AI row 32
...
1. `status: done` in REGISTRY.json for `wb-mkt-0599`
