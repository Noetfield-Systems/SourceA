# wb-mkt-0597 — Relevance AI · Integrations & API
...
Rate-limit + retry policy copied from Relevance AI operating model (Agent builder; actions + vendor credits; workforce dashboard)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0597`
