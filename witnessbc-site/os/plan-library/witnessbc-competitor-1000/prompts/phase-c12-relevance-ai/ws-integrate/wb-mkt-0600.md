# wb-mkt-0600 — Relevance AI · Integrations & API
...
Close wb-mkt-0600: integration receipt + verify PASS + https://relevanceai.com/docs/get-started/pricing
...
1. `status: done` in REGISTRY.json for `wb-mkt-0600`
