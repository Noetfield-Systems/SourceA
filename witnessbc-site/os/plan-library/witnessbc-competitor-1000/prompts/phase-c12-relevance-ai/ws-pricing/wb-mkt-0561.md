# wb-mkt-0561 — Relevance AI · Pricing & packaging
...
Capture Relevance AI public pricing evidence: Pro $19/mo; Team $234/mo — https://relevanceai.com/docs/get-started/pricing — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `wb-mkt-0561`
