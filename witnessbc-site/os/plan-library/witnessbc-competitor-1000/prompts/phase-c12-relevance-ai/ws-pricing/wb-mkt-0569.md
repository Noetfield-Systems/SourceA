# wb-mkt-0569 — Relevance AI · Pricing & packaging
...
Write competitor row evidence: Relevance AI pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `wb-mkt-0569`
