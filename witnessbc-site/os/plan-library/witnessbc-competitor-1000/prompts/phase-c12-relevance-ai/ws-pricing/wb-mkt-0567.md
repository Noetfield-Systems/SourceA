# wb-mkt-0567 — Relevance AI · Pricing & packaging
...
Add upgrade CTA path: sandbox/free → paid bay matching Relevance AI upgrade pattern where applicable
...
1. `status: done` in REGISTRY.json for `wb-mkt-0567`
