# wb-mkt-0566 — Relevance AI · Pricing & packaging
...
Document why buyers pay per Relevance AI: Replace repetitive GTM work with agents — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `wb-mkt-0566`
