# wb-mkt-0570 — Relevance AI · Pricing & packaging
...
Close wb-mkt-0570: PRIORITY row + verify PASS + link https://relevanceai.com/docs/get-started/pricing
...
1. `status: done` in REGISTRY.json for `wb-mkt-0570`
