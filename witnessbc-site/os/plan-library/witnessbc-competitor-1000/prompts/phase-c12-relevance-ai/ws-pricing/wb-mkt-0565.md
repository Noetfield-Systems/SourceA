# wb-mkt-0565 — Relevance AI · Pricing & packaging
...
Compare Relevance AI PLG motion (Agent workforce PLG) vs our onboarding — one adoption fix on `Founding cohort shadow parallel install SOW`
...
1. `status: done` in REGISTRY.json for `wb-mkt-0565`
