# wb-mkt-0558 — Relevance AI · Buyer-visible UX
...
Reject abstract rename — keep market words buyers know from Relevance AI (AI workforce platform)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0558`
