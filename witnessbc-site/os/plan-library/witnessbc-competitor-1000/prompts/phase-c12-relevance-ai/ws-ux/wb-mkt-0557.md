# wb-mkt-0557 — Relevance AI · Buyer-visible UX
...
Document who buys (GTM and ops teams) vs our ICP one sentence on `witnessbc-site/content/pricing.html` row for Relevance AI
...
1. `status: done` in REGISTRY.json for `wb-mkt-0557`
