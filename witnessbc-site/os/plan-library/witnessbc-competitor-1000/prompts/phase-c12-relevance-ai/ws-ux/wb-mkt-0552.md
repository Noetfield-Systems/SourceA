# wb-mkt-0552 — Relevance AI · Buyer-visible UX
...
Write one-line UX spec: `Relevance AI Buyer-visible UX` → buyer sees X → we show on `witnessbc.com pricing + toolkits hub` (lesson: Packaged agent install SKUs like Witness AI Flow)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0552`
