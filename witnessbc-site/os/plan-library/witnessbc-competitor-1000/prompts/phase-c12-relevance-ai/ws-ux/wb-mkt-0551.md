# wb-mkt-0551 — Relevance AI · Buyer-visible UX
...
Open https://relevanceai.com/docs/get-started/pricing — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Relevance AI uses; paste into plan evidence (vendor says: Build and deploy AI agents for GTM and operations)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0551`
