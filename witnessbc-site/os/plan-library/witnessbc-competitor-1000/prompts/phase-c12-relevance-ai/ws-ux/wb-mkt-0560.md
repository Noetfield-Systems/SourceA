# wb-mkt-0560 — Relevance AI · Buyer-visible UX
...
Mark wb-mkt-0560 done in REGISTRY with evidence path + https://relevanceai.com/docs/get-started/pricing after verify PASS
...
1. `status: done` in REGISTRY.json for `wb-mkt-0560`
