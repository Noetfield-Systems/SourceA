# wb-mkt-0572 — Relevance AI · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Packaged agent install SKUs like Witness AI Flow)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0572`
