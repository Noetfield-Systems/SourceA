# wb-mkt-0580 — Relevance AI · Run history & proof
...
Mark wb-mkt-0580 done with run page screenshot or receipt path
...
1. `status: done` in REGISTRY.json for `wb-mkt-0580`
