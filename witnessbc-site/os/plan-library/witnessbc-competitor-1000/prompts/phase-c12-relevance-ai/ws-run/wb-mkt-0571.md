# wb-mkt-0571 — Relevance AI · Run history & proof
...
From https://relevanceai.com/docs/get-started/pricing document Relevance AI run/history UX: Agent builder; actions + vendor credits; workforce dashboard — map to `Witness AI Flow install replay demo + 6 receipt types`
...
1. `status: done` in REGISTRY.json for `wb-mkt-0571`
