# wb-mkt-0857 — Dust.tt · Buyer-visible UX
...
Document who buys (Enterprise ops teams) vs our ICP one sentence on `witnessbc-site/content/pricing.html` row for Dust.tt
...
1. `status: done` in REGISTRY.json for `wb-mkt-0857`
