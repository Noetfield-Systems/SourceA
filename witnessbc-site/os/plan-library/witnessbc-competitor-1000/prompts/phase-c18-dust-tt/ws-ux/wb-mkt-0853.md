# wb-mkt-0853 — Dust.tt · Buyer-visible UX
...
Add `witnessbc.com pricing + toolkits hub` UI field or copy block implementing smallest slice of `Packaged team templates for first install`; preserve honest tier label
...
1. `status: done` in REGISTRY.json for `wb-mkt-0853`
