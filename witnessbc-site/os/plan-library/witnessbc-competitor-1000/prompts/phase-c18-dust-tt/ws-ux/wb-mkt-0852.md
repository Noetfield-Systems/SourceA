# wb-mkt-0852 — Dust.tt · Buyer-visible UX
...
Write one-line UX spec: `Dust.tt Buyer-visible UX` → buyer sees X → we show on `witnessbc.com pricing + toolkits hub` (lesson: Packaged team templates for first install)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0852`
