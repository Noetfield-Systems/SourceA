# wb-mkt-0851 — Dust.tt · Buyer-visible UX
...
Open https://dust.tt — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Dust.tt uses; paste into plan evidence (vendor says: Build internal AI assistants connected to company data)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0851`
