# wb-mkt-0860 — Dust.tt · Buyer-visible UX
...
Mark wb-mkt-0860 done in REGISTRY with evidence path + https://dust.tt after verify PASS
...
1. `status: done` in REGISTRY.json for `wb-mkt-0860`
