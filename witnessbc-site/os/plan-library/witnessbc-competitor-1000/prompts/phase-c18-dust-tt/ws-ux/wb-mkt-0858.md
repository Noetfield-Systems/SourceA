# wb-mkt-0858 — Dust.tt · Buyer-visible UX
...
Reject abstract rename — keep market words buyers know from Dust.tt (Enterprise AI assistants)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0858`
