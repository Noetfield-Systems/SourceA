# wb-mkt-0855 — Dust.tt · Buyer-visible UX
...
Diff our public copy vs Dust.tt pricing/product page — list 3 concrete gaps; fix highest P0 gap only
...
1. `status: done` in REGISTRY.json for `wb-mkt-0855`
