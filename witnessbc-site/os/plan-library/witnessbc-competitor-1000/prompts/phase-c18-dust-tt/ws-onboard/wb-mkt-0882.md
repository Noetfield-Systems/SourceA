# wb-mkt-0882 — Dust.tt · Onboarding & PLG
...
Define ≤30s-to-value step on `Founding cohort shadow parallel install SOW` copied from Dust.tt motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0882`
