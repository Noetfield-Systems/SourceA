# wb-mkt-0881 — Dust.tt · Onboarding & PLG
...
Document Dust.tt onboarding path (Enterprise assistant PLG): who runs (Vendor SaaS) → first value moment
...
1. `status: done` in REGISTRY.json for `wb-mkt-0881`
