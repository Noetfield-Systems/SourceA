# wb-mkt-0886 — Dust.tt · Onboarding & PLG
...
Write founder-facing SOW snippet if Dust.tt uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `wb-mkt-0886`
