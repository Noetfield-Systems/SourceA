# wb-mkt-0889 — Dust.tt · Onboarding & PLG
...
Docs: onboarding section cites Dust.tt as market analog with https://dust.tt
...
1. `status: done` in REGISTRY.json for `wb-mkt-0889`
