# wb-mkt-0865 — Dust.tt · Pricing & packaging
...
Compare Dust.tt PLG motion (Enterprise assistant PLG) vs our onboarding — one adoption fix on `Founding cohort shadow parallel install SOW`
...
1. `status: done` in REGISTRY.json for `wb-mkt-0865`
