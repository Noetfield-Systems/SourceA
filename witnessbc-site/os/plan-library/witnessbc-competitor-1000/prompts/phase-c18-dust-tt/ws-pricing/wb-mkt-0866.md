# wb-mkt-0866 — Dust.tt · Pricing & packaging
...
Document why buyers pay per Dust.tt: ChatGPT doesn't know company context safely — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `wb-mkt-0866`
