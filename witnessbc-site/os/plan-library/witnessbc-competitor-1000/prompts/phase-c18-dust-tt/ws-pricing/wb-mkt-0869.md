# wb-mkt-0869 — Dust.tt · Pricing & packaging
...
Write competitor row evidence: Dust.tt pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `wb-mkt-0869`
