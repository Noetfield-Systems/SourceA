# wb-mkt-0863 — Dust.tt · Pricing & packaging
...
Add or update one public price card on `witnessbc.com pricing + toolkits hub` inspired by Dust.tt packaging motion
...
1. `status: done` in REGISTRY.json for `wb-mkt-0863`
