# wb-mkt-0861 — Dust.tt · Pricing & packaging
...
Capture Dust.tt public pricing evidence: Team tiers custom — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `wb-mkt-0861`
