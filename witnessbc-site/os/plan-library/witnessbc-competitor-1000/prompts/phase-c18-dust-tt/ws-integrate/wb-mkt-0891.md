# wb-mkt-0891 — Dust.tt · Integrations & API
...
List Dust.tt integrations/APIs from https://dust.tt or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `wb-mkt-0891`
