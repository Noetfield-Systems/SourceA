# wb-mkt-0875 — Dust.tt · Run history & proof
...
Add retention note: how long run history kept vs Dust.tt (Team tiers custom tier hints)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0875`
