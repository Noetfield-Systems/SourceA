# wb-mkt-0872 — Dust.tt · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Packaged team templates for first install)
...
1. `status: done` in REGISTRY.json for `wb-mkt-0872`
