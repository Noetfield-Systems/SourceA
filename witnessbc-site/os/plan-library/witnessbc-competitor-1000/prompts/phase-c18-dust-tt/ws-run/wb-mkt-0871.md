# wb-mkt-0871 — Dust.tt · Run history & proof
...
From https://dust.tt document Dust.tt run/history UX: Template assistants; team workspaces; usage controls — map to `Witness AI Flow install replay demo + 6 receipt types`
...
1. `status: done` in REGISTRY.json for `wb-mkt-0871`
