...
**Brain unification:** `SINA_BRAIN_PLATFORM_UNIFICATION_LOCKED_v1.md` ·  YAML · worker board  
...
flowchart LR
  ...
  subgraph PAR["PARALLEL"]
    P[Portfolio lanes]
    R[Research Voice AI Lovable]
    E[AI infra credits]
  end
  MOTOR[L1 SourceA Motor]
  MOTOR --> C
  MOTOR --> F
  MOTOR --> P
  MOTOR --> R
