(function () {
  ...
  var PLAIN = {
    ...
    force_auto_tick: "Mac observe only — CF cron */10 runs full_pack×100 on cloud.",
    wire_chat_unify: "Wires Chat Unify merge pipeline to n8n webhook.",
    wire_portfolio_mail: "Wires Portfolio Mail + Chat + N8N glue.",
    refresh: "Reloads local chain_status + live queue via CF proxy.",
    trigger_cf_pack: "Browser POST to CF /tick → Railway full_pack×100 (Mac never calls Railway).",
  };
