(function () {
  ...
  const UI_VERSION = "4.11.12-living-chat-fast";
  ...
  function sizeEditorPanes() {
    ...
    const msgOuterH = Math.max(220, liveH - stripH - 12);
    ...
    if (thread) {
      const threadH = Math.max(160, msgOuterH - headH);
