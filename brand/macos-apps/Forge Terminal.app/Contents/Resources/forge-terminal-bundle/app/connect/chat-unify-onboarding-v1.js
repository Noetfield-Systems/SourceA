(function () {
  ...
  overlay.innerHTML =
    ...
    '<p class="cu-onboarding-kicker">Welcome · Forge Terminal 4.0.6-live-window</p>' +
    '<h2 id="cu-onb-title">Where do you want to start?</h2>' +
    '<p class="cu-onboarding-lead">Paste any AI reply, verify with PASS or BLOCK, and keep receipts logged — no Cursor required to begin.</p>' +
