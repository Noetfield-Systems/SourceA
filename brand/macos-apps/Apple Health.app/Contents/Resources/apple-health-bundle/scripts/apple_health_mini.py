...
def _mini_app_url() -> str:
    ...
    if os.environ.get("APPLE_HEALTH_STANDALONE") == "1":
        port = os.environ.get("APPLE_HEALTH_PORT", "13025")
        return f"http://127.0.0.1:{port}/"
    return "http://127.0.0.1:13020/mini-apps/apple-health/"
...
def apple_health_payload(*, rescan: bool = False) -> dict:
    ...
    return {
        ...
        "app": "apple-health",
        "title": "Apple Health",
        "tagline": "Wellness goals · link to factory roadmaps · open Health app",
        "mini_app_url": _mini_app_url(),
        "standalone": os.environ.get("APPLE_HEALTH_STANDALONE") == "1",
