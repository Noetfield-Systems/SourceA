...
H1_HUB_URL = CW_COCKPIT_URL  # Worker Hub trashed — Cloud Workers primary
H2_MACHINES_URL = "http://127.0.0.1:13027/"
...
def hub_canvas_target() -> dict:
    ...
    return {
        ...
        "open_canvas_hint": (
            "Chat Unify form page = same PICK rows as M1 Canvas slot D · "
            "Cursor Canvas optional beside chat"
        ),
        "chat_unify_url": CHAT_UNIFY_URL,
        "hub_url": H1_HUB_URL,
