# sa-mkt-0257 — Helicone · Buyer-visible UX
...
Document who buys (LLM app developers) vs our ICP one sentence on `brain-os/plan-registry/SOURCEA-PRIORITY.md` row for Helicone
...
1. `status: done` in REGISTRY.json for `sa-mkt-0257`
