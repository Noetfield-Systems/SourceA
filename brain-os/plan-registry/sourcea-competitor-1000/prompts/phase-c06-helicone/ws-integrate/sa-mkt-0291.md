# sa-mkt-0291 — Helicone · Integrations & API
...
List Helicone integrations/APIs from https://helicone.ai or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `sa-mkt-0291`
