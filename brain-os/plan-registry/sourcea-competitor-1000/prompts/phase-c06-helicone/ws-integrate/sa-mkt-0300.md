# sa-mkt-0300 — Helicone · Integrations & API
...
Close sa-mkt-0300: integration receipt + verify PASS + https://helicone.ai
...
1. `status: done` in REGISTRY.json for `sa-mkt-0300`
