# sa-mkt-0266 — Helicone · Pricing & packaging
...
Document why buyers pay per Helicone: Hidden LLM spend and latency; need request-level log — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `sa-mkt-0266`
