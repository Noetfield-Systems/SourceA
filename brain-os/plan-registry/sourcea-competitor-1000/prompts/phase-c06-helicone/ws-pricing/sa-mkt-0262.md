# sa-mkt-0262 — Helicone · Pricing & packaging
...
Map Helicone revenue model (Request-volume SaaS) to our `SourceA agency + Buyer-1 pricing narrative` tier names — no hidden fees theater
...
1. `status: done` in REGISTRY.json for `sa-mkt-0262`
