# sa-mkt-0269 — Helicone · Pricing & packaging
...
Write competitor row evidence: Helicone pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `sa-mkt-0269`
