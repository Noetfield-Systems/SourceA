# sa-mkt-0275 — Helicone · Run history & proof
...
Add retention note: how long run history kept vs Helicone (Free hobby ~10k req; Pro from ~$79/mo (market) tier hints)

## Implementation extraction

`Helicone · Run history & proof` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0275`
