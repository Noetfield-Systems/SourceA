# sa-mkt-0289 — Helicone · Onboarding & PLG
...
Docs: onboarding section cites Helicone as market analog with https://helicone.ai
...
1. `status: done` in REGISTRY.json for `sa-mkt-0289`
