# sa-mkt-0947 — Literal AI · Integrations & API
...
Rate-limit + retry policy copied from Literal AI operating model (Instrument app; view conversation traces and evals)

## Implementation extraction

`Literal AI · Integrations & API` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0947`
