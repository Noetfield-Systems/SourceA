# sa-mkt-0950 — Literal AI · Integrations & API
...
Close sa-mkt-0950: integration receipt + verify PASS + https://www.literalai.com
...
1. `status: done` in REGISTRY.json for `sa-mkt-0950`
