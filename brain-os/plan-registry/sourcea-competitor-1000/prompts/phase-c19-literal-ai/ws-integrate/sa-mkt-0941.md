# sa-mkt-0941 — Literal AI · Integrations & API
...
List Literal AI integrations/APIs from https://www.literalai.com or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `sa-mkt-0941`
