# sa-mkt-0917 — Literal AI · Pricing & packaging
...
Add upgrade CTA path: sandbox/free → paid bay matching Literal AI upgrade pattern where applicable
...
1. `status: done` in REGISTRY.json for `sa-mkt-0917`
