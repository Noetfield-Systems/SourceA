# sa-mkt-0907 — Literal AI · Buyer-visible UX
...
Document who buys (Agent startups) vs our ICP one sentence on `brain-os/plan-registry/SOURCEA-PRIORITY.md` row for Literal AI
...
1. `status: done` in REGISTRY.json for `sa-mkt-0907`
