# sa-mkt-0906 — Literal AI · Buyer-visible UX
...
Add `Worker job run detail page (pass/fail/steps/logs/retry)` mock row labeled mock_only until live — match Literal AI run/history metaphor not invented name
...
1. `status: done` in REGISTRY.json for `sa-mkt-0906`
