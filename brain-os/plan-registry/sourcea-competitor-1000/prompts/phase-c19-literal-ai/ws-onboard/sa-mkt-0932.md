# sa-mkt-0932 — Literal AI · Onboarding & PLG
...
Define ≤30s-to-value step on `Hub Actions + RUN INBOX first-run path` copied from Literal AI motion
...
1. `status: done` in REGISTRY.json for `sa-mkt-0932`
