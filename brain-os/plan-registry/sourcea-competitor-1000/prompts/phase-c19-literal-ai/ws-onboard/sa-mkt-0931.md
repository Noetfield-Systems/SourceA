# sa-mkt-0931 — Literal AI · Onboarding & PLG
...
Document Literal AI onboarding path (YC-style agent observability): who runs (Managed cloud) → first value moment

## Implementation extraction

`Literal AI · Onboarding & PLG` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0931`
