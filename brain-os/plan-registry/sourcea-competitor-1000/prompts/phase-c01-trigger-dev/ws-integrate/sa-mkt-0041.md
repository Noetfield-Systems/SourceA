# sa-mkt-0041 — Trigger.dev · Integrations & API
...
List Trigger.dev integrations/APIs from https://trigger.dev · https://trigger.dev/pricing or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `sa-mkt-0041`
