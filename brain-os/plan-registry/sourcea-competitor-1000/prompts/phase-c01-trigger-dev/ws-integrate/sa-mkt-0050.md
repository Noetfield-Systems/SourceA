# sa-mkt-0050 — Trigger.dev · Integrations & API
...
Close sa-mkt-0050: integration receipt + verify PASS + https://trigger.dev · https://trigger.dev/pricing
...
1. `status: done` in REGISTRY.json for `sa-mkt-0050`
