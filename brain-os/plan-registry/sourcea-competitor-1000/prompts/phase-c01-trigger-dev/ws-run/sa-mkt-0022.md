# sa-mkt-0022 — Trigger.dev · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Run detail page with pass/fail, steps, logs, retry — copy for Worker Hub job dashboard)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0022`
