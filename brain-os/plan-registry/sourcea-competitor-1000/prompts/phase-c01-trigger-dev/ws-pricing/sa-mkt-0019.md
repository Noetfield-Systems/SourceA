# sa-mkt-0019 — Trigger.dev · Pricing & packaging
...
Write competitor row evidence: Trigger.dev pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `sa-mkt-0019`
