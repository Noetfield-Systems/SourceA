# sa-mkt-0015 — Trigger.dev · Pricing & packaging
...
Compare Trigger.dev PLG motion (Open source → dev community → PLG cloud tiers) vs our onboarding — one adoption fix on `Hub Actions + RUN INBOX first-run path`
...
1. `status: done` in REGISTRY.json for `sa-mkt-0015`
