# sa-mkt-0012 — Trigger.dev · Pricing & packaging
...
Map Trigger.dev revenue model (Usage-based SaaS + self-host OSS) to our `SourceA agency + Buyer-1 pricing narrative` tier names — no hidden fees theater
...
1. `status: done` in REGISTRY.json for `sa-mkt-0012`
