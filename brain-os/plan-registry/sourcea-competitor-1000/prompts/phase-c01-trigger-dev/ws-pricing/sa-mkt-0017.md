# sa-mkt-0017 — Trigger.dev · Pricing & packaging
...
Add upgrade CTA path: sandbox/free → paid bay matching Trigger.dev upgrade pattern where applicable
...
1. `status: done` in REGISTRY.json for `sa-mkt-0017`
