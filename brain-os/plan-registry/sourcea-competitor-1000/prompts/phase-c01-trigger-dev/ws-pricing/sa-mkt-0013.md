# sa-mkt-0013 — Trigger.dev · Pricing & packaging
...
Add or update one public price card on `Worker Hub Next steps + factory-now line` inspired by Trigger.dev packaging motion
...
1. `status: done` in REGISTRY.json for `sa-mkt-0013`
