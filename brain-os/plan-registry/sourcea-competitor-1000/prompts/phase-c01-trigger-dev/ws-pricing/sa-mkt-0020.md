# sa-mkt-0020 — Trigger.dev · Pricing & packaging
...
Close sa-mkt-0020: PRIORITY row + verify PASS + link https://trigger.dev · https://trigger.dev/pricing
...
1. `status: done` in REGISTRY.json for `sa-mkt-0020`
