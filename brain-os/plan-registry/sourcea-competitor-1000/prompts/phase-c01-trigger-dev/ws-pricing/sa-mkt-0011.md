# sa-mkt-0011 — Trigger.dev · Pricing & packaging
...
Capture Trigger.dev public pricing evidence: Free $0 + Hobby $10/mo + Pro $50/mo; $0.25 per 10,000 run invocations + compute seconds — https://trigger.dev/pricing — save link or quoted range in plan receipt

## Implementation extraction

`Trigger.dev · Pricing & packaging` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0011`
