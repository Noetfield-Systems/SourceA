# sa-mkt-0009 — Trigger.dev · Buyer-visible UX
...
Ship summary in PRIORITY: preserved · changed · achieved vs Trigger.dev Buyer-visible UX
...
1. `status: done` in REGISTRY.json for `sa-mkt-0009`
