# sa-mkt-0007 — Trigger.dev · Buyer-visible UX
...
Document who buys (Backend and platform engineers at SaaS startups) vs our ICP one sentence on `brain-os/plan-registry/SOURCEA-PRIORITY.md` row for Trigger.dev
...
1. `status: done` in REGISTRY.json for `sa-mkt-0007`
