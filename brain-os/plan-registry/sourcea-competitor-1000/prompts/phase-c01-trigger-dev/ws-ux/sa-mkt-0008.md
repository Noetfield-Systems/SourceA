# sa-mkt-0008 — Trigger.dev · Buyer-visible UX
...
Reject abstract rename — keep market words buyers know from Trigger.dev (Durable background jobs & AI workflows)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0008`
