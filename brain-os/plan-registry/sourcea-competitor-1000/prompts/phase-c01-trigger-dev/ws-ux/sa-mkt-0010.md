# sa-mkt-0010 — Trigger.dev · Buyer-visible UX
...
Mark sa-mkt-0010 done in REGISTRY with evidence path + https://trigger.dev · https://trigger.dev/pricing after verify PASS
...
1. `status: done` in REGISTRY.json for `sa-mkt-0010`
