# sa-mkt-0001 — Trigger.dev · Buyer-visible UX
...
Open https://trigger.dev · https://trigger.dev/pricing — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Trigger.dev uses; paste into plan evidence (vendor says: Open-source AI agent and workflow platform — run long tasks with retries and a visual run dashboard)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0001`
