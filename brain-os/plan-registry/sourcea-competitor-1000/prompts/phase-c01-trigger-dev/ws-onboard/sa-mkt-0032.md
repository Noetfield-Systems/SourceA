# sa-mkt-0032 — Trigger.dev · Onboarding & PLG
...
Define ≤30s-to-value step on `Hub Actions + RUN INBOX first-run path` copied from Trigger.dev motion
...
1. `status: done` in REGISTRY.json for `sa-mkt-0032`
