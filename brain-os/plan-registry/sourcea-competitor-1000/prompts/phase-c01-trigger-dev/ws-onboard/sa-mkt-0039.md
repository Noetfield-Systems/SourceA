# sa-mkt-0039 — Trigger.dev · Onboarding & PLG
...
Docs: onboarding section cites Trigger.dev as market analog with https://trigger.dev · https://trigger.dev/pricing
...
1. `status: done` in REGISTRY.json for `sa-mkt-0039`
