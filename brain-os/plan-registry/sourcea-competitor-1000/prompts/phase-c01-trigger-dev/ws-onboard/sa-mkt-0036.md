# sa-mkt-0036 — Trigger.dev · Onboarding & PLG
...
Write founder-facing SOW snippet if Trigger.dev uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `sa-mkt-0036`
