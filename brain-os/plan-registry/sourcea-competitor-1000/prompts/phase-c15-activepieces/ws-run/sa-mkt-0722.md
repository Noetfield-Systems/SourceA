# sa-mkt-0722 — Activepieces · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Self-hostable workflow runs for portfolio factories)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0722`
