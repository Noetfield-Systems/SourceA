# sa-mkt-0725 — Activepieces · Run history & proof
...
Add retention note: how long run history kept vs Activepieces (OSS free; cloud paid tiers tier hints)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0725`
