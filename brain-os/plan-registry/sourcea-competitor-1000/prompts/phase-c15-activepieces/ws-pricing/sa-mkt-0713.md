# sa-mkt-0713 — Activepieces · Pricing & packaging
...
Add or update one public price card on `Worker Hub Next steps + factory-now line` inspired by Activepieces packaging motion
...
1. `status: done` in REGISTRY.json for `sa-mkt-0713`
