# sa-mkt-0720 — Activepieces · Pricing & packaging
...
Close sa-mkt-0720: PRIORITY row + verify PASS + link https://www.activepieces.com
...
1. `status: done` in REGISTRY.json for `sa-mkt-0720`
