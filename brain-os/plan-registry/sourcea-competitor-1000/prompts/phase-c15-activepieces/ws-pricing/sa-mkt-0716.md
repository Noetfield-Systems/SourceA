# sa-mkt-0716 — Activepieces · Pricing & packaging
...
Document why buyers pay per Activepieces: Want automation without vendor lock-in — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `sa-mkt-0716`
