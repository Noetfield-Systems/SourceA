# sa-mkt-0719 — Activepieces · Pricing & packaging
...
Write competitor row evidence: Activepieces pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `sa-mkt-0719`
