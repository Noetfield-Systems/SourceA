# sa-mkt-0711 — Activepieces · Pricing & packaging
...
Capture Activepieces public pricing evidence: OSS free; cloud paid tiers — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `sa-mkt-0711`
