# sa-mkt-0712 — Activepieces · Pricing & packaging
...
Map Activepieces revenue model (OSS + cloud SaaS) to our `SourceA agency + Buyer-1 pricing narrative` tier names — no hidden fees theater
...
1. `status: done` in REGISTRY.json for `sa-mkt-0712`
