# sa-mkt-0715 — Activepieces · Pricing & packaging
...
Compare Activepieces PLG motion (Open-source community → cloud) vs our onboarding — one adoption fix on `Hub Actions + RUN INBOX first-run path`

## Implementation extraction

`Activepieces · Pricing & packaging` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0715`
