# sa-mkt-0736 — Activepieces · Onboarding & PLG
...
Write founder-facing SOW snippet if Activepieces uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `sa-mkt-0736`
