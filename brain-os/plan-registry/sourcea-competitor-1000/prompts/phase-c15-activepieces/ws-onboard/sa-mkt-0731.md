# sa-mkt-0731 — Activepieces · Onboarding & PLG
...
Document Activepieces onboarding path (Open-source community → cloud): who runs (OSS + Activepieces Cloud) → first value moment

## Implementation extraction

`Activepieces · Onboarding & PLG` → what buyer sees at vendor → what we ship logged with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0731`
