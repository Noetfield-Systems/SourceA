# sa-mkt-0739 — Activepieces · Onboarding & PLG
...
Docs: onboarding section cites Activepieces as market analog with https://www.activepieces.com
...
1. `status: done` in REGISTRY.json for `sa-mkt-0739`
