# sa-mkt-0701 — Activepieces · Buyer-visible UX
...
Open https://www.activepieces.com — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Activepieces uses; paste into plan evidence (vendor says: Self-hostable Zapier alternative with flow builder)

## Implementation extraction

`Activepieces · Buyer-visible UX` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0701`
