# sa-mkt-0710 — Activepieces · Buyer-visible UX
...
Mark sa-mkt-0710 done in REGISTRY with evidence path + https://www.activepieces.com after verify PASS
...
1. `status: done` in REGISTRY.json for `sa-mkt-0710`
