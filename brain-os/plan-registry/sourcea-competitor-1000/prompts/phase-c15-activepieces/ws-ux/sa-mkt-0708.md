# sa-mkt-0708 — Activepieces · Buyer-visible UX
...
Reject abstract rename — keep market words buyers know from Activepieces (Open-source automation)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0708`
