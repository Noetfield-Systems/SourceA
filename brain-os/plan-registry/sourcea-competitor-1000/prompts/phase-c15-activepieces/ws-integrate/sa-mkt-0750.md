# sa-mkt-0750 — Activepieces · Integrations & API
...
Close sa-mkt-0750: integration receipt + verify PASS + https://www.activepieces.com
...
1. `status: done` in REGISTRY.json for `sa-mkt-0750`
