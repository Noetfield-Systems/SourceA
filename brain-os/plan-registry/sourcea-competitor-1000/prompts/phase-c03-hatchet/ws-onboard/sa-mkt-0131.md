# sa-mkt-0131 — Hatchet · Onboarding & PLG
...
Document Hatchet onboarding path (Open source 2023; AI pipeline wedge): who runs (Vendor cloud + open-source self-host) → first value moment

## Implementation extraction

`Hatchet · Onboarding & PLG` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0131`
