# sa-mkt-0132 — Hatchet · Onboarding & PLG
...
Define ≤30s-to-value step on `Hub Actions + RUN INBOX first-run path` copied from Hatchet motion
...
1. `status: done` in REGISTRY.json for `sa-mkt-0132`
