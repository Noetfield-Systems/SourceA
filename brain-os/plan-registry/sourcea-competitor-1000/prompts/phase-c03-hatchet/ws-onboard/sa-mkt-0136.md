# sa-mkt-0136 — Hatchet · Onboarding & PLG
...
Write founder-facing SOW snippet if Hatchet uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `sa-mkt-0136`
