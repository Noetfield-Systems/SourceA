# sa-mkt-0115 — Hatchet · Pricing & packaging
...
Compare Hatchet PLG motion (Open source 2023; AI pipeline wedge) vs our onboarding — one adoption fix on `Hub Actions + RUN INBOX first-run path`
...
1. `status: done` in REGISTRY.json for `sa-mkt-0115`
