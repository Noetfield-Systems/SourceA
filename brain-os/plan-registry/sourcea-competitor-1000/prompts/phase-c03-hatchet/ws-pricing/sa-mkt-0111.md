# sa-mkt-0111 — Hatchet · Pricing & packaging
...
Capture Hatchet public pricing evidence: Free tier; Starter ~$180/mo; Production ~$425/mo (market reviews) — save link or quoted range in plan receipt

## Implementation extraction

`Hatchet · Pricing & packaging` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0111`
