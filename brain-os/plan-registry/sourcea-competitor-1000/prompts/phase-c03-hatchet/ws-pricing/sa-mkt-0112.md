# sa-mkt-0112 — Hatchet · Pricing & packaging
...
Map Hatchet revenue model (Usage-based cloud + OSS) to our `SourceA agency + Buyer-1 pricing narrative` tier names — no hidden fees theater
...
1. `status: done` in REGISTRY.json for `sa-mkt-0112`
