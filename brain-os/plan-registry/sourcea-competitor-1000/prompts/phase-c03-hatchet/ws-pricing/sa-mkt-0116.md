# sa-mkt-0116 — Hatchet · Pricing & packaging
...
Document why buyers pay per Hatchet: BullMQ/Redis ops burden; Hatchet gives DAG + streaming for AI — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `sa-mkt-0116`
