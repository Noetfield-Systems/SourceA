# sa-mkt-0125 — Hatchet · Run history & proof
...
Add retention note: how long run history kept vs Hatchet (Free tier; Starter ~$180/mo; Production ~$425/mo (market reviews) tier hints)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0125`
