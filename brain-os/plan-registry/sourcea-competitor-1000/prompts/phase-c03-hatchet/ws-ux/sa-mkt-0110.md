# sa-mkt-0110 — Hatchet · Buyer-visible UX
...
Mark sa-mkt-0110 done in REGISTRY with evidence path + https://hatchet.run after verify PASS
...
1. `status: done` in REGISTRY.json for `sa-mkt-0110`
