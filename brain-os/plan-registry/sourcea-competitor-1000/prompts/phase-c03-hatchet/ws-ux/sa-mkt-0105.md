# sa-mkt-0105 — Hatchet · Buyer-visible UX
...
Diff our public copy vs Hatchet pricing/product page — list 3 concrete gaps; fix highest P0 gap only
...
1. `status: done` in REGISTRY.json for `sa-mkt-0105`
