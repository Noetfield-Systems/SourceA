# sa-mkt-0108 — Hatchet · Buyer-visible UX
...
Reject abstract rename — keep market words buyers know from Hatchet (Task orchestration for AI pipelines)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0108`
