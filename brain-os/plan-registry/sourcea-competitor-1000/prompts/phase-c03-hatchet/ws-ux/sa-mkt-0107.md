# sa-mkt-0107 — Hatchet · Buyer-visible UX
...
Document who buys (AI pipeline and data engineering teams) vs our ICP one sentence on `brain-os/plan-registry/SOURCEA-PRIORITY.md` row for Hatchet
...
1. `status: done` in REGISTRY.json for `sa-mkt-0107`
