# sa-mkt-0101 — Hatchet · Buyer-visible UX
...
Open https://hatchet.run — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Hatchet uses; paste into plan evidence (vendor says: Low-latency orchestration for agentic AI workflows with automatic retries)

## Implementation extraction

`Hatchet · Buyer-visible UX` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0101`
