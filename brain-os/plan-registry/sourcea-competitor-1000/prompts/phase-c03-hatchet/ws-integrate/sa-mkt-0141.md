# sa-mkt-0141 — Hatchet · Integrations & API
...
List Hatchet integrations/APIs from https://hatchet.run or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `sa-mkt-0141`
