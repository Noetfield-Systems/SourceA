# sa-mkt-0465 — Giskard · Pricing & packaging
...
Compare Giskard PLG motion (Paris OSS 2021 → enterprise Hub) vs our onboarding — one adoption fix on `Hub Actions + RUN INBOX first-run path`
...
1. `status: done` in REGISTRY.json for `sa-mkt-0465`
