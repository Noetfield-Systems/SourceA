# sa-mkt-0461 — Giskard · Pricing & packaging
...
Capture Giskard public pricing evidence: OSS free; Hub subscription contact sales — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `sa-mkt-0461`
