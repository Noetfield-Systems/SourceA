# sa-mkt-0470 — Giskard · Pricing & packaging
...
Close sa-mkt-0470: PRIORITY row + verify PASS + link https://www.giskard.ai
...
1. `status: done` in REGISTRY.json for `sa-mkt-0470`
