# sa-mkt-0451 — Giskard · Buyer-visible UX
...
Open https://www.giskard.ai — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Giskard uses; paste into plan evidence (vendor says: Open-source evaluation and testing for LLM agents before production)

## Implementation extraction

`Giskard · Buyer-visible UX` → what buyer sees at vendor → what we ship logged with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0451`
