# sa-mkt-0457 — Giskard · Buyer-visible UX
...
Document who buys (ML/AI QA teams) vs our ICP one sentence on `brain-os/plan-registry/SOURCEA-PRIORITY.md` row for Giskard
...
1. `status: done` in REGISTRY.json for `sa-mkt-0457`
