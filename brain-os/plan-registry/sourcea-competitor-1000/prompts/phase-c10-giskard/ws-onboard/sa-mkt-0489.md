# sa-mkt-0489 — Giskard · Onboarding & PLG
...
Docs: onboarding section cites Giskard as market analog with https://www.giskard.ai
...
1. `status: done` in REGISTRY.json for `sa-mkt-0489`
