# sa-mkt-0497 — Giskard · Integrations & API
...
Rate-limit + retry policy copied from Giskard operating model (Run test suites on agents; Hub adds collaboration and continuous red-team)

## Implementation extraction

`Giskard · Integrations & API` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0497`
