# sa-mkt-0500 — Giskard · Integrations & API
...
Close sa-mkt-0500: integration receipt + verify PASS + https://www.giskard.ai
...
1. `status: done` in REGISTRY.json for `sa-mkt-0500`
