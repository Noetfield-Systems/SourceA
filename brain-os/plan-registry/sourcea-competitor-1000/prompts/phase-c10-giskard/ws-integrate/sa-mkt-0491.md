# sa-mkt-0491 — Giskard · Integrations & API
...
List Giskard integrations/APIs from https://www.giskard.ai or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `sa-mkt-0491`
