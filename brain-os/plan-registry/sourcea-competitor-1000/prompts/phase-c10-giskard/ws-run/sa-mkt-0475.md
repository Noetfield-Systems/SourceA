# sa-mkt-0475 — Giskard · Run history & proof
...
Add retention note: how long run history kept vs Giskard (OSS free; Hub subscription contact sales tier hints)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0475`
