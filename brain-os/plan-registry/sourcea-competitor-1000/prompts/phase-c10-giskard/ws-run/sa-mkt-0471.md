# sa-mkt-0471 — Giskard · Run history & proof
...
From https://www.giskard.ai document Giskard run/history UX: Run test suites on agents; Hub adds collaboration and continuous red-team — map to `Worker job run detail page (pass/fail/steps/logs/retry)`

## Implementation extraction

`Giskard · Run history & proof` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0471`
