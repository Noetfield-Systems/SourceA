# sa-mkt-0472 — Giskard · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Pre-prod agent regression test library)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0472`
