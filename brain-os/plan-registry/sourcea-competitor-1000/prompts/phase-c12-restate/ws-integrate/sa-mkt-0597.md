# sa-mkt-0597 — Restate · Integrations & API
...
Rate-limit + retry policy copied from Restate operating model (Developer writes durable functions; engine persists state)

## Implementation extraction

`Restate · Integrations & API` → what buyer sees at vendor → what we ship logged with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0597`
