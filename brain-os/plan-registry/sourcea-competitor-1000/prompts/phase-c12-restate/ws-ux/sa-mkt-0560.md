# sa-mkt-0560 — Restate · Buyer-visible UX
...
Mark sa-mkt-0560 done in REGISTRY with evidence path + https://restate.dev after verify PASS
...
1. `status: done` in REGISTRY.json for `sa-mkt-0560`
