# sa-mkt-0558 — Restate · Buyer-visible UX
...
Reject abstract rename — keep market words buyers know from Restate (Durable execution engine)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0558`
