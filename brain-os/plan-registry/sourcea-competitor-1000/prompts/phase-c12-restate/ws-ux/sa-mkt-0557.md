# sa-mkt-0557 — Restate · Buyer-visible UX
...
Document who buys (Backend platform teams) vs our ICP one sentence on `brain-os/plan-registry/SOURCEA-PRIORITY.md` row for Restate
...
1. `status: done` in REGISTRY.json for `sa-mkt-0557`
