# sa-mkt-0572 — Restate · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Long-running worker without orchestrator ghost state)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0572`
