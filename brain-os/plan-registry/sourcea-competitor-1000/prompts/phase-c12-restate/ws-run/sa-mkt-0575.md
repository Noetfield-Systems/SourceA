# sa-mkt-0575 — Restate · Run history & proof
...
Add retention note: how long run history kept vs Restate (OSS free; cloud usage-based tier hints)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0575`
