# sa-mkt-0582 — Restate · Onboarding & PLG
...
Define ≤30s-to-value step on `Hub Actions + RUN INBOX first-run path` copied from Restate motion
...
1. `status: done` in REGISTRY.json for `sa-mkt-0582`
