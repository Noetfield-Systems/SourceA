# sa-mkt-0586 — Restate · Onboarding & PLG
...
Write founder-facing SOW snippet if Restate uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `sa-mkt-0586`
