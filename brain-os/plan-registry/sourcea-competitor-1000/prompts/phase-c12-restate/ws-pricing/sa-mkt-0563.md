# sa-mkt-0563 — Restate · Pricing & packaging
...
Add or update one public price card on `Worker Hub Next steps + factory-now line` inspired by Restate packaging motion
...
1. `status: done` in REGISTRY.json for `sa-mkt-0563`
