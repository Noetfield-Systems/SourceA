# sa-mkt-0566 — Restate · Pricing & packaging
...
Document why buyers pay per Restate: Workflow state loss on crashes; need durable execution — tie to our offer in plain English

## Implementation extraction

`Restate · Pricing & packaging` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0566`
