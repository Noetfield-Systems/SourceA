# sa-mkt-0569 — Restate · Pricing & packaging
...
Write competitor row evidence: Restate pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `sa-mkt-0569`
