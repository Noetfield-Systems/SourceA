# sa-mkt-0562 — Restate · Pricing & packaging
...
Map Restate revenue model (OSS + cloud) to our `SourceA agency + Buyer-1 pricing narrative` tier names — no hidden fees theater
...
1. `status: done` in REGISTRY.json for `sa-mkt-0562`
