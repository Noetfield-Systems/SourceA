# sa-mkt-0822 — Vellum · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Versioned prompt + eval on every dispatch)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0822`
