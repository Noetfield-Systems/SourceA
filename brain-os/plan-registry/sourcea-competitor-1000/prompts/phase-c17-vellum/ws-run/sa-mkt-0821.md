# sa-mkt-0821 — Vellum · Run history & proof
...
From https://www.vellum.ai document Vellum run/history UX: Version prompts; run evals; monitor production — map to `Worker job run detail page (pass/fail/steps/logs/retry)`

## Implementation extraction

`Vellum · Run history & proof` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0821`
