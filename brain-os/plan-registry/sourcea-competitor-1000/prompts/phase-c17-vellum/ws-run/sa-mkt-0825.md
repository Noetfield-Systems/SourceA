# sa-mkt-0825 — Vellum · Run history & proof
...
Add retention note: how long run history kept vs Vellum (Team/enterprise custom tiers tier hints)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0825`
