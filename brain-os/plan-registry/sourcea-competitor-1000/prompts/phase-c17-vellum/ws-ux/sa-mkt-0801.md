# sa-mkt-0801 — Vellum · Buyer-visible UX
...
Open https://www.vellum.ai — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Vellum uses; paste into plan evidence (vendor says: Prompt deployment, eval, and monitoring for production LLM apps)

## Implementation extraction

`Vellum · Buyer-visible UX` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0801`
