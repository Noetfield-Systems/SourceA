# sa-mkt-0803 — Vellum · Buyer-visible UX
...
Add `Worker Hub Next steps + factory-now line` UI field or copy block implementing smallest slice of `Versioned prompt + eval on every dispatch`; preserve honest tier label
...
1. `status: done` in REGISTRY.json for `sa-mkt-0803`
