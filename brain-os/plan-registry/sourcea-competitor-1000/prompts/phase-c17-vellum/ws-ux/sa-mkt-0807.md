# sa-mkt-0807 — Vellum · Buyer-visible UX
...
Document who buys (LLM product teams) vs our ICP one sentence on `brain-os/plan-registry/SOURCEA-PRIORITY.md` row for Vellum
...
1. `status: done` in REGISTRY.json for `sa-mkt-0807`
