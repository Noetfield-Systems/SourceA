# sa-mkt-0850 — Vellum · Integrations & API
...
Close sa-mkt-0850: integration receipt + verify PASS + https://www.vellum.ai
...
1. `status: done` in REGISTRY.json for `sa-mkt-0850`
