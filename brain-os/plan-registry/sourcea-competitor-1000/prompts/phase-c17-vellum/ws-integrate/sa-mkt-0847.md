# sa-mkt-0847 — Vellum · Integrations & API
...
Rate-limit + retry policy copied from Vellum operating model (Version prompts; run evals; monitor production)

## Implementation extraction

`Vellum · Integrations & API` → what buyer sees at vendor → what we ship logged with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0847`
