# sa-mkt-0836 — Vellum · Onboarding & PLG
...
Write founder-facing SOW snippet if Vellum uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `sa-mkt-0836`
