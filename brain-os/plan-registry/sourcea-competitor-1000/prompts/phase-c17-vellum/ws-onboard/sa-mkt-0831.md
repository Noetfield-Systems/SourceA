# sa-mkt-0831 — Vellum · Onboarding & PLG
...
Document Vellum onboarding path (Product-led for AI teams): who runs (Managed SaaS) → first value moment

## Implementation extraction

`Vellum · Onboarding & PLG` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0831`
