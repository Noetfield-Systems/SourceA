# sa-mkt-0839 — Vellum · Onboarding & PLG
...
Docs: onboarding section cites Vellum as market analog with https://www.vellum.ai
...
1. `status: done` in REGISTRY.json for `sa-mkt-0839`
