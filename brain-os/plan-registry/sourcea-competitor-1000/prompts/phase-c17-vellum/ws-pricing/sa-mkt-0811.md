# sa-mkt-0811 — Vellum · Pricing & packaging
...
Capture Vellum public pricing evidence: Team/enterprise custom tiers — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `sa-mkt-0811`
