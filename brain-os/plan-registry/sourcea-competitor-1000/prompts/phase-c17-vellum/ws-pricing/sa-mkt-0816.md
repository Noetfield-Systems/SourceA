# sa-mkt-0816 — Vellum · Pricing & packaging
...
Document why buyers pay per Vellum: Prompt chaos in production; need versioned deploy — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `sa-mkt-0816`
