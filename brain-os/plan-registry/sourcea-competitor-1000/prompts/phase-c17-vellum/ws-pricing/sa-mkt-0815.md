# sa-mkt-0815 — Vellum · Pricing & packaging
...
Compare Vellum PLG motion (Product-led for AI teams) vs our onboarding — one adoption fix on `Hub Actions + RUN INBOX first-run path`

## Implementation extraction

`Vellum · Pricing & packaging` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0815`
