# sa-mkt-0425 — Promptfoo · Run history & proof
...
Add retention note: how long run history kept vs Promptfoo (Community free 10k probes/mo; enterprise contact sales tier hints)

## Implementation extraction

`Promptfoo · Run history & proof` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0425`
