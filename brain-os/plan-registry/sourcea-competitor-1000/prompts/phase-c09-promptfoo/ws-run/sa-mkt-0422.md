# sa-mkt-0422 — Promptfoo · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Pre-ship eval gate on worker output)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0422`
