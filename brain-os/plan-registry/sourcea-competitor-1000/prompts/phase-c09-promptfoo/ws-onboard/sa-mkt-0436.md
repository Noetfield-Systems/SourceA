# sa-mkt-0436 — Promptfoo · Onboarding & PLG
...
Write founder-facing SOW snippet if Promptfoo uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `sa-mkt-0436`
