# sa-mkt-0431 — Promptfoo · Onboarding & PLG
...
Document Promptfoo onboarding path (Open source → Fortune 500 adoption → enterprise): who runs (OSS free; Enterprise custom (acquired OpenAI Mar 2026)) → first value moment

## Implementation extraction

`Promptfoo · Onboarding & PLG` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0431`
