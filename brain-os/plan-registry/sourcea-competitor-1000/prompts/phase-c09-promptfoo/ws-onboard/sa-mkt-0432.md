# sa-mkt-0432 — Promptfoo · Onboarding & PLG
...
Define ≤30s-to-value step on `Hub Actions + RUN INBOX first-run path` copied from Promptfoo motion
...
1. `status: done` in REGISTRY.json for `sa-mkt-0432`
