# sa-mkt-0407 — Promptfoo · Buyer-visible UX
...
Document who buys (Developers and security teams) vs our ICP one sentence on `brain-os/plan-registry/SOURCEA-PRIORITY.md` row for Promptfoo
...
1. `status: done` in REGISTRY.json for `sa-mkt-0407`
