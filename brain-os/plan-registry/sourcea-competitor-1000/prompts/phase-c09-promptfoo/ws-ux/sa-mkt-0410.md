# sa-mkt-0410 — Promptfoo · Buyer-visible UX
...
Mark sa-mkt-0410 done in REGISTRY with evidence path + https://www.promptfoo.dev after verify PASS
...
1. `status: done` in REGISTRY.json for `sa-mkt-0410`
