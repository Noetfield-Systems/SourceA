# sa-mkt-0408 — Promptfoo · Buyer-visible UX
...
Reject abstract rename — keep market words buyers know from Promptfoo (LLM eval & red-team CLI)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0408`
