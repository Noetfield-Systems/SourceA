# sa-mkt-0401 — Promptfoo · Buyer-visible UX
...
Open https://www.promptfoo.dev — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Promptfoo uses; paste into plan evidence (vendor says: Test prompts, agents, RAG — red teaming for jailbreaks and PII leaks)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0401`
