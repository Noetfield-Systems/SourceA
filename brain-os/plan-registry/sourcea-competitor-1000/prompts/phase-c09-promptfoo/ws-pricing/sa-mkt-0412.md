# sa-mkt-0412 — Promptfoo · Pricing & packaging
...
Map Promptfoo revenue model (OSS + enterprise SaaS) to our `SourceA agency + Buyer-1 pricing narrative` tier names — no hidden fees theater
...
1. `status: done` in REGISTRY.json for `sa-mkt-0412`
