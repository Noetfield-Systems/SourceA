# sa-mkt-0415 — Promptfoo · Pricing & packaging
...
Compare Promptfoo PLG motion (Open source → Fortune 500 adoption → enterprise) vs our onboarding — one adoption fix on `Hub Actions + RUN INBOX first-run path`
...
1. `status: done` in REGISTRY.json for `sa-mkt-0415`
