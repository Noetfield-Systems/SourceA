# sa-mkt-0420 — Promptfoo · Pricing & packaging
...
Close sa-mkt-0420: PRIORITY row + verify PASS + link https://www.promptfoo.dev
...
1. `status: done` in REGISTRY.json for `sa-mkt-0420`
