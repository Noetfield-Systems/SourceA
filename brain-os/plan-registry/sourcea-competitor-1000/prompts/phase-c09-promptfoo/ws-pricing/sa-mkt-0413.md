# sa-mkt-0413 — Promptfoo · Pricing & packaging
...
Add or update one public price card on `Worker Hub Next steps + factory-now line` inspired by Promptfoo packaging motion
...
1. `status: done` in REGISTRY.json for `sa-mkt-0413`
