# sa-mkt-0447 — Promptfoo · Integrations & API
...
Rate-limit + retry policy copied from Promptfoo operating model (CLI/CI runs matrix evals locally or in cloud)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0447`
