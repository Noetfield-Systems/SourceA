# sa-mkt-0441 — Promptfoo · Integrations & API
...
List Promptfoo integrations/APIs from https://www.promptfoo.dev or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `sa-mkt-0441`
