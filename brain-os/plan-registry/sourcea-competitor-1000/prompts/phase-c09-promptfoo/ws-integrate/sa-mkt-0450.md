# sa-mkt-0450 — Promptfoo · Integrations & API
...
Close sa-mkt-0450: integration receipt + verify PASS + https://www.promptfoo.dev
...
1. `status: done` in REGISTRY.json for `sa-mkt-0450`
