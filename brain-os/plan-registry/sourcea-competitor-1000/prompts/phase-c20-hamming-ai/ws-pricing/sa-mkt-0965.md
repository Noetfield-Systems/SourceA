# sa-mkt-0965 — Hamming AI · Pricing & packaging
...
Compare Hamming AI PLG motion (Voice agent QA niche) vs our onboarding — one adoption fix on `Hub Actions + RUN INBOX first-run path`
...
1. `status: done` in REGISTRY.json for `sa-mkt-0965`
