# sa-mkt-0961 — Hamming AI · Pricing & packaging
...
Capture Hamming AI public pricing evidence: Custom (young startup) — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `sa-mkt-0961`
