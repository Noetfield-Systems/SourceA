# sa-mkt-0962 — Hamming AI · Pricing & packaging
...
Map Hamming AI revenue model (Enterprise contracts) to our `SourceA agency + Buyer-1 pricing narrative` tier names — no hidden fees theater

## Implementation extraction

`Hamming AI · Pricing & packaging` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0962`
