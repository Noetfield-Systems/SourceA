# sa-mkt-0967 — Hamming AI · Pricing & packaging
...
Add upgrade CTA path: sandbox/free → paid bay matching Hamming AI upgrade pattern where applicable
...
1. `status: done` in REGISTRY.json for `sa-mkt-0967`
