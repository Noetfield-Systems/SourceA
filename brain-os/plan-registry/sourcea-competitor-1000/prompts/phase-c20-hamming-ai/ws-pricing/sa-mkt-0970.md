# sa-mkt-0970 — Hamming AI · Pricing & packaging
...
Close sa-mkt-0970: PRIORITY row + verify PASS + link https://www.hamming.ai
...
1. `status: done` in REGISTRY.json for `sa-mkt-0970`
