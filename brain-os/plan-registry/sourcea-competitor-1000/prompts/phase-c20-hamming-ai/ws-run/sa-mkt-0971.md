# sa-mkt-0971 — Hamming AI · Run history & proof
...
From https://www.hamming.ai document Hamming AI run/history UX: Define scenarios; run regression; score outcomes — map to `Worker job run detail page (pass/fail/steps/logs/retry)`

## Implementation extraction

`Hamming AI · Run history & proof` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0971`
