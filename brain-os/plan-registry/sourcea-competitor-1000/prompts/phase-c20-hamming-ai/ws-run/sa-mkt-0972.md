# sa-mkt-0972 — Hamming AI · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Regression scenario suite before agent release)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0972`
