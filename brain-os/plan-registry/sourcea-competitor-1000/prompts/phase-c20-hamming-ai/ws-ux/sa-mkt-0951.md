# sa-mkt-0951 — Hamming AI · Buyer-visible UX
...
Open https://www.hamming.ai — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Hamming AI uses; paste into plan evidence (vendor says: Scenario test suites for voice and conversational agents)

## Implementation extraction

`Hamming AI · Buyer-visible UX` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0951`
