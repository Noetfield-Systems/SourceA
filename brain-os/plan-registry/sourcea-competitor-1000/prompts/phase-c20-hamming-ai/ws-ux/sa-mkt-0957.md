# sa-mkt-0957 — Hamming AI · Buyer-visible UX
...
Document who buys (Voice AI and agent QA teams) vs our ICP one sentence on `brain-os/plan-registry/SOURCEA-PRIORITY.md` row for Hamming AI
...
1. `status: done` in REGISTRY.json for `sa-mkt-0957`
