# sa-mkt-0989 — Hamming AI · Onboarding & PLG
...
Docs: onboarding section cites Hamming AI as market analog with https://www.hamming.ai
...
1. `status: done` in REGISTRY.json for `sa-mkt-0989`
