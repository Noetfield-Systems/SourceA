# sa-mkt-0981 — Hamming AI · Onboarding & PLG
...
Document Hamming AI onboarding path (Voice agent QA niche): who runs (Managed SaaS custom) → first value moment

## Implementation extraction

`Hamming AI · Onboarding & PLG` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0981`
