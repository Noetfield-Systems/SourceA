# sa-mkt-0982 — Hamming AI · Onboarding & PLG
...
Define ≤30s-to-value step on `Hub Actions + RUN INBOX first-run path` copied from Hamming AI motion
...
1. `status: done` in REGISTRY.json for `sa-mkt-0982`
