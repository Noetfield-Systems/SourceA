# sa-mkt-0991 — Hamming AI · Integrations & API
...
List Hamming AI integrations/APIs from https://www.hamming.ai or docs — pick one we can wire this quarter

## Implementation extraction

`Hamming AI · Integrations & API` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0991`
