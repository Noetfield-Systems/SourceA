# sa-mkt-0222 — Langfuse · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Hierarchical trace viewer per agent turn with cost/latency)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0222`
