# sa-mkt-0221 — Langfuse · Run history & proof
...
From https://langfuse.com · https://langfuse.com/docs document Langfuse run/history UX: SDK captures traces; dashboard filters by user, session, cost, latency — map to `Worker job run detail page (pass/fail/steps/logs/retry)`

## Implementation extraction

`Langfuse · Run history & proof` → what buyer sees at vendor → what we ship logged with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0221`
