# sa-mkt-0225 — Langfuse · Run history & proof
...
Add retention note: how long run history kept vs Langfuse (Free 50k obs/mo; Core ~$29/mo; Pro ~$199/mo — https://langfuse.com/pricing tier hints)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0225`
