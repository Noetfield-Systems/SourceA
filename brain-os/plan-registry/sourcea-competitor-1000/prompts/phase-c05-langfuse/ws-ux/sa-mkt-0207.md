# sa-mkt-0207 — Langfuse · Buyer-visible UX
...
Document who buys (AI engineering teams) vs our ICP one sentence on `brain-os/plan-registry/SOURCEA-PRIORITY.md` row for Langfuse
...
1. `status: done` in REGISTRY.json for `sa-mkt-0207`
