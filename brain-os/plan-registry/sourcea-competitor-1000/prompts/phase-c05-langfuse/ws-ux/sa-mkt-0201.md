# sa-mkt-0201 — Langfuse · Buyer-visible UX
...
Open https://langfuse.com · https://langfuse.com/docs — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Langfuse uses; paste into plan evidence (vendor says: Observability, prompts, evals, and analytics for LLM apps and agents)

## Implementation extraction

`Langfuse · Buyer-visible UX` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0201`
