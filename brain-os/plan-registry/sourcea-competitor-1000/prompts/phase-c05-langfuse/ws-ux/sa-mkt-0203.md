# sa-mkt-0203 — Langfuse · Buyer-visible UX
...
Add `Worker Hub Next steps + factory-now line` UI field or copy block implementing smallest slice of `Hierarchical trace viewer per agent turn with cost/latency`; preserve honest tier label
...
1. `status: done` in REGISTRY.json for `sa-mkt-0203`
