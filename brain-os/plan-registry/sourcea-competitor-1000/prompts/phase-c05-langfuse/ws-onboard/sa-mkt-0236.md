# sa-mkt-0236 — Langfuse · Onboarding & PLG
...
Write founder-facing SOW snippet if Langfuse uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `sa-mkt-0236`
