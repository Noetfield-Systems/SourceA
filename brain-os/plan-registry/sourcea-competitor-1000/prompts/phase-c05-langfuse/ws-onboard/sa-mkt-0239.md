# sa-mkt-0239 — Langfuse · Onboarding & PLG
...
Docs: onboarding section cites Langfuse as market analog with https://langfuse.com · https://langfuse.com/docs
...
1. `status: done` in REGISTRY.json for `sa-mkt-0239`
