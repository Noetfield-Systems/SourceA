# sa-mkt-0231 — Langfuse · Onboarding & PLG
...
Document Langfuse onboarding path (Open-source MIT → 2300+ companies → cloud upsell): who runs (Cloud SaaS or MIT self-host) → first value moment
...
1. `status: done` in REGISTRY.json for `sa-mkt-0231`
