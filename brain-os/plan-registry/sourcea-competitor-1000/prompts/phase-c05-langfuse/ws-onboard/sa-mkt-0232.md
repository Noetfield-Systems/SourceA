# sa-mkt-0232 — Langfuse · Onboarding & PLG
...
Define ≤30s-to-value step on `Hub Actions + RUN INBOX first-run path` copied from Langfuse motion
...
1. `status: done` in REGISTRY.json for `sa-mkt-0232`
