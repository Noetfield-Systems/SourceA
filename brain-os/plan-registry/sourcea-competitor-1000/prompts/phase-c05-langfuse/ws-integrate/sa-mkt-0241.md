# sa-mkt-0241 — Langfuse · Integrations & API
...
List Langfuse integrations/APIs from https://langfuse.com · https://langfuse.com/docs or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `sa-mkt-0241`
