# sa-mkt-0250 — Langfuse · Integrations & API
...
Close sa-mkt-0250: integration receipt + verify PASS + https://langfuse.com · https://langfuse.com/docs
...
1. `status: done` in REGISTRY.json for `sa-mkt-0250`
