# sa-mkt-0219 — Langfuse · Pricing & packaging
...
Write competitor row evidence: Langfuse pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `sa-mkt-0219`
