# sa-mkt-0215 — Langfuse · Pricing & packaging
...
Compare Langfuse PLG motion (Open-source MIT → 2300+ companies → cloud upsell) vs our onboarding — one adoption fix on `Hub Actions + RUN INBOX first-run path`
...
1. `status: done` in REGISTRY.json for `sa-mkt-0215`
