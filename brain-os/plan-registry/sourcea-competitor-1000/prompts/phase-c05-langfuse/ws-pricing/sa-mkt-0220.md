# sa-mkt-0220 — Langfuse · Pricing & packaging
...
Close sa-mkt-0220: PRIORITY row + verify PASS + link https://langfuse.com · https://langfuse.com/docs
...
1. `status: done` in REGISTRY.json for `sa-mkt-0220`
