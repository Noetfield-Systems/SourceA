# sa-mkt-0800 — Relay.app · Integrations & API
...
Close sa-mkt-0800: integration receipt + verify PASS + https://www.relay.app
...
1. `status: done` in REGISTRY.json for `sa-mkt-0800`
