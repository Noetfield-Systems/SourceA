# sa-mkt-0797 — Relay.app · Integrations & API
...
Rate-limit + retry policy copied from Relay.app operating model (Workflow pauses for human approval; then continues)

## Implementation extraction

`Relay.app · Integrations & API` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0797`
