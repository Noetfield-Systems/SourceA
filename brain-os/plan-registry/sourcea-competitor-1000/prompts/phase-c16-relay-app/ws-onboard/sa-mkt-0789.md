# sa-mkt-0789 — Relay.app · Onboarding & PLG
...
Docs: onboarding section cites Relay.app as market analog with https://www.relay.app
...
1. `status: done` in REGISTRY.json for `sa-mkt-0789`
