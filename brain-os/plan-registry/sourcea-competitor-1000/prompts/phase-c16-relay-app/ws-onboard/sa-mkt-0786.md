# sa-mkt-0786 — Relay.app · Onboarding & PLG
...
Write founder-facing SOW snippet if Relay.app uses services-led motion — Witness/TrustField lanes

## Implementation extraction

`Relay.app · Onboarding & PLG` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0786`
