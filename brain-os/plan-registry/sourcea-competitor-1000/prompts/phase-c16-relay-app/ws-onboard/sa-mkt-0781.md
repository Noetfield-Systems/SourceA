# sa-mkt-0781 — Relay.app · Onboarding & PLG
...
Document Relay.app onboarding path (SMB ops PLG): who runs (Vendor SaaS) → first value moment
...
1. `status: done` in REGISTRY.json for `sa-mkt-0781`
