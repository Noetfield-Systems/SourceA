# sa-mkt-0782 — Relay.app · Onboarding & PLG
...
Define ≤30s-to-value step on `Hub Actions + RUN INBOX first-run path` copied from Relay.app motion
...
1. `status: done` in REGISTRY.json for `sa-mkt-0782`
