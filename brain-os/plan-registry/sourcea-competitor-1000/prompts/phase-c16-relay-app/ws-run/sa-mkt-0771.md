# sa-mkt-0771 — Relay.app · Run history & proof
...
From https://www.relay.app document Relay.app run/history UX: Workflow pauses for human approval; then continues — map to `Worker job run detail page (pass/fail/steps/logs/retry)`

## Implementation extraction

`Relay.app · Run history & proof` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0771`
