# sa-mkt-0775 — Relay.app · Run history & proof
...
Add retention note: how long run history kept vs Relay.app (From ~$19/mo (market) tier hints)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0775`
