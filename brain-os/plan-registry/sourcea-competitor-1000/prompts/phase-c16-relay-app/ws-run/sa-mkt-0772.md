# sa-mkt-0772 — Relay.app · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Approval step before ACT/implement in worker loop)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0772`
