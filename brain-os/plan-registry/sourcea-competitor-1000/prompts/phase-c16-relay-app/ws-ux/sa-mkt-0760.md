# sa-mkt-0760 — Relay.app · Buyer-visible UX
...
Mark sa-mkt-0760 done in REGISTRY with evidence path + https://www.relay.app after verify PASS
...
1. `status: done` in REGISTRY.json for `sa-mkt-0760`
