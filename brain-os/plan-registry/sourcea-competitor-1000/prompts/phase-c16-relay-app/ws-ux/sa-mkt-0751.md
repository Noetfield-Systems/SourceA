# sa-mkt-0751 — Relay.app · Buyer-visible UX
...
Open https://www.relay.app — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Relay.app uses; paste into plan evidence (vendor says: Collaborative automations with approval steps)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0751`
