# sa-mkt-0757 — Relay.app · Buyer-visible UX
...
Document who buys (Ops and rev teams) vs our ICP one sentence on `brain-os/plan-registry/SOURCEA-PRIORITY.md` row for Relay.app
...
1. `status: done` in REGISTRY.json for `sa-mkt-0757`
