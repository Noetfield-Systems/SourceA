# sa-mkt-0759 — Relay.app · Buyer-visible UX
...
Ship summary in PRIORITY: preserved · changed · achieved vs Relay.app Buyer-visible UX
...
1. `status: done` in REGISTRY.json for `sa-mkt-0759`
