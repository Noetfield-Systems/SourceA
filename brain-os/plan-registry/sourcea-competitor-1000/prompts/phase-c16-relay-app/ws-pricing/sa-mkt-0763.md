# sa-mkt-0763 — Relay.app · Pricing & packaging
...
Add or update one public price card on `Worker Hub Next steps + factory-now line` inspired by Relay.app packaging motion
...
1. `status: done` in REGISTRY.json for `sa-mkt-0763`
