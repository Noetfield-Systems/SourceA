# sa-mkt-0770 — Relay.app · Pricing & packaging
...
Close sa-mkt-0770: PRIORITY row + verify PASS + link https://www.relay.app
...
1. `status: done` in REGISTRY.json for `sa-mkt-0770`
