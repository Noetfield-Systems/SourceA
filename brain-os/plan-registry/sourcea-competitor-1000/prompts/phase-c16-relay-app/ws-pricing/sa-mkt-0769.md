# sa-mkt-0769 — Relay.app · Pricing & packaging
...
Write competitor row evidence: Relay.app pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `sa-mkt-0769`
