# sa-mkt-0762 — Relay.app · Pricing & packaging
...
Map Relay.app revenue model (Seat + workflow SaaS) to our `SourceA agency + Buyer-1 pricing narrative` tier names — no hidden fees theater

## Implementation extraction

`Relay.app · Pricing & packaging` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0762`
