# sa-mkt-0761 — Relay.app · Pricing & packaging
...
Capture Relay.app public pricing evidence: From ~$19/mo (market) — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `sa-mkt-0761`
