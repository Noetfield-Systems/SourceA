# sa-mkt-0766 — Relay.app · Pricing & packaging
...
Document why buyers pay per Relay.app: Full auto is risky; need founder approval gates — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `sa-mkt-0766`
