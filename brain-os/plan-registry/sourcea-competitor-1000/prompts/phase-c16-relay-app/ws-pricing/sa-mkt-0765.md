# sa-mkt-0765 — Relay.app · Pricing & packaging
...
Compare Relay.app PLG motion (SMB ops PLG) vs our onboarding — one adoption fix on `Hub Actions + RUN INBOX first-run path`
...
1. `status: done` in REGISTRY.json for `sa-mkt-0765`
