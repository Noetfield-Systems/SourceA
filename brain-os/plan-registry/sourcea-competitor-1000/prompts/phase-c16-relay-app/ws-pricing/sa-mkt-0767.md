# sa-mkt-0767 — Relay.app · Pricing & packaging
...
Add upgrade CTA path: sandbox/free → paid bay matching Relay.app upgrade pattern where applicable
...
1. `status: done` in REGISTRY.json for `sa-mkt-0767`
