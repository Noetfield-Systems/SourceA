# sa-mkt-0397 — Braintrust · Integrations & API
...
Rate-limit + retry policy copied from Braintrust operating model (Log spans; run eval suites; compare prompt versions)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0397`
