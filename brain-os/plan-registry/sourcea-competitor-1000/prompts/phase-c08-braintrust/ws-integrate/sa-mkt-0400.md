# sa-mkt-0400 — Braintrust · Integrations & API
...
Close sa-mkt-0400: integration receipt + verify PASS + https://www.braintrust.dev
...
1. `status: done` in REGISTRY.json for `sa-mkt-0400`
