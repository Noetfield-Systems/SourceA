# sa-mkt-0386 — Braintrust · Onboarding & PLG
...
Write founder-facing SOW snippet if Braintrust uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `sa-mkt-0386`
