# sa-mkt-0381 — Braintrust · Onboarding & PLG
...
Document Braintrust onboarding path (Eval-first wedge for AI product teams): who runs (Managed cloud) → first value moment
...
1. `status: done` in REGISTRY.json for `sa-mkt-0381`
