# sa-mkt-0375 — Braintrust · Run history & proof
...
Add retention note: how long run history kept vs Braintrust (From ~$249/mo (market); free tier for evals tier hints)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0375`
