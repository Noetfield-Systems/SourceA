# sa-mkt-0372 — Braintrust · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: PASS/FAIL eval score on shipped agent runs)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0372`
