# sa-mkt-0366 — Braintrust · Pricing & packaging
...
Document why buyers pay per Braintrust: Ship AI without knowing if quality regressed — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `sa-mkt-0366`
