# sa-mkt-0365 — Braintrust · Pricing & packaging
...
Compare Braintrust PLG motion (Eval-first wedge for AI product teams) vs our onboarding — one adoption fix on `Hub Actions + RUN INBOX first-run path`
...
1. `status: done` in REGISTRY.json for `sa-mkt-0365`
