# sa-mkt-0361 — Braintrust · Pricing & packaging
...
Capture Braintrust public pricing evidence: From ~$249/mo (market); free tier for evals — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `sa-mkt-0361`
