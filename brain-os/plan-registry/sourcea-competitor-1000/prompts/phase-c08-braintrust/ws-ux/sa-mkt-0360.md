# sa-mkt-0360 — Braintrust · Buyer-visible UX
...
Mark sa-mkt-0360 done in REGISTRY with evidence path + https://www.braintrust.dev after verify PASS
...
1. `status: done` in REGISTRY.json for `sa-mkt-0360`
