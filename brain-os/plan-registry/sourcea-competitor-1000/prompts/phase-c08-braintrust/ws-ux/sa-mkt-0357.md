# sa-mkt-0357 — Braintrust · Buyer-visible UX
...
Document who buys (AI product and eng teams) vs our ICP one sentence on `brain-os/plan-registry/SOURCEA-PRIORITY.md` row for Braintrust
...
1. `status: done` in REGISTRY.json for `sa-mkt-0357`
