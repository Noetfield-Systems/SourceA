# sa-mkt-0353 — Braintrust · Buyer-visible UX
...
Add `Worker Hub Next steps + factory-now line` UI field or copy block implementing smallest slice of `PASS/FAIL eval score on shipped agent runs`; preserve honest tier label
...
1. `status: done` in REGISTRY.json for `sa-mkt-0353`
