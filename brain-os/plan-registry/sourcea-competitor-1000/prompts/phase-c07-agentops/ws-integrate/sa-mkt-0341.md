# sa-mkt-0341 — AgentOps · Integrations & API
...
List AgentOps integrations/APIs from https://www.agentops.ai or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `sa-mkt-0341`
