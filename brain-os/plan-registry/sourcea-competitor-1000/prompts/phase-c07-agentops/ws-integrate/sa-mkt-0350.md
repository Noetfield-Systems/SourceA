# sa-mkt-0350 — AgentOps · Integrations & API
...
Close sa-mkt-0350: integration receipt + verify PASS + https://www.agentops.ai
...
1. `status: done` in REGISTRY.json for `sa-mkt-0350`
