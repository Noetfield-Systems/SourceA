# sa-mkt-0347 — AgentOps · Integrations & API
...
Rate-limit + retry policy copied from AgentOps operating model (SDK records agent steps, tools, costs; time-travel debugging UI)

## Implementation extraction

`AgentOps · Integrations & API` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0347`
