# sa-mkt-0336 — AgentOps · Onboarding & PLG
...
Write founder-facing SOW snippet if AgentOps uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `sa-mkt-0336`
