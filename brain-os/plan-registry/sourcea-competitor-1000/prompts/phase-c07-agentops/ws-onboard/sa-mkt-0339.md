# sa-mkt-0339 — AgentOps · Onboarding & PLG
...
Docs: onboarding section cites AgentOps as market analog with https://www.agentops.ai
...
1. `status: done` in REGISTRY.json for `sa-mkt-0339`
