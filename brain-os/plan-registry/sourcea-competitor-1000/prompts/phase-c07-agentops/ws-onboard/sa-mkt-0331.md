# sa-mkt-0331 — AgentOps · Onboarding & PLG
...
Document AgentOps onboarding path (Agent-specific niche vs generic APM): who runs (Managed cloud (SDK OSS MIT)) → first value moment

## Implementation extraction

`AgentOps · Onboarding & PLG` → what buyer sees at vendor → what we ship logged with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0331`
