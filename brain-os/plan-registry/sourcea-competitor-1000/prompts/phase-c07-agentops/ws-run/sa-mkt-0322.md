# sa-mkt-0322 — AgentOps · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Time-travel replay for worker/agent debugging)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0322`
