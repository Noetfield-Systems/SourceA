# sa-mkt-0325 — AgentOps · Run history & proof
...
Add retention note: how long run history kept vs AgentOps (Free tier ~5k events; Pro ~$40/mo (market) tier hints)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0325`
