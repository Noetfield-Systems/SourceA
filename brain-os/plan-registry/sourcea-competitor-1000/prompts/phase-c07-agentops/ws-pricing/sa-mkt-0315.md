# sa-mkt-0315 — AgentOps · Pricing & packaging
...
Compare AgentOps PLG motion (Agent-specific niche vs generic APM) vs our onboarding — one adoption fix on `Hub Actions + RUN INBOX first-run path`
...
1. `status: done` in REGISTRY.json for `sa-mkt-0315`
