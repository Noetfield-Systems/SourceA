# sa-mkt-0311 — AgentOps · Pricing & packaging
...
Capture AgentOps public pricing evidence: Free tier ~5k events; Pro ~$40/mo (market) — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `sa-mkt-0311`
