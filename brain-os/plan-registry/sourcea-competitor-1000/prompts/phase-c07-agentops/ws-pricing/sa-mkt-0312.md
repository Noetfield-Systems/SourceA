# sa-mkt-0312 — AgentOps · Pricing & packaging
...
Map AgentOps revenue model (Event-volume SaaS) to our `SourceA agency + Buyer-1 pricing narrative` tier names — no hidden fees theater
...
1. `status: done` in REGISTRY.json for `sa-mkt-0312`
