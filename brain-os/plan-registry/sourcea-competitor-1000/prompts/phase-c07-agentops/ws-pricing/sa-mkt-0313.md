# sa-mkt-0313 — AgentOps · Pricing & packaging
...
Add or update one public price card on `Worker Hub Next steps + factory-now line` inspired by AgentOps packaging motion
...
1. `status: done` in REGISTRY.json for `sa-mkt-0313`
