# sa-mkt-0307 — AgentOps · Buyer-visible UX
...
Document who buys (Agent builders and AI startups) vs our ICP one sentence on `brain-os/plan-registry/SOURCEA-PRIORITY.md` row for AgentOps
...
1. `status: done` in REGISTRY.json for `sa-mkt-0307`
