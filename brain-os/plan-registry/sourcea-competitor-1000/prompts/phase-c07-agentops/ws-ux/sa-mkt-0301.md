# sa-mkt-0301 — AgentOps · Buyer-visible UX
...
Open https://www.agentops.ai — screenshot or quote the exact buyer-facing Buyer-visible UX sentence AgentOps uses; paste into plan evidence (vendor says: Session replay and monitoring for autonomous AI agents)

## Implementation extraction

`AgentOps · Buyer-visible UX` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0301`
