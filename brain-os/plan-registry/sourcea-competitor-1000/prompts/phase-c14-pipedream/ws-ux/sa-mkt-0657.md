# sa-mkt-0657 — Pipedream · Buyer-visible UX
...
Document who buys (Developers and ops) vs our ICP one sentence on `brain-os/plan-registry/SOURCEA-PRIORITY.md` row for Pipedream
...
1. `status: done` in REGISTRY.json for `sa-mkt-0657`
