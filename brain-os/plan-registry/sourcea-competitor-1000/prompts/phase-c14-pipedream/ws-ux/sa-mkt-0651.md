# sa-mkt-0651 — Pipedream · Buyer-visible UX
...
Open https://pipedream.com — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Pipedream uses; paste into plan evidence (vendor says: Connect APIs and run code workflows with event triggers)

## Implementation extraction

`Pipedream · Buyer-visible UX` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0651`
