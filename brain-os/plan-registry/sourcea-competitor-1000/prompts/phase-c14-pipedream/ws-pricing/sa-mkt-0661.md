# sa-mkt-0661 — Pipedream · Pricing & packaging
...
Capture Pipedream public pricing evidence: Free tier + usage paid plans — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `sa-mkt-0661`
