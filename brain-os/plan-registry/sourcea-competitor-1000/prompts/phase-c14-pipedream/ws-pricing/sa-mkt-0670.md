# sa-mkt-0670 — Pipedream · Pricing & packaging
...
Close sa-mkt-0670: PRIORITY row + verify PASS + link https://pipedream.com
...
1. `status: done` in REGISTRY.json for `sa-mkt-0670`
