# sa-mkt-0666 — Pipedream · Pricing & packaging
...
Document why buyers pay per Pipedream: Glue between SaaS tools without maintaining cron servers — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `sa-mkt-0666`
