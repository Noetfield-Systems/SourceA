# sa-mkt-0700 — Pipedream · Integrations & API
...
Close sa-mkt-0700: integration receipt + verify PASS + https://pipedream.com
...
1. `status: done` in REGISTRY.json for `sa-mkt-0700`
