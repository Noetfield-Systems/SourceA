# sa-mkt-0672 — Pipedream · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Connector-based automation run log pattern)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0672`
