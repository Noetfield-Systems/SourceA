# sa-mkt-0675 — Pipedream · Run history & proof
...
Add retention note: how long run history kept vs Pipedream (Free tier + usage paid plans tier hints)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0675`
