# sa-mkt-0682 — Pipedream · Onboarding & PLG
...
Define ≤30s-to-value step on `Hub Actions + RUN INBOX first-run path` copied from Pipedream motion
...
1. `status: done` in REGISTRY.json for `sa-mkt-0682`
