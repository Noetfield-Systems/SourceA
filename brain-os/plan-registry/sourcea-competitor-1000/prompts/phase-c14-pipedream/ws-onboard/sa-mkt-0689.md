# sa-mkt-0689 — Pipedream · Onboarding & PLG
...
Docs: onboarding section cites Pipedream as market analog with https://pipedream.com
...
1. `status: done` in REGISTRY.json for `sa-mkt-0689`
