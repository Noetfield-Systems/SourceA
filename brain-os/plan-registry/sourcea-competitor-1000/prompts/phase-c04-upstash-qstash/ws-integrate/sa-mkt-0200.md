# sa-mkt-0200 — Upstash QStash · Integrations & API
...
Close sa-mkt-0200: integration receipt + verify PASS + https://upstash.com/qstash · https://upstash.com/pricing
...
1. `status: done` in REGISTRY.json for `sa-mkt-0200`
