# sa-mkt-0197 — Upstash QStash · Integrations & API
...
Rate-limit + retry policy copied from Upstash QStash operating model (Publish HTTP message; QStash delivers with retries and DLQ)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0197`
