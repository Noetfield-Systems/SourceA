# sa-mkt-0199 — Upstash QStash · Integrations & API
...
Update catalog/registry row for integration — Upstash QStash row 4
...
1. `status: done` in REGISTRY.json for `sa-mkt-0199`
