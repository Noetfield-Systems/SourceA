# sa-mkt-0161 — Upstash QStash · Pricing & packaging
...
Capture Upstash QStash public pricing evidence: ~$1 per 100k messages pay-as-you-go; tiers from ~$180/mo — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `sa-mkt-0161`
