# sa-mkt-0162 — Upstash QStash · Pricing & packaging
...
Map Upstash QStash revenue model (Message-volume SaaS) to our `SourceA agency + Buyer-1 pricing narrative` tier names — no hidden fees theater
...
1. `status: done` in REGISTRY.json for `sa-mkt-0162`
