# sa-mkt-0163 — Upstash QStash · Pricing & packaging
...
Add or update one public price card on `Worker Hub Next steps + factory-now line` inspired by Upstash QStash packaging motion
...
1. `status: done` in REGISTRY.json for `sa-mkt-0163`
