# sa-mkt-0167 — Upstash QStash · Pricing & packaging
...
Add upgrade CTA path: sandbox/free → paid bay matching Upstash QStash upgrade pattern where applicable
...
1. `status: done` in REGISTRY.json for `sa-mkt-0167`
