# sa-mkt-0169 — Upstash QStash · Pricing & packaging
...
Write competitor row evidence: Upstash QStash pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `sa-mkt-0169`
