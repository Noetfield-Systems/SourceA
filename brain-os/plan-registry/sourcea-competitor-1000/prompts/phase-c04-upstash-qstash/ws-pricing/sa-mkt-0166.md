# sa-mkt-0166 — Upstash QStash · Pricing & packaging
...
Document why buyers pay per Upstash QStash: Simple cron/webhook delivery without running Redis — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `sa-mkt-0166`
