# sa-mkt-0151 — Upstash QStash · Buyer-visible UX
...
Open https://upstash.com/qstash · https://upstash.com/pricing — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Upstash QStash uses; paste into plan evidence (vendor says: Serverless message queue — schedule and retry HTTP calls without infra)

## Implementation extraction

`Upstash QStash · Buyer-visible UX` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0151`
