# sa-mkt-0157 — Upstash QStash · Buyer-visible UX
...
Document who buys (Serverless developers) vs our ICP one sentence on `brain-os/plan-registry/SOURCEA-PRIORITY.md` row for Upstash QStash
...
1. `status: done` in REGISTRY.json for `sa-mkt-0157`
