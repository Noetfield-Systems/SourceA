# sa-mkt-0155 — Upstash QStash · Buyer-visible UX
...
Diff our public copy vs Upstash QStash pricing/product page — list 3 concrete gaps; fix highest P0 gap only
...
1. `status: done` in REGISTRY.json for `sa-mkt-0155`
