# sa-mkt-0171 — Upstash QStash · Run history & proof
...
From https://upstash.com/qstash · https://upstash.com/pricing document Upstash QStash run/history UX: Publish HTTP message; QStash delivers with retries and DLQ — map to `Worker job run detail page (pass/fail/steps/logs/retry)`

## Implementation extraction

`Upstash QStash · Run history & proof` → what buyer sees at vendor → what we ship logged with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0171`
