# sa-mkt-0172 — Upstash QStash · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Lightweight dispatch layer for hub Actions → cloud workers)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0172`
