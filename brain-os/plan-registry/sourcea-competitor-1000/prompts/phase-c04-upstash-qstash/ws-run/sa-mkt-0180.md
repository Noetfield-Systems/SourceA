# sa-mkt-0180 — Upstash QStash · Run history & proof
...
Mark sa-mkt-0180 done with run page screenshot or receipt path
...
1. `status: done` in REGISTRY.json for `sa-mkt-0180`
