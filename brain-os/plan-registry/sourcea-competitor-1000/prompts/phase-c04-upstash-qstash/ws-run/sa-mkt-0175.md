# sa-mkt-0175 — Upstash QStash · Run history & proof
...
Add retention note: how long run history kept vs Upstash QStash (~$1 per 100k messages pay-as-you-go; tiers from ~$180/mo tier hints)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0175`
