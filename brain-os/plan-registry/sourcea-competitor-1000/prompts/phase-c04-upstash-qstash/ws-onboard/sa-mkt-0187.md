# sa-mkt-0187 — Upstash QStash · Onboarding & PLG
...
Measure drop-off: list one friction point vs Upstash QStash and fix
...
1. `status: done` in REGISTRY.json for `sa-mkt-0187`
