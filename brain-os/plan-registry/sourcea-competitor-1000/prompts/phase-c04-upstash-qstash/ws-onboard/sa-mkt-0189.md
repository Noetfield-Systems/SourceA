# sa-mkt-0189 — Upstash QStash · Onboarding & PLG
...
Docs: onboarding section cites Upstash QStash as market analog with https://upstash.com/qstash · https://upstash.com/pricing
...
1. `status: done` in REGISTRY.json for `sa-mkt-0189`
