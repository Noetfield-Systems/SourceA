# sa-mkt-0607 — Windmill · Buyer-visible UX
...
Document who buys (Ops and platform teams) vs our ICP one sentence on `brain-os/plan-registry/SOURCEA-PRIORITY.md` row for Windmill
...
1. `status: done` in REGISTRY.json for `sa-mkt-0607`
