# sa-mkt-0602 — Windmill · Buyer-visible UX
...
Write one-line UX spec: `Windmill Buyer-visible UX` → buyer sees X → we show on `Worker Hub Next steps + factory-now line` (lesson: Internal ops job dashboard with run history)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0602`
