# sa-mkt-0603 — Windmill · Buyer-visible UX
...
Add `Worker Hub Next steps + factory-now line` UI field or copy block implementing smallest slice of `Internal ops job dashboard with run history`; preserve honest tier label
...
1. `status: done` in REGISTRY.json for `sa-mkt-0603`
