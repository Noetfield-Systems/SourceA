# sa-mkt-0601 — Windmill · Buyer-visible UX
...
Open https://windmill.dev — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Windmill uses; paste into plan evidence (vendor says: Scripts, flows, schedules with run history and permissions)

## Implementation extraction

`Windmill · Buyer-visible UX` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0601`
