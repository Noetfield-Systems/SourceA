# sa-mkt-0622 — Windmill · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Internal ops job dashboard with run history)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0622`
