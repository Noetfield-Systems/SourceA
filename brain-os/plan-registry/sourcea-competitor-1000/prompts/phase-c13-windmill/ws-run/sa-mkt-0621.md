# sa-mkt-0621 — Windmill · Run history & proof
...
From https://windmill.dev document Windmill run/history UX: Write scripts/flows; schedule; audit run log — map to `Worker job run detail page (pass/fail/steps/logs/retry)`
...
1. `status: done` in REGISTRY.json for `sa-mkt-0621`
