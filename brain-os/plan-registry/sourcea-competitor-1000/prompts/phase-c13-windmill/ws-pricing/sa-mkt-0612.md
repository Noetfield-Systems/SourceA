# sa-mkt-0612 — Windmill · Pricing & packaging
...
Map Windmill revenue model (OSS + seat/usage cloud) to our `SourceA agency + Buyer-1 pricing narrative` tier names — no hidden fees theater
...
1. `status: done` in REGISTRY.json for `sa-mkt-0612`
