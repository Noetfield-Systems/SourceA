# sa-mkt-0616 — Windmill · Pricing & packaging
...
Document why buyers pay per Windmill: Internal ops automations need audit trail — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `sa-mkt-0616`
