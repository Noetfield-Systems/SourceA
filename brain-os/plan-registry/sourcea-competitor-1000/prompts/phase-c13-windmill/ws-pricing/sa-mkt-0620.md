# sa-mkt-0620 — Windmill · Pricing & packaging
...
Close sa-mkt-0620: PRIORITY row + verify PASS + link https://windmill.dev
...
1. `status: done` in REGISTRY.json for `sa-mkt-0620`
