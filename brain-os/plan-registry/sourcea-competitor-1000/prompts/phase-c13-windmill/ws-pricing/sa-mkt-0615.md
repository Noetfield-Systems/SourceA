# sa-mkt-0615 — Windmill · Pricing & packaging
...
Compare Windmill PLG motion (Open-source automation platform) vs our onboarding — one adoption fix on `Hub Actions + RUN INBOX first-run path`

## Implementation extraction

`Windmill · Pricing & packaging` → what buyer sees at vendor → what we ship logged with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0615`
