# sa-mkt-0647 — Windmill · Integrations & API
...
Rate-limit + retry policy copied from Windmill operating model (Write scripts/flows; schedule; audit run log)

## Implementation extraction

`Windmill · Integrations & API` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0647`
