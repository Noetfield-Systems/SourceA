# sa-mkt-0650 — Windmill · Integrations & API
...
Close sa-mkt-0650: integration receipt + verify PASS + https://windmill.dev
...
1. `status: done` in REGISTRY.json for `sa-mkt-0650`
