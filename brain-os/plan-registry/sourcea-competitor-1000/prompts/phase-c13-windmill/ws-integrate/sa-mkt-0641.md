# sa-mkt-0641 — Windmill · Integrations & API
...
List Windmill integrations/APIs from https://windmill.dev or docs — pick one we can wire this quarter
...
1. `status: done` in REGISTRY.json for `sa-mkt-0641`
