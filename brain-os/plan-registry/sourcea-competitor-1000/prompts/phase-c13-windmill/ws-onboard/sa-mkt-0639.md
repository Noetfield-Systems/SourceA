# sa-mkt-0639 — Windmill · Onboarding & PLG
...
Docs: onboarding section cites Windmill as market analog with https://windmill.dev
...
1. `status: done` in REGISTRY.json for `sa-mkt-0639`
