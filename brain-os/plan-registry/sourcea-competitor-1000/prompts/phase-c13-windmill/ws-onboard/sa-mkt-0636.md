# sa-mkt-0636 — Windmill · Onboarding & PLG
...
Write founder-facing SOW snippet if Windmill uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `sa-mkt-0636`
