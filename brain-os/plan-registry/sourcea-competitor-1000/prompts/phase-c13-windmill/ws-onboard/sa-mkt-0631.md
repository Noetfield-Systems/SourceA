# sa-mkt-0631 — Windmill · Onboarding & PLG
...
Document Windmill onboarding path (Open-source automation platform): who runs (OSS + Windmill Cloud) → first value moment

## Implementation extraction

`Windmill · Onboarding & PLG` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0631`
