# sa-mkt-0072 — Inngest · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Step timeline + trace retention tiers on every factory job)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0072`
