# sa-mkt-0071 — Inngest · Run history & proof
...
From https://www.inngest.com · https://www.inngest.com/pricing document Inngest run/history UX: Event triggers functions; each step durable with trace retention — map to `Worker job run detail page (pass/fail/steps/logs/retry)`

## Implementation extraction

`Inngest · Run history & proof` → what buyer sees at vendor → what we ship logged with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0071`
