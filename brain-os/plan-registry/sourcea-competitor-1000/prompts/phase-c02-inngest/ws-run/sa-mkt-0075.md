# sa-mkt-0075 — Inngest · Run history & proof
...
Add retention note: how long run history kept vs Inngest (Hobby $0 (50k executions); Pro $75/mo — https://www.inngest.com/pricing tier hints)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0075`
