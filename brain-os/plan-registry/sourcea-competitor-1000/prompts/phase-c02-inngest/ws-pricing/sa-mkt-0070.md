# sa-mkt-0070 — Inngest · Pricing & packaging
...
Close sa-mkt-0070: PRIORITY row + verify PASS + link https://www.inngest.com · https://www.inngest.com/pricing
...
1. `status: done` in REGISTRY.json for `sa-mkt-0070`
