# sa-mkt-0066 — Inngest · Pricing & packaging
...
Document why buyers pay per Inngest: Serverless timeout limits break AI workflows; Inngest removes that pain — tie to our offer in plain English
...
1. `status: done` in REGISTRY.json for `sa-mkt-0066`
