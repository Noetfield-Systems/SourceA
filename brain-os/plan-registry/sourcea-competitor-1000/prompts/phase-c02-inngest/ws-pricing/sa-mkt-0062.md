# sa-mkt-0062 — Inngest · Pricing & packaging
...
Map Inngest revenue model (Tiered SaaS by executions + events) to our `SourceA agency + Buyer-1 pricing narrative` tier names — no hidden fees theater
...
1. `status: done` in REGISTRY.json for `sa-mkt-0062`
