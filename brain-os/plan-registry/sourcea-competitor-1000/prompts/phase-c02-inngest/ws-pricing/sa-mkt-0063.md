# sa-mkt-0063 — Inngest · Pricing & packaging
...
Add or update one public price card on `Worker Hub Next steps + factory-now line` inspired by Inngest packaging motion
...
1. `status: done` in REGISTRY.json for `sa-mkt-0063`
