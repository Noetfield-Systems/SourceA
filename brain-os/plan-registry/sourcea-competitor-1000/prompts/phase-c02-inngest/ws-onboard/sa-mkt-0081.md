# sa-mkt-0081 — Inngest · Onboarding & PLG
...
Document Inngest onboarding path (Dev-first docs, framework integrations, free tier): who runs (Vendor-managed cloud; OSS self-host) → first value moment
...
1. `status: done` in REGISTRY.json for `sa-mkt-0081`
