# sa-mkt-0089 — Inngest · Onboarding & PLG
...
Docs: onboarding section cites Inngest as market analog with https://www.inngest.com · https://www.inngest.com/pricing
...
1. `status: done` in REGISTRY.json for `sa-mkt-0089`
