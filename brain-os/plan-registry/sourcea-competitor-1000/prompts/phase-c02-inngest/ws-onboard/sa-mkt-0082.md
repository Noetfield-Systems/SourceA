# sa-mkt-0082 — Inngest · Onboarding & PLG
...
Define ≤30s-to-value step on `Hub Actions + RUN INBOX first-run path` copied from Inngest motion
...
1. `status: done` in REGISTRY.json for `sa-mkt-0082`
