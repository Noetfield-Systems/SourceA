# sa-mkt-0057 — Inngest · Buyer-visible UX
...
Document who buys (Serverless product teams on Vercel/Netlify) vs our ICP one sentence on `brain-os/plan-registry/SOURCEA-PRIORITY.md` row for Inngest
...
1. `status: done` in REGISTRY.json for `sa-mkt-0057`
