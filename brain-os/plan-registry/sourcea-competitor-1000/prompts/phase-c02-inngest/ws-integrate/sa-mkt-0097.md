# sa-mkt-0097 — Inngest · Integrations & API
...
Rate-limit + retry policy copied from Inngest operating model (Event triggers functions; each step durable with trace retention)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0097`
