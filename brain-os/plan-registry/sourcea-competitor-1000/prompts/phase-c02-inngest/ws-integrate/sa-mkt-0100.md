# sa-mkt-0100 — Inngest · Integrations & API
...
Close sa-mkt-0100: integration receipt + verify PASS + https://www.inngest.com · https://www.inngest.com/pricing
...
1. `status: done` in REGISTRY.json for `sa-mkt-0100`
