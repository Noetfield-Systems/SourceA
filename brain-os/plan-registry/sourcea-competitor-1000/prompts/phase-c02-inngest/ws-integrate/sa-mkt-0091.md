# sa-mkt-0091 — Inngest · Integrations & API
...
List Inngest integrations/APIs from https://www.inngest.com · https://www.inngest.com/pricing or docs — pick one we can wire this quarter

## Implementation extraction

`Inngest · Integrations & API` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0091`
