# sa-mkt-0547 — Mastra · Integrations & API
...
Rate-limit + retry policy copied from Mastra operating model (Define agents in TS; deploy with tracing hooks)

## Implementation extraction

`Mastra · Integrations & API` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0547`
