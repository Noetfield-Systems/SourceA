# sa-mkt-0525 — Mastra · Run history & proof
...
Add retention note: how long run history kept vs Mastra (OSS free; cloud tiers (market) tier hints)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0525`
