# sa-mkt-0521 — Mastra · Run history & proof
...
From https://mastra.ai document Mastra run/history UX: Define agents in TS; deploy with tracing hooks — map to `Worker job run detail page (pass/fail/steps/logs/retry)`

## Implementation extraction

`Mastra · Run history & proof` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0521`
