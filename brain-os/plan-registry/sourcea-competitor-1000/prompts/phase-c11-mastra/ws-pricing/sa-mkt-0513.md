# sa-mkt-0513 — Mastra · Pricing & packaging
...
Add or update one public price card on `Worker Hub Next steps + factory-now line` inspired by Mastra packaging motion
...
1. `status: done` in REGISTRY.json for `sa-mkt-0513`
