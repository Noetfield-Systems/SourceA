# sa-mkt-0512 — Mastra · Pricing & packaging
...
Map Mastra revenue model (OSS + cloud hosting) to our `SourceA agency + Buyer-1 pricing narrative` tier names — no hidden fees theater

## Implementation extraction

`Mastra · Pricing & packaging` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0512`
