# sa-mkt-0515 — Mastra · Pricing & packaging
...
Compare Mastra PLG motion (Dev framework PLG) vs our onboarding — one adoption fix on `Hub Actions + RUN INBOX first-run path`
...
1. `status: done` in REGISTRY.json for `sa-mkt-0515`
