# sa-mkt-0511 — Mastra · Pricing & packaging
...
Capture Mastra public pricing evidence: OSS free; cloud tiers (market) — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `sa-mkt-0511`
