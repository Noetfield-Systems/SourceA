# sa-mkt-0501 — Mastra · Buyer-visible UX
...
Open https://mastra.ai — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Mastra uses; paste into plan evidence (vendor says: Agent framework with built-in observability and workflow primitives)

## Implementation extraction

`Mastra · Buyer-visible UX` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0501`
