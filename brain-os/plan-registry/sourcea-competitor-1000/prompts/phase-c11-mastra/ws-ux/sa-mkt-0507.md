# sa-mkt-0507 — Mastra · Buyer-visible UX
...
Document who buys (TypeScript agent developers) vs our ICP one sentence on `brain-os/plan-registry/SOURCEA-PRIORITY.md` row for Mastra
...
1. `status: done` in REGISTRY.json for `sa-mkt-0507`
