# sa-mkt-0531 — Mastra · Onboarding & PLG
...
Document Mastra onboarding path (Dev framework PLG): who runs (OSS + Mastra Cloud) → first value moment
...
1. `status: done` in REGISTRY.json for `sa-mkt-0531`
