# sa-mkt-0536 — Mastra · Onboarding & PLG
...
Write founder-facing SOW snippet if Mastra uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `sa-mkt-0536`
