# sa-mkt-0532 — Mastra · Onboarding & PLG
...
Define ≤30s-to-value step on `Hub Actions + RUN INBOX first-run path` copied from Mastra motion
...
1. `status: done` in REGISTRY.json for `sa-mkt-0532`
