# sa-mkt-0872 — Portkey · Run history & proof
...
Spec run detail fields: status · steps · failure class · retry · timestamp (from lesson: Route models + log every call at dispatch)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0872`
