# sa-mkt-0875 — Portkey · Run history & proof
...
Add retention note: how long run history kept vs Portkey (Usage-tier SaaS tier hints)
...
1. `status: done` in REGISTRY.json for `sa-mkt-0875`
