# sa-mkt-0857 — Portkey · Buyer-visible UX
...
Document who buys (Platform engineering) vs our ICP one sentence on `brain-os/plan-registry/SOURCEA-PRIORITY.md` row for Portkey
...
1. `status: done` in REGISTRY.json for `sa-mkt-0857`
