# sa-mkt-0851 — Portkey · Buyer-visible UX
...
Open https://portkey.ai — screenshot or quote the exact buyer-facing Buyer-visible UX sentence Portkey uses; paste into plan evidence (vendor says: LLM gateway with routing, caching, observability, governance)

## Implementation extraction

`Portkey · Buyer-visible UX` → what buyer sees at vendor → what we ship logged with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0851`
