# sa-mkt-0859 — Portkey · Buyer-visible UX
...
Ship summary in PRIORITY: preserved · changed · achieved vs Portkey Buyer-visible UX
...
1. `status: done` in REGISTRY.json for `sa-mkt-0859`
