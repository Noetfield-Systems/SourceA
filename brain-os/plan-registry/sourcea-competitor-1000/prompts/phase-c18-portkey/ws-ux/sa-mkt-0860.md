# sa-mkt-0860 — Portkey · Buyer-visible UX
...
Mark sa-mkt-0860 done in REGISTRY with evidence path + https://portkey.ai after verify PASS
...
1. `status: done` in REGISTRY.json for `sa-mkt-0860`
