# sa-mkt-0862 — Portkey · Pricing & packaging
...
Map Portkey revenue model (Usage + platform fee) to our `SourceA agency + Buyer-1 pricing narrative` tier names — no hidden fees theater
...
1. `status: done` in REGISTRY.json for `sa-mkt-0862`
