# sa-mkt-0861 — Portkey · Pricing & packaging
...
Capture Portkey public pricing evidence: Usage-tier SaaS — save link or quoted range in plan receipt
...
1. `status: done` in REGISTRY.json for `sa-mkt-0861`
