# sa-mkt-0869 — Portkey · Pricing & packaging
...
Write competitor row evidence: Portkey pricing → our SKU → defer/shipped with path
...
1. `status: done` in REGISTRY.json for `sa-mkt-0869`
