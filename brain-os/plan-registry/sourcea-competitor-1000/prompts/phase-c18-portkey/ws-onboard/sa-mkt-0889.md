# sa-mkt-0889 — Portkey · Onboarding & PLG
...
Docs: onboarding section cites Portkey as market analog with https://portkey.ai
...
1. `status: done` in REGISTRY.json for `sa-mkt-0889`
