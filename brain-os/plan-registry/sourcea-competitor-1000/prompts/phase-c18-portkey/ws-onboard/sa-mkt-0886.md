# sa-mkt-0886 — Portkey · Onboarding & PLG
...
Write founder-facing SOW snippet if Portkey uses services-led motion — Witness/TrustField lanes
...
1. `status: done` in REGISTRY.json for `sa-mkt-0886`
