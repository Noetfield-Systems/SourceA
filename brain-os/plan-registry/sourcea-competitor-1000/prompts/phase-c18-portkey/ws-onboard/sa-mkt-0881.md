# sa-mkt-0881 — Portkey · Onboarding & PLG
...
Document Portkey onboarding path (Gateway wedge in crowded LLM ops): who runs (Managed cloud) → first value moment

## Implementation extraction

`Portkey · Onboarding & PLG` → what buyer sees at vendor → what we ship on disk with receipt.
...
1. `status: done` in REGISTRY.json for `sa-mkt-0881`
