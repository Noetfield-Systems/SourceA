# sa-score-0577 — E2E gate for URL utm_segment overrides default lane
...
**Deliverable:** E2E gate for URL utm_segment overrides default lane
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0577`
