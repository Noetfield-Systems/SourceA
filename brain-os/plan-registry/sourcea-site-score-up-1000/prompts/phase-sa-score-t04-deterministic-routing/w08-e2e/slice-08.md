# sa-score-0578 — E2E gate for returning visitor last-segment hint
...
**Deliverable:** E2E gate for returning visitor last-segment hint
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0578`
