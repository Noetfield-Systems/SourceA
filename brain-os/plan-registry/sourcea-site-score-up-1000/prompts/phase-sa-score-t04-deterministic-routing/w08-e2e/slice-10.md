# sa-score-0580 — E2E gate for cursor lane deep-link Forge with query
...
**Deliverable:** E2E gate for cursor lane deep-link Forge with query
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0580`
