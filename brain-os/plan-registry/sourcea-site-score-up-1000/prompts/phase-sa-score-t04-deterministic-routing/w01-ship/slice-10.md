# sa-score-0510 — Ship routing decision receipt in pulse events
...
**Deliverable:** Ship routing decision receipt in pulse events
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0510`
