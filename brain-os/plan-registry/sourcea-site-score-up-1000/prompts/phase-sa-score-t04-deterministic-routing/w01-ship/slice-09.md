# sa-score-0509 — Ship agency lane case-study filter preset
...
**Deliverable:** Ship agency lane case-study filter preset
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0509`
