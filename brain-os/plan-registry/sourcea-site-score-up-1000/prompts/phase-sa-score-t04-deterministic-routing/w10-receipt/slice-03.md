# sa-score-0593 — Receipt logged for guided prompt once-per-session localStorage key
...
**Deliverable:** Receipt logged for guided prompt once-per-session localStorage key
