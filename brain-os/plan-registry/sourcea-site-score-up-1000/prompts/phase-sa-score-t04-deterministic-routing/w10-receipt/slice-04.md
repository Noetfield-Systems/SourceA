# sa-score-0594 — Receipt on disk for brain chip messages map to segment tracks
...
**Deliverable:** Receipt on disk for brain chip messages map to segment tracks
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0594`
