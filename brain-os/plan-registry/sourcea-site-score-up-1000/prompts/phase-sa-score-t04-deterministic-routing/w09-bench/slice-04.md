# sa-score-0584 — Bench vs market for guided prompt once-per-session localStorage key

**Saved at:** 2026-06-25T09:23:55Z
**Version:** 1 · **Tier:** T1 · **Phase:** MOONSHOT
**Score dimension:** Deterministic routing (80→97)
**Market analog:** Intercom Fin
...
**Deliverable:** Bench vs market for guided prompt once-per-session localStorage key
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0584`
