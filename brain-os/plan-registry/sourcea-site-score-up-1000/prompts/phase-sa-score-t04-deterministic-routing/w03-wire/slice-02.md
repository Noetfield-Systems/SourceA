# sa-score-0522 — Wire URL utm_segment overrides default lane
...
**Deliverable:** Wire URL utm_segment overrides default lane
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0522`
