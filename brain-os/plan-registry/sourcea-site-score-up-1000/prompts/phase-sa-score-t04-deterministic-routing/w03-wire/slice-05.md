# sa-score-0525 — Wire cursor lane deep-link Forge with query
...
**Deliverable:** Wire cursor lane deep-link Forge with query
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0525`
