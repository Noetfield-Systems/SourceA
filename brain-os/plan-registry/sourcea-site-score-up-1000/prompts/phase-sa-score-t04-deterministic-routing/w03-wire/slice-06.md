# sa-score-0526 — Wire beginner lane forces /learn before /start
...
**Deliverable:** Wire beginner lane forces /learn before /start
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0526`
