# sa-score-0527 — Wire agency lane case-study filter preset
...
**Deliverable:** Wire agency lane case-study filter preset
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0527`
