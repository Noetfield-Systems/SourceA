# sa-score-0550 — Rewrite copy for URL utm_segment overrides default lane
...
**Deliverable:** Rewrite copy for URL utm_segment overrides default lane
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0550`
