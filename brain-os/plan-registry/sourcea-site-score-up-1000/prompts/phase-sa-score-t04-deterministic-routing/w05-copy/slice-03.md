# sa-score-0543 — Rewrite copy for cursor lane deep-link Forge with query
...
**Deliverable:** Rewrite copy for cursor lane deep-link Forge with query
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0543`
