# sa-score-0548 — Rewrite copy for guided prompt once-per-session localStorage key
...
**Deliverable:** Rewrite copy for guided prompt once-per-session localStorage key
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0548`
