# sa-score-0516 — Prove live cursor lane deep-link Forge with query
...
**Deliverable:** Prove live cursor lane deep-link Forge with query
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0516`
