# sa-score-0514 — Prove live returning visitor last-segment hint
...
**Deliverable:** Prove live returning visitor last-segment hint
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0514`
