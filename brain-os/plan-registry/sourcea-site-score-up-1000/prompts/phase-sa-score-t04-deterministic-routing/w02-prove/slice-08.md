# sa-score-0518 — Prove live agency lane case-study filter preset
...
**Deliverable:** Prove live agency lane case-study filter preset
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0518`
