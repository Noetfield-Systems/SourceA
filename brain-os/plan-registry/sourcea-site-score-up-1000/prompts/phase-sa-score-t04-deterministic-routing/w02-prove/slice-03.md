# sa-score-0513 — Prove live URL utm_segment overrides default lane
...
**Deliverable:** Prove live URL utm_segment overrides default lane
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0513`
