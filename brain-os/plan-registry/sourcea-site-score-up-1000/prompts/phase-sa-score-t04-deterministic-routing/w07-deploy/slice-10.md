# sa-score-0570 — Deploy VC proof lane skip learn redirect
...
**Deliverable:** Deploy VC proof lane skip learn redirect
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0570`
