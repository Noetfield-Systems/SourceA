# sa-score-0563 — Deploy agency lane case-study filter preset
...
**Deliverable:** Deploy agency lane case-study filter preset
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0563`
