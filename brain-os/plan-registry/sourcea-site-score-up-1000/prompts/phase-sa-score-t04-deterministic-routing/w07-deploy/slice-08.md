# sa-score-0568 — Deploy URL utm_segment overrides default lane
...
**Deliverable:** Deploy URL utm_segment overrides default lane
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0568`
