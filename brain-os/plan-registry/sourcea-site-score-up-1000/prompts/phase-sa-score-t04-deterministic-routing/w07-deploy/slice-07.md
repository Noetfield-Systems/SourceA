# sa-score-0567 — Deploy brain chip messages map to segment tracks
...
**Deliverable:** Deploy brain chip messages map to segment tracks
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0567`
