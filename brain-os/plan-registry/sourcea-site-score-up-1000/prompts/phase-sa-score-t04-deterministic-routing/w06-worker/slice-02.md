# sa-score-0552 — Worker endpoint for cursor lane deep-link Forge with query
...
**Deliverable:** Worker endpoint for cursor lane deep-link Forge with query
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0552`
