# sa-score-0559 — Worker endpoint for URL utm_segment overrides default lane
...
**Deliverable:** Worker endpoint for URL utm_segment overrides default lane
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0559`
