# sa-score-0557 — Worker endpoint for guided prompt once-per-session localStorage key
...
**Deliverable:** Worker endpoint for guided prompt once-per-session localStorage key
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0557`
