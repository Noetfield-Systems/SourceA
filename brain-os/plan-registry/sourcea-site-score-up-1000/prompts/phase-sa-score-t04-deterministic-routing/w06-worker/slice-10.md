# sa-score-0560 — Worker endpoint for returning visitor last-segment hint
...
**Deliverable:** Worker endpoint for returning visitor last-segment hint
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0560`
