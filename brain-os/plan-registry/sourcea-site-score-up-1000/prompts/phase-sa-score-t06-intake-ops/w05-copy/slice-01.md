# sa-score-0341 — Rewrite copy for intake schema sourcea-site-intake-v1.json
...
**Deliverable:** Rewrite copy for intake schema sourcea-site-intake-v1.json
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0341`
