# sa-score-0351 — Worker endpoint for duplicate intake dedupe by email+day
...
**Deliverable:** Worker endpoint for duplicate intake dedupe by email+day
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0351`
