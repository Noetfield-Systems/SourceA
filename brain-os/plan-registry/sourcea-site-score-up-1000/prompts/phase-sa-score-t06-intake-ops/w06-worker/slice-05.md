# sa-score-0355 — Worker endpoint for unified inbox export CSV
...
**Deliverable:** Worker endpoint for unified inbox export CSV
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0355`
