# sa-score-0357 — Worker endpoint for MVP submissions in pulse-founder inbox tab
...
**Deliverable:** Worker endpoint for MVP submissions in pulse-founder inbox tab
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0357`
