# sa-score-0352 — Worker endpoint for intake status webhook to founder Slack
...
**Deliverable:** Worker endpoint for intake status webhook to founder Slack
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0352`
