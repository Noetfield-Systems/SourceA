# sa-score-0358 — Worker endpoint for brain chat transcript KV log (founder-only)
...
**Deliverable:** Worker endpoint for brain chat transcript KV log (founder-only)
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0358`
