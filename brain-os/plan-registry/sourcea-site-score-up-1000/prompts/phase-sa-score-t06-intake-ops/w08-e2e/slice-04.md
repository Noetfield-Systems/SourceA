# sa-score-0374 — E2E gate for sandbox-intake.js → sourcea-mvp-intake-v1 worker
...
**Deliverable:** E2E gate for sandbox-intake.js → sourcea-mvp-intake-v1 worker
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0374`
