# sa-score-0373 — E2E gate for unified inbox export CSV
...
**Deliverable:** E2E gate for unified inbox export CSV
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0373`
