# sa-score-0372 — E2E gate for agency lane intake on case-studies
...
**Deliverable:** E2E gate for agency lane intake on case-studies
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0372`
