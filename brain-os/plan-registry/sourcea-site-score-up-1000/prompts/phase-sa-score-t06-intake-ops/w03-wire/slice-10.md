# sa-score-0330 — Wire MVP submissions in pulse-founder inbox tab
...
**Deliverable:** Wire MVP submissions in pulse-founder inbox tab
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0330`
