# sa-score-0327 — Wire agency lane intake on case-studies
...
**Deliverable:** Wire agency lane intake on case-studies
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0327`
