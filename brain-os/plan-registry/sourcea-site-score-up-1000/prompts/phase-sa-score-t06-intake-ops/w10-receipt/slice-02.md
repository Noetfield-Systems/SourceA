# sa-score-0392 — Receipt logged for sandbox-intake.js → sourcea-mvp-intake-v1 worker
...
**Deliverable:** Receipt logged for sandbox-intake.js → sourcea-mvp-intake-v1 worker
