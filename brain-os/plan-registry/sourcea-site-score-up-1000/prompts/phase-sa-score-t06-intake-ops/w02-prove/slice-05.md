# sa-score-0315 — Prove live duplicate intake dedupe by email+day
...
**Deliverable:** Prove live duplicate intake dedupe by email+day
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0315`
