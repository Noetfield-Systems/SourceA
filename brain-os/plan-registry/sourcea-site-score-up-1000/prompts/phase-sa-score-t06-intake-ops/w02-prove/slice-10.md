# sa-score-0320 — Prove live sandbox-intake.js → sourcea-mvp-intake-v1 worker
...
**Deliverable:** Prove live sandbox-intake.js → sourcea-mvp-intake-v1 worker
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0320`
