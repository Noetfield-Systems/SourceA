# sa-score-0314 — Prove live intake schema sourcea-site-intake-v1.json
...
**Deliverable:** Prove live intake schema sourcea-site-intake-v1.json
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0314`
