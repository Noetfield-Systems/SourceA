# sa-score-0361 — Deploy intake status webhook to founder Slack
...
**Deliverable:** Deploy intake status webhook to founder Slack
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0361`
