# sa-score-0370 — Deploy duplicate intake dedupe by email+day
...
**Deliverable:** Deploy duplicate intake dedupe by email+day
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0370`
