# sa-score-0363 — Deploy agency lane intake on case-studies
...
**Deliverable:** Deploy agency lane intake on case-studies
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0363`
