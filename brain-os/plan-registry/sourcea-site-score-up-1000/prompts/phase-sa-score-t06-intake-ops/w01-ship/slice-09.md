# sa-score-0309 — Ship agency lane intake on case-studies
...
**Deliverable:** Ship agency lane intake on case-studies
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0309`
