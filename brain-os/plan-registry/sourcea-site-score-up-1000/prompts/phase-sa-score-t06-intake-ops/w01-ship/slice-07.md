# sa-score-0307 — Ship intake status webhook to founder Slack
...
**Deliverable:** Ship intake status webhook to founder Slack
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0307`
