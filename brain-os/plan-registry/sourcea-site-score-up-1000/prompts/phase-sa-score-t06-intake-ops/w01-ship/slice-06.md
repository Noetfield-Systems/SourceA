# sa-score-0306 — Ship duplicate intake dedupe by email+day
...
**Deliverable:** Ship duplicate intake dedupe by email+day
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0306`
