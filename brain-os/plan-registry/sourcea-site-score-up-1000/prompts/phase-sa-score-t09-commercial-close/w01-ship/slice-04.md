# sa-score-0204 — Ship agency retainer intake → CRM row
...
**Deliverable:** Ship agency retainer intake → CRM row
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0204`
