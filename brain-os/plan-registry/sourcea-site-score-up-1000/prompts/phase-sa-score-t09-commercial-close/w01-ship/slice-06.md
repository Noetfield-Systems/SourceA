# sa-score-0206 — Ship cal.com demoted below proof on pricing
...
**Deliverable:** Ship cal.com demoted below proof on pricing
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0206`
