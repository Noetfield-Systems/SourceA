# sa-score-0208 — Ship case study PDF gate with email capture
...
**Deliverable:** Ship case study PDF gate with email capture
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0208`
