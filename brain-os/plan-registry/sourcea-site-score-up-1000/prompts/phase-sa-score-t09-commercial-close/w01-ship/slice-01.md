# sa-score-0201 — Ship pricing CTA → /start not mailto
...
**Deliverable:** Ship pricing CTA → /start not mailto
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0201`
