# sa-score-0220 — Prove live pricing CTA → /start not mailto
...
**Deliverable:** Prove live pricing CTA → /start not mailto
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0220`
