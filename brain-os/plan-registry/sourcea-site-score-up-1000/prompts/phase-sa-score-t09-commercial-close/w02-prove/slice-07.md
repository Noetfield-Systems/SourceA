# sa-score-0217 — Prove live case study PDF gate with email capture
...
**Deliverable:** Prove live case study PDF gate with email capture
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0217`
