# sa-score-0240 — Polish UI for scoped SKU cards with DONE · VERIFY bullets
...
**Deliverable:** Polish UI for scoped SKU cards with DONE · VERIFY bullets
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0240`
