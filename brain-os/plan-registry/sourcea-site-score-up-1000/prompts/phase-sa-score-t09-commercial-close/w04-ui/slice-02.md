# sa-score-0232 — Polish UI for license inquiry → worker not mailto
...
**Deliverable:** Polish UI for license inquiry → worker not mailto
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0232`
