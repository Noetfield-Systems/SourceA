# sa-score-0233 — Polish UI for cal.com demoted below proof on pricing
...
**Deliverable:** Polish UI for cal.com demoted below proof on pricing
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0233`
