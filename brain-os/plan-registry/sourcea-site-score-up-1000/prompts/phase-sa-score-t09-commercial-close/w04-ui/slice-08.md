# sa-score-0238 — Polish UI for pricing CTA → /start not mailto
...
**Deliverable:** Polish UI for pricing CTA → /start not mailto
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0238`
