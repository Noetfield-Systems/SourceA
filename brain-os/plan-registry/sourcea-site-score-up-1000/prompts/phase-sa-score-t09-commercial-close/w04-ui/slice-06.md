# sa-score-0236 — Polish UI for self-serve MSA snippet on /trust
...
**Deliverable:** Polish UI for self-serve MSA snippet on /trust
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0236`
