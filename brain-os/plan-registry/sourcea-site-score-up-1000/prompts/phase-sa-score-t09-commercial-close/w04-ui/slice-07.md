# sa-score-0237 — Polish UI for revenue receipt in founder dashboard
...
**Deliverable:** Polish UI for revenue receipt in founder dashboard
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0237`
