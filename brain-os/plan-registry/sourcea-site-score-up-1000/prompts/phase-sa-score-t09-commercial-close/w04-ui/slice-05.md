# sa-score-0235 — Polish UI for case study PDF gate with email capture
...
**Deliverable:** Polish UI for case study PDF gate with email capture
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0235`
