# sa-score-0262 — Deploy case study PDF gate with email capture
...
**Deliverable:** Deploy case study PDF gate with email capture
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0262`
