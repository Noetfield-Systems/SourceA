# sa-score-0266 — Deploy Stripe payment link for Ops Health Audit $750
...
**Deliverable:** Deploy Stripe payment link for Ops Health Audit $750
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0266`
