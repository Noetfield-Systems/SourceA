# sa-score-0268 — Deploy agency retainer intake → CRM row
...
**Deliverable:** Deploy agency retainer intake → CRM row
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0268`
