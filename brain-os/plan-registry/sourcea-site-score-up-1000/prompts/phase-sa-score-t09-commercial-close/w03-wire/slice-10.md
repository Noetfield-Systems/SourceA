# sa-score-0230 — Wire Stripe payment link for Ops Health Audit $750
...
**Deliverable:** Wire Stripe payment link for Ops Health Audit $750
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0230`
