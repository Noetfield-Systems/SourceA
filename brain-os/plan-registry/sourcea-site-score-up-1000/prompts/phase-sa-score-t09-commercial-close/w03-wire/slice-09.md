# sa-score-0229 — Wire pricing CTA → /start not mailto
...
**Deliverable:** Wire pricing CTA → /start not mailto
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0229`
