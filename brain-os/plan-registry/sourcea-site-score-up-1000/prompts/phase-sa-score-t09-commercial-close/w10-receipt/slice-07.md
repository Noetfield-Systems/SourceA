# sa-score-0297 — Receipt on disk for cal.com demoted below proof on pricing
...
**Deliverable:** Receipt on disk for cal.com demoted below proof on pricing
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0297`
