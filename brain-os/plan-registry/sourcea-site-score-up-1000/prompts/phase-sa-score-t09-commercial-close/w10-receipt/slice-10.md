# sa-score-0300 — Receipt on disk for self-serve MSA snippet on /trust
...
**Deliverable:** Receipt on disk for self-serve MSA snippet on /trust
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0300`
