# sa-score-0249 — Rewrite copy for scoped SKU cards with DONE · VERIFY bullets
...
**Deliverable:** Rewrite copy for scoped SKU cards with DONE · VERIFY bullets
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0249`
