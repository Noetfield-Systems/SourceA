# sa-score-0247 — Rewrite copy for pricing CTA → /start not mailto
...
**Deliverable:** Rewrite copy for pricing CTA → /start not mailto
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0247`
