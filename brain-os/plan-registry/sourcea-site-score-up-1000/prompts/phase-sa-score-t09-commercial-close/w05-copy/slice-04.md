# sa-score-0244 — Rewrite copy for case study PDF gate with email capture
...
**Deliverable:** Rewrite copy for case study PDF gate with email capture
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0244`
