# sa-score-0241 — Rewrite copy for license inquiry → worker not mailto
...
**Deliverable:** Rewrite copy for license inquiry → worker not mailto
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0241`
