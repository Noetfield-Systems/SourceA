# sa-score-0246 — Rewrite copy for revenue receipt in founder dashboard
...
**Deliverable:** Rewrite copy for revenue receipt in founder dashboard
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0246`
