# sa-score-0242 — Rewrite copy for cal.com demoted below proof on pricing
...
**Deliverable:** Rewrite copy for cal.com demoted below proof on pricing
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0242`
