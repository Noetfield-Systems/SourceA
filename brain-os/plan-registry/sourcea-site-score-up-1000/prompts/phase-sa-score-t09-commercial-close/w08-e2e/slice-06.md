# sa-score-0276 — E2E gate for scoped SKU cards with DONE · VERIFY bullets
...
**Deliverable:** E2E gate for scoped SKU cards with DONE · VERIFY bullets
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0276`
