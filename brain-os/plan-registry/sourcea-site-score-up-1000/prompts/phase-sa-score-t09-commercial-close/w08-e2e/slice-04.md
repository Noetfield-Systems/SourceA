# sa-score-0274 — E2E gate for pricing CTA → /start not mailto
...
**Deliverable:** E2E gate for pricing CTA → /start not mailto
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0274`
