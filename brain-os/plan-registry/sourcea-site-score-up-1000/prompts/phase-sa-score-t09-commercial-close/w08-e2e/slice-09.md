# sa-score-0279 — E2E gate for cal.com demoted below proof on pricing
...
**Deliverable:** E2E gate for cal.com demoted below proof on pricing
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0279`
