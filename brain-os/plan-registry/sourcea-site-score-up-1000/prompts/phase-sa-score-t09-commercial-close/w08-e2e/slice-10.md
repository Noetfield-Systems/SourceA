# sa-score-0280 — E2E gate for ROI calculator widget on /offer
...
**Deliverable:** E2E gate for ROI calculator widget on /offer
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0280`
