# sa-score-0271 — E2E gate for case study PDF gate with email capture
...
**Deliverable:** E2E gate for case study PDF gate with email capture
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0271`
