# sa-score-0290 — Bench vs market for case study PDF gate with email capture
...
**Deliverable:** Bench vs market for case study PDF gate with email capture
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0290`
