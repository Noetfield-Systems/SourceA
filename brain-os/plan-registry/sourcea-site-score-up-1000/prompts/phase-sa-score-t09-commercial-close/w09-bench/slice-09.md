# sa-score-0289 — Bench vs market for ROI calculator widget on /offer
...
**Deliverable:** Bench vs market for ROI calculator widget on /offer
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0289`
