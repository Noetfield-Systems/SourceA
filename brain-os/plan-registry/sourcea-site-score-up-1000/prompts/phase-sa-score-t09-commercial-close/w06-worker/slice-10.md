# sa-score-0260 — Worker endpoint for license inquiry → worker not mailto
...
**Deliverable:** Worker endpoint for license inquiry → worker not mailto
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0260`
