# sa-score-0255 — Worker endpoint for revenue receipt in founder dashboard
...
**Deliverable:** Worker endpoint for revenue receipt in founder dashboard
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0255`
