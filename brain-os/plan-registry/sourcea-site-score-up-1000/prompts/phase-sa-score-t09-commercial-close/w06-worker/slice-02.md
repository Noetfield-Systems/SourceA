# sa-score-0252 — Worker endpoint for ROI calculator widget on /offer
...
**Deliverable:** Worker endpoint for ROI calculator widget on /offer
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0252`
