# sa-score-0256 — Worker endpoint for pricing CTA → /start not mailto
...
**Deliverable:** Worker endpoint for pricing CTA → /start not mailto
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0256`
