# sa-score-0746 — Rewrite copy for weekly email digest to founder
...
**Deliverable:** Rewrite copy for weekly email digest to founder
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0746`
