# sa-score-0748 — Rewrite copy for top_events alert threshold in founder UI
...
**Deliverable:** Rewrite copy for top_events alert threshold in founder UI
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0748`
