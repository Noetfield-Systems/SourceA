# sa-score-0742 — Rewrite copy for guided_show completion rate
...
**Deliverable:** Rewrite copy for guided_show completion rate
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0742`
