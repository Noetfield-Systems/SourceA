# sa-score-0749 — Rewrite copy for feedback type filter bug/idea/praise
...
**Deliverable:** Rewrite copy for feedback type filter bug/idea/praise
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0749`
