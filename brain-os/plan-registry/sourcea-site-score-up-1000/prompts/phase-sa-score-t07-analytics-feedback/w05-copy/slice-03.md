# sa-score-0743 — Rewrite copy for export 7-day rollup JSON
...
**Deliverable:** Rewrite copy for export 7-day rollup JSON
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0743`
