# sa-score-0741 — Rewrite copy for cal overlay open/close conversion metric
...
**Deliverable:** Rewrite copy for cal overlay open/close conversion metric
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0741`
