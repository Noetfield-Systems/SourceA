# sa-score-0771 — E2E gate for anonymize PII in public stats
...
**Deliverable:** E2E gate for anonymize PII in public stats
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0771`
