# sa-score-0778 — E2E gate for cal overlay open/close conversion metric
...
**Deliverable:** E2E gate for cal overlay open/close conversion metric
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0778`
