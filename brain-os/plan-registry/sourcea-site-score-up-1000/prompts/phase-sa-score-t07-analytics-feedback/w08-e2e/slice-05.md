# sa-score-0775 — E2E gate for top_events alert threshold in founder UI
...
**Deliverable:** E2E gate for top_events alert threshold in founder UI
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0775`
