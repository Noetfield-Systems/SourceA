# sa-score-0770 — Deploy guided_show completion rate
...
**Deliverable:** Deploy guided_show completion rate
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0770`
