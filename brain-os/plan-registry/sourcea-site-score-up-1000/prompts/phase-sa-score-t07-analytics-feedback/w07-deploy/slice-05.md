# sa-score-0765 — Deploy funnel dashboard: segment → proof → intake
...
**Deliverable:** Deploy funnel dashboard: segment → proof → intake
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0765`
