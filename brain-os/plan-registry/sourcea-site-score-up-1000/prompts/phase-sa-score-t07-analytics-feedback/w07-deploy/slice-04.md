# sa-score-0764 — Deploy weekly email digest to founder
...
**Deliverable:** Deploy weekly email digest to founder
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0764`
