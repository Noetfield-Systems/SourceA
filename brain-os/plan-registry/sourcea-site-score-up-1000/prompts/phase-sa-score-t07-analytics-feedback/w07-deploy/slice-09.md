# sa-score-0769 — Deploy cal overlay open/close conversion metric
...
**Deliverable:** Deploy cal overlay open/close conversion metric
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0769`
