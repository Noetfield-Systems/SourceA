# sa-score-0715 — Prove live guided_show completion rate
...
**Deliverable:** Prove live guided_show completion rate
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0715`
