# sa-score-0714 — Prove live cal overlay open/close conversion metric
...
**Deliverable:** Prove live cal overlay open/close conversion metric
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0714`
