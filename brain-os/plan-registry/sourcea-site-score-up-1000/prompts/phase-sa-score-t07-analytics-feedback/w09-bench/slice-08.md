# sa-score-0788 — Bench vs market for guided_show completion rate
...
**Deliverable:** Bench vs market for guided_show completion rate
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0788`
