# sa-score-0784 — Bench vs market for top_events alert threshold in founder UI
...
**Deliverable:** Bench vs market for top_events alert threshold in founder UI
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0784`
