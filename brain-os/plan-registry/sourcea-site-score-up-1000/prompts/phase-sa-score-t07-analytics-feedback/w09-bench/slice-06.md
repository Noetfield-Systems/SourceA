# sa-score-0786 — Bench vs market for pageview path normalization /sourcea prefix

**Saved at:** 2026-06-25T09:23:55Z
**Version:** 1 · **Tier:** T2 · **Phase:** MOONSHOT
**Score dimension:** Analytics & feedback (82→98)
**Market analog:** PostHog
...
**Deliverable:** Bench vs market for pageview path normalization /sourcea prefix
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0786`
