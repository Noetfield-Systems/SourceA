# sa-score-0753 — Worker endpoint for anonymize PII in public stats
...
**Deliverable:** Worker endpoint for anonymize PII in public stats
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0753`
