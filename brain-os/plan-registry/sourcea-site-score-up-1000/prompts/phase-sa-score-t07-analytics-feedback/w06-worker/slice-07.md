# sa-score-0757 — Worker endpoint for top_events alert threshold in founder UI
...
**Deliverable:** Worker endpoint for top_events alert threshold in founder UI
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0757`
