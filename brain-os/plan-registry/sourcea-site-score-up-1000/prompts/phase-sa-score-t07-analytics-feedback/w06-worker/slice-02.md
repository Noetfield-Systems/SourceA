# sa-score-0752 — Worker endpoint for export 7-day rollup JSON
...
**Deliverable:** Worker endpoint for export 7-day rollup JSON
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0752`
