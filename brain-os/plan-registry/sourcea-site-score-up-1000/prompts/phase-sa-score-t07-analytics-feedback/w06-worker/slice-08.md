# sa-score-0758 — Worker endpoint for feedback type filter bug/idea/praise
...
**Deliverable:** Worker endpoint for feedback type filter bug/idea/praise
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0758`
