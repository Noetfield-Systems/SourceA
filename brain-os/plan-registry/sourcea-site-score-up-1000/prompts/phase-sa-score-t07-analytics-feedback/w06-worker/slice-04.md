# sa-score-0754 — Worker endpoint for spam feedback rate limit per IP
...
**Deliverable:** Worker endpoint for spam feedback rate limit per IP
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0754`
