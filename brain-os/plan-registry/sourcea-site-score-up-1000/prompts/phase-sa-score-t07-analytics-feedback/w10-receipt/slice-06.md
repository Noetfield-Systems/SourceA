# sa-score-0796 — Receipt on disk for cal overlay open/close conversion metric
...
**Deliverable:** Receipt on disk for cal overlay open/close conversion metric
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0796`
