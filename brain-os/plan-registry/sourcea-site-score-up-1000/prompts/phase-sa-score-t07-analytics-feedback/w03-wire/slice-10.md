# sa-score-0730 — Wire top_events alert threshold in founder UI
...
**Deliverable:** Wire top_events alert threshold in founder UI
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0730`
