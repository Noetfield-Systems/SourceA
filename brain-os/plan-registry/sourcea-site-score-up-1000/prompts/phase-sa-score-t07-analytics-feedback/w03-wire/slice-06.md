# sa-score-0726 — Wire anonymize PII in public stats
...
**Deliverable:** Wire anonymize PII in public stats
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0726`
