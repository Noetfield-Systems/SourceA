# sa-score-0156 — Worker endpoint for hero typography pass — match Linear/Vercel rhythm
...
**Deliverable:** Worker endpoint for hero typography pass — match Linear/Vercel rhythm
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0156`
