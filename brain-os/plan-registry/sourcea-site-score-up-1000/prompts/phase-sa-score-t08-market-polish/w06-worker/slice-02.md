# sa-score-0152 — Worker endpoint for forge terminal iframe chrome polish
...
**Deliverable:** Worker endpoint for forge terminal iframe chrome polish
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0152`
