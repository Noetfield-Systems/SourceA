# sa-score-0178 — E2E gate for unified button radius + shadow tokens in app.css
...
**Deliverable:** E2E gate for unified button radius + shadow tokens in app.css
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0178`
