# sa-score-0138 — Polish UI for hero typography pass — match Linear/Vercel rhythm
...
**Deliverable:** Polish UI for hero typography pass — match Linear/Vercel rhythm
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0138`
