# sa-score-0137 — Polish UI for lighthouse performance budget ≥90 mobile
...
**Deliverable:** Polish UI for lighthouse performance budget ≥90 mobile
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0137`
