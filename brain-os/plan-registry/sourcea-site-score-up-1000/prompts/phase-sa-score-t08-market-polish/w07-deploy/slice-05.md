# sa-score-0165 — Deploy hero typography pass — match Linear/Vercel rhythm
...
**Deliverable:** Deploy hero typography pass — match Linear/Vercel rhythm
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0165`
