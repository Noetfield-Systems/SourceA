# sa-score-0141 — Rewrite copy for unified button radius + shadow tokens in app.css
...
**Deliverable:** Rewrite copy for unified button radius + shadow tokens in app.css
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0141`
