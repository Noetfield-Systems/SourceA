# sa-score-0147 — Rewrite copy for hero typography pass — match Linear/Vercel rhythm
...
**Deliverable:** Rewrite copy for hero typography pass — match Linear/Vercel rhythm
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0147`
