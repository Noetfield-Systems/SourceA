# sa-score-0143 — Rewrite copy for forge terminal iframe chrome polish
...
**Deliverable:** Rewrite copy for forge terminal iframe chrome polish
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0143`
