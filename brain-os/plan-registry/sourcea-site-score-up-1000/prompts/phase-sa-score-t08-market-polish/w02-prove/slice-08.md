# sa-score-0118 — Prove live footer link grid cleanup
...
**Deliverable:** Prove live footer link grid cleanup
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0118`
