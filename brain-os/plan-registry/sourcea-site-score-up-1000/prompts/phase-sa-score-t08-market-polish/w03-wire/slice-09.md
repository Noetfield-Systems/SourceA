# sa-score-0129 — Wire hero typography pass — match Linear/Vercel rhythm
...
**Deliverable:** Wire hero typography pass — match Linear/Vercel rhythm
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0129`
