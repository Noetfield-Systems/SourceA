# sa-score-0106 — Ship trust page visual parity with pricing
...
**Deliverable:** Ship trust page visual parity with pricing
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0106`
