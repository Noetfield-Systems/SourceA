# sa-score-0104 — Ship loading skeleton on pulse-founder dashboard
...
**Deliverable:** Ship loading skeleton on pulse-founder dashboard
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0104`
