# sa-score-0110 — Ship lighthouse performance budget ≥90 mobile
...
**Deliverable:** Ship lighthouse performance budget ≥90 mobile
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0110`
