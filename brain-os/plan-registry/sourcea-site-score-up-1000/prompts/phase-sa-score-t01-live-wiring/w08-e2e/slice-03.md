# sa-score-0673 — E2E gate for worker health /api/site/health/v1
...
**Deliverable:** E2E gate for worker health /api/site/health/v1
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0673`
