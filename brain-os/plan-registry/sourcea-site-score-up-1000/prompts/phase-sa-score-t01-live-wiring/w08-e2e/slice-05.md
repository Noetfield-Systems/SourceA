# sa-score-0675 — E2E gate for sourcea-site-pulse-config-v1.json worker URL
...
**Deliverable:** E2E gate for sourcea-site-pulse-config-v1.json worker URL
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0675`
