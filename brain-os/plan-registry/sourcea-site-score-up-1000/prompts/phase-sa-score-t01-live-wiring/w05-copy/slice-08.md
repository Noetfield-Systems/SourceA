# sa-score-0648 — Rewrite copy for sourcea-site-pulse-config-v1.json worker URL
...
**Deliverable:** Rewrite copy for sourcea-site-pulse-config-v1.json worker URL
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0648`
