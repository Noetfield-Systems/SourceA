# sa-score-0647 — Rewrite copy for pulse worker route on sourcea.app/api/site/*
...
**Deliverable:** Rewrite copy for pulse worker route on sourcea.app/api/site/*
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0647`
