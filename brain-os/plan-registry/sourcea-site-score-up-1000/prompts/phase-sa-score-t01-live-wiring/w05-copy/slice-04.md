# sa-score-0644 — Rewrite copy for public stats embed on /sourcea/status
...
**Deliverable:** Rewrite copy for public stats embed on /sourcea/status
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0644`
