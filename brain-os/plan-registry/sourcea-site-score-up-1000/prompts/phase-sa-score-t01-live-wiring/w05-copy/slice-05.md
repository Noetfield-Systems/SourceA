# sa-score-0645 — Rewrite copy for CORS allow sourcea.app on all site APIs
...
**Deliverable:** Rewrite copy for CORS allow sourcea.app on all site APIs
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0645`
