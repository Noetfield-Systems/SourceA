# sa-score-0601 — Ship pulse worker route on sourcea.app/api/site/*
...
**Deliverable:** Ship pulse worker route on sourcea.app/api/site/*
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0601`
