# sa-score-0609 — Ship CORS allow sourcea.app on all site APIs
...
**Deliverable:** Ship CORS allow sourcea.app on all site APIs
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0609`
