# sa-score-0602 — Ship sourcea-site-pulse-config-v1.json worker URL
...
**Deliverable:** Ship sourcea-site-pulse-config-v1.json worker URL
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0602`
