# sa-score-0608 — Ship public stats embed on /sourcea/status
...
**Deliverable:** Ship public stats embed on /sourcea/status
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0608`
