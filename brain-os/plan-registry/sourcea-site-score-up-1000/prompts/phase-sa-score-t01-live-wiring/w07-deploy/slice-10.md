# sa-score-0670 — Deploy brain-chat worker pulse event bridge
...
**Deliverable:** Deploy brain-chat worker pulse event bridge
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0670`
