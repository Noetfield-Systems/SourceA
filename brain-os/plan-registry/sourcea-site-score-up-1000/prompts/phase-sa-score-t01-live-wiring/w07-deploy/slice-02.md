# sa-score-0662 — Deploy public stats embed on /sourcea/status
...
**Deliverable:** Deploy public stats embed on /sourcea/status
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0662`
