# sa-score-0663 — Deploy CORS allow sourcea.app on all site APIs
...
**Deliverable:** Deploy CORS allow sourcea.app on all site APIs
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0663`
