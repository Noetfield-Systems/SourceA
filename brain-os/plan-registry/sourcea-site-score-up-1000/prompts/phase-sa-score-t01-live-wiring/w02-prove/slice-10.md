# sa-score-0620 — Prove live pulse worker route on sourcea.app/api/site/*
...
**Deliverable:** Prove live pulse worker route on sourcea.app/api/site/*
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0620`
