# sa-score-0611 — Prove live sourcea-site-pulse-config-v1.json worker URL
...
**Deliverable:** Prove live sourcea-site-pulse-config-v1.json worker URL
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0611`
