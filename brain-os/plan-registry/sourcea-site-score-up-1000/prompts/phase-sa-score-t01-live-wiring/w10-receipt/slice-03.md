# sa-score-0693 — Receipt logged for sourcea-site-pulse-config-v1.json worker URL
...
**Deliverable:** Receipt logged for sourcea-site-pulse-config-v1.json worker URL
