# sa-score-0651 — Worker endpoint for brain-chat worker pulse event bridge
...
**Deliverable:** Worker endpoint for brain-chat worker pulse event bridge
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0651`
