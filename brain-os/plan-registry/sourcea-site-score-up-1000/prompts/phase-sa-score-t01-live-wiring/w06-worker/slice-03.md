# sa-score-0653 — Worker endpoint for public stats embed on /sourcea/status
...
**Deliverable:** Worker endpoint for public stats embed on /sourcea/status
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0653`
