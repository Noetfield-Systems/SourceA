# sa-score-0655 — Worker endpoint for worker health /api/site/health/v1
...
**Deliverable:** Worker endpoint for worker health /api/site/health/v1
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0655`
