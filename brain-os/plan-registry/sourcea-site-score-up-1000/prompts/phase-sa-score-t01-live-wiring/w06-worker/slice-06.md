# sa-score-0656 — Worker endpoint for pulse worker route on sourcea.app/api/site/*
...
**Deliverable:** Worker endpoint for pulse worker route on sourcea.app/api/site/*
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0656`
