# sa-score-0684 — Bench vs market for sourcea-site-pulse-config-v1.json worker URL

**Saved at:** 2026-06-25T09:23:55Z
**Version:** 1 · **Tier:** T1 · **Phase:** MOONSHOT
**Score dimension:** Live wiring (88→100)
**Market analog:** Cloudflare Workers
...
**Deliverable:** Bench vs market for sourcea-site-pulse-config-v1.json worker URL
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0684`
