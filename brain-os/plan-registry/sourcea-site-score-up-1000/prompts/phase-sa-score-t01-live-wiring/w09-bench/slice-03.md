# sa-score-0683 — Bench vs market for pulse worker route on sourcea.app/api/site/*
...
**Deliverable:** Bench vs market for pulse worker route on sourcea.app/api/site/*
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0683`
