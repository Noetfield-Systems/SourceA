# sa-score-0629 — Wire pulse worker route on sourcea.app/api/site/*
...
**Deliverable:** Wire pulse worker route on sourcea.app/api/site/*
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0629`
