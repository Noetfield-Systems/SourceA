# sa-score-0625 — Wire mvp-intake worker linked from /start form
...
**Deliverable:** Wire mvp-intake worker linked from /start form
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0625`
