# sa-score-0855 — Worker endpoint for glossary page /sourcea/vocabulary
...
**Deliverable:** Worker endpoint for glossary page /sourcea/vocabulary
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0855`
