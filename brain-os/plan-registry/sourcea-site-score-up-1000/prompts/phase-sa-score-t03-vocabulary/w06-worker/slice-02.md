# sa-score-0852 — Worker endpoint for living_ui label on Forge paths only
...
**Deliverable:** Worker endpoint for living_ui label on Forge paths only
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0852`
