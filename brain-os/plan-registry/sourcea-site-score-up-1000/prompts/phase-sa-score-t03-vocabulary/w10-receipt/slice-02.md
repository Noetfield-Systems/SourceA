# sa-score-0892 — Receipt logged for sourcea-landing-cta-v1.json version bump + changelog
...
**Deliverable:** Receipt logged for sourcea-landing-cta-v1.json version bump + changelog
