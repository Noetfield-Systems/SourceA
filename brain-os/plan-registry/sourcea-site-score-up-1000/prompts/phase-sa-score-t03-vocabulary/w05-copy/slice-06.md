# sa-score-0846 — Rewrite copy for glossary page /sourcea/vocabulary
...
**Deliverable:** Rewrite copy for glossary page /sourcea/vocabulary
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0846`
