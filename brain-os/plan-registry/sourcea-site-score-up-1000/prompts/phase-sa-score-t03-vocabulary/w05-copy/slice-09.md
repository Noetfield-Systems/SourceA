# sa-score-0849 — Rewrite copy for Talk to a human only on data-sa-book-fallback
...
**Deliverable:** Rewrite copy for Talk to a human only on data-sa-book-fallback
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0849`
