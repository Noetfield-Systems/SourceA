# sa-score-0863 — Deploy vocabulary validator script in CI
...
**Deliverable:** Deploy vocabulary validator script in CI
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0863`
