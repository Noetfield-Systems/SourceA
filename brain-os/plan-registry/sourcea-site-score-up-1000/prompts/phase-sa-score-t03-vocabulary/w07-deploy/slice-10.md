# sa-score-0870 — Deploy commercial_intake GOAL·DONE·VERIFY on /start
...
**Deliverable:** Deploy commercial_intake GOAL·DONE·VERIFY on /start
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0870`
