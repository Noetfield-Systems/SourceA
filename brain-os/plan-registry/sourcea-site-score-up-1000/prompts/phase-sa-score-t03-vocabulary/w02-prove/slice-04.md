# sa-score-0814 — Prove live proof_surface copy on all proof CTAs
...
**Deliverable:** Prove live proof_surface copy on all proof CTAs
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0814`
