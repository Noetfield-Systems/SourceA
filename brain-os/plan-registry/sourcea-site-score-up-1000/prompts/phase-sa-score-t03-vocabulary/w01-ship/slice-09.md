# sa-score-0809 — Ship vocabulary validator script in CI
...
**Deliverable:** Ship vocabulary validator script in CI
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0809`
