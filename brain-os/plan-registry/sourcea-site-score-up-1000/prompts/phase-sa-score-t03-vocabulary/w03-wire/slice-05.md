# sa-score-0825 — Wire living_ui label on Forge paths only
...
**Deliverable:** Wire living_ui label on Forge paths only
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0825`
