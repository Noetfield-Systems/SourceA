# sa-score-0823 — Wire proof_surface copy on all proof CTAs
...
**Deliverable:** Wire proof_surface copy on all proof CTAs
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0823`
