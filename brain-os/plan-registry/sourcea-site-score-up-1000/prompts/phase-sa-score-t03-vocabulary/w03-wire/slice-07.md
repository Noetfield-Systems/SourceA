# sa-score-0827 — Wire vocabulary validator script in CI
...
**Deliverable:** Wire vocabulary validator script in CI
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0827`
