# sa-score-0407 — Ship segment strip on all dist pages via build inject
...
**Deliverable:** Ship segment strip on all dist pages via build inject
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0407`
