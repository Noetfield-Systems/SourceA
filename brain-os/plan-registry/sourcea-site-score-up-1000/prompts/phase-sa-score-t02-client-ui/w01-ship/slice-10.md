# sa-score-0410 — Ship error states on pulse-founder auth failure
...
**Deliverable:** Ship error states on pulse-founder auth failure
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0410`
