# sa-score-0498 — Receipt logged for segment strip on all dist pages via build inject
...
**Deliverable:** Receipt logged for segment strip on all dist pages via build inject
