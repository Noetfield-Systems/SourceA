# sa-score-0414 — Prove live feedback FAB z-index above Cal overlay
...
**Deliverable:** Prove live feedback FAB z-index above Cal overlay
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0414`
