# sa-score-0411 — Prove live remove duplicate pulse script tags on founder-home
...
**Deliverable:** Prove live remove duplicate pulse script tags on founder-home
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0411`
