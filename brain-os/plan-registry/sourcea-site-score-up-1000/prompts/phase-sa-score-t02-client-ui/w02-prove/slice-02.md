# sa-score-0412 — Prove live data-sa-proof-cta href consistency sitewide
...
**Deliverable:** Prove live data-sa-proof-cta href consistency sitewide
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0412`
