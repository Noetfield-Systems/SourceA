# sa-score-0465 — Deploy founder-home hero primary = See live receipt per CTA SSOT
...
**Deliverable:** Deploy founder-home hero primary = See live receipt per CTA SSOT
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0465`
