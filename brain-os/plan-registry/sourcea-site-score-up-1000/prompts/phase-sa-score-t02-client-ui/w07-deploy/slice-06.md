# sa-score-0466 — Deploy remove duplicate pulse script tags on founder-home
...
**Deliverable:** Deploy remove duplicate pulse script tags on founder-home
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0466`
