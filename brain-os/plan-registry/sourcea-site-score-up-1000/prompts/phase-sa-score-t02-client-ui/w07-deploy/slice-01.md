# sa-score-0461 — Deploy segment strip on all dist pages via build inject
...
**Deliverable:** Deploy segment strip on all dist pages via build inject
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0461`
