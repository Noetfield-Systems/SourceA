# sa-score-0451 — Worker endpoint for guided tour dismiss persists per session
...
**Deliverable:** Worker endpoint for guided tour dismiss persists per session
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0451`
