# sa-score-0460 — Worker endpoint for feedback FAB z-index above Cal overlay
...
**Deliverable:** Worker endpoint for feedback FAB z-index above Cal overlay
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0460`
