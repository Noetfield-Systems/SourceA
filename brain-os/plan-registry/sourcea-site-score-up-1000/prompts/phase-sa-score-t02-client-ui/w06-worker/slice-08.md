# sa-score-0458 — Worker endpoint for data-sa-proof-cta href consistency sitewide
...
**Deliverable:** Worker endpoint for data-sa-proof-cta href consistency sitewide
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0458`
