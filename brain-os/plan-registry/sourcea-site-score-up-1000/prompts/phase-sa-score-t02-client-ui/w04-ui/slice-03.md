# sa-score-0433 — Polish UI for guided tour dismiss persists per session
...
**Deliverable:** Polish UI for guided tour dismiss persists per session
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0433`
