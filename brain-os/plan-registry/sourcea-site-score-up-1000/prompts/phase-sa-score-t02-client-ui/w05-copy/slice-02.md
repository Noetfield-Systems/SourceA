# sa-score-0442 — Rewrite copy for guided tour dismiss persists per session
...
**Deliverable:** Rewrite copy for guided tour dismiss persists per session
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0442`
