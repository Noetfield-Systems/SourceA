# sa-score-0441 — Rewrite copy for feedback FAB z-index above Cal overlay
...
**Deliverable:** Rewrite copy for feedback FAB z-index above Cal overlay
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0441`
