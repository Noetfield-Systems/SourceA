# sa-score-0443 — Rewrite copy for segment strip on all dist pages via build inject
...
**Deliverable:** Rewrite copy for segment strip on all dist pages via build inject
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0443`
