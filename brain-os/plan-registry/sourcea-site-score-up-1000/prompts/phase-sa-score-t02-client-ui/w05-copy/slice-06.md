# sa-score-0446 — Rewrite copy for error states on pulse-founder auth failure
...
**Deliverable:** Rewrite copy for error states on pulse-founder auth failure
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0446`
