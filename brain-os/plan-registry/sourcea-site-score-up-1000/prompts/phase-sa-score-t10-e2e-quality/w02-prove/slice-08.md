# sa-score-0918 — Prove live deploy smoke after wrangler pages
...
**Deliverable:** Prove live deploy smoke after wrangler pages
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0918`
