# sa-score-0914 — Prove live broken link crawler on dist/
...
**Deliverable:** Prove live broken link crawler on dist/
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0914`
