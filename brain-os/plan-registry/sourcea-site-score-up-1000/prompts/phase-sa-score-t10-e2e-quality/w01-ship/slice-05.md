# sa-score-0905 — Ship broken link crawler on dist/
...
**Deliverable:** Ship broken link crawler on dist/
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0905`
