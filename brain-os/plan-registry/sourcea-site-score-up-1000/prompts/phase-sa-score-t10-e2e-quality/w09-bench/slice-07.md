# sa-score-0987 — Bench vs market for broken link crawler on dist/
...
**Deliverable:** Bench vs market for broken link crawler on dist/
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0987`
