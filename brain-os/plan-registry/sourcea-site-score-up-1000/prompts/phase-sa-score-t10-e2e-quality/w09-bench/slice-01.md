# sa-score-0981 — Bench vs market for deploy smoke after wrangler pages
...
**Deliverable:** Bench vs market for deploy smoke after wrangler pages
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0981`
