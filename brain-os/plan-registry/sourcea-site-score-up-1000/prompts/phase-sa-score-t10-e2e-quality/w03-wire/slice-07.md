# sa-score-0927 — Wire deploy smoke after wrangler pages
...
**Deliverable:** Wire deploy smoke after wrangler pages
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0927`
