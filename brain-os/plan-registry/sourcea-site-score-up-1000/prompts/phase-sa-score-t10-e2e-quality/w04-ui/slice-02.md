# sa-score-0932 — Polish UI for broken link crawler on dist/
...
**Deliverable:** Polish UI for broken link crawler on dist/
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0932`
