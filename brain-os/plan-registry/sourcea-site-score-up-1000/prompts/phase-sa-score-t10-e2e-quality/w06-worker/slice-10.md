# sa-score-0960 — Worker endpoint for broken link crawler on dist/
...
**Deliverable:** Worker endpoint for broken link crawler on dist/
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0960`
