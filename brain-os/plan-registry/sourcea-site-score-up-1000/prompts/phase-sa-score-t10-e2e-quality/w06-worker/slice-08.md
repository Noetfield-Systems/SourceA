# sa-score-0958 — Worker endpoint for Playwright sandbox submit no mailto
...
**Deliverable:** Worker endpoint for Playwright sandbox submit no mailto
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0958`
