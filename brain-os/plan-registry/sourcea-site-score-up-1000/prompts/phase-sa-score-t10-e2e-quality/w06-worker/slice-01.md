# sa-score-0951 — Worker endpoint for JSON schema validate all data/*.json
...
**Deliverable:** Worker endpoint for JSON schema validate all data/*.json
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0951`
