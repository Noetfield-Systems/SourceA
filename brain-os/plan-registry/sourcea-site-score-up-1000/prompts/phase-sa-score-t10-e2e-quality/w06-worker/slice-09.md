# sa-score-0959 — Worker endpoint for Playwright pulse-founder key gate
...
**Deliverable:** Worker endpoint for Playwright pulse-founder key gate
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0959`
