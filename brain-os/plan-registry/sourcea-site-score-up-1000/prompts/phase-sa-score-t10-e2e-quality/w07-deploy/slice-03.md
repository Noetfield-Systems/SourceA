# sa-score-0963 — Deploy deploy smoke after wrangler pages
...
**Deliverable:** Deploy deploy smoke after wrangler pages
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0963`
