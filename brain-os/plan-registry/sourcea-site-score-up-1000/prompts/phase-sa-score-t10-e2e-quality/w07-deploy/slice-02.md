# sa-score-0962 — Deploy accessibility axe on /learn
...
**Deliverable:** Deploy accessibility axe on /learn
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0962`
