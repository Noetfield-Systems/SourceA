# sa-score-0978 — E2E gate for broken link crawler on dist/
...
**Deliverable:** E2E gate for broken link crawler on dist/
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0978`
