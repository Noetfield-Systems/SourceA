# sa-score-0077 — E2E gate for proof run status page /sourcea/proof/run/:id
...
**Deliverable:** E2E gate for proof run status page /sourcea/proof/run/:id
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0077`
