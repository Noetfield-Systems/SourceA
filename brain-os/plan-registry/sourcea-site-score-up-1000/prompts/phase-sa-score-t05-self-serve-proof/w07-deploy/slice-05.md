...
**Deliverable:** Deploy stranger POST /api/proof/run/v1 → cloud job → public receipt URL
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0065`
