# sa-score-0054 — Worker endpoint for proof pack download ZIP with checksum
...
**Deliverable:** Worker endpoint for proof pack download ZIP with checksum
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0054`
