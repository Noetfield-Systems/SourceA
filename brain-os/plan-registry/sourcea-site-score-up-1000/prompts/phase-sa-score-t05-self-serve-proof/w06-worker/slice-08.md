# sa-score-0058 — Worker endpoint for email receipt link after async proof completes
...
**Deliverable:** Worker endpoint for email receipt link after async proof completes
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0058`
