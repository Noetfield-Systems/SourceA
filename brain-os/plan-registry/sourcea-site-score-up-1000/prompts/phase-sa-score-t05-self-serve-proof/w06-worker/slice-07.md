# sa-score-0057 — Worker endpoint for proof run progress bar on /sourcea/proof/live
...
**Deliverable:** Worker endpoint for proof run progress bar on /sourcea/proof/live
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0057`
