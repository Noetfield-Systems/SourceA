# sa-score-0056 — Worker endpoint for stranger POST /api/proof/run/v1 → cloud job → public receipt URL

**Saved at:** 2026-06-25T09:23:55Z
**Version:** 1 · **Tier:** T2 · **Phase:** NEXT
**Score dimension:** Self-serve proof (65→95)
**Market analog:** Trigger.dev
**Workstream:** w06-worker · Worker
**Slice:** 6/10
...
**Deliverable:** Worker endpoint for stranger POST /api/proof/run/v1 → cloud job → public receipt URL
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0056`
