# sa-score-0060 — Worker endpoint for Forge Terminal handoff after proof quiz pass
...
**Deliverable:** Worker endpoint for Forge Terminal handoff after proof quiz pass
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0060`
