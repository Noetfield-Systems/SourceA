# sa-score-0059 — Worker endpoint for proof run status page /sourcea/proof/run/:id
...
**Deliverable:** Worker endpoint for proof run status page /sourcea/proof/run/:id
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0059`
