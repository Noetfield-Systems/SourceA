# sa-score-0044 — Rewrite copy for sandbox bounded job → worker queue not mailto
...
**Deliverable:** Rewrite copy for sandbox bounded job → worker queue not mailto
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0044`
