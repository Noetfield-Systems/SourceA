# sa-score-0045 — Rewrite copy for proof pack download ZIP with checksum
...
**Deliverable:** Rewrite copy for proof pack download ZIP with checksum
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0045`
