# sa-score-0022 — Wire proof run status page /sourcea/proof/run/:id
...
**Deliverable:** Wire proof run status page /sourcea/proof/run/:id
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0022`
