# sa-score-0024 — Wire VC proof lane ends on verifiable receipt not Cal
...
**Deliverable:** Wire VC proof lane ends on verifiable receipt not Cal
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0024`
