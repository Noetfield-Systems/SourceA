# sa-score-0030 — Wire proof run progress bar on /sourcea/proof/live
...
**Deliverable:** Wire proof run progress bar on /sourcea/proof/live
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0030`
