# sa-score-0092 — Receipt logged for stranger POST /api/proof/run/v1 → cloud job → public receipt URL
...
**Deliverable:** Receipt logged for stranger POST /api/proof/run/v1 → cloud job → public receipt URL
