# sa-score-0092 — Receipt on disk for stranger POST /api/proof/run/v1 → cloud job → public receipt URL

**Saved at:** 2026-06-25T09:23:55Z
**Version:** 1 · **Tier:** T0 · **Phase:** NEXT
**Score dimension:** Self-serve proof (65→95)
**Market analog:** Trigger.dev
**Workstream:** w10-receipt · Receipt
**Slice:** 2/10
...
**Deliverable:** Receipt on disk for stranger POST /api/proof/run/v1 → cloud job → public receipt URL
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0092`
