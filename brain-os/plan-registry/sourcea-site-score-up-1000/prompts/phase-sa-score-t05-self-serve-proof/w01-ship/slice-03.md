# sa-score-0003 — Ship email receipt link after async proof completes
...
**Deliverable:** Ship email receipt link after async proof completes
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0003`
