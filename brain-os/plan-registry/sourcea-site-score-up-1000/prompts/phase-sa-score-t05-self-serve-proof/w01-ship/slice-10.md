# sa-score-0010 — Ship stranger proof SLA copy ≤15 min on hero
...
**Deliverable:** Ship stranger proof SLA copy ≤15 min on hero
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0010`
