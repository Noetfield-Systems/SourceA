# sa-score-0008 — Ship sandbox bounded job → worker queue not mailto
...
**Deliverable:** Ship sandbox bounded job → worker queue not mailto
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0008`
