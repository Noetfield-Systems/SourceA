# sa-score-0090 — Bench vs market for sandbox bounded job → worker queue not mailto
...
**Deliverable:** Bench vs market for sandbox bounded job → worker queue not mailto
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0090`
