# sa-score-0084 — Bench vs market for proof run progress bar on /sourcea/proof/live
...
**Deliverable:** Bench vs market for proof run progress bar on /sourcea/proof/live
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0084`
