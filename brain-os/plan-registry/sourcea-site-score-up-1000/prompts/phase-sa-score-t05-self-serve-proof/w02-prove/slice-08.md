# sa-score-0018 — Prove live proof pack download ZIP with checksum
...
**Deliverable:** Prove live proof pack download ZIP with checksum
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0018`
