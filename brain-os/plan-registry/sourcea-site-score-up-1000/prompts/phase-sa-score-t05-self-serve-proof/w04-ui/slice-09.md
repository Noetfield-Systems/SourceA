# sa-score-0039 — Polish UI for proof run progress bar on /sourcea/proof/live
...
**Deliverable:** Polish UI for proof run progress bar on /sourcea/proof/live
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0039`
