# sa-score-0035 — Polish UI for sandbox bounded job → worker queue not mailto
...
**Deliverable:** Polish UI for sandbox bounded job → worker queue not mailto
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0035`
