# sa-score-0037 — Polish UI for stranger proof SLA copy ≤15 min on hero
...
**Deliverable:** Polish UI for stranger proof SLA copy ≤15 min on hero
...
1. `status: done` in `brain-os/plan-registry/sourcea-site-score-up-1000/REGISTRY.json` for `sa-score-0037`
