# sa-next-0313 — SourceA next plan
...
**Legacy upgrade:** UP-0313 (CLD · Cloud motor & FBE)
...
Factory runtime · Prove · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0313`
