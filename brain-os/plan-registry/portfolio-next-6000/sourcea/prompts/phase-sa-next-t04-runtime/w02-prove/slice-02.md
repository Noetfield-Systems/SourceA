# sa-next-0312 — SourceA next plan
...
**Legacy upgrade:** UP-0312 (CLD · Cloud motor & FBE)
...
Factory runtime · Prove · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0312`
