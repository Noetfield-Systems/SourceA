# sa-next-0318 — SourceA next plan
...
**Legacy upgrade:** UP-0318 (CLD · Cloud motor & FBE)
...
Factory runtime · Prove · slice 8/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0318`
