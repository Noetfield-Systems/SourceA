# sa-next-0314 — SourceA next plan
...
**Legacy upgrade:** UP-0314 (CLD · Cloud motor & FBE)
...
Factory runtime · Prove · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0314`
