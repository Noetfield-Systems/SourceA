# sa-next-0357 — SourceA next plan
...
**Legacy upgrade:** UP-0357 (CLD · Cloud motor & FBE)
...
**Supabase edge only** — Cloud motor & FBE (CLD).

Factory runtime · Govern · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0357`
