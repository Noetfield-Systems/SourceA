# sa-next-0354 — SourceA next plan
...
**Legacy upgrade:** UP-0354 (CLD · Cloud motor & FBE)
...
Factory runtime · Govern · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0354`
