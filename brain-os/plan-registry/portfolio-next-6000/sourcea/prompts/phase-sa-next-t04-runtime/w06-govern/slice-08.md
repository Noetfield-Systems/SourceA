# sa-next-0358 — SourceA next plan
...
**Legacy upgrade:** UP-0358 (CLD · Cloud motor & FBE)
...
Factory runtime · Govern · slice 8/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0358`
