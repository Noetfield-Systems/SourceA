# sa-next-0371 — SourceA next plan
...
**Legacy upgrade:** UP-0371 (CLD · Cloud motor & FBE)
...
Factory runtime · Validate · slice 1/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0371`
