# sa-next-0376 — SourceA next plan
...
**Legacy upgrade:** UP-0376 (CLD · Cloud motor & FBE)
...
Factory runtime · Validate · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0376`
