# sa-next-0374 — SourceA next plan
...
**Legacy upgrade:** UP-0374 (CLD · Cloud motor & FBE)
...
Factory runtime · Validate · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0374`
