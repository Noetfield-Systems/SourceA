# sa-next-0373 — SourceA next plan
...
**Legacy upgrade:** UP-0373 (CLD · Cloud motor & FBE)
...
Factory runtime · Validate · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0373`
