# sa-next-0380 — SourceA next plan
...
**Legacy upgrade:** UP-0380 (CLD · Cloud motor & FBE)
...
Factory runtime · Validate · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0380`
