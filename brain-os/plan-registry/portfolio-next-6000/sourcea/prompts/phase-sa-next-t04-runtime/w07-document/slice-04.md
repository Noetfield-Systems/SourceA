# sa-next-0364 — SourceA next plan
...
**Legacy upgrade:** UP-0364 (CLD · Cloud motor & FBE)
...
**CF Worker motor defer** — Cloud motor & FBE (CLD).

Factory runtime · Document · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0364`
