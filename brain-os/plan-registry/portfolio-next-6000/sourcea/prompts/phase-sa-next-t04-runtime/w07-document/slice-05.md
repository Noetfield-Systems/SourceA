# sa-next-0365 — SourceA next plan
...
**Legacy upgrade:** UP-0365 (CLD · Cloud motor & FBE)
...
Factory runtime · Document · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0365`
