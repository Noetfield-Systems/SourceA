# sa-next-0366 — SourceA next plan
...
**Legacy upgrade:** UP-0366 (CLD · Cloud motor & FBE)
...
Factory runtime · Document · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0366`
