# sa-next-0369 — SourceA next plan
...
**Legacy upgrade:** UP-0369 (CLD · Cloud motor & FBE)
...
Factory runtime · Document · slice 9/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0369`
