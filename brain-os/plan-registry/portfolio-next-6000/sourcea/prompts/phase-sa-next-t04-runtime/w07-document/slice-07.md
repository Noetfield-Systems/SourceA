# sa-next-0367 — SourceA next plan
...
**Legacy upgrade:** UP-0367 (CLD · Cloud motor & FBE)
...
Factory runtime · Document · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0367`
