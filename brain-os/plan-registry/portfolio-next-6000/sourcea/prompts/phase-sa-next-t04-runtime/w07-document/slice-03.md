# sa-next-0363 — SourceA next plan
...
**Legacy upgrade:** UP-0363 (CLD · Cloud motor & FBE)
...
Factory runtime · Document · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0363`
