# sa-next-0336 — SourceA next plan
...
**Legacy upgrade:** UP-0336 (CLD · Cloud motor & FBE)
...
Factory runtime · Build · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0336`
