# sa-next-0332 — SourceA next plan
...
**Legacy upgrade:** UP-0332 (CLD · Cloud motor & FBE)
...
Factory runtime · Build · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0332`
