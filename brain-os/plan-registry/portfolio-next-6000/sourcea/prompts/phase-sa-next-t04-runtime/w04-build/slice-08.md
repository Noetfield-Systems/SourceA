# sa-next-0338 — SourceA next plan
...
**Legacy upgrade:** UP-0338 (CLD · Cloud motor & FBE)
...
Factory runtime · Build · slice 8/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0338`
