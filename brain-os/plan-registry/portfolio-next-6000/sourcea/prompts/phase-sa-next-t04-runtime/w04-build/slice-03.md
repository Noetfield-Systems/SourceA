# sa-next-0333 — SourceA next plan
...
**Legacy upgrade:** UP-0333 (CLD · Cloud motor & FBE)
...
Factory runtime · Build · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0333`
