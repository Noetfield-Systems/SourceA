# sa-next-0335 — SourceA next plan
...
**Legacy upgrade:** UP-0335 (CLD · Cloud motor & FBE)
...
**Blueprint queue head** — Cloud motor & FBE (CLD).

Factory runtime · Build · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0335`
