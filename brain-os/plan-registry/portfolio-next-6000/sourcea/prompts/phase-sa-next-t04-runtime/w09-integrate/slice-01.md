# sa-next-0381 — SourceA next plan
...
**Legacy upgrade:** UP-0381 (CLD · Cloud motor & FBE)
...
**Job retry policy** — Cloud motor & FBE (CLD).

Factory runtime · Integrate · slice 1/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0381`
