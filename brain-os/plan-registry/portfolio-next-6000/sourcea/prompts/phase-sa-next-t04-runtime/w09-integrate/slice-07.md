# sa-next-0387 — SourceA next plan
...
**Legacy upgrade:** UP-0387 (CLD · Cloud motor & FBE)
...
**Motor health probe** — Cloud motor & FBE (CLD).

Factory runtime · Integrate · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0387`
