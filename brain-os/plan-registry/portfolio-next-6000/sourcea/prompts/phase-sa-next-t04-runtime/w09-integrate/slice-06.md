# sa-next-0386 — SourceA next plan
...
**Legacy upgrade:** UP-0386 (CLD · Cloud motor & FBE)
...
Factory runtime · Integrate · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0386`
