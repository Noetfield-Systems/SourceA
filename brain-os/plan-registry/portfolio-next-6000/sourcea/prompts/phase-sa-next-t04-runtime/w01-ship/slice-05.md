# sa-next-0305 — SourceA next plan
...
**Legacy upgrade:** UP-0305 (CU · Chat Unify machines)
...
**Receipt path standard** — Chat Unify machines (CU).

Factory runtime · Ship · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0305`
