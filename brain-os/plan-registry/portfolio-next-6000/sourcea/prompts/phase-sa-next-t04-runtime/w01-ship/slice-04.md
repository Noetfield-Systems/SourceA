# sa-next-0304 — SourceA next plan
...
**Legacy upgrade:** UP-0304 (CU · Chat Unify machines)
...
Factory runtime · Ship · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0304`
