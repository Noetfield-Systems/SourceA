# sa-next-0307 — SourceA next plan
...
**Legacy upgrade:** UP-0307 (CLD · Cloud motor & FBE)
...
Factory runtime · Ship · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0307`
