# sa-next-0306 — SourceA next plan
...
**Legacy upgrade:** UP-0306 (CLD · Cloud motor & FBE)
...
Factory runtime · Ship · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0306`
