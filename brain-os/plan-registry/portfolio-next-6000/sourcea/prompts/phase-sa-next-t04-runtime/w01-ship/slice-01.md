...
**Chat memory ban enforce** — Chat Unify machines (CU).

Factory runtime · Ship · slice 1/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0301`
