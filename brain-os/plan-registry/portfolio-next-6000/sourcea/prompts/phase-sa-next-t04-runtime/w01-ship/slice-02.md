# sa-next-0302 — SourceA next plan
...
**Legacy upgrade:** UP-0302 (CU · Chat Unify machines)
...
Factory runtime · Ship · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0302`
