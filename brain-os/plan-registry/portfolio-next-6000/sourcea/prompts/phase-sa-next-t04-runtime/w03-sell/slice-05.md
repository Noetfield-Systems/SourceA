# sa-next-0325 — SourceA next plan
...
**Legacy upgrade:** UP-0325 (CLD · Cloud motor & FBE)
...
**Auto Runtime specialist tick** — Cloud motor & FBE (CLD).

Factory runtime · Sell · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0325`
