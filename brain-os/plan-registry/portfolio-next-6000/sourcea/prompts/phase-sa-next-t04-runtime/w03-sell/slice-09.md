# sa-next-0329 — SourceA next plan
...
**Legacy upgrade:** UP-0329 (CLD · Cloud motor & FBE)
...
**Secondary drain batches** — Cloud motor & FBE (CLD).

Factory runtime · Sell · slice 9/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0329`
