# sa-next-0323 — SourceA next plan
...
**Legacy upgrade:** UP-0323 (CLD · Cloud motor & FBE)
...
Factory runtime · Sell · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0323`
