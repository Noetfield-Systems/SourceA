# sa-next-0326 — SourceA next plan
...
**Legacy upgrade:** UP-0326 (CLD · Cloud motor & FBE)
...
Factory runtime · Sell · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0326`
