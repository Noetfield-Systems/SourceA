# sa-next-0322 — SourceA next plan
...
**Legacy upgrade:** UP-0322 (CLD · Cloud motor & FBE)
...
Factory runtime · Sell · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0322`
