# sa-next-0327 — SourceA next plan
...
**Legacy upgrade:** UP-0327 (CLD · Cloud motor & FBE)
...
Factory runtime · Sell · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0327`
