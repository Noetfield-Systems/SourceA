# sa-next-0330 — SourceA next plan
...
**Legacy upgrade:** UP-0330 (CLD · Cloud motor & FBE)
...
Factory runtime · Sell · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0330`
