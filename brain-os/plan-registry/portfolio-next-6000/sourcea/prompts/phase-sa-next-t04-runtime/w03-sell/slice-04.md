# sa-next-0324 — SourceA next plan
...
**Legacy upgrade:** UP-0324 (CLD · Cloud motor & FBE)
...
Factory runtime · Sell · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0324`
