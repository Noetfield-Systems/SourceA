# sa-next-0394 — SourceA next plan
...
**Legacy upgrade:** UP-0394 (GOV · Governance & SSOT)
...
Factory runtime · Scale · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0394`
