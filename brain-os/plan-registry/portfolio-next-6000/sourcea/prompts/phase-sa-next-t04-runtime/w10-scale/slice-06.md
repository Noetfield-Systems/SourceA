# sa-next-0396 — SourceA next plan
...
**Legacy upgrade:** UP-0396 (GOV · Governance & SSOT)
...
Factory runtime · Scale · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0396`
