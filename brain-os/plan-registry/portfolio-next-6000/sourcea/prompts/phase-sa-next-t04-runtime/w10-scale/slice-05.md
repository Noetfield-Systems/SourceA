# sa-next-0395 — SourceA next plan
...
**Legacy upgrade:** UP-0395 (GOV · Governance & SSOT)
...
**Stale law scan** — Governance & SSOT (GOV).

Factory runtime · Scale · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0395`
