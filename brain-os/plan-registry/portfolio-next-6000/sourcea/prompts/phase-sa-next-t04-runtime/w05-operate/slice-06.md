# sa-next-0346 — SourceA next plan
...
**Legacy upgrade:** UP-0346 (CLD · Cloud motor & FBE)
...
Factory runtime · Operate · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0346`
