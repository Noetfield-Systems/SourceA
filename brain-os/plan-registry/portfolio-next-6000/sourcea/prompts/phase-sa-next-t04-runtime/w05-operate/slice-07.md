# sa-next-0347 — SourceA next plan
...
**Legacy upgrade:** UP-0347 (CLD · Cloud motor & FBE)
...
Factory runtime · Operate · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0347`
