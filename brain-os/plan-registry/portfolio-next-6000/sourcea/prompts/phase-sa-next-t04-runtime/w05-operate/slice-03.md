# sa-next-0343 — SourceA next plan
...
**Legacy upgrade:** UP-0343 (CLD · Cloud motor & FBE)
...
Factory runtime · Operate · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0343`
