# sa-next-0344 — SourceA next plan
...
**Legacy upgrade:** UP-0344 (CLD · Cloud motor & FBE)
...
Factory runtime · Operate · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0344`
