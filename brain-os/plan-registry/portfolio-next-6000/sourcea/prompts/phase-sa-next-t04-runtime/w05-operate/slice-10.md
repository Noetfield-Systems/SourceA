# sa-next-0350 — SourceA next plan
...
**Legacy upgrade:** UP-0350 (CLD · Cloud motor & FBE)
...
Factory runtime · Operate · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0350`
