# sa-next-0345 — SourceA next plan
...
**Legacy upgrade:** UP-0345 (CLD · Cloud motor & FBE)
...
Factory runtime · Operate · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0345`
