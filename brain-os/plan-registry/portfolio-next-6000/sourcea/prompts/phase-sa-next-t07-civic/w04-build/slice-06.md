# sa-next-0636 — SourceA next plan
...
**Legacy upgrade:** UP-0636 (INT · Integrations & MCP)
...
**n8n community pack** — Integrations & MCP (INT).

Civic proof lab · Build · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0636`
