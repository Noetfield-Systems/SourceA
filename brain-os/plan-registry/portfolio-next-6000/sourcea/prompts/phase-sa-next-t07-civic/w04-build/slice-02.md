# sa-next-0632 — SourceA next plan
...
**Legacy upgrade:** UP-0632 (INT · Integrations & MCP)
...
Civic proof lab · Build · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0632`
