# sa-next-0631 — SourceA next plan
...
**Legacy upgrade:** UP-0631 (INT · Integrations & MCP)
...
Civic proof lab · Build · slice 1/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0631`
