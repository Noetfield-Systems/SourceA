# sa-next-0664 — SourceA next plan
...
**Legacy upgrade:** UP-0664 (INT · Integrations & MCP)
...
Civic proof lab · Document · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0664`
