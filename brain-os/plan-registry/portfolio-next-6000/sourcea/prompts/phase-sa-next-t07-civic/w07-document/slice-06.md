# sa-next-0666 — SourceA next plan
...
**Legacy upgrade:** UP-0666 (INT · Integrations & MCP)
...
Civic proof lab · Document · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0666`
