# sa-next-0670 — SourceA next plan
...
**Legacy upgrade:** UP-0670 (INT · Integrations & MCP)
...
**hooks.sourcea.app SLA** — Integrations & MCP (INT).

Civic proof lab · Document · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0670`
