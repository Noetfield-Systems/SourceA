# sa-next-0667 — SourceA next plan
...
**Legacy upgrade:** UP-0667 (INT · Integrations & MCP)
...
Civic proof lab · Document · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0667`
