# sa-next-0668 — SourceA next plan
...
**Legacy upgrade:** UP-0668 (INT · Integrations & MCP)
...
Civic proof lab · Document · slice 8/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0668`
