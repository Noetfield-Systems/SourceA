# sa-next-0644 — SourceA next plan
...
**Legacy upgrade:** UP-0644 (INT · Integrations & MCP)
...
Civic proof lab · Operate · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0644`
