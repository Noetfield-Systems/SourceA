# sa-next-0645 — SourceA next plan
...
**Legacy upgrade:** UP-0645 (INT · Integrations & MCP)
...
Civic proof lab · Operate · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0645`
