# sa-next-0646 — SourceA next plan
...
**Legacy upgrade:** UP-0646 (INT · Integrations & MCP)
...
Civic proof lab · Operate · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0646`
