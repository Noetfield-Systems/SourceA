# sa-next-0649 — SourceA next plan
...
**Legacy upgrade:** UP-0649 (INT · Integrations & MCP)
...
Civic proof lab · Operate · slice 9/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0649`
