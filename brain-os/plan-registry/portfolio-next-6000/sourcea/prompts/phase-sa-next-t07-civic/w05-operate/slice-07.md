# sa-next-0647 — SourceA next plan
...
**Legacy upgrade:** UP-0647 (INT · Integrations & MCP)
...
Civic proof lab · Operate · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0647`
