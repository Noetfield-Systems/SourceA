# sa-next-0648 — SourceA next plan
...
**Legacy upgrade:** UP-0648 (INT · Integrations & MCP)
...
Civic proof lab · Operate · slice 8/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0648`
