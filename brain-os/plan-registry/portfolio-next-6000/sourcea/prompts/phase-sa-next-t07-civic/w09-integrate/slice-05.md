# sa-next-0685 — SourceA next plan
...
**Legacy upgrade:** UP-0685 (INT · Integrations & MCP)
...
Civic proof lab · Integrate · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0685`
