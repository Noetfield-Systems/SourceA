# sa-next-0683 — SourceA next plan
...
**Legacy upgrade:** UP-0683 (INT · Integrations & MCP)
...
Civic proof lab · Integrate · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0683`
