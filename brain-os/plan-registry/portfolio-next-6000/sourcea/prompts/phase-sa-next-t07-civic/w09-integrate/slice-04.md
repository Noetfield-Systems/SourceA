# sa-next-0684 — SourceA next plan
...
**Legacy upgrade:** UP-0684 (INT · Integrations & MCP)
...
**Integration catalog API** — Integrations & MCP (INT).

Civic proof lab · Integrate · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0684`
