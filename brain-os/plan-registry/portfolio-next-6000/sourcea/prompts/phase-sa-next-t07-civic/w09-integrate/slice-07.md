# sa-next-0687 — SourceA next plan
...
**Legacy upgrade:** UP-0687 (INT · Integrations & MCP)
...
Civic proof lab · Integrate · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0687`
