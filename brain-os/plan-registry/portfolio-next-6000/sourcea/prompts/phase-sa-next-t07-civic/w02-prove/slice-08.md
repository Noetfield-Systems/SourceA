# sa-next-0618 — SourceA next plan
...
**Legacy upgrade:** UP-0618 (SAS · SaaS & platform)
...
Civic proof lab · Prove · slice 8/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0618`
