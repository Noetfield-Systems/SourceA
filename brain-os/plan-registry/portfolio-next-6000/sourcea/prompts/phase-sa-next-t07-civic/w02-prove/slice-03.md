# sa-next-0613 — SourceA next plan
...
**Legacy upgrade:** UP-0613 (SAS · SaaS & platform)
...
**Early access T2 scope** — SaaS & platform (SAS).

Civic proof lab · Prove · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0613`
