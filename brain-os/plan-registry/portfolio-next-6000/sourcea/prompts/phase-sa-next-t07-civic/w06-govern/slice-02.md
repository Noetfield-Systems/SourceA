# sa-next-0652 — SourceA next plan
...
**Legacy upgrade:** UP-0652 (INT · Integrations & MCP)
...
Civic proof lab · Govern · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0652`
