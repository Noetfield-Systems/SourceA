# sa-next-0657 — SourceA next plan
...
**Legacy upgrade:** UP-0657 (INT · Integrations & MCP)
...
**Cursor extension** — Integrations & MCP (INT).

Civic proof lab · Govern · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0657`
