# sa-next-0695 — SourceA next plan
...
**Legacy upgrade:** UP-0695 (OBS · Observability & ops)
...
**OpenTelemetry traces** — Observability & ops (OBS).

Civic proof lab · Scale · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0695`
