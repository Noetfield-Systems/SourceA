# sa-next-0604 — SourceA next plan
...
**Legacy upgrade:** UP-0604 (SAS · SaaS & platform)
...
Civic proof lab · Ship · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0604`
