# sa-next-0609 — SourceA next plan
...
**Legacy upgrade:** UP-0609 (SAS · SaaS & platform)
...
**Design partner portal** — SaaS & platform (SAS).

Civic proof lab · Ship · slice 9/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0609`
