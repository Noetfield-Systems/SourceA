# sa-next-0606 — SourceA next plan
...
**Legacy upgrade:** UP-0606 (SAS · SaaS & platform)
...
Civic proof lab · Ship · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0606`
