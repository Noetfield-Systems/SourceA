# sa-next-0605 — SourceA next plan
...
**Legacy upgrade:** UP-0605 (SAS · SaaS & platform)
...
**Churn alerts** — SaaS & platform (SAS).

Civic proof lab · Ship · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0605`
