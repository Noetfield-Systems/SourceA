# sa-next-0603 — SourceA next plan
...
**Legacy upgrade:** UP-0603 (SAS · SaaS & platform)
...
Civic proof lab · Ship · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0603`
