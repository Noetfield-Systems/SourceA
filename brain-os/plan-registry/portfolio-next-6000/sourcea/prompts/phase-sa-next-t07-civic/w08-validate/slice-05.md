# sa-next-0675 — SourceA next plan
...
**Legacy upgrade:** UP-0675 (INT · Integrations & MCP)
...
Civic proof lab · Validate · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0675`
