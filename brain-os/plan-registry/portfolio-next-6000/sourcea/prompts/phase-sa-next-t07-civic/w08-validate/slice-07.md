# sa-next-0677 — SourceA next plan
...
**Legacy upgrade:** UP-0677 (INT · Integrations & MCP)
...
**OpenAPI publish** — Integrations & MCP (INT).

Civic proof lab · Validate · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0677`
