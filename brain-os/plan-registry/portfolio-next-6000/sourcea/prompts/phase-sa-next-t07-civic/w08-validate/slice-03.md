# sa-next-0673 — SourceA next plan
...
**Legacy upgrade:** UP-0673 (INT · Integrations & MCP)
...
**command.sourcea.app team** — Integrations & MCP (INT).

Civic proof lab · Validate · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0673`
