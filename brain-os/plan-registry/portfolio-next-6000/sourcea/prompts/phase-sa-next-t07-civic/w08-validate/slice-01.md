# sa-next-0671 — SourceA next plan
...
**Legacy upgrade:** UP-0671 (INT · Integrations & MCP)
...
Civic proof lab · Validate · slice 1/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0671`
