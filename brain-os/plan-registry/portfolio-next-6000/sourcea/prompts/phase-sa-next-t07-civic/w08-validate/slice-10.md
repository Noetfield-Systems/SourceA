# sa-next-0680 — SourceA next plan
...
**Legacy upgrade:** UP-0680 (INT · Integrations & MCP)
...
**Webhook schema v2** — Integrations & MCP (INT).

Civic proof lab · Validate · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0680`
