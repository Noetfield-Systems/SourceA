# sa-next-0674 — SourceA next plan
...
**Legacy upgrade:** UP-0674 (INT · Integrations & MCP)
...
Civic proof lab · Validate · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0674`
