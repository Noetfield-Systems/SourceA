# sa-next-0678 — SourceA next plan
...
**Legacy upgrade:** UP-0678 (INT · Integrations & MCP)
...
Civic proof lab · Validate · slice 8/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0678`
