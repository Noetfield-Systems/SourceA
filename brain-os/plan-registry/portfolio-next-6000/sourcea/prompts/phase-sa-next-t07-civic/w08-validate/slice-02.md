# sa-next-0672 — SourceA next plan
...
**Legacy upgrade:** UP-0672 (INT · Integrations & MCP)
...
Civic proof lab · Validate · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0672`
