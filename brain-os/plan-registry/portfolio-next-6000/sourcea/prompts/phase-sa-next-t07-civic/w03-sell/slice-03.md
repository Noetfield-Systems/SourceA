# sa-next-0623 — SourceA next plan
...
**Legacy upgrade:** UP-0623 (SAS · SaaS & platform)
...
Civic proof lab · Sell · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0623`
