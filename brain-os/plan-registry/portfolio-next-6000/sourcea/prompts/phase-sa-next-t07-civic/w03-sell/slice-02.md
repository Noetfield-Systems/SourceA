# sa-next-0622 — SourceA next plan
...
**Legacy upgrade:** UP-0622 (SAS · SaaS & platform)
...
Civic proof lab · Sell · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0622`
