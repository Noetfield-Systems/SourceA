# sa-next-0627 — SourceA next plan
...
**Legacy upgrade:** UP-0627 (INT · Integrations & MCP)
...
Civic proof lab · Sell · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0627`
