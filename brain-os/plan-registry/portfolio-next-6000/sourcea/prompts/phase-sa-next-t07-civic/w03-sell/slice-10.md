# sa-next-0630 — SourceA next plan
...
**Legacy upgrade:** UP-0630 (INT · Integrations & MCP)
...
Civic proof lab · Sell · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0630`
