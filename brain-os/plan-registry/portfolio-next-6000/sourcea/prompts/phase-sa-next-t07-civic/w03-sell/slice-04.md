# sa-next-0624 — SourceA next plan
...
**Legacy upgrade:** UP-0624 (SAS · SaaS & platform)
...
Civic proof lab · Sell · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0624`
