# sa-next-0625 — SourceA next plan
...
**Legacy upgrade:** UP-0625 (SAS · SaaS & platform)
...
**Subscription proof pack** — SaaS & platform (SAS).

Civic proof lab · Sell · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0625`
