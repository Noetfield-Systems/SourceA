# sa-next-0629 — SourceA next plan
...
**Legacy upgrade:** UP-0629 (INT · Integrations & MCP)
...
**MCP-native registry** — Integrations & MCP (INT).

Civic proof lab · Sell · slice 9/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0629`
