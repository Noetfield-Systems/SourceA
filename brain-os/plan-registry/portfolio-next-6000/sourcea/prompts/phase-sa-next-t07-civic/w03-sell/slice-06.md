# sa-next-0626 — SourceA next plan
...
**Legacy upgrade:** UP-0626 (INT · Integrations & MCP)
...
Civic proof lab · Sell · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0626`
