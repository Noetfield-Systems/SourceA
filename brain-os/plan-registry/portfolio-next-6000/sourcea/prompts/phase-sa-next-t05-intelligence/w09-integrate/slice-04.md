# sa-next-0484 — SourceA next plan
...
**Legacy upgrade:** UP-0484 (ENT · Enterprise & compliance)
...
**RBAC multi-tenant** — Enterprise & compliance (ENT).

Noetfield Intelligence 613 · Integrate · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0484`
