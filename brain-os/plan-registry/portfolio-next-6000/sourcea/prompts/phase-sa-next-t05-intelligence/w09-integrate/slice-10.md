# sa-next-0490 — SourceA next plan
...
**Legacy upgrade:** UP-0490 (ENT · Enterprise & compliance)
...
**Data residency option** — Enterprise & compliance (ENT).

Noetfield Intelligence 613 · Integrate · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0490`
