# sa-next-0406 — SourceA next plan
...
**Legacy upgrade:** UP-0406 (GOV · Governance & SSOT)
...
Noetfield Intelligence 613 · Ship · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0406`
