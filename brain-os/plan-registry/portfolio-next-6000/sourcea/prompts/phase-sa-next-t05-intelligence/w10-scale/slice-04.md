# sa-next-0494 — SourceA next plan
...
**Legacy upgrade:** UP-0494 (ENT · Enterprise & compliance)
...
Noetfield Intelligence 613 · Scale · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0494`
