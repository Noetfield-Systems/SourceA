# sa-next-0493 — SourceA next plan
...
**Legacy upgrade:** UP-0493 (ENT · Enterprise & compliance)
...
Noetfield Intelligence 613 · Scale · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0493`
