# sa-next-0495 — SourceA next plan
...
**Legacy upgrade:** UP-0495 (ENT · Enterprise & compliance)
...
**SSO SAML** — Enterprise & compliance (ENT).

Noetfield Intelligence 613 · Scale · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0495`
