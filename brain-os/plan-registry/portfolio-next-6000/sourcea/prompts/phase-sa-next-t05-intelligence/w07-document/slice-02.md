# sa-next-0462 — SourceA next plan
...
**Legacy upgrade:** UP-0462 (ENT · Enterprise & compliance)
...
1. `status: done` in REGISTRY.json for `sa-next-0462`
