# sa-next-0815 — SourceA next plan
...
**Legacy upgrade:** UP-0815 (HUB · Hub & standalone apps)
...
Hub & control plane · Prove · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0815`
