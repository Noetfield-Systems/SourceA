# sa-next-0814 — SourceA next plan
...
**Legacy upgrade:** UP-0814 (HUB · Hub & standalone apps)
...
Hub & control plane · Prove · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0814`
