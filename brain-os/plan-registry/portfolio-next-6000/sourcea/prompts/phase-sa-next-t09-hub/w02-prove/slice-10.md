# sa-next-0820 — SourceA next plan
...
**Legacy upgrade:** UP-0820 (HUB · Hub & standalone apps)
...
Hub & control plane · Prove · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0820`
