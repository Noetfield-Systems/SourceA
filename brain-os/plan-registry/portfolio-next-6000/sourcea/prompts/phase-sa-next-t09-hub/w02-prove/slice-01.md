# sa-next-0811 — SourceA next plan
...
**Legacy upgrade:** UP-0811 (HUB · Hub & standalone apps)
...
Hub & control plane · Prove · slice 1/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0811`
