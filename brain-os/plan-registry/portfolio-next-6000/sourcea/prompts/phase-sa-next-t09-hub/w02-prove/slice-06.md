# sa-next-0816 — SourceA next plan
...
**Legacy upgrade:** UP-0816 (HUB · Hub & standalone apps)
...
**Mac Health Guard** — Hub & standalone apps (HUB).

Hub & control plane · Prove · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0816`
