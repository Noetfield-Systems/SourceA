# sa-next-0819 — SourceA next plan
...
**Legacy upgrade:** UP-0819 (HUB · Hub & standalone apps)
...
Hub & control plane · Prove · slice 9/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0819`
