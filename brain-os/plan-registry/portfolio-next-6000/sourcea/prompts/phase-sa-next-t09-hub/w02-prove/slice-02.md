# sa-next-0812 — SourceA next plan
...
**Legacy upgrade:** UP-0812 (HUB · Hub & standalone apps)
...
Hub & control plane · Prove · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0812`
