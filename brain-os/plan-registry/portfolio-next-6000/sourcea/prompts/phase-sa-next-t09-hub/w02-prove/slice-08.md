# sa-next-0818 — SourceA next plan
...
**Legacy upgrade:** UP-0818 (HUB · Hub & standalone apps)
...
Hub & control plane · Prove · slice 8/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0818`
