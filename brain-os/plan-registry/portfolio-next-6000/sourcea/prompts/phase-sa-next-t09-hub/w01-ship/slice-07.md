# sa-next-0807 — SourceA next plan
...
**Legacy upgrade:** UP-0807 (HUB · Hub & standalone apps)
...
Hub & control plane · Ship · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0807`
