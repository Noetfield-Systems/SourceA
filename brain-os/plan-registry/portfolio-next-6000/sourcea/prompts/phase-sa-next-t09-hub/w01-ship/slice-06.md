# sa-next-0806 — SourceA next plan
...
**Legacy upgrade:** UP-0806 (HUB · Hub & standalone apps)
...
Hub & control plane · Ship · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0806`
