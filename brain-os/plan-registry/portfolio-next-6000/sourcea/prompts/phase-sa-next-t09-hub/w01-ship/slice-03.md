# sa-next-0803 — SourceA next plan
...
**Legacy upgrade:** UP-0803 (MED · Media & commercial factory)
...
Hub & control plane · Ship · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0803`
