# sa-next-0809 — SourceA next plan
...
**Legacy upgrade:** UP-0809 (HUB · Hub & standalone apps)
...
**Worker Hub H1 polish** — Hub & standalone apps (HUB).

Hub & control plane · Ship · slice 9/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0809`
