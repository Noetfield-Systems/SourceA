# sa-next-0810 — SourceA next plan
...
**Legacy upgrade:** UP-0810 (HUB · Hub & standalone apps)
...
Hub & control plane · Ship · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0810`
