# sa-next-0805 — SourceA next plan
...
**Legacy upgrade:** UP-0805 (MED · Media & commercial factory)
...
Hub & control plane · Ship · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0805`
