# sa-next-0804 — SourceA next plan
...
**Legacy upgrade:** UP-0804 (MED · Media & commercial factory)
...
Hub & control plane · Ship · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0804`
