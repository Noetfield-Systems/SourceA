# sa-next-0839 — SourceA next plan
...
**Legacy upgrade:** UP-0839 (HUB · Hub & standalone apps)
...
Hub & control plane · Build · slice 9/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0839`
