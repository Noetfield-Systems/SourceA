# sa-next-0840 — SourceA next plan
...
**Legacy upgrade:** UP-0840 (HUB · Hub & standalone apps)
...
Hub & control plane · Build · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0840`
