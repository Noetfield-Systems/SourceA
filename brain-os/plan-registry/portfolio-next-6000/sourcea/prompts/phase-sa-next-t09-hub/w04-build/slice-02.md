# sa-next-0832 — SourceA next plan
...
**Legacy upgrade:** UP-0832 (HUB · Hub & standalone apps)
...
Hub & control plane · Build · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0832`
