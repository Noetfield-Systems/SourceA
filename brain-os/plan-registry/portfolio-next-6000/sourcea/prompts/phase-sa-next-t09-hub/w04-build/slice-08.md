# sa-next-0838 — SourceA next plan
...
**Legacy upgrade:** UP-0838 (HUB · Hub & standalone apps)
...
Hub & control plane · Build · slice 8/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0838`
