# sa-next-0831 — SourceA next plan
...
**Legacy upgrade:** UP-0831 (HUB · Hub & standalone apps)
...
Hub & control plane · Build · slice 1/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0831`
