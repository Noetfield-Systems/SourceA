# sa-next-0833 — SourceA next plan
...
**Legacy upgrade:** UP-0833 (HUB · Hub & standalone apps)
...
Hub & control plane · Build · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0833`
