# sa-next-0836 — SourceA next plan
...
**Legacy upgrade:** UP-0836 (HUB · Hub & standalone apps)
...
**Hub Pro change log** — Hub & standalone apps (HUB).

Hub & control plane · Build · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0836`
