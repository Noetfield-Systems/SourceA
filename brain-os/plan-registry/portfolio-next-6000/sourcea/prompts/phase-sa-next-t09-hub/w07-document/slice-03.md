# sa-next-0863 — SourceA next plan
...
**Legacy upgrade:** UP-0863 (HUB · Hub & standalone apps)
...
Hub & control plane · Document · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0863`
