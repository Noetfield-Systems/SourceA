# sa-next-0864 — SourceA next plan
...
**Legacy upgrade:** UP-0864 (LNG · Long-horizon & moonshots)
...
Hub & control plane · Document · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0864`
