# sa-next-0861 — SourceA next plan
...
**Legacy upgrade:** UP-0861 (HUB · Hub & standalone apps)
...
Hub & control plane · Document · slice 1/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0861`
