# sa-next-0867 — SourceA next plan
...
**Legacy upgrade:** UP-0867 (LNG · Long-horizon & moonshots)
...
Hub & control plane · Document · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0867`
