# sa-next-0825 — SourceA next plan
...
**Legacy upgrade:** UP-0825 (HUB · Hub & standalone apps)
...
**Cloud Workers app** — Hub & standalone apps (HUB).

Hub & control plane · Sell · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0825`
