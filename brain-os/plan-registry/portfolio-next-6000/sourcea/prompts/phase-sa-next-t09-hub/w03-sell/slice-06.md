# sa-next-0826 — SourceA next plan
...
**Legacy upgrade:** UP-0826 (HUB · Hub & standalone apps)
...
Hub & control plane · Sell · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0826`
