# sa-next-0830 — SourceA next plan
...
**Legacy upgrade:** UP-0830 (HUB · Hub & standalone apps)
...
Hub & control plane · Sell · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0830`
