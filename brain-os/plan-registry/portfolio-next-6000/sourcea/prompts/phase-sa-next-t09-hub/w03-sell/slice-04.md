# sa-next-0824 — SourceA next plan
...
**Legacy upgrade:** UP-0824 (HUB · Hub & standalone apps)
...
Hub & control plane · Sell · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0824`
