# sa-next-0823 — SourceA next plan
...
**Legacy upgrade:** UP-0823 (HUB · Hub & standalone apps)
...
Hub & control plane · Sell · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0823`
