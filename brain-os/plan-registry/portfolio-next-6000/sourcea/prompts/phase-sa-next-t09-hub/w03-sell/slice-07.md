# sa-next-0827 — SourceA next plan
...
**Legacy upgrade:** UP-0827 (HUB · Hub & standalone apps)
...
Hub & control plane · Sell · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0827`
