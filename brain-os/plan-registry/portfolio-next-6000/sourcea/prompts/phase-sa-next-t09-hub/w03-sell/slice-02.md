# sa-next-0822 — SourceA next plan
...
**Legacy upgrade:** UP-0822 (HUB · Hub & standalone apps)
...
Hub & control plane · Sell · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0822`
