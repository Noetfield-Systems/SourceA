# sa-next-0829 — SourceA next plan
...
**Legacy upgrade:** UP-0829 (HUB · Hub & standalone apps)
...
**Form official UX** — Hub & standalone apps (HUB).

Hub & control plane · Sell · slice 9/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0829`
