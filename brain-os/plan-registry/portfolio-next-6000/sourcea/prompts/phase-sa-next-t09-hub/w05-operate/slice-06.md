# sa-next-0846 — SourceA next plan
...
**Legacy upgrade:** UP-0846 (HUB · Hub & standalone apps)
...
Hub & control plane · Operate · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0846`
