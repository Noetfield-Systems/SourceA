# sa-next-0843 — SourceA next plan
...
**Legacy upgrade:** UP-0843 (HUB · Hub & standalone apps)
...
Hub & control plane · Operate · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0843`
