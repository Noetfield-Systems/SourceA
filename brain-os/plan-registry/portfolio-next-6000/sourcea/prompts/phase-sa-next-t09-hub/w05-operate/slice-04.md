# sa-next-0844 — SourceA next plan
...
**Legacy upgrade:** UP-0844 (HUB · Hub & standalone apps)
...
Hub & control plane · Operate · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0844`
