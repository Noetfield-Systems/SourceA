# sa-next-0842 — SourceA next plan
...
**Legacy upgrade:** UP-0842 (HUB · Hub & standalone apps)
...
Hub & control plane · Operate · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0842`
