# sa-next-0849 — SourceA next plan
...
**Legacy upgrade:** UP-0849 (HUB · Hub & standalone apps)
...
Hub & control plane · Operate · slice 9/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0849`
