# sa-next-0847 — SourceA next plan
...
**Legacy upgrade:** UP-0847 (HUB · Hub & standalone apps)
...
Hub & control plane · Operate · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0847`
