# sa-next-0848 — SourceA next plan
...
**Legacy upgrade:** UP-0848 (HUB · Hub & standalone apps)
...
Hub & control plane · Operate · slice 8/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0848`
