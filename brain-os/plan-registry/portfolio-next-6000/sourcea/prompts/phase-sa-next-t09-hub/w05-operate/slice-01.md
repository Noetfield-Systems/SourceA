# sa-next-0841 — SourceA next plan
...
**Legacy upgrade:** UP-0841 (HUB · Hub & standalone apps)
...
Hub & control plane · Operate · slice 1/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0841`
