# sa-next-0845 — SourceA next plan
...
**Legacy upgrade:** UP-0845 (HUB · Hub & standalone apps)
...
**Standalone codesign** — Hub & standalone apps (HUB).

Hub & control plane · Operate · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0845`
