# sa-next-0873 — SourceA next plan
...
**Legacy upgrade:** UP-0873 (LNG · Long-horizon & moonshots)
...
Hub & control plane · Validate · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0873`
