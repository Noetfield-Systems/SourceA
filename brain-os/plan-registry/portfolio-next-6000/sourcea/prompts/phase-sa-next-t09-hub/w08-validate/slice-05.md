# sa-next-0875 — SourceA next plan
...
**Legacy upgrade:** UP-0875 (LNG · Long-horizon & moonshots)
...
Hub & control plane · Validate · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0875`
