# sa-next-0871 — SourceA next plan
...
**Legacy upgrade:** UP-0871 (LNG · Long-horizon & moonshots)
...
Hub & control plane · Validate · slice 1/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0871`
