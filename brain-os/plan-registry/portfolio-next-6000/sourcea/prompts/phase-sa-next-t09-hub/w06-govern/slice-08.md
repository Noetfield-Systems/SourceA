# sa-next-0858 — SourceA next plan
...
**Legacy upgrade:** UP-0858 (HUB · Hub & standalone apps)
...
Hub & control plane · Govern · slice 8/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0858`
