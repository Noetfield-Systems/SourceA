# sa-next-0857 — SourceA next plan
...
**Legacy upgrade:** UP-0857 (HUB · Hub & standalone apps)
...
Hub & control plane · Govern · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0857`
