# sa-next-0851 — SourceA next plan
...
**Legacy upgrade:** UP-0851 (HUB · Hub & standalone apps)
...
Hub & control plane · Govern · slice 1/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0851`
