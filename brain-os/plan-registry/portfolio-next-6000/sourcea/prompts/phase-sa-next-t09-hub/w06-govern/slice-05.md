# sa-next-0855 — SourceA next plan
...
**Legacy upgrade:** UP-0855 (HUB · Hub & standalone apps)
...
Hub & control plane · Govern · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0855`
