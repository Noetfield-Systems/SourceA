# sa-next-0856 — SourceA next plan
...
**Legacy upgrade:** UP-0856 (HUB · Hub & standalone apps)
...
Hub & control plane · Govern · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0856`
