# sa-next-0852 — SourceA next plan
...
**Legacy upgrade:** UP-0852 (HUB · Hub & standalone apps)
...
**Port map E2E** — Hub & standalone apps (HUB).

Hub & control plane · Govern · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0852`
