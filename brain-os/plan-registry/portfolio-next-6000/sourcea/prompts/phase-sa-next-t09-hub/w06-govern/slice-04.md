# sa-next-0854 — SourceA next plan
...
**Legacy upgrade:** UP-0854 (HUB · Hub & standalone apps)
...
Hub & control plane · Govern · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0854`
