# sa-next-0853 — SourceA next plan
...
**Legacy upgrade:** UP-0853 (HUB · Hub & standalone apps)
...
Hub & control plane · Govern · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0853`
