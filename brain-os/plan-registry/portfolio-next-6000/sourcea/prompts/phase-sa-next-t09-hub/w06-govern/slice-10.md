# sa-next-0860 — SourceA next plan
...
**Legacy upgrade:** UP-0860 (HUB · Hub & standalone apps)
...
Hub & control plane · Govern · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0860`
