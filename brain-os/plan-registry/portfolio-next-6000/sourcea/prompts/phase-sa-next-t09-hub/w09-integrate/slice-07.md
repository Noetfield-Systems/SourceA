# sa-next-0887 — SourceA next plan
...
**Legacy upgrade:** UP-0887 (LNG · Long-horizon & moonshots)
...
Hub & control plane · Integrate · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0887`
