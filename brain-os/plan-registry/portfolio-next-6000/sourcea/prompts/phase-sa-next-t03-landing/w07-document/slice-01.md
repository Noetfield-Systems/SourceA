# sa-next-0261 — SourceA next plan
...
**Legacy upgrade:** UP-0261 (CU · Chat Unify machines)
...
Landing & web · Document · slice 1/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0261`
