# sa-next-0266 — SourceA next plan
...
**Legacy upgrade:** UP-0266 (CU · Chat Unify machines)
...
Landing & web · Document · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0266`
