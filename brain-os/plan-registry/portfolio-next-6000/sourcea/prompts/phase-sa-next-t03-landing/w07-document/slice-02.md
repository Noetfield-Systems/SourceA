# sa-next-0262 — SourceA next plan
...
**Legacy upgrade:** UP-0262 (CU · Chat Unify machines)
...
Landing & web · Document · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0262`
