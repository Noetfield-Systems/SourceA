# sa-next-0268 — SourceA next plan
...
**Legacy upgrade:** UP-0268 (CU · Chat Unify machines)
...
Landing & web · Document · slice 8/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0268`
