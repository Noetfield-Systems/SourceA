# sa-next-0225 — SourceA next plan
...
**Legacy upgrade:** UP-0225 (PRF · Proof & Proof Pack)
...
**Board-ready PDF from pack** — Proof & Proof Pack (PRF).

Landing & web · Sell · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0225`
