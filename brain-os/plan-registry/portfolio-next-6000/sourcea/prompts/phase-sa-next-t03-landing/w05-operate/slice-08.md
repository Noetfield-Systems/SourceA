# sa-next-0248 — SourceA next plan
...
**Legacy upgrade:** UP-0248 (CU · Chat Unify machines)
...
**API Station routes** — Chat Unify machines (CU).

Landing & web · Operate · slice 8/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0248`
