# sa-next-0241 — SourceA next plan
...
**Legacy upgrade:** UP-0241 (CU · Chat Unify machines)
...
**Decisions machine** — Chat Unify machines (CU).

Landing & web · Operate · slice 1/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0241`
