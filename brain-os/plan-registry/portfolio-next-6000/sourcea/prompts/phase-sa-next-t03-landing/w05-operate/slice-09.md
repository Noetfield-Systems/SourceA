# sa-next-0249 — SourceA next plan
...
**Legacy upgrade:** UP-0249 (CU · Chat Unify machines)
...
Landing & web · Operate · slice 9/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0249`
