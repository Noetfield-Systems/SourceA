# sa-next-0247 — SourceA next plan
...
**Legacy upgrade:** UP-0247 (CU · Chat Unify machines)
...
Landing & web · Operate · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0247`
