# sa-next-0250 — SourceA next plan
...
**Legacy upgrade:** UP-0250 (CU · Chat Unify machines)
...
**n8n template gated** — Chat Unify machines (CU).

Landing & web · Operate · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0250`
