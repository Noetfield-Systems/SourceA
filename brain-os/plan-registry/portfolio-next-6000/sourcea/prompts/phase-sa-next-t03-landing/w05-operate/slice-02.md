# sa-next-0242 — SourceA next plan
...
**Legacy upgrade:** UP-0242 (CU · Chat Unify machines)
...
Landing & web · Operate · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0242`
