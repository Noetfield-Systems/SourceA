# sa-next-0246 — SourceA next plan
...
**Legacy upgrade:** UP-0246 (CU · Chat Unify machines)
...
**Official Form batch** — Chat Unify machines (CU).

Landing & web · Operate · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0246`
