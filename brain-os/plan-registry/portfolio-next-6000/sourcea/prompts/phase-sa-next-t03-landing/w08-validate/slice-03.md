# sa-next-0273 — SourceA next plan
...
**Legacy upgrade:** UP-0273 (CU · Chat Unify machines)
...
**Cursor bridge docs** — Chat Unify machines (CU).

Landing & web · Validate · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0273`
