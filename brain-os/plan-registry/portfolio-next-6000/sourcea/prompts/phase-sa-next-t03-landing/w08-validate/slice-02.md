# sa-next-0272 — SourceA next plan
...
**Legacy upgrade:** UP-0272 (CU · Chat Unify machines)
...
Landing & web · Validate · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0272`
