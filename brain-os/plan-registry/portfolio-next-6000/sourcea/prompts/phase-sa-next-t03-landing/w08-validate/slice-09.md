# sa-next-0279 — SourceA next plan
...
**Legacy upgrade:** UP-0279 (CU · Chat Unify machines)
...
**Tab UX upgrade** — Chat Unify machines (CU).

Landing & web · Validate · slice 9/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0279`
