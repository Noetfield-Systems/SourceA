# sa-next-0275 — SourceA next plan
...
**Legacy upgrade:** UP-0275 (CU · Chat Unify machines)
...
Landing & web · Validate · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0275`
