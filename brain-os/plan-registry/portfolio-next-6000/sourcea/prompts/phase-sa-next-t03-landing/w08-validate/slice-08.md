# sa-next-0278 — SourceA next plan
...
**Legacy upgrade:** UP-0278 (CU · Chat Unify machines)
...
Landing & web · Validate · slice 8/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0278`
