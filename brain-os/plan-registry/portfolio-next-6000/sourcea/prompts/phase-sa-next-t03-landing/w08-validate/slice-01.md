# sa-next-0271 — SourceA next plan
...
**Legacy upgrade:** UP-0271 (CU · Chat Unify machines)
...
Landing & web · Validate · slice 1/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0271`
