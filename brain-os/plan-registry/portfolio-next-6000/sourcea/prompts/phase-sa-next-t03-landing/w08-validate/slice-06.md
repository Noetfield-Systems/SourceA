# sa-next-0276 — SourceA next plan
...
**Legacy upgrade:** UP-0276 (CU · Chat Unify machines)
...
**Seven machine row E2E** — Chat Unify machines (CU).

Landing & web · Validate · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0276`
