# sa-next-0280 — SourceA next plan
...
**Legacy upgrade:** UP-0280 (CU · Chat Unify machines)
...
**Truth gate heuristics** — Chat Unify machines (CU).

Landing & web · Validate · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0280`
