...
**Disk-bound claim validator** — Proof & Proof Pack (PRF).

Landing & web · Prove · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0217`
