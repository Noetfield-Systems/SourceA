# sa-next-0295 — SourceA next plan
...
**Legacy upgrade:** UP-0295 (CU · Chat Unify machines)
...
**Auto-seal on PASS** — Chat Unify machines (CU).

Landing & web · Scale · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0295`
