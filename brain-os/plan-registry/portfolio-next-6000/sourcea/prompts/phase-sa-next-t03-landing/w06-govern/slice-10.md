# sa-next-0260 — SourceA next plan
...
**Legacy upgrade:** UP-0260 (CU · Chat Unify machines)
...
**DMG auto-update** — Chat Unify machines (CU).

Landing & web · Govern · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0260`
