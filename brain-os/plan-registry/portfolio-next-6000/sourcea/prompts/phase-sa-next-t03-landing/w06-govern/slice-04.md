# sa-next-0254 — SourceA next plan
...
**Legacy upgrade:** UP-0254 (CU · Chat Unify machines)
...
**Integrations manifest version** — Chat Unify machines (CU).

Landing & web · Govern · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0254`
