# sa-next-0257 — SourceA next plan
...
**Legacy upgrade:** UP-0257 (CU · Chat Unify machines)
...
**Mac app notarize** — Chat Unify machines (CU).

Landing & web · Govern · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0257`
