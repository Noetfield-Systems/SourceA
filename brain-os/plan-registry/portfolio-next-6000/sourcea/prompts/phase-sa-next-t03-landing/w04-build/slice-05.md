# sa-next-0235 — SourceA next plan
...
**Legacy upgrade:** UP-0235 (CU · Chat Unify machines)
...
**Connect webhooks** — Chat Unify machines (CU).

Landing & web · Build · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0235`
