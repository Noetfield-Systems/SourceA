# sa-next-0240 — SourceA next plan
...
**Legacy upgrade:** UP-0240 (CU · Chat Unify machines)
...
**Tasks machine** — Chat Unify machines (CU).

Landing & web · Build · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0240`
