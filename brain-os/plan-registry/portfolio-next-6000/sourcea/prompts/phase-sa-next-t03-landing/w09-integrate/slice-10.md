# sa-next-0290 — SourceA next plan
...
**Legacy upgrade:** UP-0290 (CU · Chat Unify machines)
...
Landing & web · Integrate · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0290`
