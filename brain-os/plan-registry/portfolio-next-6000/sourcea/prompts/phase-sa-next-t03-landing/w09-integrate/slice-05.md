# sa-next-0285 — SourceA next plan
...
**Legacy upgrade:** UP-0285 (CU · Chat Unify machines)
...
Landing & web · Integrate · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0285`
