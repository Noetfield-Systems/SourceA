# sa-next-0287 — SourceA next plan
...
**Legacy upgrade:** UP-0287 (CU · Chat Unify machines)
...
**Founder loop gate** — Chat Unify machines (CU).

Landing & web · Integrate · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0287`
