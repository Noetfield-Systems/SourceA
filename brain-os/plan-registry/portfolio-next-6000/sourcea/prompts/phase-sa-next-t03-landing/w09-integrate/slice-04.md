# sa-next-0284 — SourceA next plan
...
**Legacy upgrade:** UP-0284 (CU · Chat Unify machines)
...
**ORD loop latency** — Chat Unify machines (CU).

Landing & web · Integrate · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0284`
