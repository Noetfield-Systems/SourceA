# sa-next-0286 — SourceA next plan
...
**Legacy upgrade:** UP-0286 (CU · Chat Unify machines)
...
Landing & web · Integrate · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0286`
