# sa-next-0281 — SourceA next plan
...
**Legacy upgrade:** UP-0281 (CU · Chat Unify machines)
...
Landing & web · Integrate · slice 1/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0281`
