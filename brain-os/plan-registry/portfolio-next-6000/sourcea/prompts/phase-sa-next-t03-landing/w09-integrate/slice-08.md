# sa-next-0288 — SourceA next plan
...
**Legacy upgrade:** UP-0288 (CU · Chat Unify machines)
...
Landing & web · Integrate · slice 8/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0288`
