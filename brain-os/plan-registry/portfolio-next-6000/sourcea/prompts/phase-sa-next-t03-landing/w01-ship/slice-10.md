...
**Compliance mapping row** — Proof & Proof Pack (PRF).

Landing & web · Ship · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0210`
