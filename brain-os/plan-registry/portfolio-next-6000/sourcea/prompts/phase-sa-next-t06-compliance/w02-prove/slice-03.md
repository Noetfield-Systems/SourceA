# sa-next-0513 — SourceA next plan
...
**Legacy upgrade:** UP-0513 (ENT · Enterprise & compliance)
...
MSB & compliance · Prove · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0513`
