# sa-next-0517 — SourceA next plan
...
**Legacy upgrade:** UP-0517 (ENT · Enterprise & compliance)
...
**Key rotation policy** — Enterprise & compliance (ENT).

MSB & compliance · Prove · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0517`
