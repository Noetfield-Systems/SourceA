# sa-next-0529 — SourceA next plan
...
**Legacy upgrade:** UP-0529 (ENT · Enterprise & compliance)
...
MSB & compliance · Sell · slice 9/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0529`
