# sa-next-0528 — SourceA next plan
...
**Legacy upgrade:** UP-0528 (ENT · Enterprise & compliance)
...
MSB & compliance · Sell · slice 8/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0528`
