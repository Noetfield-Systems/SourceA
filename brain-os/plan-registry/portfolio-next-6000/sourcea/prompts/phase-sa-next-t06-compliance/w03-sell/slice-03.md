# sa-next-0523 — SourceA next plan
...
**Legacy upgrade:** UP-0523 (ENT · Enterprise & compliance)
...
MSB & compliance · Sell · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0523`
