# sa-next-0522 — SourceA next plan
...
**Legacy upgrade:** UP-0522 (ENT · Enterprise & compliance)
...
MSB & compliance · Sell · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0522`
