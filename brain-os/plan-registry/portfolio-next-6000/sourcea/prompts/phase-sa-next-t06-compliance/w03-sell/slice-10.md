# sa-next-0530 — SourceA next plan
...
**Legacy upgrade:** UP-0530 (ENT · Enterprise & compliance)
...
MSB & compliance · Sell · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0530`
