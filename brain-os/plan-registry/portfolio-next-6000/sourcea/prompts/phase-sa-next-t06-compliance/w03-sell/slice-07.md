# sa-next-0527 — SourceA next plan
...
**Legacy upgrade:** UP-0527 (ENT · Enterprise & compliance)
...
MSB & compliance · Sell · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0527`
