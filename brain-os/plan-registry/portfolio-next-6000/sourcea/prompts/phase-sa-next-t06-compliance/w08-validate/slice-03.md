# sa-next-0573 — SourceA next plan
...
**Legacy upgrade:** UP-0573 (SAS · SaaS & platform)
...
MSB & compliance · Validate · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0573`
