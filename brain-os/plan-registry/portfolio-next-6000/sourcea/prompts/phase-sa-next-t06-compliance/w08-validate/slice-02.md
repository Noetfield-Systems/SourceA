# sa-next-0572 — SourceA next plan
...
**Legacy upgrade:** UP-0572 (SAS · SaaS & platform)
...
MSB & compliance · Validate · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0572`
