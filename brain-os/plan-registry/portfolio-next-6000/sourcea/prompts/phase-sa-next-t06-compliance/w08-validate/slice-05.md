# sa-next-0575 — SourceA next plan
...
**Legacy upgrade:** UP-0575 (SAS · SaaS & platform)
...
MSB & compliance · Validate · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0575`
