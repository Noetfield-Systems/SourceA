# sa-next-0580 — SourceA next plan
...
**Legacy upgrade:** UP-0580 (SAS · SaaS & platform)
...
MSB & compliance · Validate · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0580`
