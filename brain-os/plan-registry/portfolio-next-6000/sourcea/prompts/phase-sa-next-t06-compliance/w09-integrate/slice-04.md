# sa-next-0584 — SourceA next plan
...
**Legacy upgrade:** UP-0584 (SAS · SaaS & platform)
...
**API keys portal** — SaaS & platform (SAS).

MSB & compliance · Integrate · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0584`
