# sa-next-0590 — SourceA next plan
...
**Legacy upgrade:** UP-0590 (SAS · SaaS & platform)
...
MSB & compliance · Integrate · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0590`
