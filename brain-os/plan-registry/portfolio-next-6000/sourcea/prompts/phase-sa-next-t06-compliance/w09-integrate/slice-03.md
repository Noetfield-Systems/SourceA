# sa-next-0583 — SourceA next plan
...
**Legacy upgrade:** UP-0583 (SAS · SaaS & platform)
...
MSB & compliance · Integrate · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0583`
