# sa-next-0585 — SourceA next plan
...
**Legacy upgrade:** UP-0585 (SAS · SaaS & platform)
...
MSB & compliance · Integrate · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0585`
