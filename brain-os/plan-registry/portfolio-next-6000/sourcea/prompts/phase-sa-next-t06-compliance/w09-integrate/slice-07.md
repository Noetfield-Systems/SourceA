# sa-next-0587 — SourceA next plan
...
**Legacy upgrade:** UP-0587 (SAS · SaaS & platform)
...
**Webhook subscriptions** — SaaS & platform (SAS).

MSB & compliance · Integrate · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0587`
