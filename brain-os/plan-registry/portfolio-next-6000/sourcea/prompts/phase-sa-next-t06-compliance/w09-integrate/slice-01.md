# sa-next-0581 — SourceA next plan
...
**Legacy upgrade:** UP-0581 (SAS · SaaS & platform)
...
**License machine SKU** — SaaS & platform (SAS).

MSB & compliance · Integrate · slice 1/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0581`
