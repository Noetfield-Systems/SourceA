# sa-next-0568 — SourceA next plan
...
**Legacy upgrade:** UP-0568 (SAS · SaaS & platform)
...
MSB & compliance · Document · slice 8/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0568`
