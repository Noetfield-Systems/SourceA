# sa-next-0567 — SourceA next plan
...
**Legacy upgrade:** UP-0567 (SAS · SaaS & platform)
...
MSB & compliance · Document · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0567`
