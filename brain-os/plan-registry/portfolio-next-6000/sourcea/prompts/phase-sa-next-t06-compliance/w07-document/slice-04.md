# sa-next-0564 — SourceA next plan
...
**Legacy upgrade:** UP-0564 (SAS · SaaS & platform)
...
MSB & compliance · Document · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0564`
