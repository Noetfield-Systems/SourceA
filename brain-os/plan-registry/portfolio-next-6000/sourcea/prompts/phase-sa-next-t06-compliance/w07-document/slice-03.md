# sa-next-0563 — SourceA next plan
...
**Legacy upgrade:** UP-0563 (SAS · SaaS & platform)
...
**Team seats RBAC** — SaaS & platform (SAS).

MSB & compliance · Document · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0563`
