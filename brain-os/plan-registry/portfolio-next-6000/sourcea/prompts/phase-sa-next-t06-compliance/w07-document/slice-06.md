# sa-next-0566 — SourceA next plan
...
**Legacy upgrade:** UP-0566 (SAS · SaaS & platform)
...
MSB & compliance · Document · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0566`
