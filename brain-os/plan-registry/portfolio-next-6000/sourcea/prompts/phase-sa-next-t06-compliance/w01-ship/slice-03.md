# sa-next-0503 — SourceA next plan
...
**Legacy upgrade:** UP-0503 (ENT · Enterprise & compliance)
...
MSB & compliance · Ship · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0503`
