# sa-next-0505 — SourceA next plan
...
**Legacy upgrade:** UP-0505 (ENT · Enterprise & compliance)
...
MSB & compliance · Ship · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0505`
