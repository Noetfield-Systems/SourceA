# sa-next-0501 — SourceA next plan
...
**Legacy upgrade:** UP-0501 (ENT · Enterprise & compliance)
...
**Vendor security pack** — Enterprise & compliance (ENT).

MSB & compliance · Ship · slice 1/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0501`
