# sa-next-0506 — SourceA next plan
...
**Legacy upgrade:** UP-0506 (ENT · Enterprise & compliance)
...
MSB & compliance · Ship · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0506`
