# sa-next-0508 — SourceA next plan
...
**Legacy upgrade:** UP-0508 (ENT · Enterprise & compliance)
...
MSB & compliance · Ship · slice 8/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0508`
