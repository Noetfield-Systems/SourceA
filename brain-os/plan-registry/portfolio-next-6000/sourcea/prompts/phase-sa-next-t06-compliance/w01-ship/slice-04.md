# sa-next-0504 — SourceA next plan
...
**Legacy upgrade:** UP-0504 (ENT · Enterprise & compliance)
...
MSB & compliance · Ship · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0504`
