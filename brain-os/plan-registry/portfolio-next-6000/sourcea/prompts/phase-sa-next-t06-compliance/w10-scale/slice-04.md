# sa-next-0594 — SourceA next plan
...
**Legacy upgrade:** UP-0594 (SAS · SaaS & platform)
...
MSB & compliance · Scale · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0594`
