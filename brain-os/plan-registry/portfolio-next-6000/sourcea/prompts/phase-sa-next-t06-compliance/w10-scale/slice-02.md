# sa-next-0592 — SourceA next plan
...
**Legacy upgrade:** UP-0592 (SAS · SaaS & platform)
...
**Rate limit tiers** — SaaS & platform (SAS).

MSB & compliance · Scale · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0592`
