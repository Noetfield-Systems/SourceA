# sa-next-0593 — SourceA next plan
...
**Legacy upgrade:** UP-0593 (SAS · SaaS & platform)
...
MSB & compliance · Scale · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0593`
