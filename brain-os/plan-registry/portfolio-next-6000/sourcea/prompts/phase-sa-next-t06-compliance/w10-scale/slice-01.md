# sa-next-0591 — SourceA next plan
...
**Legacy upgrade:** UP-0591 (SAS · SaaS & platform)
...
MSB & compliance · Scale · slice 1/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0591`
