# sa-next-0547 — SourceA next plan
...
**Legacy upgrade:** UP-0547 (ENT · Enterprise & compliance)
...
MSB & compliance · Operate · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0547`
