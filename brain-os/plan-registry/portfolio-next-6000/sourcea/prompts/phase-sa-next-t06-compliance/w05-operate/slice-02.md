# sa-next-0542 — SourceA next plan
...
**Legacy upgrade:** UP-0542 (ENT · Enterprise & compliance)
...
MSB & compliance · Operate · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0542`
