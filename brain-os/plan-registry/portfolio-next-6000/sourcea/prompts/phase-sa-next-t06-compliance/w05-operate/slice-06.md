# sa-next-0546 — SourceA next plan
...
**Legacy upgrade:** UP-0546 (ENT · Enterprise & compliance)
...
**Dedicated tenant** — Enterprise & compliance (ENT).

MSB & compliance · Operate · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0546`
