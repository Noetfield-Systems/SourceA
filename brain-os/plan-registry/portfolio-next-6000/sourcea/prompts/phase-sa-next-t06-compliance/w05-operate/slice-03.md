# sa-next-0543 — SourceA next plan
...
**Legacy upgrade:** UP-0543 (ENT · Enterprise & compliance)
...
MSB & compliance · Operate · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0543`
