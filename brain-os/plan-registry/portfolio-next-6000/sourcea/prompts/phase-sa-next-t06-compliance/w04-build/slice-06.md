# sa-next-0536 — SourceA next plan
...
**Legacy upgrade:** UP-0536 (ENT · Enterprise & compliance)
...
**Control-to-receipt bind** — Enterprise & compliance (ENT).

MSB & compliance · Build · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0536`
