# sa-next-0531 — SourceA next plan
...
**Legacy upgrade:** UP-0531 (ENT · Enterprise & compliance)
...
MSB & compliance · Build · slice 1/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0531`
