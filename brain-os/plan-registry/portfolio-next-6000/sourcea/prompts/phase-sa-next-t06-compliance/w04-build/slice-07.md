# sa-next-0537 — SourceA next plan
...
**Legacy upgrade:** UP-0537 (ENT · Enterprise & compliance)
...
MSB & compliance · Build · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0537`
