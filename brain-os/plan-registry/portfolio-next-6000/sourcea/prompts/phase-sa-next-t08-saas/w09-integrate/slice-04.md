# sa-next-0784 — SourceA next plan
...
**Legacy upgrade:** UP-0784 (MED · Media & commercial factory)
...
**Tier A/B/C matrix** — Media & commercial factory (MED).

Agentic SaaS · Integrate · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0784`
