# sa-next-0096 — SourceA next plan
...
**Legacy upgrade:** UP-0096 (WEB · Storefront & site)
...
**Boot-proof inject** — Storefront & site (WEB).

Revenue & outreach · Scale · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0096`
