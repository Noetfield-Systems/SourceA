# sa-next-0094 — SourceA next plan

**Version:** 1 · **Tier:** T1 · **Phase:** NEXT
**Theme:** t01-revenue · Revenue & outreach
**Workstream:** w10-scale · Scale
**Slice:** 4/10 · **Receipt gate:** design_partner
**Legacy upgrade:** UP-0094 (WEB · Storefront & site)
...
Revenue & outreach · Scale · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0094`
