# sa-next-0095 — SourceA next plan
...
**Legacy upgrade:** UP-0095 (WEB · Storefront & site)
...
**Status page live wire** — Storefront & site (WEB).

Revenue & outreach · Scale · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0095`
