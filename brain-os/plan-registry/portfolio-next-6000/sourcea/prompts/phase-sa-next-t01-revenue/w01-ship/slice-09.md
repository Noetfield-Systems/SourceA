# sa-next-0009 — SourceA next plan
...
**Legacy upgrade:** UP-0009 (REV · Revenue & GTM)
...
**Design partner intake** — Revenue & GTM (REV).

Revenue & outreach · Ship · slice 9/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0009`
