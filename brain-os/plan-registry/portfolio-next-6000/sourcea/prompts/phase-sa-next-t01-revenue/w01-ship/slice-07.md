# sa-next-0007 — SourceA next plan
...
**Legacy upgrade:** UP-0007 (REV · Revenue & GTM)
...
Revenue & outreach · Ship · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0007`
