# sa-next-0010 — SourceA next plan
...
**Legacy upgrade:** UP-0010 (REV · Revenue & GTM)
...
**Retainer weekly export** — Revenue & GTM (REV).

Revenue & outreach · Ship · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0010`
