# sa-next-0003 — SourceA next plan
...
**Legacy upgrade:** UP-0003 (REV · Revenue & GTM)
...
Revenue & outreach · Ship · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0003`
