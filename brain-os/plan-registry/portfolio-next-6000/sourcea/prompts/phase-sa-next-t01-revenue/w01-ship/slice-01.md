# sa-next-0001 — SourceA next plan
...
**Legacy upgrade:** UP-0001 (REV · Revenue & GTM)
...
**Close T1 paying client** — Revenue & GTM (REV).

Revenue & outreach · Ship · slice 1/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0001`
