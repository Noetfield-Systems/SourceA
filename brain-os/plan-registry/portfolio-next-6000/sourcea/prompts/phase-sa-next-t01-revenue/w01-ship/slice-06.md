# sa-next-0006 — SourceA next plan
...
**Legacy upgrade:** UP-0006 (REV · Revenue & GTM)
...
Revenue & outreach · Ship · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0006`
