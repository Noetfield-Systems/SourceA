# sa-next-0004 — SourceA next plan
...
**Legacy upgrade:** UP-0004 (REV · Revenue & GTM)
...
**Seal client Proof Pack** — Revenue & GTM (REV).

Revenue & outreach · Ship · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0004`
