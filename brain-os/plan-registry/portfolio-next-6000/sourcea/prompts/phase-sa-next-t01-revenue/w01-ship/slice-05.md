# sa-next-0005 — SourceA next plan
...
**Legacy upgrade:** UP-0005 (REV · Revenue & GTM)
...
Revenue & outreach · Ship · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0005`
