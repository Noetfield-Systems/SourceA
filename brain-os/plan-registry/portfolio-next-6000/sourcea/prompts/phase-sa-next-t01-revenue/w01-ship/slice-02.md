# sa-next-0002 — SourceA next plan
...
**Legacy upgrade:** UP-0002 (REV · Revenue & GTM)
...
Revenue & outreach · Ship · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0002`
