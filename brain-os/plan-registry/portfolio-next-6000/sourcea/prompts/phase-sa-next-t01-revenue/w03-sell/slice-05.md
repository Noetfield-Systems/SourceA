# sa-next-0025 — SourceA next plan
...
**Legacy upgrade:** UP-0025 (REV · Revenue & GTM)
...
**Outreach loop receipt** — Revenue & GTM (REV).

Revenue & outreach · Sell · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0025`
