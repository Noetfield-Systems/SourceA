# sa-next-0027 — SourceA next plan
...
**Legacy upgrade:** UP-0027 (REV · Revenue & GTM)
...
Revenue & outreach · Sell · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0027`
