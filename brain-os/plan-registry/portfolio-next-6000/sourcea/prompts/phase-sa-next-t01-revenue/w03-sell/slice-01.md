# sa-next-0021 — SourceA next plan
...
**Legacy upgrade:** UP-0021 (REV · Revenue & GTM)
...
Revenue & outreach · Sell · slice 1/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0021`
