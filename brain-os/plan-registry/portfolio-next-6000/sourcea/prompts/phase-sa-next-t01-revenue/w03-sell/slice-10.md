# sa-next-0030 — SourceA next plan
...
**Legacy upgrade:** UP-0030 (REV · Revenue & GTM)
...
**Hybrid per-outcome pricing** — Revenue & GTM (REV).

Revenue & outreach · Sell · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0030`
