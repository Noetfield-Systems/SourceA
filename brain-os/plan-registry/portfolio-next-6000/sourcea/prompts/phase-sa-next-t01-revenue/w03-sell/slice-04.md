# sa-next-0024 — SourceA next plan
...
**Legacy upgrade:** UP-0024 (REV · Revenue & GTM)
...
Revenue & outreach · Sell · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0024`
