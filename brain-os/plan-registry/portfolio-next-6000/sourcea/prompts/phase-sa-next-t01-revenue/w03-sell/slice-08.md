# sa-next-0028 — SourceA next plan
...
**Legacy upgrade:** UP-0028 (REV · Revenue & GTM)
...
Revenue & outreach · Sell · slice 8/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0028`
