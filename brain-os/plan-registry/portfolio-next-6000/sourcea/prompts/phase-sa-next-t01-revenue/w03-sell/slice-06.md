# sa-next-0026 — SourceA next plan
...
**Legacy upgrade:** UP-0026 (REV · Revenue & GTM)
...
Revenue & outreach · Sell · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0026`
