# sa-next-0023 — SourceA next plan
...
**Legacy upgrade:** UP-0023 (REV · Revenue & GTM)
...
Revenue & outreach · Sell · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0023`
