# sa-next-0078 — SourceA next plan
...
**Legacy upgrade:** UP-0078 (REV · Revenue & GTM)
...
Revenue & outreach · Validate · slice 8/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0078`
