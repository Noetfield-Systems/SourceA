# sa-next-0076 — SourceA next plan
...
**Legacy upgrade:** UP-0076 (REV · Revenue & GTM)
...
Revenue & outreach · Validate · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0076`
