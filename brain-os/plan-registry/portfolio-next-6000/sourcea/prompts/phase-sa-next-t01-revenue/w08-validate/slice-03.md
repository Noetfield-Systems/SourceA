# sa-next-0073 — SourceA next plan
...
**Legacy upgrade:** UP-0073 (REV · Revenue & GTM)
...
Revenue & outreach · Validate · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0073`
