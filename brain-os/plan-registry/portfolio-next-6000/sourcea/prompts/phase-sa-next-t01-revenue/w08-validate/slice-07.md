# sa-next-0077 — SourceA next plan
...
**Legacy upgrade:** UP-0077 (REV · Revenue & GTM)
...
**Vertical wedge video-ad** — Revenue & GTM (REV).

Revenue & outreach · Validate · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0077`
