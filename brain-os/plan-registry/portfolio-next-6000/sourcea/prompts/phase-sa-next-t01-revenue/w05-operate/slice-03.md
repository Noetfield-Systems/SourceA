# sa-next-0043 — SourceA next plan
...
**Legacy upgrade:** UP-0043 (REV · Revenue & GTM)
...
Revenue & outreach · Operate · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0043`
