# sa-next-0042 — SourceA next plan
...
**Legacy upgrade:** UP-0042 (REV · Revenue & GTM)
...
Revenue & outreach · Operate · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0042`
