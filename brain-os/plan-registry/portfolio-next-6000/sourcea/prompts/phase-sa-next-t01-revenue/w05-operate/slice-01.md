# sa-next-0041 — SourceA next plan
...
**Legacy upgrade:** UP-0041 (REV · Revenue & GTM)
...
Revenue & outreach · Operate · slice 1/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0041`
