# sa-next-0047 — SourceA next plan
...
**Legacy upgrade:** UP-0047 (REV · Revenue & GTM)
...
**Meridian pipeline** — Revenue & GTM (REV).

Revenue & outreach · Operate · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0047`
