# sa-next-0050 — SourceA next plan
...
**Legacy upgrade:** UP-0050 (REV · Revenue & GTM)
...
**Discovery call booking** — Revenue & GTM (REV).

Revenue & outreach · Operate · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0050`
