# sa-next-0046 — SourceA next plan
...
**Legacy upgrade:** UP-0046 (REV · Revenue & GTM)
...
Revenue & outreach · Operate · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0046`
