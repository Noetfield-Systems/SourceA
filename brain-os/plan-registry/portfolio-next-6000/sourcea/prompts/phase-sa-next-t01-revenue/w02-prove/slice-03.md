# sa-next-0013 — SourceA next plan
...
**Legacy upgrade:** UP-0013 (REV · Revenue & GTM)
...
Revenue & outreach · Prove · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0013`
