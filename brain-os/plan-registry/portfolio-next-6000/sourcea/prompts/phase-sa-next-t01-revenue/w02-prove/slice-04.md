# sa-next-0014 — SourceA next plan
...
**Legacy upgrade:** UP-0014 (REV · Revenue & GTM)
...
Revenue & outreach · Prove · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0014`
