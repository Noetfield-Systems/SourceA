# sa-next-0012 — SourceA next plan
...
**Legacy upgrade:** UP-0012 (REV · Revenue & GTM)
...
Revenue & outreach · Prove · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0012`
