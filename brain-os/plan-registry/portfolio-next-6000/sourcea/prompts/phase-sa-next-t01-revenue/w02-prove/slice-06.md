# sa-next-0016 — SourceA next plan
...
**Legacy upgrade:** UP-0016 (REV · Revenue & GTM)
...
Revenue & outreach · Prove · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0016`
