# sa-next-0015 — SourceA next plan
...
**Legacy upgrade:** UP-0015 (REV · Revenue & GTM)
...
**Audit funnel CTA** — Revenue & GTM (REV).

Revenue & outreach · Prove · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0015`
