# sa-next-0020 — SourceA next plan
...
**Legacy upgrade:** UP-0020 (REV · Revenue & GTM)
...
**Agency screen-share script** — Revenue & GTM (REV).

Revenue & outreach · Prove · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0020`
