...
**Build funnel deposit flow** — Revenue & GTM (REV).

Revenue & outreach · Prove · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0017`
