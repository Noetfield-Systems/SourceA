# sa-next-0081 — SourceA next plan

**Version:** 1 · **Tier:** T0 · **Phase:** NEXT
**Theme:** t01-revenue · Revenue & outreach
**Workstream:** w09-integrate · Integrate
**Slice:** 1/10 · **Receipt gate:** revenue_outreach
**Legacy upgrade:** UP-0081 (WEB · Storefront & site)
...
Revenue & outreach · Integrate · slice 1/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0081`
