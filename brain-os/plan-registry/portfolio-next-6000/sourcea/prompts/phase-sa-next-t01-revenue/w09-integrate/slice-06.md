# sa-next-0086 — SourceA next plan
...
**Legacy upgrade:** UP-0086 (WEB · Storefront & site)
...
Revenue & outreach · Integrate · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0086`
