# sa-next-0083 — SourceA next plan
...
**Legacy upgrade:** UP-0083 (WEB · Storefront & site)
...
**Two-hub consolidation** — Storefront & site (WEB).

Revenue & outreach · Integrate · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0083`
