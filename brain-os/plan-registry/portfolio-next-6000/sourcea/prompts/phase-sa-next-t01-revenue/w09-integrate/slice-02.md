# sa-next-0082 — SourceA next plan
...
**Legacy upgrade:** UP-0082 (WEB · Storefront & site)
...
Revenue & outreach · Integrate · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0082`
