# sa-next-0087 — SourceA next plan

**Version:** 1 · **Tier:** T2 · **Phase:** NEXT
**Theme:** t01-revenue · Revenue & outreach
**Workstream:** w09-integrate · Integrate
**Slice:** 7/10 · **Receipt gate:** design_partner
**Legacy upgrade:** UP-0087 (WEB · Storefront & site)
...
Revenue & outreach · Integrate · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0087`
