# sa-next-0085 — SourceA next plan
...
**Legacy upgrade:** UP-0085 (WEB · Storefront & site)
...
Revenue & outreach · Integrate · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0085`
