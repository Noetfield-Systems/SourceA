# sa-next-0060 — SourceA next plan
...
**Legacy upgrade:** UP-0060 (REV · Revenue & GTM)
...
Revenue & outreach · Govern · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0060`
