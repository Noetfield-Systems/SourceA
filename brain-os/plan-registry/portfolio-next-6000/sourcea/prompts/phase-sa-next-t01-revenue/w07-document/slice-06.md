# sa-next-0066 — SourceA next plan
...
**Legacy upgrade:** UP-0066 (REV · Revenue & GTM)
...
Revenue & outreach · Document · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0066`
