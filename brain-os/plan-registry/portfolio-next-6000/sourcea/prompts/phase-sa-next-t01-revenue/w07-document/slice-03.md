# sa-next-0063 — SourceA next plan
...
**Legacy upgrade:** UP-0063 (REV · Revenue & GTM)
...
Revenue & outreach · Document · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0063`
