# sa-next-0061 — SourceA next plan
...
**Legacy upgrade:** UP-0061 (REV · Revenue & GTM)
...
**NRR tracking** — Revenue & GTM (REV).

Revenue & outreach · Document · slice 1/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0061`
