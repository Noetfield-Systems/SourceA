# sa-next-0069 — SourceA next plan
...
**Legacy upgrade:** UP-0069 (REV · Revenue & GTM)
...
**Procurement pack ship** — Revenue & GTM (REV).

Revenue & outreach · Document · slice 9/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0069`
