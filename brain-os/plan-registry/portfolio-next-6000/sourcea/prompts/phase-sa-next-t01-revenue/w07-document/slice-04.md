# sa-next-0064 — SourceA next plan
...
**Legacy upgrade:** UP-0064 (REV · Revenue & GTM)
...
**Churn receipt audit** — Revenue & GTM (REV).

Revenue & outreach · Document · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0064`
