# sa-next-0038 — SourceA next plan
...
**Legacy upgrade:** UP-0038 (REV · Revenue & GTM)
...
Revenue & outreach · Build · slice 8/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0038`
