# sa-next-0040 — SourceA next plan
...
**Legacy upgrade:** UP-0040 (REV · Revenue & GTM)
...
**Case study from paid run** — Revenue & GTM (REV).

Revenue & outreach · Build · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0040`
