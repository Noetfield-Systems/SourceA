# sa-next-0035 — SourceA next plan
...
**Legacy upgrade:** UP-0035 (REV · Revenue & GTM)
...
**SOW template disk** — Revenue & GTM (REV).

Revenue & outreach · Build · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0035`
