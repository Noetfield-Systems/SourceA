# sa-next-0032 — SourceA next plan
...
**Legacy upgrade:** UP-0032 (REV · Revenue & GTM)
...
Revenue & outreach · Build · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0032`
