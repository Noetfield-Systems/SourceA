# sa-next-0037 — SourceA next plan
...
**Legacy upgrade:** UP-0037 (REV · Revenue & GTM)
...
**Client redaction policy** — Revenue & GTM (REV).

Revenue & outreach · Build · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0037`
