# sa-next-0131 — SourceA next plan
...
**Legacy upgrade:** UP-0131 (WEB · Storefront & site)
...
**Chat Unify download CTA** — Storefront & site (WEB).

Proof & receipts · Build · slice 1/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0131`
