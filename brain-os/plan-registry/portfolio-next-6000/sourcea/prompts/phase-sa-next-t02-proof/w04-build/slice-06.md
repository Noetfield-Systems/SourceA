# sa-next-0136 — SourceA next plan
...
**Legacy upgrade:** UP-0136 (WEB · Storefront & site)
...
Proof & receipts · Build · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0136`
