# sa-next-0140 — SourceA next plan
...
**Legacy upgrade:** UP-0140 (WEB · Storefront & site)
...
**Recipe firewall manifest** — Storefront & site (WEB).

Proof & receipts · Build · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0140`
