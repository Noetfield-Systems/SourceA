# sa-next-0195 — SourceA next plan
...
**Legacy upgrade:** UP-0195 (PRF · Proof & Proof Pack)
...
Proof & receipts · Scale · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0195`
