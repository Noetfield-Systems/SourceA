# sa-next-0198 — SourceA next plan
...
**Legacy upgrade:** UP-0198 (PRF · Proof & Proof Pack)
...
Proof & receipts · Scale · slice 8/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0198`
