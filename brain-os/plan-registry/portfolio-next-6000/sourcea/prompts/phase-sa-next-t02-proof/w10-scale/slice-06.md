# sa-next-0196 — SourceA next plan
...
**Legacy upgrade:** UP-0196 (PRF · Proof & Proof Pack)
...
**Export HTML template** — Proof & Proof Pack (PRF).

Proof & receipts · Scale · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0196`
