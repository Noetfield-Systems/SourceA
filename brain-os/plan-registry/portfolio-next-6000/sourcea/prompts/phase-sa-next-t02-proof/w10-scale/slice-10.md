# sa-next-0200 — SourceA next plan
...
**Legacy upgrade:** UP-0200 (PRF · Proof & Proof Pack)
...
**Export PDF template** — Proof & Proof Pack (PRF).

Proof & receipts · Scale · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0200`
