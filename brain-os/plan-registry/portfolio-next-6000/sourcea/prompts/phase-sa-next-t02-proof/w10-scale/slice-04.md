# sa-next-0194 — SourceA next plan
...
**Legacy upgrade:** UP-0194 (PRF · Proof & Proof Pack)
...
Proof & receipts · Scale · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0194`
