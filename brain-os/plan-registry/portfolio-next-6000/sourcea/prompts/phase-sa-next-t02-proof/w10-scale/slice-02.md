# sa-next-0192 — SourceA next plan
...
**Legacy upgrade:** UP-0192 (PRF · Proof & Proof Pack)
...
Proof & receipts · Scale · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0192`
