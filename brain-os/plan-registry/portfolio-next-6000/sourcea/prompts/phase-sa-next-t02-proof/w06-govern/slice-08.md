# sa-next-0158 — SourceA next plan
...
**Legacy upgrade:** UP-0158 (PRF · Proof & Proof Pack)
...
Proof & receipts · Govern · slice 8/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0158`
