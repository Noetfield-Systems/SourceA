# sa-next-0157 — SourceA next plan
...
**Legacy upgrade:** UP-0157 (PRF · Proof & Proof Pack)
...
Proof & receipts · Govern · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0157`
