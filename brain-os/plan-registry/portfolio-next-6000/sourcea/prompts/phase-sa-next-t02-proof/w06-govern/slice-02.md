# sa-next-0152 — SourceA next plan
...
**Legacy upgrade:** UP-0152 (PRF · Proof & Proof Pack)
...
Proof & receipts · Govern · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0152`
