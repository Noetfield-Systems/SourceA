# sa-next-0113 — SourceA next plan
...
**Legacy upgrade:** UP-0113 (WEB · Storefront & site)
...
Proof & receipts · Prove · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0113`
