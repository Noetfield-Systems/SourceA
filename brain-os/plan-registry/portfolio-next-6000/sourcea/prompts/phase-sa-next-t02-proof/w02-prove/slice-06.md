# sa-next-0116 — SourceA next plan
...
**Legacy upgrade:** UP-0116 (WEB · Storefront & site)
...
**Pricing bands sync** — Storefront & site (WEB).

Proof & receipts · Prove · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0116`
