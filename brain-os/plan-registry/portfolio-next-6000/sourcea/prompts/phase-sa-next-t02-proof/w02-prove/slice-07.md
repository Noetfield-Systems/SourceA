# sa-next-0117 — SourceA next plan
...
**Legacy upgrade:** UP-0117 (WEB · Storefront & site)
...
**Security procurement strip** — Storefront & site (WEB).

Proof & receipts · Prove · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0117`
