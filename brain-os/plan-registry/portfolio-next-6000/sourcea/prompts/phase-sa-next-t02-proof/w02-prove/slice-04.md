# sa-next-0114 — SourceA next plan
...
**Legacy upgrade:** UP-0114 (WEB · Storefront & site)
...
**Compare matrix update** — Storefront & site (WEB).

Proof & receipts · Prove · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0114`
