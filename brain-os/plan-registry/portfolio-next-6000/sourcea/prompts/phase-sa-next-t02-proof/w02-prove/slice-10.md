# sa-next-0120 — SourceA next plan
...
**Legacy upgrade:** UP-0120 (WEB · Storefront & site)
...
**Sources citations page** — Storefront & site (WEB).

Proof & receipts · Prove · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0120`
