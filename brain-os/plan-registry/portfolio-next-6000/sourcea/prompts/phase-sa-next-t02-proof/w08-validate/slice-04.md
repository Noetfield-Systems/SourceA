# sa-next-0174 — SourceA next plan
...
**Legacy upgrade:** UP-0174 (PRF · Proof & Proof Pack)
...
Proof & receipts · Validate · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0174`
