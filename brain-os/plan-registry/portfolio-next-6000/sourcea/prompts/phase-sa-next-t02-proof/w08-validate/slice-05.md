# sa-next-0175 — SourceA next plan
...
**Legacy upgrade:** UP-0175 (PRF · Proof & Proof Pack)
...
Proof & receipts · Validate · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0175`
