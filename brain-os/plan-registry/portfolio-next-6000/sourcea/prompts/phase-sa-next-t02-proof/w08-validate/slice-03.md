# sa-next-0173 — SourceA next plan
...
**Legacy upgrade:** UP-0173 (PRF · Proof & Proof Pack)
...
**Weekly PDF export** — Proof & Proof Pack (PRF).

Proof & receipts · Validate · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0173`
