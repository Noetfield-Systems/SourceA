# sa-next-0171 — SourceA next plan
...
**Legacy upgrade:** UP-0171 (PRF · Proof & Proof Pack)
...
Proof & receipts · Validate · slice 1/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0171`
