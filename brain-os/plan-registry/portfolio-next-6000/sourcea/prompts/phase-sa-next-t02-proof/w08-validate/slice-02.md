# sa-next-0172 — SourceA next plan
...
**Legacy upgrade:** UP-0172 (PRF · Proof & Proof Pack)
...
Proof & receipts · Validate · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0172`
