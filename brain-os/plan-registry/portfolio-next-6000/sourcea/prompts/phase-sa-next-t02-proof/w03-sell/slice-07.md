# sa-next-0127 — SourceA next plan
...
**Legacy upgrade:** UP-0127 (WEB · Storefront & site)
...
Proof & receipts · Sell · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0127`
