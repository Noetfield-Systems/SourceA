# sa-next-0125 — SourceA next plan
...
**Legacy upgrade:** UP-0125 (WEB · Storefront & site)
...
Proof & receipts · Sell · slice 5/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0125`
