# sa-next-0129 — SourceA next plan
...
**Legacy upgrade:** UP-0129 (WEB · Storefront & site)
...
**Sandbox demo upgrade** — Storefront & site (WEB).

Proof & receipts · Sell · slice 9/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0129`
