# sa-next-0104 — SourceA next plan
...
**Legacy upgrade:** UP-0104 (WEB · Storefront & site)
...
Proof & receipts · Ship · slice 4/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0104`
