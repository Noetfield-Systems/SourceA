# sa-next-0107 — SourceA next plan
...
**Legacy upgrade:** UP-0107 (WEB · Storefront & site)
...
Proof & receipts · Ship · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0107`
