# sa-next-0102 — SourceA next plan
...
**Legacy upgrade:** UP-0102 (WEB · Storefront & site)
...
**W1 hero embed** — Storefront & site (WEB).

Proof & receipts · Ship · slice 2/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0102`
