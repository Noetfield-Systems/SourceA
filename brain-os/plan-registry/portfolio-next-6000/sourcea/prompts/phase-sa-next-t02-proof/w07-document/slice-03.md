# sa-next-0163 — SourceA next plan
...
**Legacy upgrade:** UP-0163 (PRF · Proof & Proof Pack)
...
**6-month retention** — Proof & Proof Pack (PRF).

Proof & receipts · Document · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0163`
