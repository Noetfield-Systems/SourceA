# sa-next-0166 — SourceA next plan
...
**Legacy upgrade:** UP-0166 (PRF · Proof & Proof Pack)
...
Proof & receipts · Document · slice 6/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0166`
