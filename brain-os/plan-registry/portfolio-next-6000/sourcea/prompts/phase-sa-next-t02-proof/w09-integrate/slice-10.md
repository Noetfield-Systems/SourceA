# sa-next-0190 — SourceA next plan
...
**Legacy upgrade:** UP-0190 (PRF · Proof & Proof Pack)
...
Proof & receipts · Integrate · slice 10/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0190`
