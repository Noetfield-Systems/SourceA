# sa-next-0187 — SourceA next plan
...
**Legacy upgrade:** UP-0187 (PRF · Proof & Proof Pack)
...
Proof & receipts · Integrate · slice 7/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0187`
