# sa-next-0143 — SourceA next plan
...
**Legacy upgrade:** UP-0143 (WEB · Storefront & site)
...
Proof & receipts · Operate · slice 3/10.
...
1. `status: done` in REGISTRY.json for `sa-next-0143`
