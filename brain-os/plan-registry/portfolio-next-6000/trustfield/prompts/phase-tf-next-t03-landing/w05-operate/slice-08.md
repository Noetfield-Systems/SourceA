...
TrustField · Landing & web · Operate · slice 8/10 — P3 — research · defer · compare-only. Bounded path only. Receipt logged before done. Parent: FINTRAC MSB programs — payment execution only. Priority doc: `prompts/future-plans-1000.json`.
