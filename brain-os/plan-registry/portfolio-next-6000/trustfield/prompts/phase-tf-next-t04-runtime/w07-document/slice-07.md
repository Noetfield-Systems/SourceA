...
TrustField · Factory runtime · Document · slice 7/10 — P2 — harden · validate · document. Bounded path only. Receipt logged before done. Parent: FINTRAC MSB programs — payment execution only. Priority doc: `prompts/future-plans-1000.json`.
