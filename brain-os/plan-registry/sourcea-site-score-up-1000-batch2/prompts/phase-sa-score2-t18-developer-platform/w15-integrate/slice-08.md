# sa-score2-0748 — Integrate webhook POST /api/site/webhook/v1 for partner events

**Saved at:** 2026-06-25T09:28:52Z
**Batch:** 2 · **Grade:** A · **Tier:** T2 · **Phase:** MOONSHOT
**Score dimension:** Developer & partner API (40→90)
**Market analog:** Stripe API / Twilio webhooks
...
**Deliverable:** Integrate webhook POST /api/site/webhook/v1 for partner events
