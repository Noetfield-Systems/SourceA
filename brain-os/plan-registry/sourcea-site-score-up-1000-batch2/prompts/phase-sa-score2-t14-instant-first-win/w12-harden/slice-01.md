# sa-score2-0311 — Harden interactive proof console on hero with real KV stat tick
...
**Deliverable:** Harden interactive proof console on hero with real KV stat tick
