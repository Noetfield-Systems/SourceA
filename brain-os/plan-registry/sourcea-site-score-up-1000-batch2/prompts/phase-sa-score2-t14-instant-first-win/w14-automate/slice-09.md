# sa-score2-0339 — Automate interactive proof console on hero with real KV stat tick
...
**Deliverable:** Automate interactive proof console on hero with real KV stat tick
