# sa-score2-0375 — Scale interactive proof console on hero with real KV stat tick
...
**Deliverable:** Scale interactive proof console on hero with real KV stat tick
