# sa-score2-0304 — Architect Forge Terminal pre-filled prompt from segment choice
...
**Deliverable:** Architect Forge Terminal pre-filled prompt from segment choice
