# sa-score2-0302 — Architect interactive proof console on hero with real KV stat tick
...
**Deliverable:** Architect interactive proof console on hero with real KV stat tick
