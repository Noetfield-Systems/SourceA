# sa-score2-0384 — Monetize interactive proof console on hero with real KV stat tick
...
**Deliverable:** Monetize interactive proof console on hero with real KV stat tick
