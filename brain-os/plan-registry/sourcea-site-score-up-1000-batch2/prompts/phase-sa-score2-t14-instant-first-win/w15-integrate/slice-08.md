# sa-score2-0348 — Integrate interactive proof console on hero with real KV stat tick
...
**Deliverable:** Integrate interactive proof console on hero with real KV stat tick
