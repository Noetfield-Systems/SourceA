# sa-score2-0350 — Integrate Forge Terminal pre-filled prompt from segment choice
...
**Deliverable:** Integrate Forge Terminal pre-filled prompt from segment choice
