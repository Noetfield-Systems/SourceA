# sa-score2-0393 — Defend interactive proof console on hero with real KV stat tick
...
**Deliverable:** Defend interactive proof console on hero with real KV stat tick
