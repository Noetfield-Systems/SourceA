# sa-score2-0366 — Comply interactive proof console on hero with real KV stat tick
...
**Deliverable:** Comply interactive proof console on hero with real KV stat tick
