# sa-score2-0357 — Optimize interactive proof console on hero with real KV stat tick
...
**Deliverable:** Optimize interactive proof console on hero with real KV stat tick
