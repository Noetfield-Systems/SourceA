# sa-score2-0330 — Measure interactive proof console on hero with real KV stat tick
...
**Deliverable:** Measure interactive proof console on hero with real KV stat tick
