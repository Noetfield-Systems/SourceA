# sa-score2-0329 — Measure 60-second stranger path: land → segment → live receipt open
...
**Deliverable:** Measure 60-second stranger path: land → segment → live receipt open
