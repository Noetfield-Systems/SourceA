# sa-score2-0474 — Scale unique title/description per segment landing via build inject
...
**Deliverable:** Scale unique title/description per segment landing via build inject
