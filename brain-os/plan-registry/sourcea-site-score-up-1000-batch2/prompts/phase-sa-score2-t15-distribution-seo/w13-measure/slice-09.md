# sa-score2-0429 — Measure unique title/description per segment landing via build inject
...
**Deliverable:** Measure unique title/description per segment landing via build inject
