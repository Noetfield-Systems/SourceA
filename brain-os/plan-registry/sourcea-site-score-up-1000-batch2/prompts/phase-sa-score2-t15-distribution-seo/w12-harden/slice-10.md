# sa-score2-0420 — Harden unique title/description per segment landing via build inject
...
**Deliverable:** Harden unique title/description per segment landing via build inject
