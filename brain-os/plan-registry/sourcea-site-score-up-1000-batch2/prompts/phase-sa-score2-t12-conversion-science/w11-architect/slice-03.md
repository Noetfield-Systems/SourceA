# sa-score2-0103 — Architect cohort table: first segment vs conversion to feedback
...
**Deliverable:** Architect cohort table: first segment vs conversion to feedback
