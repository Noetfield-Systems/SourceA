# sa-score2-0056 — Optimize Ed25519-signed proof receipt JSON with public /api/proof/verify/v1
...
**Workstream:** w16-optimize · Optimize
**Slice:** 6/10
...
**Deliverable:** Optimize Ed25519-signed proof receipt JSON with public /api/proof/verify/v1
