# sa-score2-0054 — Optimize public proof gallery with signature badges only for valid rows
...
**Deliverable:** Optimize public proof gallery with signature badges only for valid rows
