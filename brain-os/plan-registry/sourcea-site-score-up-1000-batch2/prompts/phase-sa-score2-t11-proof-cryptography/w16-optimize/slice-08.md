# sa-score2-0058 — Optimize immutable proof run ID in Cloudflare Durable Object ledger
...
**Deliverable:** Optimize immutable proof run ID in Cloudflare Durable Object ledger
