# sa-score2-0055 — Optimize compare receipt hash to on-chain anchor stub (Labs tier)
...
**Deliverable:** Optimize compare receipt hash to on-chain anchor stub (Labs tier)
