# sa-score2-0046 — Integrate compare receipt hash to on-chain anchor stub (Labs tier)
...
**Deliverable:** Integrate compare receipt hash to on-chain anchor stub (Labs tier)
