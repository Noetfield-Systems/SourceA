# sa-score2-0047 — Integrate Ed25519-signed proof receipt JSON with public /api/proof/verify/v1

**Saved at:** 2026-06-25T09:28:52Z
**Batch:** 2 · **Grade:** A · **Tier:** T2 · **Phase:** NOW
**Score dimension:** Proof integrity & cryptography (58→96)
**Market analog:** Sigstore / GitHub attestations
**Workstream:** w15-integrate · Integrate
**Slice:** 7/10
...
Grade-A P2 — harden ·  · document

**Deliverable:** Integrate Ed25519-signed proof receipt JSON with public /api/proof/verify/v1
