# sa-score2-0038 — Automate Ed25519-signed proof receipt JSON with public /api/proof/verify/v1
...
**Deliverable:** Automate Ed25519-signed proof receipt JSON with public /api/proof/verify/v1
