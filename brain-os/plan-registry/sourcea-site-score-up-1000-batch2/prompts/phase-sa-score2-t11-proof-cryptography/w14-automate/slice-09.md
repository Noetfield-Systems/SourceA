# sa-score2-0039 — Automate SHA-256 manifest for proof pack ZIP with on-page checksum display
...
**Deliverable:** Automate SHA-256 manifest for proof pack ZIP with on-page checksum display
