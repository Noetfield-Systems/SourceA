# sa-score2-0031 — Automate third-party verify page: paste receipt JSON → green/red verdict
...
**Deliverable:** Automate third-party verify page: paste receipt JSON → green/red verdict
