# sa-score2-0037 — Automate compare receipt hash to on-chain anchor stub (Labs tier)
...
**Deliverable:** Automate compare receipt hash to on-chain anchor stub (Labs tier)
