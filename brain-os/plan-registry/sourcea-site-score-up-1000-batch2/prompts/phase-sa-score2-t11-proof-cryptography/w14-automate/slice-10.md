# sa-score2-0040 — Automate immutable proof run ID in Cloudflare Durable Object ledger
...
**Deliverable:** Automate immutable proof run ID in Cloudflare Durable Object ledger
