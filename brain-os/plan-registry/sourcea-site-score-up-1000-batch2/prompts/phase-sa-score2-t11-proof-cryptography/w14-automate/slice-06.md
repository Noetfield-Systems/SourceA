# sa-score2-0036 — Automate public proof gallery with signature badges only for valid rows
...
**Deliverable:** Automate public proof gallery with signature badges only for valid rows
