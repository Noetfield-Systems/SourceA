# sa-score2-0065 — Comply Ed25519-signed proof receipt JSON with public /api/proof/verify/v1
...
**Deliverable:** Comply Ed25519-signed proof receipt JSON with public /api/proof/verify/v1
