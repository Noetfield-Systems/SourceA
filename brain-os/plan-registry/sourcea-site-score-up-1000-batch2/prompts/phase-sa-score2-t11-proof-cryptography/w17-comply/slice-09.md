# sa-score2-0069 — Comply receipt includes git commit hash + deploy URL + timestamp chain
...
**Deliverable:** Comply receipt includes git commit hash + deploy URL + timestamp chain
