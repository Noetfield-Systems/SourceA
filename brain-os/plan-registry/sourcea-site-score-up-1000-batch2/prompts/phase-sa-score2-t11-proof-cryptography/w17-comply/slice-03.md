# sa-score2-0063 — Comply public proof gallery with signature badges only for valid rows
...
**Deliverable:** Comply public proof gallery with signature badges only for valid rows
