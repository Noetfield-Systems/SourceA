# sa-score2-0074 — Scale Ed25519-signed proof receipt JSON with public /api/proof/verify/v1
...
**Deliverable:** Scale Ed25519-signed proof receipt JSON with public /api/proof/verify/v1
