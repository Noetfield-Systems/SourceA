# sa-score2-0072 — Scale public proof gallery with signature badges only for valid rows
...
**Deliverable:** Scale public proof gallery with signature badges only for valid rows
