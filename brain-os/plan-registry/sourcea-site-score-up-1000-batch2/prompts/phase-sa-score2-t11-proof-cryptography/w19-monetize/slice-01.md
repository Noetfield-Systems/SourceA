# sa-score2-0081 — Monetize public proof gallery with signature badges only for valid rows
...
**Deliverable:** Monetize public proof gallery with signature badges only for valid rows
