# sa-score2-0082 — Monetize compare receipt hash to on-chain anchor stub (Labs tier)
...
**Deliverable:** Monetize compare receipt hash to on-chain anchor stub (Labs tier)
