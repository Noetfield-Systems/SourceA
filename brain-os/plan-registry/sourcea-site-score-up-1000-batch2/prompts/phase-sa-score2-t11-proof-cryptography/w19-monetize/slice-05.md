# sa-score2-0085 — Monetize immutable proof run ID in Cloudflare Durable Object ledger
...
**Deliverable:** Monetize immutable proof run ID in Cloudflare Durable Object ledger
