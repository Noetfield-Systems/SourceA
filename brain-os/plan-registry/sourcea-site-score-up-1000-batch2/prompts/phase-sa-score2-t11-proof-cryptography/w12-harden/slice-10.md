# sa-score2-0020 — Harden Ed25519-signed proof receipt JSON with public /api/proof/verify/v1
...
**Deliverable:** Harden Ed25519-signed proof receipt JSON with public /api/proof/verify/v1
