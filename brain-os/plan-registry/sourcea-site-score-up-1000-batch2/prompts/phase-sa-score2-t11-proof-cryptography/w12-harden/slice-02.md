# sa-score2-0012 — Harden immutable proof run ID in Cloudflare Durable Object ledger
...
**Deliverable:** Harden immutable proof run ID in Cloudflare Durable Object ledger
