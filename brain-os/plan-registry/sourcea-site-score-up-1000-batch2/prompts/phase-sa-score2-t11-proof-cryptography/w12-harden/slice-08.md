# sa-score2-0018 — Harden public proof gallery with signature badges only for valid rows
...
**Deliverable:** Harden public proof gallery with signature badges only for valid rows
