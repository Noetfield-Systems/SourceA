# sa-score2-0023 — Measure receipt includes git commit hash + deploy URL + timestamp chain
...
**Deliverable:** Measure receipt includes git commit hash + deploy URL + timestamp chain
