# sa-score2-0029 — Measure Ed25519-signed proof receipt JSON with public /api/proof/verify/v1
...
**Deliverable:** Measure Ed25519-signed proof receipt JSON with public /api/proof/verify/v1
