# sa-score2-0022 — Measure third-party verify page: paste receipt JSON → green/red verdict
...
**Deliverable:** Measure third-party verify page: paste receipt JSON → green/red verdict
