# sa-score2-0021 — Measure immutable proof run ID in Cloudflare Durable Object ledger
...
**Deliverable:** Measure immutable proof run ID in Cloudflare Durable Object ledger
