# sa-score2-0027 — Measure public proof gallery with signature badges only for valid rows
...
**Workstream:** w13-measure · Measure
**Slice:** 7/10
...
**Deliverable:** Measure public proof gallery with signature badges only for valid rows
