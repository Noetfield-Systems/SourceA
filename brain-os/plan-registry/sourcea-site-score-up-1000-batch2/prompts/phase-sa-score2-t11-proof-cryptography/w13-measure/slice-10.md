# sa-score2-0030 — Measure SHA-256 manifest for proof pack ZIP with on-page checksum display
...
**Deliverable:** Measure SHA-256 manifest for proof pack ZIP with on-page checksum display
