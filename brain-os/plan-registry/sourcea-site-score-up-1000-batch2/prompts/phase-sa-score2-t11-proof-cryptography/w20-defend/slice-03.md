# sa-score2-0093 — Defend SHA-256 manifest for proof pack ZIP with on-page checksum display
...
**Deliverable:** Defend SHA-256 manifest for proof pack ZIP with on-page checksum display
