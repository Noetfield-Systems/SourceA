# sa-score2-0096 — Defend receipt includes git commit hash + deploy URL + timestamp chain
...
**Workstream:** w20-defend · Defend moat
**Slice:** 6/10
...
**Deliverable:** Defend receipt includes git commit hash + deploy URL + timestamp chain
