# sa-score2-0094 — Defend immutable proof run ID in Cloudflare Durable Object ledger
...
**Deliverable:** Defend immutable proof run ID in Cloudflare Durable Object ledger
