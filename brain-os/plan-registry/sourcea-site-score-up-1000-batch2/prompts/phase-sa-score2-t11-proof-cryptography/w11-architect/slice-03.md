# sa-score2-0003 — Architect immutable proof run ID in Cloudflare Durable Object ledger
...
**Deliverable:** Architect immutable proof run ID in Cloudflare Durable Object ledger
