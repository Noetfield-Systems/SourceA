# sa-score2-0010 — Architect compare receipt hash to on-chain anchor stub (Labs tier)
...
**Deliverable:** Architect compare receipt hash to on-chain anchor stub (Labs tier)
