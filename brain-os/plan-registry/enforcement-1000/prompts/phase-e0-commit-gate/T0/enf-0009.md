...
# [AGENT-AUTO-ENFORCEMENT@2026-06-11] enf-0009 — CI grep: FAIL if new scripts use open(...,'w') on ~/.sina/receipts/enforcement/ without commit_inten
