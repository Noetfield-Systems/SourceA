...
# [AGENT-AUTO-ENFORCEMENT@2026-06-11] enf-0857 — [CHAOS] Kill/replay stress — prove still holds: Add validate-single-commit-path-v1.sh demo scope onl
