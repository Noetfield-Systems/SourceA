...
# [AGENT-AUTO-ENFORCEMENT@2026-06-11] enf-0283 — [POLISH] Document or DELETE if no W2 impact: CI: run tamper FAIL must exit 1 — grep exit code in run
