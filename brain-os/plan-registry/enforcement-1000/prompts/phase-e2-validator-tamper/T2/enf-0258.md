...
# [AGENT-AUTO-ENFORCEMENT@2026-06-11] enf-0258 — [CHAOS] Kill/replay stress — prove still holds: CI: run tamper FAIL must exit 1 — grep exit code in 
