# ag-c-1617 — AgentGo SA4 case study plan (v3 polished)

**Version:** 3 · **Tier:** T3 · **Phase:** MOONSHOT · **Rank:** 1617
**Angle:** C · Angle C — Wil L3 demo
**Theme:** t09-wil-gate · Wil ship gate & separation
**Workstream:** w01-ship · Ship
**Slice:** 17/20 · **Receipt gate:** revenue_outreach
...
**Document subdomain option for** Wil L3 separation law + ship gate receipts.
...
1. `status: done` in REGISTRY.json for `ag-c-1617`
