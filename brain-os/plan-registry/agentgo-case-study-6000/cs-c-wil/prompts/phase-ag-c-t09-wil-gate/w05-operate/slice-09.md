# ag-c-1689 — AgentGo SA4 case study plan (v3 polished)

**Version:** 3 · **Tier:** T2 · **Phase:** MOONSHOT · **Rank:** 1689
**Angle:** C · Angle C — Wil L3 demo
**Theme:** t09-wil-gate · Wil ship gate & separation
**Workstream:** w05-operate · Operate
**Slice:** 9/20 · **Receipt gate:** dual_deploy_pass
...
**Light hub command-data sync for** Wil L3 separation law + ship gate receipts.
...
1. `status: done` in REGISTRY.json for `ag-c-1689`
