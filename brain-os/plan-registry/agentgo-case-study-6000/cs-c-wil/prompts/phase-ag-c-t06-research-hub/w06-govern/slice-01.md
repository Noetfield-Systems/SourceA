# ag-c-1101 — AgentGo SA4 case study plan (v3 polished)

**Version:** 3 · **Tier:** T0 · **Phase:** MOONSHOT · **Rank:** 1101
...
**Apply separation law to** research + guides + glossary hub.
...
1. `status: done` in REGISTRY.json for `ag-c-1101`
