# ag-c-1001 — AgentGo SA4 case study plan (v3 polished)

**Version:** 3 · **Tier:** T0 · **Phase:** MOONSHOT · **Rank:** 1001
...
**Ship smallest buyer-visible slice of** research + guides + glossary hub.
...
1. `status: done` in REGISTRY.json for `ag-c-1001`
