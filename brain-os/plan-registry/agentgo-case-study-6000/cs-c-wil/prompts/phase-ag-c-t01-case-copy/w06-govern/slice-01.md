# ag-c-0101 — AgentGo SA4 case study plan (v3 polished)

**Version:** 3 · **Tier:** T0 · **Phase:** NEXT · **Rank:** 101
...
**Apply separation law to** case study prose (challenge · shipped · verification).
...
**Phase:** NEXT · **Tier:** T0 · **Workstream:** Govern
...
1. `status: done` in REGISTRY.json for `ag-c-0101`
