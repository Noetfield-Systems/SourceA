# ag-c-0036 — AgentGo SA4 case study plan (v3 polished)

**Version:** 3 · **Tier:** T3 · **Phase:** NEXT · **Rank:** 36
...
**Prove AgentGo ≠ SourceA copy for** case study prose (challenge · shipped · verification).
...
**Phase:** NEXT · **Tier:** T3 · **Workstream:** Prove
...
1. `status: done` in REGISTRY.json for `ag-c-0036`
