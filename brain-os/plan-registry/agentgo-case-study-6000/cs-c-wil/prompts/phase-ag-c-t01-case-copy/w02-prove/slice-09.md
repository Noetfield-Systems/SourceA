# ag-c-0029 — AgentGo SA4 case study plan (v3 polished)

**Version:** 3 · **Tier:** T2 · **Phase:** NOW · **Rank:** 29
...
**Wire sourcea-boot eval path for** case study prose (challenge · shipped · verification).
...
Vault archive when bundle stable.
...
1. `status: done` in REGISTRY.json for `ag-c-0029`
