# ag-c-0022 — AgentGo SA4 case study plan (v3 polished)

**Version:** 3 · **Tier:** T0 · **Phase:** NOW · **Rank:** 22
...
**Write manifest JSON for** case study prose (challenge · shipped · verification).
...
**Phase:** NOW · **Tier:** T0 · **Workstream:** Prove

## Polish wisdom (v3)

Agent onboarding: pick-agentgo + polish v3 one paragraph.
...
1. `status: done` in REGISTRY.json for `ag-c-0022`
