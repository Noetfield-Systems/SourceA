# ag-c-0023 — AgentGo SA4 case study plan (v3 polished)

**Version:** 3 · **Tier:** T1 · **Phase:** NOW · **Rank:** 23
...
**Parse sitemap.xml scope for** case study prose (challenge · shipped · verification).
...
Regenerate runbook: polish_agentgo_case_study_v3.py.
...
1. `status: done` in REGISTRY.json for `ag-c-0023`
