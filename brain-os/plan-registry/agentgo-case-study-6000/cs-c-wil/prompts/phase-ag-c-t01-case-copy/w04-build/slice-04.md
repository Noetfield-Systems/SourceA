# ag-c-0064 — AgentGo SA4 case study plan (v3 polished)

**Version:** 3 · **Tier:** T1 · **Phase:** NEXT · **Rank:** 64
...
**Wire JS behavior for** case study prose (challenge · shipped · verification).
...
**Phase:** NEXT · **Tier:** T1 · **Workstream:** Build
...
1. `status: done` in REGISTRY.json for `ag-c-0064`
