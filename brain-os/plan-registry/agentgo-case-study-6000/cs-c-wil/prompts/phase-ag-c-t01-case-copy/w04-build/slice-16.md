# ag-c-0076 — AgentGo SA4 case study plan (v3 polished)

**Version:** 3 · **Tier:** T3 · **Phase:** NEXT · **Rank:** 76
...
**Patch pick script for** case study prose (challenge · shipped · verification).
...
**Phase:** NEXT · **Tier:** T3 · **Workstream:** Build
...
1. `status: done` in REGISTRY.json for `ag-c-0076`
