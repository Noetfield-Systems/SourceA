# ag-c-0072 — AgentGo SA4 case study plan (v3 polished)

**Version:** 3 · **Tier:** T2 · **Phase:** NEXT · **Rank:** 72
...
**Fix a11y for** case study prose (challenge · shipped · verification).
...
**Phase:** NEXT · **Tier:** T2 · **Workstream:** Build
...
1. `status: done` in REGISTRY.json for `ag-c-0072`
