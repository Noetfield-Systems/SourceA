# ag-c-0081 — AgentGo SA4 case study plan (v3 polished)

**Version:** 3 · **Tier:** T0 · **Phase:** NEXT · **Rank:** 81
...
**Operate SA4 serve.sh for** case study prose (challenge · shipped · verification).
...
**Phase:** NEXT · **Tier:** T0 · **Workstream:** Operate
...
1. `status: done` in REGISTRY.json for `ag-c-0081`
