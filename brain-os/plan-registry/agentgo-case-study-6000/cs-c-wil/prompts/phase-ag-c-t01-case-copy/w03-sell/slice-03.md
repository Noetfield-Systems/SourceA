# ag-c-0043 — AgentGo SA4 case study plan (v3 polished)

**Version:** 3 · **Tier:** T1 · **Phase:** NEXT · **Rank:** 43
...
**Draft outreach template A for** case study prose (challenge · shipped · verification).
...
**Phase:** NEXT · **Tier:** T1 · **Workstream:** Sell
...
1. `status: done` in REGISTRY.json for `ag-c-0043`
