# ag-c-0001 — AgentGo SA4 case study plan (v3 polished)

**Version:** 3 · **Tier:** T0 · **Phase:** NOW · **Rank:** 1
...
Extract 3 separation lines from TERMINOLOGY_2026 — quote don't paraphrase route counts.
...
1. `status: done` in REGISTRY.json for `ag-c-0001`
