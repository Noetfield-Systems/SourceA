# ag-c-0003 — AgentGo SA4 case study plan (v3 polished)

**Version:** 3 · **Tier:** T1 · **Phase:** NOW · **Rank:** 3
...
**Add page to commercial + depth gates for** case study prose (challenge · shipped · verification).
...
**Phase:** NOW · **Tier:** T1 · **Workstream:** Ship

## Polish wisdom (v3)

Ship gate criteria in prose: routes · browser · E2E · legacy zero — defer numbers to Wil doc.
...
1. `status: done` in REGISTRY.json for `ag-c-0003`
