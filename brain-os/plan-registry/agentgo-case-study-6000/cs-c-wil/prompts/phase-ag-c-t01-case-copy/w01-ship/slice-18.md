# ag-c-0018 — AgentGo SA4 case study plan (v3 polished)

**Version:** 3 · **Tier:** T3 · **Phase:** NOW · **Rank:** 18
...
**Document rollback for** case study prose (challenge · shipped · verification).
...
FAQ: 'Is AgentGo SourceA?' → No — hosted lane only.
...
1. `status: done` in REGISTRY.json for `ag-c-0018`
