# ag-c-0013 — AgentGo SA4 case study plan (v3 polished)

**Version:** 3 · **Tier:** T3 · **Phase:** NOW · **Rank:** 13
...
**Add Cal.com talking point for** case study prose (challenge · shipped · verification).
...
PRIORITY evidence row — polish complete date.
...
1. `status: done` in REGISTRY.json for `ag-c-0013`
