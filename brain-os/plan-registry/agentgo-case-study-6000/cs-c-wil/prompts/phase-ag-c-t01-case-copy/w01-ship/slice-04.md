# ag-c-0004 — AgentGo SA4 case study plan (v3 polished)

**Version:** 3 · **Tier:** T1 · **Phase:** NOW · **Rank:** 4
...
SOURCEA-PRIORITY Wil section cross-link — case study as portfolio proof.
...
1. `status: done` in REGISTRY.json for `ag-c-0004`
