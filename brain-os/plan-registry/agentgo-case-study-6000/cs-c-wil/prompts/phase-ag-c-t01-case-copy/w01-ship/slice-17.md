# ag-c-0017 — AgentGo SA4 case study plan (v3 polished)

**Version:** 3 · **Tier:** T3 · **Phase:** NOW · **Rank:** 17
...
**Document subdomain option for** case study prose (challenge · shipped · verification).
...
**Phase:** NOW · **Tier:** T3 · **Workstream:** Ship

## Polish wisdom (v3)

Port map in FAQ: production vs demo vs Wil localhost.
...
1. `status: done` in REGISTRY.json for `ag-c-0017`
