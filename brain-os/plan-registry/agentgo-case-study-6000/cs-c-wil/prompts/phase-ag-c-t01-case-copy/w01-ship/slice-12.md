# ag-c-0012 — AgentGo SA4 case study plan (v3 polished)

**Version:** 3 · **Tier:** T2 · **Phase:** NOW · **Rank:** 12
...
**Wire footer case study column for** case study prose (challenge · shipped · verification).
...
AGENTGO-CASE-STUDY-6000.md index — v3 polish commands.
...
1. `status: done` in REGISTRY.json for `ag-c-0012`
