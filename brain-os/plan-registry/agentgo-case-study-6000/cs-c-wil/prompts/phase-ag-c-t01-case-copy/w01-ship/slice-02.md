# ag-c-0002 — AgentGo SA4 case study plan (v3 polished)

**Version:** 3 · **Tier:** T0 · **Phase:** NOW · **Rank:** 2
...
**Wire nav + breadcrumb for** case study prose (challenge · shipped · verification).
...
Footer disclaimer is law — portfolio lane · not AgentGo SaaS checkout.
...
1. `status: done` in REGISTRY.json for `ag-c-0002`
