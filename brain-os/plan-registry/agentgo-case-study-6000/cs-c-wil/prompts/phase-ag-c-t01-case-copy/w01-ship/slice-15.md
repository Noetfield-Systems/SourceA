# ag-c-0015 — AgentGo SA4 case study plan (v3 polished)

**Version:** 3 · **Tier:** T3 · **Phase:** NOW · **Rank:** 15
...
CRM doc GEO ICP fields — separate from Noetfield 613.
...
1. `status: done` in REGISTRY.json for `ag-c-0015`
