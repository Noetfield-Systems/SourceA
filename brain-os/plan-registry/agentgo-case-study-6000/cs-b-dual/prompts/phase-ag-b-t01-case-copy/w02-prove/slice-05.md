# ag-b-0025 — AgentGo SA4 case study plan (v3 polished)
...
Founder 5-step runbook: deploy · validate · open · screen-share · CRM.
...
1. `status: done` in REGISTRY.json for `ag-b-0025`
