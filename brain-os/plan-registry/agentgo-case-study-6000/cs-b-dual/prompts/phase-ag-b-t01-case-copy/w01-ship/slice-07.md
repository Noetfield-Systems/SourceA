# ag-b-0007 — AgentGo SA4 case study plan (v3 polished)
...
Hub glance link optional — founder session only; no hub marathon.
...
1. `status: done` in REGISTRY.json for `ag-b-0007`
