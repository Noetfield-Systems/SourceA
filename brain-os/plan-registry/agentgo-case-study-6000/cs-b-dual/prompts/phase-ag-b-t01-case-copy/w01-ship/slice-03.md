# ag-b-0003 — AgentGo SA4 case study plan (v3 polished)
...
Case study Angle B section: name ports 5180 canonical · 8080 cinematic.
...
1. `status: done` in REGISTRY.json for `ag-b-0003`
