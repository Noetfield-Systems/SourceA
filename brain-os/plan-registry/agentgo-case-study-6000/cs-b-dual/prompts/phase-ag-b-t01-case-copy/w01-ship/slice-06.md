# ag-b-0006 — AgentGo SA4 case study plan (v3 polished)
...
PureFlow = live URL proof · AgentGo = desktop deploy proof — say both honestly.
...
1. `status: done` in REGISTRY.json for `ag-b-0006`
