# ag-b-0001 — AgentGo SA4 case study plan (v3 polished)
...
Run deploy script once — capture stdout paths in receipt JSON.
...
1. `status: done` in REGISTRY.json for `ag-b-0001`
