# ag-b-0004 — AgentGo SA4 case study plan (v3 polished)
...
Port map table: sourcea.app production vs localhost demo — never blur them.
...
1. `status: done` in REGISTRY.json for `ag-b-0004`
