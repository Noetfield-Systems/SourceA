# ag-a-0002 — AgentGo SA4 case study plan (v3 polished)
...
Hero must name three proof angles on one page — factory · dual deploy · Wil separation — before any feature list.
...
1. `status: done` in REGISTRY.json for `ag-a-0002`
