# ag-a-0013 — AgentGo SA4 case study plan (v3 polished)
...
Sitemap.xml line count cross-check — flag if claim drifts >5% from find count.
...
1. `status: done` in REGISTRY.json for `ag-a-0013`
