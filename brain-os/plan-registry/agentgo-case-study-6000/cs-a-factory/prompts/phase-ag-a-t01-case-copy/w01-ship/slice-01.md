# ag-a-0001 — AgentGo SA4 case study plan (v3 polished)
...
Open with the buyer question: 'Can your factory ship category scale?' — not 'we built a website.'
...
1. `status: done` in REGISTRY.json for `ag-a-0001`
