# ag-a-0006 — AgentGo SA4 case study plan (v3 polished)
...
Pick demo subset: homepage + 3 trackers + 3 compare + 3 research — document paths in manifest.
...
1. `status: done` in REGISTRY.json for `ag-a-0006`
