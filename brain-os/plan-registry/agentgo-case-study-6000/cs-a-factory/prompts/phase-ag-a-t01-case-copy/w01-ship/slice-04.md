# ag-a-0004 — AgentGo SA4 case study plan (v3 polished)
...
OG description = one sharp outcome; cut any second sentence that repeats ALLOW/BLOCK vocabulary.
...
1. `status: done` in REGISTRY.json for `ag-a-0004`
