# ag-a-0019 — AgentGo SA4 case study plan (v3 polished)
...
sourcea-boot CTA on case study footer — eval path for technical buyers.
...
1. `status: done` in REGISTRY.json for `ag-a-0019`
