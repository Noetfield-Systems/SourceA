# ag-a-0020 — AgentGo SA4 case study plan (v3 polished)
...
PureFlow diff table on case study or linked doc — trades vs GEO column headers.
...
1. `status: done` in REGISTRY.json for `ag-a-0020`
