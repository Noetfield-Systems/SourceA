# ag-a-0005 — AgentGo SA4 case study plan (v3 polished)
...
CTAs: cal.com/sourcea/proof-demo primary · offer secondary · no third competing button.
...
1. `status: done` in REGISTRY.json for `ag-a-0005`
