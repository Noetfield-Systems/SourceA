# ag-a-0008 — AgentGo SA4 case study plan (v3 polished)
...
CRM seed: SaaS marketing director · not trades operator · note angle in outreach field.
...
1. `status: done` in REGISTRY.json for `ag-a-0008`
