# ag-a-0018 — AgentGo SA4 case study plan (v3 polished)
...
Tamper demo script: 90-second procurement version — request → receipt → tamper-FAIL.
...
1. `status: done` in REGISTRY.json for `ag-a-0018`
