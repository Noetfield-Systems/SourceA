# ag-a-0022 — AgentGo SA4 case study plan (v3 polished)
...
validate-agentgo-case-study-6000 v3 — unique titles + schema_version 3.
...
1. `status: done` in REGISTRY.json for `ag-a-0022`
