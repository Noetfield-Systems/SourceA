# ag-a-0021 — AgentGo SA4 case study plan (v3 polished)
...
Map receipt_gate on landing-ship rows only after gates PASS.
...
1. `status: done` in REGISTRY.json for `ag-a-0021`
