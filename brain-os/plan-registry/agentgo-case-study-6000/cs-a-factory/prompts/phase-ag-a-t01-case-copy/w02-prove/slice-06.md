# ag-a-0026 — AgentGo SA4 case study plan (v3 polished)
...
Dual port curl optional — only when founder has servers running.
...
1. `status: done` in REGISTRY.json for `ag-a-0026`
