...
**Lane:** SourceA · **Wedge:** w15-feature-delivery-removed · Ship differentiated feature slice
...
Fast-sell: SourceA · Ship differentiated feature slice · Ship smallest build slice. Ship smallest slice that moves a buyer toward **Asset B diagnostic $3K slice** with a path to **DFY $3–10K + retainer**. Receipt logged before done.
