# fs-sa-0313 — Fast-sell plan

**Version:** 1 · **Tier:** T1 · **Phase:** MOONSHOT
**Lane:** SourceA · **Wedge:** w17-upsell · Tier-1 → Tier-2 upsell motion
...
Fast-sell: SourceA · Tier-1 → Tier-2 upsell motion · Ship smallest build slice. Ship smallest slice that moves a buyer toward **Asset B diagnostic $3K slice** with a path to **DFY $3–10K + retainer**. Receipt on disk before done.
...
1. `status: done` in REGISTRY.json for `fs-sa-0313`
