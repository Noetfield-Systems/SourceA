...
Fast-sell: SourceA · Vertical wedge (diaspora · RCIC · broker · trades) · Save reusable template. Ship smallest slice that moves a buyer toward **Asset B diagnostic $3K slice** with a path to **DFY $3–10K + retainer**. Receipt logged before done.
