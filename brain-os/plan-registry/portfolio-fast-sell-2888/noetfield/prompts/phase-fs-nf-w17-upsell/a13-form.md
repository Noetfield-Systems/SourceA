...
Fast-sell: Noetfield · Tier-1 → Tier-2 upsell motion · Founder decision form row. Ship smallest slice that moves a buyer toward **Intelligence diagnostic $2.5–5K** with a path to **Build $8–25K + retainer**. Receipt logged before done.
...
1. `status: done` in REGISTRY.json for `fs-nf-0298`
