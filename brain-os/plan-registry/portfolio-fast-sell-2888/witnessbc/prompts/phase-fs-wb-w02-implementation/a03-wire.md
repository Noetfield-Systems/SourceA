...
Fast-sell: WitnessBC · Tier-2 build & integrate · Wire SKU on landing. Ship smallest slice that moves a buyer toward **Public proof page pilot** with a path to **Civic annual + audit export**. Receipt logged before done.
