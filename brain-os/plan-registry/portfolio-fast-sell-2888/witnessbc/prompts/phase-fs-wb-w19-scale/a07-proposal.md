...
Fast-sell: WitnessBC · Repeatable playbook + template · 1-page proposal PDF. Ship smallest slice that moves a buyer toward **Public proof page pilot** with a path to **Civic annual + audit export**. Receipt logged before done.
