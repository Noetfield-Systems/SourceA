...
Fast-sell: WitnessBC · Base fee + usage overage · SOW / order form. Ship smallest slice that moves a buyer toward **Public proof page pilot** with a path to **Civic annual + audit export**. Receipt logged before done.
