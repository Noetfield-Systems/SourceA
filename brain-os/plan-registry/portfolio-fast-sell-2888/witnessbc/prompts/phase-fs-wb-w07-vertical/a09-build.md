# fs-wb-0123 — Fast-sell plan

**Version:** 1 · **Tier:** T1 · **Phase:** LATER
**Lane:** WitnessBC · **Wedge:** w07-vertical · Vertical wedge (diaspora · RCIC · broker · trades)
...
Fast-sell: WitnessBC · Vertical wedge (diaspora · RCIC · broker · trades) · Ship smallest build slice. Ship smallest slice that moves a buyer toward **Public proof page pilot** with a path to **Civic annual + audit export**. Receipt on disk before done.
...
1. `status: done` in REGISTRY.json for `fs-wb-0123`
