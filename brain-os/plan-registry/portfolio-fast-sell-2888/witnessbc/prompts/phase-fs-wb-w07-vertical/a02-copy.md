...
Fast-sell: WitnessBC · Vertical wedge (diaspora · RCIC · broker · trades) · Write buyer-facing copy. Ship smallest slice that moves a buyer toward **Public proof page pilot** with a path to **Civic annual + audit export**. Receipt logged before done.
