# fs-wb-0142 — Fast-sell plan

**Version:** 1 · **Tier:** T1 · **Phase:** LATER
**Lane:** WitnessBC · **Wedge:** w08-landing · Landing + pricing page ship
...
Fast-sell: WitnessBC · Landing + pricing page ship · Ship smallest build slice. Ship smallest slice that moves a buyer toward **Public proof page pilot** with a path to **Civic annual + audit export**. Receipt on disk before done.
...
1. `status: done` in REGISTRY.json for `fs-wb-0142`
