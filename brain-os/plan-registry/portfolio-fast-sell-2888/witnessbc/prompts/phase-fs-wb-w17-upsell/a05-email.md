...
Fast-sell: WitnessBC · Tier-1 → Tier-2 upsell motion · Outreach email draft. Ship smallest slice that moves a buyer toward **Public proof page pilot** with a path to **Civic annual + audit export**. Receipt logged before done.
