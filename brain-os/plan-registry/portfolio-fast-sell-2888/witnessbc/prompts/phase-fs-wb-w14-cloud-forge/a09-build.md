# fs-wb-0256 — Fast-sell plan

**Version:** 1 · **Tier:** T1 · **Phase:** MOONSHOT
**Lane:** WitnessBC · **Wedge:** w14-cloud-forge · Cloud forge run + Supabase row
...
Fast-sell: WitnessBC · Cloud forge run + Supabase row · Ship smallest build slice. Ship smallest slice that moves a buyer toward **Public proof page pilot** with a path to **Civic annual + audit export**. Receipt on disk before done.
...
1. `status: done` in REGISTRY.json for `fs-wb-0256`
