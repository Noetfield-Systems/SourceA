...
Fast-sell: WitnessBC · Cloud forge run + Supabase row · Ship smallest build slice. Ship smallest slice that moves a buyer toward **Public proof page pilot** with a path to **Civic annual + audit export**. Receipt logged before done.
