# fs-wb-0180 — Fast-sell plan

**Version:** 1 · **Tier:** T1 · **Phase:** LATER
**Lane:** WitnessBC · **Wedge:** w10-outreach · Cold outreach + book meeting
...
Fast-sell: WitnessBC · Cold outreach + book meeting · Ship smallest build slice. Ship smallest slice that moves a buyer toward **Public proof page pilot** with a path to **Civic annual + audit export**. Receipt on disk before done.
...
1. `status: done` in REGISTRY.json for `fs-wb-0180`
