...
Fast-sell: WitnessBC · Cold outreach + book meeting · Ask for referral. Ship smallest slice that moves a buyer toward **Public proof page pilot** with a path to **Civic annual + audit export**. Receipt logged before done.
