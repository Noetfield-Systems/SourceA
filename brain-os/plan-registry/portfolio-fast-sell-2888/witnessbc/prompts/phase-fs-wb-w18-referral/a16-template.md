...
Fast-sell: WitnessBC · Partner / accountant channel · Save reusable template. Ship smallest slice that moves a buyer toward **Public proof page pilot** with a path to **Civic annual + audit export**. Receipt on disk before done.
