...
Fast-sell: WitnessBC · Hub one-tap Action · Client handoff doc. Ship smallest slice that moves a buyer toward **Public proof page pilot** with a path to **Civic annual + audit export**. Receipt logged before done.
