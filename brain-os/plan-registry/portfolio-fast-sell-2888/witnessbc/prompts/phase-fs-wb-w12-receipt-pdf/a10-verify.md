...
Fast-sell: WitnessBC · Receipt / Proof Pack PDF · Verify PASS receipt. Ship smallest slice that moves a buyer toward **Public proof page pilot** with a path to **Civic annual + audit export**. Receipt logged before done.
