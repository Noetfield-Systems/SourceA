...
**Lane:** WitnessBC · **Wedge:** w15-feature-delivery-removed · Ship differentiated feature slice
...
Fast-sell: WitnessBC · Ship differentiated feature slice · Ship smallest build slice. Ship smallest slice that moves a buyer toward **Public proof page pilot** with a path to **Civic annual + audit export**. Receipt logged before done.
