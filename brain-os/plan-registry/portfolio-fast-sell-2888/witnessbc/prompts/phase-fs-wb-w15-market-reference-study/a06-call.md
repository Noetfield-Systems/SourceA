...
Fast-sell: WitnessBC · Ship differentiated feature slice · Discovery call script. Ship smallest slice that moves a buyer toward **Public proof page pilot** with a path to **Civic annual + audit export**. Receipt logged before done.
