...
Fast-sell: WitnessBC · Client onboard checklist · Save reusable template. Ship smallest slice that moves a buyer toward **Public proof page pilot** with a path to **Civic annual + audit export**. Receipt logged before done.
