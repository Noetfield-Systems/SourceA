...
Fast-sell: WitnessBC · Client onboard checklist · Log W3 / NW economic signal. Ship smallest slice that moves a buyer toward **Public proof page pilot** with a path to **Civic annual + audit export**. Receipt on disk before done.
