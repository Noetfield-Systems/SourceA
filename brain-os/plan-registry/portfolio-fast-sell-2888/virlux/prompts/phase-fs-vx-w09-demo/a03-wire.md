...
Fast-sell: VIRLUX · Live demo URL + proof · Wire SKU on landing. Ship smallest slice that moves a buyer toward **One factory recipe demo** with a path to **Team + usage tier**. Receipt logged before done.
