...
Fast-sell: VIRLUX · Client onboard checklist · SOW / order form. Ship smallest slice that moves a buyer toward **One factory recipe demo** with a path to **Team + usage tier**. Receipt on disk before done.
