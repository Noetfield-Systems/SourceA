...
Fast-sell: VIRLUX · Partner / accountant channel · LinkedIn proof post. Ship smallest slice that moves a buyer toward **One factory recipe demo** with a path to **Team + usage tier**. Receipt logged before done.
