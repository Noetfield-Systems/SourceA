...
Fast-sell: VIRLUX · Hub one-tap Action · Log W3 / NW economic signal. Ship smallest slice that moves a buyer toward **One factory recipe demo** with a path to **Team + usage tier**. Receipt logged before done.
