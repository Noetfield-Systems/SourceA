...
Fast-sell: VIRLUX · Hub one-tap Action · Research comp pricing page. Ship smallest slice that moves a buyer toward **One factory recipe demo** with a path to **Team + usage tier**. Receipt logged before done.
