...
Fast-sell: VIRLUX · Monthly ops retainer · 1-page proposal PDF. Ship smallest slice that moves a buyer toward **One factory recipe demo** with a path to **Team + usage tier**. Receipt logged before done.
