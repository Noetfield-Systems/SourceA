...
Fast-sell: Vertical GTM SKUs · Client case study on disk · SOW / order form. Ship smallest slice that moves a buyer toward **$99–199/mo self-serve** with a path to **$499/mo + onboarding**. Receipt on disk before done.
...
1. `status: done` in REGISTRY.json for `fs-gt-0198`
