...
Fast-sell: SourceA Agency Asset B · Client onboard checklist · Retainer renewal touch. Ship smallest slice that moves a buyer toward **Workflow audit $1.5–3K** with a path to **Build + $1–5K/mo optimize**. Receipt logged before done.
