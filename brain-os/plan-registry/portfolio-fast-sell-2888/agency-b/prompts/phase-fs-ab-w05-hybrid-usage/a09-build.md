...
Fast-sell: SourceA Agency Asset B · Base fee + usage overage · Ship smallest build slice. Ship smallest slice that moves a buyer toward **Workflow audit $1.5–3K** with a path to **Build + $1–5K/mo optimize**. Receipt logged before done.
