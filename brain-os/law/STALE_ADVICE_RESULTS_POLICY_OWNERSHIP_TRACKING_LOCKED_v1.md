...
**How we enforce:** Machine validators **PASS** · live context JSON files **clean** · inject chain **named owner per surface** · Governance **tracks receipts** · ASF **closes incidents** when proof is logged — not when an agent “promises” in chat.
