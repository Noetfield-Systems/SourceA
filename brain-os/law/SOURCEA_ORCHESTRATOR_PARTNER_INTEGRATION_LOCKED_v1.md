...
**Topic:** Policy layer above durable orchestrators — **partner, not **  
...
** context:** `archive/attachments/commercial/SOURCEA__LANDSCAPE_RESEARCH_REPORT_v1.md`
...
| **** |  on Copilot — different layer (agent security vs policy re-brief) |
