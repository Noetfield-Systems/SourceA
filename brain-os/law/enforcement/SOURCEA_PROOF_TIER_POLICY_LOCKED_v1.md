...
**Forbidden:** "1,710 done" · "all greens" · " research complete" when any row is not `http_fetch`.
...
Cloud Forge Run queue rows serve **WitnessBC  registry** (`wb-mkt-*`). They are **portfolio factory proof**, not Noetfield Systems Inc. customer deliverables. Noetfield pitch uses its own receipts lane.
