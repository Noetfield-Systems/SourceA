...
**Worker · Brain · Maintainer · every agent: ship the sa/task logged — never default to hub rebuild, full refresh, or `build-sina-command-panel.py`; Super Fast Hub light sync + task validators only.**
...
| **Gov / Commercial** | LOCKED law logged | Hub tabs as progress |
