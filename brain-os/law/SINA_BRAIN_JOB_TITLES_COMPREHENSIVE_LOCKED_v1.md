...
| Field | Detail |
|-------|--------|
| **Scope** |  matrix · precedent rows · vault deposit |
| **Forbidden** | 200-company matrix execution in Brain or Worker chat |
| **Artifacts** | `SINA__AND_REFERENCE_MATRIX_v1.yaml` |
...
| Field | Detail |
|-------|--------|
| **Rule** | Pillar B —  row before feature advocacy |
| **Artifacts** | `SINA__AND_REFERENCE_MATRIX_v1.yaml` |
