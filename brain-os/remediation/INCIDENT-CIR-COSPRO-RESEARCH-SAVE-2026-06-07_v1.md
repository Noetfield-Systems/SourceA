...
Research lane B treated competitor/voice findings as **product SSOT updates** instead of **vault-only artifacts** + RESEARCH mirror. `research_save_enforcer.py` validates mirrors but does **not** block cross-path writes to product docs.
