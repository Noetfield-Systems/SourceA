...
test -f brain-os/scripts/brain_gather_rules_v1.py
...
grep -q 'brain-os/law/BRAIN_UNIFIED_RULES_LOCKED_v1.md' brain-os/scripts/cursor_entry_gate.py

python3 brain-os/scripts/brain_gather_rules_v1.py --json | python3 -c "
import json,sys
...
bash brain-os/scripts/validate-brain-rules-narrate-v1.sh
