...
BRAIN_LOCKED_DOCS = [
    ...
    "brain-os/enforcement/BRAIN_ENFORCEMENT_AUDIT_PROMPT_LOCKED_v1.md",
...
BRAIN_CURSOR_MIRROR = [
    "brain-os/cursor/rules/000-brain-unified.mdc",
    "brain-os/cursor/rules/000-entry-gate.mdc",
]

BRAIN_SCRIPTS = [
    "brain-os/scripts/brain-session-start.sh",
    "brain-os/scripts/brain_run_loop_trace_v1.py",
    "brain-os/scripts/brain_narrate_loop_v1.py",
    "brain-os/scripts/brain_intent_gate_v1.py",
    "brain-os/scripts/brain_gather_rules_v1.py",
    "brain-os/scripts/brain_run_loop_v1.py",
    "brain-os/scripts/brain_execute_turn_v1.py",
    "brain-os/scripts/brain_validate_goal1_v1.py",
    "brain-os/scripts/cursor_entry_gate.py",
    "brain-os/scripts/brain_os_paths.py",
    "brain-os/scripts/sync-brain-pack.sh",
]
