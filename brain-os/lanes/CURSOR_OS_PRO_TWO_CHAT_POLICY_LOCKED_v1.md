...
**Law:** Research chat **does not** ship product code. Product chat **does not** own  matrices.
...
python3 ~/Desktop/SourceA/scripts/research_root_sync.py register \
  ...
  --producer cursor_os_pro --bucket  --cores research
...
Read: docs/SINGLE-SOURCE-OF-TRUTH.md · docs/VOICE_AGENT_ROADMAP_LOCKED_v1.md
 tiers: scripts/investor-data-200.json (read-only reference)
