...
|------|----------------|----------------|
| 1 | Listed 100 `sa-mkt-*` competitor plans as “cloud/FORGE only — no factory on Mac.” | Secondary pack — **not Mac work at all.** |
...
Secondary     = 5000 competitor plans (5 stacks × 1000) · cloud/API batch drain ONLY
...
|-------|----------------|---------------|
| **E1** | “Cloud/FORGE only” for 100 competitor plans | Implies Mac/chat can skip control law · treats secondary as Mac queue |
...
| **Secondary competitor-1000** | **NO** | Cloud cron/tick · FORGE · free LLM chain · OpenRouter cap |
...
- “Worker picks + implements” competitor bulk on Mac
