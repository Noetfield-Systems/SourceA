...
const enumSuite = new .Suite("z.enum");
...
const longEnumSuite = new .Suite("long z.enum");
...
const undefinedSuite = new .Suite("z.undefined");
...
const literalSuite = new .Suite("z.literal");
const short = "short";
const bad = "bad";
...
const numberSuite = new .Suite("z.number");
...
const dateSuite = new .Suite("z.date");
...
const symbolSuite = new .Suite("z.symbol");
