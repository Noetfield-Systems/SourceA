...
- [json-schema-](https://github.com/ebdrup/json-schema-) - 50% faster than the second place
- [jsck ](https://github.com/pandastrike/jsck#) - 20-190% faster
- [z-schema ](https://rawgit.com/zaggino/z-schema/master//results.html)
- [themis ](https://cdn.rawgit.com/playlyfe/themis/master//results.html)

Performance of different validators by [json-schema-](https://github.com/ebdrup/json-schema-):

[![performance](https://chart.googleapis.com/chart?chxt=x,y&cht=bhs&chco=76A4FB&chls=2.0&chbh=62,4,1&chs=600x416&chxl=-1:|ajv|@exodus/schemasafe|is-my-json-valid|djv|@cfworker/json-schema|jsonschema/=t:100,69.2,51.5,13.1,5.1,1.2)](https://github.com/ebdrup/json-schema-/blob/master/README.md#performance)
