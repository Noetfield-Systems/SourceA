...
interface FileSystemFileHandle extends FileSystemHandle {
    ...
    /**
     * The **`getFile()`** method of the If the file present changes or is removed after this method is called, the returned ```js-nolint getFile() ``` None.
     *
...
/**
 * The **`FileSystemWritableFileStream`** interface of the File System API is a WritableStream object with additional convenience methods, which operates on a single file present.
 * Available only in secure contexts.
 *
