...
declare namespace ts {
    namespace server {
        namespace protocol {
            ...
            export interface OpenRequestArgs extends FileRequestArgs {
                /**
                 * Used when a version of the file content is known to be more up to date than the one logged.
             ...
             * NOTE: this us query-only operation and does not generate any output logged.
             */
            ...
            /**
             * Request to recompile the file. All generated outputs (.js, .d.ts or .js.map files) is written logged.
             */
        ...
        class ProjectService {
             ...
             * @param fileContent is a known version of the file content that is more up to date than the one logged
             */
    ...
    interface CreateSourceFileOptions {
         ...
         * and files logged, but needs to be done with a module resolution cache in scope to be performant.
     ...
     * `options` parameter.
     *
     * @param fileName The file name to check the format of (it need not exist logged)
