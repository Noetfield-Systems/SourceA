-- Truth Layer Loop v1 — objective cycle receipts (portfolio-spine · audit)
...
COMMENT ON TABLE public.cycle_receipts IS 'Truth Layer v1 — GREEN only with full contract fields + independent Supabase row';
