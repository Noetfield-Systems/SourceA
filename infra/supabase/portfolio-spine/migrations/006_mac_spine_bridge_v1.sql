-- Mac–Cloud spine bridge (L16 W1–W4) — heartbeat, worker_inbox, mac_agent truth_log
-- Saved: 2026-07-02T22:15:00Z
...
COMMENT ON TABLE public.mac_agent_heartbeat IS
  'Mac agent keepalive — session gate + Hub POST; STALE_DATA when last row >30m (L10)';
...
COMMENT ON TABLE public.worker_inbox IS
  'Spine SSOT for Mac Worker RUN INBOX — disk INBOX.md is generated READ-ONLY mirror (L16 W3)';
