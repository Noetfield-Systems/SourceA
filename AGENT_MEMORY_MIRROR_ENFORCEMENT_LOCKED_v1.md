...
**All agent-law surfaces mirror one machine SSOT — session gate fail-closed; CRITICAL validators fail hub build; no founder-facing stale phrase may survive on disk.**
...
| Stale phrase on disk | `validate-law-supersession-surfaces-v1.sh` CRITICAL — blocks anti-staleness bundle |
