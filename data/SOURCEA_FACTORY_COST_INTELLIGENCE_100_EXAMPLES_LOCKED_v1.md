...
**Version:** 1.0.0 · **Saved:** 2026-06-19T02:25:45Z · **Authority:** ASF SAVE+WORK
**Path:** `data/SOURCEA_FACTORY_COST_INTELLIGENCE_100_EXAMPLES_LOCKED_v1.md` (worker lane mirror)
**Doc target (ASF):** `docs/SOURCEA_FACTORY_COST_INTELLIGENCE_100_EXAMPLES_LOCKED_v1.md`
...
- **ORIENT:** unified namespace · SKU-line-plant cost baselines · cross-factory benchmark
