...
bash C13/open.sh
# or
python3 -m http.server 8130 --directory C13
```

## Sections cloned

- Nav · hero + live fleet mock · pillar chips  
- Urgency stats (50:1 · 72% · $4.6M)  
- Six management pillars · lifecycle 01–06 · vendor comparison matrix  
- Integrations grid · 4-tier pricing · newsletter footer  
