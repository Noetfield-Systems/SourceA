...
# Sourcea Products Catalog V1

- **schema**: sourcea-products-catalog-v1
- **version**: 1.0.0
- **generated_at**: 2026-06-24T15:11:48Z
- **product_count**: 9
## case_studies
## PureFlow
...
- **proof**: Governed prompt pipeline on disk
- **url**: /sourcea/forge/
- **status**: active
- **tier**: T2
## Chat Unify
...
- **proof**: Web desk · Mac app · session truth gate
- **url**: /unify/
- **demo_url**: /unify-demo/
- **download_url**: /downloads/chat-unify-mac-v1.dmg
- **status**: active
- **tier**: T2
## Cloud Workers
- **id**: cloud-workers
...
- **tier**: T2
## services
## Asset B · Agent Loop Build
- **id**: asset-b-loop-build
- **slug**: asset-b
- **kind**: service
- **rank**: 3
- **title**: Asset B · Agent Loop Build
- **subtitle**: Fixed-scope governed automation
