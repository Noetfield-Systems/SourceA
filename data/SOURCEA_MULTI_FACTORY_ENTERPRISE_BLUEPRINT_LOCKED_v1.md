...
**Version:** 1.0.0 · **Saved:** 2026-06-19T07:08:25Z · **Authority:** ASF SAVE  
**Path:** `data/SOURCEA_MULTI_FACTORY_ENTERPRISE_BLUEPRINT_LOCKED_v1.md`  
**Promote target:** `docs/SOURCEA_MULTI_FACTORY_ENTERPRISE_BLUEPRINT_LOCKED_v1.md` (founder cross-lane)  
**Machine SSOT aliases:** `data/multi-factory-enterprise-tree-advisory-v1.json` · `data/architecture-ledger-v1.json`
...
Apply only when WORK names Supabase project. Do not fork Gemini Bun monorepo.
...
3. `SAVE TO: docs/SOURCEA_MULTI_FACTORY_ENTERPRISE_BLUEPRINT_LOCKED_v1.md` — promote this file to docs authority index  
4. `WORK: supabase-edge-loop` — first real cloud auto-loop  
5. W3 confirm-sent · OEGCC LLM hook  
