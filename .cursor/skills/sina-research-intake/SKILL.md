...
description: Submits research and analysis to the Sina Agent Hub pipeline (intake → brainstorm → evaluate → promote). Use when the user or agent finishes research, competitive analysis, external paste review, or any finding that should be evaluated before implementation.
