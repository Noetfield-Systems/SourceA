...
Load **`references/sourcea-wiring.md`** for paths, boot commands, motor chain, receipt dirs, and Mac dispatch law. Deterministic loop rules: **`references/deterministic-loops.md`** (D1–D8). Human law mirror: `docs/GOVERNED_AUTORUN_LAWS_v3.md`.
