...
**Sell the three-line campus headless.**  sell agents or clones. SourceA FBE sells **Motor + Refinery + Assembly** with **prove_only** honesty and **RunReceipt** proof — Mac manages platform; cloud scales production.
