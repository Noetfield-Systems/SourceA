# Controlled Autorun Laws v3

**Schema:** `controlled-autorun-laws-v3`  
**Saved at (UTC):** 2026-07-02T12:30:00Z  
**Owner:** SourceA Loop Specialist (standing assignment)  
**Skill SSOT:** controlled-autorun v3 (Cursor skill)  
**Determinism reference:** `.cursor/skills/controlled-autorun/references/deterministic-loops.md` (D1–D8)  
...
| Artifact | Path |
|----------|------|
| Laws v3 (this doc) | `docs/CONTROLLED_AUTORUN_LAWS_v3.md` |
| Determinism reference | `.cursor/skills/controlled-autorun/references/deterministic-loops.md` |
