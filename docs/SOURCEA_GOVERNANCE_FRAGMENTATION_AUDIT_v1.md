...
| **Worker scope** | `.cursor/rules/000-entry-gate.mdc` · `.cursor/rules/sourcea-worker-inbox.mdc` · `brain-os/law/SOURCEA_COMMERCIAL_WORKER_LOOP_LOCKED_v1.md` · `docs/GOVERNED_AUTORUN_LAWS_v3.md` · `brain-os/law/enforcement/RUN_INBOX_DISK_TRUTH_EXECUTION_LOCKED_v1.md` | **CONFLICT** → unified: `SOURCEA_WORKER_SCOPE_UNIFIED_LOCKED_v1.md` |
