...
| File | Change |
|------|--------|
| `sites/SourceA-landing/[agent-aispm-vendor].html` | Removed “operates a self-healing factory daily”; added **pre-revenue**; Self-heal → Monitor/target language; Live → Demo |
| `sites/SourceA-landing/[agent-aispm-vendor].html` | Removed daily factory / self-healing claims; LIVE → TARGET; added **pre-revenue** |
...
8. **Deploy** — push agent-aispm-vendor HTML hygiene to production if not auto-deployed
