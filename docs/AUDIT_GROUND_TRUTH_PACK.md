...
| File | Change |
|------|--------|
| `sites/SourceA-landing/[external-design-benchmark].html` | Removed “operates a self-healing factory daily”; added **pre-revenue**; Self-heal → Monitor/target language; Live → Demo |
| `sites/SourceA-landing/[external-design-benchmark].html` | Removed daily factory / self-healing claims; LIVE → TARGET; added **pre-revenue** |
...
8. **Deploy** — push external-design-benchmark HTML hygiene to production if not auto-deployed
