...
> **Investigator Circle always tracks loop health logged; Judge Room verdicts conflicts; Advisory Circle ranks next prompts; Loop Specialist composes and dispatches — Brain alone holds execution authority; rooms REPORT or bounded ACT, never a second Brain.**
