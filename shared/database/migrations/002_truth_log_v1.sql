-- Truth Layer v2 — mirror of infra/supabase/portfolio-spine/migrations/002_truth_log_v1.sql
...
COMMENT ON TABLE public.truth_log IS
  'Independent autonomy verifier — INSERT via service_role on Railway/CF only';
