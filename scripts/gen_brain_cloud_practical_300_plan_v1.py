...
def _wire_specs() -> list[tuple]:
    ...
    qgath = [
        ...
        ("Enforce Q-GATH-04 A: loop auto respects cloud_proof not INBOX alone", "loop_specialist dispatch requires cloud URL", "loop-specialist-tick-receipt-v1.json", "wire"),
...
def _loop_specs() -> list[tuple]:
    titles = [
        ...
        "Loop specialist advisory points to C300 head id",
        ...
        "Goal1 loop auto observes cloud federated receipts",
        ...
        "Loop auto graduation receipt loop-auto-graduation-v1.json",
        ...
        "Brain phase0 line on surfaces when loop auto ON",
        "Founder close line Worker RUN INBOX head control-only",
        "Loop auto mode documented in loop-specialist-cloud-contract",
...
def _scale_specs() -> list[tuple]:
    titles = [
        ...
        "Gate C300-300: 10 factories CLOUD_ONLY proven + loop auto live",
...
def generate() -> dict:
    phases_meta = [
        ...
        ("P1-LOOP", "Loop auto cloud dispatch", 131, 180, _loop_specs()),
