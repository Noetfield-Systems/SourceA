...
def _smart_loop_active() -> bool:
    """Loop specialist auto owns ACT delivery — not founder resume / Hub Deliver."""
...
def deliver_to_worker_inbox(
    ...
    *,
    ...
    payload = {
        ...
        "meta": healed_meta,
        "pickup": {
            "worker_chat": "Open SourceA Worker chat — prompt is here (not pasted into Brain)",
...
"""
    ...
    return {
        ...
        "message": (
            "Worker prompt in the repository — open SourceA Worker chat, say run inbox "
