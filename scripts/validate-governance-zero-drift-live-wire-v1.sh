...
chains = row["chains"]
for key in ("L0_5_L1_L2", "cross_layer", "governance_drift", "SASCIP", "vocabulary", "monitor_pulse", "mac_law"):
...
assert surf.get("mac_law_agent_lock_line") or surf.get("mac_law_universal_line"), "surfaces missing mac law lines"
