...
PHASE_TASKS: list[list[str]] = [
    [  # s0 SSOT
        ...
        "Verify _phase_d_complete() matches D1–D16 on-disk artifacts",
    ...
    [  # s5 commercial
        ...
        "Validate wire lane progress md exists on disk for Wire agent",
...
def main() -> None:
    ...
    registry = {
        ...
        "verdicts": {
            ...
            "world_model_compare": "D-layer packet path competitive vs raw-agent; weak on IDE ENFORCE + live fleet proof",
        },
        "success_criteria": {
