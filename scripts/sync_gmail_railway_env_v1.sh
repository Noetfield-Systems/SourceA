...
[[ -n "${TELEGRAM_OPS_CHAT_ID:-}" ]] && args+=("TELEGRAM_OPS_CHAT_ID=${TELEGRAM_OPS_CHAT_ID}")
[[ -n "${TELEGRAM_PRIMARY_BOT_TOKEN:-${TELEGRAM_BOT_TOKEN:-}}" ]] && args+=("TELEGRAM_PRIMARY_BOT_TOKEN=${TELEGRAM_PRIMARY_BOT_TOKEN:-${TELEGRAM_BOT_TOKEN}}")
