...
Deploys witnessbc-site/dist/deploy to deploy-witnessbc-agents-governance on the-777-foundation.
...
RECEIPT = SINA / "gate-w-witnessbc-vercel-receipt-v1.json"
DEFAULT_PROJECT = "deploy-witnessbc-agents-governance"
...
def gate_w_start(*, project: str = DEFAULT_PROJECT, skip_recipe: bool = False) -> dict:
    ...
    dashboard_fix = [
        ...
        "Project name: deploy-witnessbc-agents-governance",
