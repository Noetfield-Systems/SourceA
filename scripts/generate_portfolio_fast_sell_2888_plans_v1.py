...
LANES = [
    ...
    },
    {
        ...
        "verify": "test -f ~/Desktop/SourceA/docs/PORTFOLIO_TWO_TIER_COMPETITOR_PRO_ANALYSIS_LOCKED_v1.md",
        "external_repo": "~/Desktop/SourceA",
    },
]
...
def build_8888_master(now: str, lane_results: list[dict], errors: list[str]) -> None:
    ...
    master = {
        ...
        "version": "1.0.0",
        "generated_at": now,
        "law_doc": "docs/PORTFOLIO_TWO_TIER_COMPETITOR_PRO_ANALYSIS_LOCKED_v1.md",
        "analysis_doc": "docs/PORTFOLIO_TWO_TIER_COMPETITOR_PRO_ANALYSIS_LOCKED_v1.md",
