...
def run_machine_process_cycle() -> dict:
    ...
    chain = [
        ...
        ("receipt_chain", [py, str(SCRIPTS / "receipt_chain_hmac_audit_v1.py"), "--json"]),
        ("critic_second", [py, str(SCRIPTS / "adversarial_critic_second_v1.py"), "--json"]),
        ("merge_gate", [py, str(SCRIPTS / "machine_merge_gate_v1.py"), "--json"]),
        ("dispatch_reconciler", [py, str(SCRIPTS / "dispatch_template_reconciler_v1.py"), "--json"]),
