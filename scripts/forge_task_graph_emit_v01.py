#!/usr/bin/env python3
"""Emit forge-task-graph-v0.1 from  pick (all stacks)."""
...
from portfolio__pick_lib import enrich_pick, load_registry, phase_order, pick_backlog_plans, resolve_stack  # noqa: E402
...
def main() -> int:
    ...
    ap.add_argument("--pick-json", default="", help="Path to pick JSON array from pick-portfolio--plan")
