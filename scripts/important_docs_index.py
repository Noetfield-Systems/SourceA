...
_RAW_SECTIONS: list[tuple[str, list[tuple[str, str, str, str, str, str]]]] = [
    ...
    (
        ...
        [
            ...
            ("SINA_GOVERNANCE_ENTRY_LOCKED_v1.md", "Governance entry router", "START — branch to laws; anti-fragmentation; active vs archive.", "P0", "agent", "roadmap"),
            ...
            ("SINA_AUTHORITY_INDEX_MAP_LOCKED_v1.md", "Authority index map", "Registry of canonical laws — one topic one doc.", "P0", "agent", "roadmap"),
    ...
    (
        ...
        "both",
        [
            ("SINA_OS_SSOT_LOCKED.md", "Sina OS SSOT", "Master ecosystem law.", "P0", "both", "ssot"),
