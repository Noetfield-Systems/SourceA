...
_RAW_SECTIONS: list[tuple[str, list[tuple[str, str, str, str, str, str]]]] = [
    ...
    (
        ...
        [
            ...
            ("brain-os/law/entry/README_SOURCE_A.md", "Source A entry (30 min)", "Legacy path — STEP 0 points to entry/START_HERE.", "P0", "agent", "entry"),
            ...
            ("brain-os/law/SINA_PROMPT_FAST_LOOP_LOCKED_v1.md", "Prompt-fast loop", "Meta / factory / repo — one 10-pack per session.", "P0", "agent", "loop"),
            ...
            ("brain-os/law/AUTO_CONFLICT_ENGINE_V3_LOCKED.md", "ACE v3", "DESIGN / EXECUTION / DELIVERY planes.", "P1", "agent", "conflict"),
            ("brain-os/law/SINAAI_PARALLEL_LANES_NO_BLOCK_PROGRESS_LOCKED_v1.md", "Never block lanes", "Repo blockers ≠ stop all progress.", "P1", "agent", "conflict"),
    ...
    (
        ...
        [
            ...
            ("brain-os/law/GOVERNANCE_UNIFICATION_ENGINE_LOCKED_v1.md", "Governance unification engine", "ASF batch intake — score vs mission, merge into LOCKED SSOT, archive duplicates, sync authority index; one truth for founder + business.", "P0", "agent", "governance"),
        ],
    ),
    (
        "founder_daily",
        ...
        [
            ...
            ("brain-os/law/SINA_APPS_GUIDE_FOR_SINA_v1.md", "Apps guide", "Desktop icons + roles.", "P1", "founder", "command"),
            ...
            ("brain-os/law/WIRE_LANE_PROGRESS.md", "Wire lane progress", "G1/G2/G3 checklist.", "P1", "founder", "wire"),
            ("brain-os/law/enforcement/FOUNDER_FIRST_ASSISTANT_TRACKING_LAW_LOCKED_v1.md", "Founder request tracking", "Never lose ideas/orders — Today + Track.", "P0", "founder", "tracking"),
            ("brain-os/law/ORDER_GUARDIAN_AGENT_LOCKED_v1.md", "Order Guardian agent", "Task orders + smart advisor in hub.", "P0", "founder", "tracking"),
            ("brain-os/law/TASK_ORDERS_OPEN_REGISTER_LOCKED_v1.md", "Task orders register", "All open/partial/deferred orders — LOCKED.", "P0", "founder", "tracking"),
            ("brain-os/law/enforcement/FOUNDER_SAVE_AND_LOCK_IMMEDIATE_APP_LAW_LOCKED_v1.md", "Save & lock → app", "Every save/lock → file + hub same session.", "P0", "founder", "tracking"),
            ("brain-os/law/enforcement/FOUNDER_AGENT_USE_GUIDE_LOCKED_v1.md", "Agents Window guide", "100 tasks · Agents vs Editor · hub reminders.", "P0", "founder", "agents"),
            (
    ...
    (
        ...
        [
            ...
            ("brain-os/law/UNDERSTANDING_ROLES_CURSOR_ECOSYSTEM_v1.md", "Roles map", "ASF, lanes, Cursor chats.", "P1", "both", "map"),
            ("AGENT_OPERATING_ROLES_LOCKED_v1.md", "Operating roles", "Role definitions locked.", "P2", "both", "map"),
            ("brain-os/law/SINA_CURSOR_PROMPT_QUEUE_ORDER_v1.md", "Prompt queue", "Manual queue order (legacy path).", "P2", "both", "command"),
            ("brain-os/law/SINA_SEMEJ_AGENT_v1.md", "SEMEJ agent", "Multi-AI Chrome chain law.", "P2", "both", "semej"),
            ("brain-os/law/SINA_ADVISOR_CURSOR_CONNECT_v1.md", "AI Advisory", "Golden links + coach.", "P2", "founder", "command"),
            ("brain-os/law/SINA_MAC_HEALTH_GUARD_LOCKED_v1.md", "Mac Health Guard", "Mini app law — local Mac security agents.", "P1", "founder", "security"),
            ("brain-os/law/SINA_HUB_ESSENTIALS_LOCKED_v1.md", "Hub Essentials map", "Unified app index — one non-repetitive map.", "P1", "both", "command"),
            ("brain-os/law/SINA_PERSONAL_DATABASE_LAYER_A_LOCKED_v1.md", "Personal DB Layer A", "L0–L4 SSOT — copy agents train here.", "P0", "both", "personal-db"),
            ...
            ("brain-os/law/SINA_SEMI_SEPARATE_AGENT_NOTICE_LOCKED_v1.md", "Semi-separate lanes", "Wire, Cursor OS Pro, MergePack, Prompt OS — not five repos.", "P0", "agent", "command"),
            ("brain-os/law/SINA_AUTOMATION_SPINE_AND_N8N_LOCKED_v1.md", "Automation spine + n8n", "Hub Actions · starter test · n8n is glue only.", "P0", "both", "automation"),
            ...
            ("brain-os/law/META_REASONING_POLICY_STACK_LOCKED_v1.md", "Meta-reasoning policy stack", "L0–L12 decision governance — SSOT wins; critic isolated; policy→code map.", "P0", "agent", "roadmap"),
            ...
            ("brain-os/wtm/WORLD_TARGET_MODEL_AUTHORITY_LAW_LOCKED_v1.md", "WTM authority law", "Graph/memory/planning boundaries — zero ambiguity.", "P0", "both", "roadmap"),
            ("brain-os/wtm/WORLD_TARGET_MODEL_STEP_ID_MIGRATION_LOCKED_v1.md", "Step ID migration v4", "INCIDENT-004 — old D/C/B/A IDs → phase-aligned.", "P1", "both", "roadmap"),
            ("brain-os/wtm/WORLD_TARGET_MODEL_ROADMAP_LAW_LOCKED_v2.md", "WTM separation law", "Major upgrade tab only — not factory/investor.", "P1", "both", "roadmap"),
            ("brain-os/law/HUB_SOURCE_UI_ALIGNMENT_PROCEDURE_LOCKED_v1.md", "Hub source/UI alignment", "SSOT → build → payload → UI; audit on every rebuild.", "P0", "agent", "roadmap"),
            ("brain-os/law/STRATEGIC_NEXT_STEPS_SYNTHESIS_LOCKED_v2.md", "Strategic next steps (LOCKED v2)", "Big picture goals, pendings, phase plan — WTM panel.", "P0", "both", "roadmap"),
            ("brain-os/law/COUNCIL_BRIEF_STRATEGIC_SLICE_EVAL_L0_ENFORCE_LOCKED_v1.md", "Council brief · strategic slice", "Founder build order — Eval-1/L0/ENFORCE; lane law.", "P0", "both", "roadmap"),
            ("brain-os/law/enforcement/law/enforcement/ENFORCE_BYPASS_MAP_LOCKED_v1.md", "ENFORCE bypass map", "Which ingress paths are gated vs bypassed — hub gate receipts panel.", "P0", "agent", "roadmap"),
            ("DISPATCH_POLICY_LOCKED_v1.md", "Dispatch policy", "Auto-execution classes — gated on Eval-1b live pass.", "P0", "agent", "roadmap"),
            ("brain-os/law/TRUST_LEDGER_SCHEMA_LOCKED_v1.md", "Trust ledger schema", "agent-governance-events.jsonl row schema v1.", "P1", "agent", "governance"),
    ...
    (
        ...
        "both",
        [
            ("brain-os/law/SINA_PERSONAL_DATABASE_LAYER_A_LOCKED_v1.md", "Layer A law", "Frontmatter, access, ingestion path.", "P0", "both", "layer-a"),
    ...
    (
        ...
        "agent",
        [
            ("brain-os/law/SINAAI_PHASE1_STABILIZATION_ONLY_LOCKED_v1.md", "SA-019 Phase 1", "Wins daily — ops freeze.", "P0", "agent", "promptos"),
            ("brain-os/law/SINAAI_PROMPT_OS_CORE_FINAL_DECISION_LOCKED_v1.md", "Prompt OS decision", "Operating model — read #2 after SSOT.", "P0", "agent", "promptos"),
            ("brain-os/law/SINAAI_EXECUTION_TRUTH_LAYER_LOCKED_v1.md", "Execution truth", "Evidence + re-rank Phase 2.", "P1", "agent", "promptos"),
            ("brain-os/law/SINAAI_AGENT_YAML_INGEST_LOCKED_v1.md", "YAML ingest", "Ingest contract after Cursor.", "P1", "agent", "promptos"),
            ("brain-os/system/ASF_FIVE_REPOS_PLUS_COMMAND_CHAT_v1.md", "Five repos + Lane 0", "Dispatch + ingest map.", "P1", "both", "promptos"),
            ("brain-os/law/SINAAI_ARCHITECT_V2_INDUSTRIAL_POLICY_LOCKED_v1.md", "Architect v2", "Max 5 blockers — not doc police.", "P1", "agent", "promptos"),
            ("ASF_FULL_DAY_EXECUTION_PLAYBOOK_LOCKED_v1.md", "Full day playbook", "Long Prompt OS day.", "P2", "agent", "promptos"),
            ("brain-os/law/PROMPT_OS_CORE_MVP_BUILD_ORDER_LOCKED_v1.md", "MVP build order", "9 deliverables reference.", "P2", "maintainer", "promptos"),
            ("brain-os/law/SINAAI_AGENTS_AND_AUTOMATION_UNIFIED_BLUEPRINT_LOCKED_v1.md", "Agents blueprint", "Canonical automation map.", "P1", "agent", "promptos"),
        ],
    ),
    (
        "ecosystem_law",
        ...
        [
            ...
            ("brain-os/system/SOURCE_A_DOCUMENT_SEQUENCE_REGISTRY_LOCKED_v1.md", "Document registry", "Chronology + authority order.", "P1", "both", "registry"),
            ("brain-os/law/AUTO_CONFLICT_EXAMPLE_AGENT_STACK_POLICY_v1_LOCKED.md", "ACE example", "Worked stack policy example.", "P2", "agent", "conflict"),
            ...
            ("brain-os/law/SINAAI_ECOSYSTEM_FINAL_STATE_AND_NEXT_PLAN_LOCKED_v1.md", "When lost", "Handoff + next plan.", "P2", "both", "map"),
            ("brain-os/law/SINAAI_MASTER_BLUEPRINT_END_TO_END_v1.md", "End-to-end blueprint", "Roadmap narrative.", "P3", "both", "map"),
            ("ASF_MILESTONE_GLOSSARY_LOCKED_v1.md", "M8 glossary", "M8 vs Cursor vs wire terms.", "P2", "founder", "map"),
            ("brain-os/law/PLAN_STATUS_VOCAB_LOCKED_v1.md", "Plan status vocab", "Parked vs ship language.", "P2", "agent", "map"),
            ("brain-os/law/enforcement/FOUNDER_NO_CREDIT_CARD_INFRA_LOCKED_v1.md", "No credit card", "Infra rule for deploy.", "P2", "founder", "infra"),
            ("brain-os/law/SINAAI_FAST_TRACK_FORCE_MAJEURE_LOCKED_v1.md", "Fast track F8", "Fail forward per repo.", "P2", "agent", "blockers"),
        ],
    ),
    (
        "noetfield_lanes",
        ...
        [
            (
                "brain-os/law/NOETFIELD_CLOUD_GIT_AND_AGENT_ENTRY_UNIFIED_LOCKED_v1.md",
    ...
    (
        ...
        [
            ...
            ("brain-os/law/PRODUCT_FACTORY_ROADMAP_LOCKED_v1.md", "Factory roadmap", "Utility factory path.", "P2", "both", "factory"),
