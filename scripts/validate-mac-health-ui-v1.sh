#!/usr/bin/env bash
# validate-mac-health-ui-v1.sh — Founder-glance UI gate (v3.3+)
set -euo pipefail
...
for needle in "app.css?v=${VER}" "app.js?v=${VER}" "mhg-founder-glance" "mhg-founder-card" "Relieve pressure" "id=\"panel-more\"" "playwright-banner" "log-shield" "hub-truth-badge"; do
