#!/usr/bin/env bash
# validate-governed-autorun-skill-v1.sh — skill + laws + reconciler wired (light, Mac-safe)
set -euo pipefail
...
[[ -f "$ROOT/docs/GOVERNED_AUTORUN_LAWS_v2.md" ]] || fail "missing GOVERNED_AUTORUN_LAWS_v2.md"
...
grep -q 'governed-autorun' "$ROOT/docs/GOVERNED_AUTORUN_LAWS_v2.md" \
