...
="$ROOT/archive/attachments/commercial/SOURCEA__LANDSCAPE_RESEARCH_REPORT_v1.md"
...
required = (
    ...
    "SOURCEA__LANDSCAPE_RESEARCH_REPORT_v1.md",
    "SOURCEA_NOETFIELD__LANDSCAPE_2026-06-15_v1_3.md",
    "Consolidation",
