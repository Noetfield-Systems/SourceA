...
_STAGING_SCRIPT_FILES = (
    ...
    "implement_competitor_evidence_slice_v1.py",
...
def _stage_deploy_context() -> dict:
    ...
    reg_src = ROOT / "brain-os" / "plan-registry" / "sourcea-competitor-1000"
    reg_dst = STAGING / "data" / "sourcea-competitor-1000-registry"
    if reg_src.is_dir():
        shutil.copytree(reg_src, reg_dst)
        copied.append("data/sourcea-competitor-1000-registry/")
