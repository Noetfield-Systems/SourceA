...
MCP_ROWS = [
    ...
    {"id": "C300-MCP-004", "title": "Supabase mcp-receipts bucket spec on disk", "tier": "P2", "status": "done"},
    ...
    {"id": "C300-MCP-010", "title": "P2_sse_live receipt on disk", "tier": "P2", "status": "done"},
]
