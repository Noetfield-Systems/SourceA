...
FILE_RENAMES: list[tuple[str, str]] = [
    ...
    ("scripts/cloud_drain_seal_competitor_complete_v1.py", "scripts/cloud_forge_run_seal_competitor_complete_v1.py"),
    ...
    ("scripts/generate_competitor_5000_drain_patch_v1.py", "scripts/generate_competitor_5000_forge_run_patch_v1.py"),
    ...
    ("data/cloud-drain-competitor-5000-patch-v1.json", "data/cloud-forge-run-competitor-5000-patch-v1.json"),
...
TEXT_REPLACEMENTS: list[tuple[str, str]] = [
    ...
    ("cloud-drain-competitor-5000-patch", "cloud-forge-run-competitor-5000-patch"),
    ...
    ("cloud_drain_seal_competitor_complete_v1", "cloud_forge_run_seal_competitor_complete_v1"),
    ...
    ("generate_competitor_5000_drain_patch_v1", "generate_competitor_5000_forge_run_patch_v1"),
    ...
    ("cloud-drain-competitor", "cloud-forge-run-competitor"),
