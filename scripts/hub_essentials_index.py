...
READ_CHAIN: list[dict[str, str]] = [
    ...
    {"path": "archive/legacy/sina-command/SINA_COMMAND_NO_TERMINAL_FOUNDER_LOCKED_v1.md", "title": "No Terminal (founder)", "why": "Founder one-tap Actions only — agents run shell."},
    ...
    {"path": "archive/legacy/sina-command/SINA_COMMAND_EDIT_LOCK_LOCKED_v1.md", "title": "Edit lock", "why": "Who may edit SourceA."},
    ...
    {"path": "archive/legacy/sina-command/SINA_COMMAND_SYSTEM_UPDATE_NOTICE_LOCKED_v1.md", "title": "System update notice", "why": "All agents — read before work; per-repo tasks inside."},
...
_PILLAR_DEFS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "items": [
            ...
            {"kind": "doc", "path": "archive/legacy/sina-command/SINA_COMMAND_CENTER_VISION_LOCKED_v1.md", "title": "Command vision", "desc": "Hub on top — Layer A wins conflicts"},
