...
READ_CHAIN: list[dict[str, str]] = [
    {"path": "README_SOURCE_A.md", "title": "Source A entry (30 min)", "why": "Step 0 router + five core laws — then branch by task."},
    ...
    {"path": "SINA_GOVERNANCE_ENTRY_LOCKED_v1.md", "title": "Governance entry router", "why": "Single entry — pick branch; no duplicate law reading."},
    {"path": "SOURCEA_RESULT_DRIVEN_DISCUSSION_POLICY_LOCKED_v1.md", "title": "Result-driven discussion policy", "why": "Hyper-active conduct — understand pain/goals from disk, evidence+event-driven, option matrix, act+verify, golden insight + founder next actions every session. Not chat-only."},
    ...
    {"path": "SINA_AUTHORITY_INDEX_MAP_LOCKED_v1.md", "title": "Authority index map", "why": "Which law governs what; active vs archive/superseded."},
    ...
    {"path": "SINA_COMMAND_NO_TERMINAL_FOUNDER_LOCKED_v1.md", "title": "No Terminal (founder)", "why": "Founder one-tap Actions only — agents run shell."},
    {"path": "brain-os/enforcement/GOAL1_LOOP_ACTIVATION_CHAIN_LOCKED_v1.md", "title": "Goal 1 activation chain", "why": "INJECT → VALIDATE → ACTIVATE — deliver alone ≠ running."},
    {"path": "SINA_OS_SSOT_LOCKED.md", "title": "Sina OS SSOT", "why": "Master ecosystem law."},
    {"path": "SINAAI_PHASE1_STABILIZATION_ONLY_LOCKED_v1.md", "title": "SA-019 Phase 1", "why": "Daily ops freeze."},
    {"path": "SINAAI_PROMPT_OS_CORE_FINAL_DECISION_LOCKED_v1.md", "title": "Prompt OS decision", "why": "Operating model after SSOT."},
    ...
    {"path": "SINA_PROMPT_FAST_LOOP_LOCKED_v1.md", "title": "Prompt-fast loop", "why": "Meta / factory / repo layers."},
    {"path": "SINA_AGENT_LOOP_ORDER_v1.md", "title": "Loop order", "why": "Rounds in app only."},
    {"path": "SINA_COMMAND_EDIT_LOCK_LOCKED_v1.md", "title": "Edit lock", "why": "Who may edit SourceA."},
    ...
    {"path": "GOVERNANCE_UNIFICATION_ENGINE_LOCKED_v1.md", "title": "Governance unification engine", "why": "When ASF sends new rules or docs — one pass: score vs mission, merge into canonical LOCKED files, archive superseded, sync authority index. Stops law sprawl; one SSOT for founder orders and the business system."},
    {"path": "archive/attachments/2026-06-12/GOV_E2E_UNIFICATION_MANIFEST_LOCKED_v1.md", "title": "E2E unification manifest", "why": "Light map — truth stack, skills, memory, plans, machines, E2E status; one read instead of 213 root LOCKED files."},
    ...
    {"path": "GOVERNANCE_DRIFT_ENGINE_LOCKED_v1.md", "title": "Governance drift engine", "why": "Aggregate audit score — Today tab + drift sensors."},
    {"path": "FOUNDER_FIRST_ASSISTANT_TRACKING_LAW_LOCKED_v1.md", "title": "Founder request tracking", "why": "Never lose ASF ideas/orders — registry + Today + Track."},
    {"path": "ORDER_GUARDIAN_AGENT_LOCKED_v1.md", "title": "Order Guardian agent", "why": "Task orders register + smart advisor — what to do now from live state."},
    {"path": "TASK_ORDERS_OPEN_REGISTER_LOCKED_v1.md", "title": "Task orders open register", "why": "All open/partial/deferred orders — machine mirror in ~/.sina/task-orders/."},
    {"path": "FOUNDER_SAVE_AND_LOCK_IMMEDIATE_APP_LAW_LOCKED_v1.md", "title": "Save & lock → app immediately", "why": "Every save/lock goes to file + hub same session — no chat-only memory."},
    {"path": "FOUNDER_AGENT_USE_GUIDE_LOCKED_v1.md", "title": "Agents Window use guide", "why": "100 tasks · when to use Agents vs Editor · hub reminders + copy prompts."},
    {"path": "SINA_MAC_HEALTH_GUARD_LOCKED_v1.md", "title": "Mac Health Guard", "why": "Local Mac security mini app law."},
    {"path": "SINA_HUB_ESSENTIALS_LOCKED_v1.md", "title": "Hub Essentials map", "why": "How to add tabs/apps once — no duplicate surfaces."},
    {"path": "META_REASONING_POLICY_STACK_LOCKED_v1.md", "title": "Meta-reasoning policy stack", "why": "L0–L12 decision governance umbrella — SSOT wins; critic isolated; validate before execute."},
    ...
    {"path": "SINA_POST_CLAUDE_ANALYSIS_SHIP_READY_COMPANION_v1.md", "title": "Post-Claude ship-ready companion", "why": "Everything after Claude AI chat analysis — gate, D5 ship, checklist, agent start map."},
    ...
    {"path": "STRATEGIC_NEXT_STEPS_SYNTHESIS_LOCKED_v2.md", "title": "Strategic next steps (LOCKED v2)", "why": "Big picture goals, pendings, phase plan — hub WTM panel."},
    {"path": "SOURCEA_REFERENCE_ARCHITECTURE_CONSTELLATION_LOCKED_v1.md", "title": "Reference architecture constellation", "why": "Full external market map (29 refs) — layers, categories, SourceA place/status, golden build vs buy insights. ThinkFleet tone · Temporal spine · Stripe docs."},
    {"path": "SOURCEA_SYSTEM_INTEGRITY_100_STEP_PLAYBOOK_LOCKED_v1.md", "title": "System integrity 100-step playbook", "why": "10 phases · Founder + Maintainer — law/machine/projection audit, 24 decisive forks, conflict governance, agents. Tick in Canvas sidebar."},
    {"path": "SOURCEA_COMPLEX_SITUATION_FORK_MACHINE_LOCKED_v1.md", "title": "Complex situation fork machine", "why": "Mega chat · Brain · multi-fork — inventory forks, Effect per option, ASF confirm format, execute to disk. Prompt + script + Canvas."},
    ...
    {"path": "SOURCEA_FIVE_STEP_AUTONOMOUS_PROGRESS_BLUEPRINT_LOCKED_v1.md", "title": "Five-step autonomous progress (APEX)", "why": "Daily machine SCAN→SAY→PICK→PROVE→SHIP — 2026–2027 autonomous agentic path. Wraps Fork + 100-step + Layer A."},
    ...
    {"path": "SOURCEA_INTEGRITY_STACK_UNIFIED_BLUEPRINT_BATCH_2_LOCKED_v1.md", "title": "Integrity stack — Batch 2 unified map", "why": "One doc: 4 artifacts compared · hierarchy · paradoxes · duplicates · order · canonical ASF prefix."},
    {"path": "SOURCEA_CROSS_DOC_LINKAGE_AND_AUDIT_LOCKED_v1.md", "title": "Cross-doc linkage & audit", "why": "Link 10 session docs across time · human vs machine channel · paradox · duplication · dual-language audit."},
    {"path": "SOURCEA_LOST_LINK_RECOVERY_ETHICS_LOCKED_v1.md", "title": "Lost link recovery ethics", "why": "Transcript + disk search · FOUND = complete reward · truth tree down-only · @sina-conscious-recovery skill."},
    {"path": "SOURCEA_SSOT_FOUNDATION_WRITING_GUIDE_LOCKED_v1.md", "title": "SSOT foundation (human)", "why": "018 egg · subject→SSOT→blueprint→hatch · why hierarchies exist."},
    {"path": "SOURCEA_LIVE_GOVERNANCE_BIG_PICTURE_LOCKED_v1.md", "title": "Live governance big picture", "why": "P0–P7 tiers · truth tree §2b · propagation cascade · need vs noise."},
    {"path": "SOURCEA_FROZEN_ARCHIVE_REVIVAL_AUDIT_LOCKED_v1.md", "title": "Frozen archive revival", "why": "MonoRepo 002 tiers · what to revive · 024 AUTO-RUN blocked."},
    {"path": "SOURCEA_ECOSYSTEM_MASTER_CATALOG_LOCKED_v1.md", "title": "Ecosystem master catalog", "why": "T0–T12 thread chain · counts · live vs paper · one page inventory."},
    ...
    {"path": "SOURCEA_TODAY_SESSION_UNIFIED_CLOSEOUT_RECEIPT_2026-06-11_LOCKED_v1.md", "title": "Today session closeout 2026-06-11", "why": "Unified receipt — nothing left behind · full wire · FOUND list · machine proof · founder next 3."},
    {"path": "SOURCEA_LIVE_FOUNDER_DECISION_FORM_LOCKED_v1.md", "title": "Live founder decision form", "why": "ANSWERED · Canvas open · pending ledger · open questions — every SCAN until RT cascade."},
    {"path": "archive/attachments/2026-06-12/MAINTAINER_1_INTEGRITY_PACK_5_CONTINUITY_BRIDGE_v1.md", "title": "M1 → Brain · INTEGRITY PACK 5 bridge", "why": "FOUND — Canvas + 100-step + Five-step continuity; nothing lost from M1 megachat a53f3fa1."},
    {"path": "SOURCEA_FOUNDER_MESSAGE_NORMALIZATION_LOCKED_v1.md", "title": "Founder message normalization", "why": "CAPS = non-caps for ASF orders · PICK keys · Track titles."},
    {"path": "SOURCEA_GOVERNANCE_EVENT_SPINE_SCHEMA_LOCKED_v1.md", "title": "Governance event spine G1+G2", "why": "Runtime kernel — spine ledger · reference graph · impact scan · projection-only hub."},
    {"path": "COUNCIL_BRIEF_STRATEGIC_SLICE_EVAL_L0_ENFORCE_LOCKED_v1.md", "title": "Council brief · strategic slice", "why": "Founder build order — not L8 primary; lane law."},
    {"path": "ENFORCE_BYPASS_MAP_LOCKED_v1.md", "title": "ENFORCE bypass map", "why": "Gate receipts panel — what ENFORCE covers vs bypasses."},
    {"path": "SINA_EXECUTION_INTELLIGENCE_STACK_LOCKED_v1.md", "title": "Execution intelligence stack", "why": "Locked build order: spine → memory → patterns → self-optimization."},
    {"path": "SINA_PERSONAL_DATABASE_LAYER_A_LOCKED_v1.md", "title": "Personal DB Layer A", "why": "SSOT for copy agents — L0–L4, ingestion, access."},
    {"path": "SINA_COMMAND_SYSTEM_UPDATE_NOTICE_LOCKED_v1.md", "title": "System update notice", "why": "All agents — read before work; per-repo tasks inside."},
    {"path": "SINA_SEMI_SEPARATE_AGENT_NOTICE_LOCKED_v1.md", "title": "Semi-separate lanes", "why": "Wire · Cursor OS Pro · MergePack · Prompt OS boundaries."},
]
...
_PILLAR_DEFS: list[dict[str, Any]] = [
    {
        ...
        "items": [
            ...
            {"kind": "doc", "path": "SINA_POST_CLAUDE_ANALYSIS_SHIP_READY_COMPANION_v1.md", "title": "Ship-ready companion", "desc": "Post-Claude analysis — full checklist"},
            {"kind": "tab", "tab": "decision-governance", "title": "Decision governance", "desc": "L0–L12 meta-reasoning stack — SSOT wins · critic isolated"},
            {"kind": "doc", "path": "META_REASONING_POLICY_STACK_LOCKED_v1.md", "title": "Meta-reasoning policy stack", "desc": "LOCKED umbrella — decision sovereignty"},
            ...
            {"kind": "doc", "path": "TASK_ORDERS_OPEN_REGISTER_LOCKED_v1.md", "title": "Task orders register", "desc": "All open/partial/deferred — LOCKED doc"},
    ...
    },
    {
        ...
        "items": [
            {"kind": "doc", "path": "NOETFIELD_CLOUD_GIT_AND_AGENT_ENTRY_UNIFIED_LOCKED_v1.md", "title": "Unified guide (app + law)", "desc": "Share vs not · 3 layers · read orders"},
            ...
            {"kind": "doc", "path": "SINA_SEMI_SEPARATE_AGENT_NOTICE_LOCKED_v1.md", "title": "Semi-separate lanes", "desc": "Wire · Cursor OS Pro · cloud Noetfield"},
        ],
    },
    {
        "id": "automation",
        ...
        "items": [
            ...
            {"kind": "doc", "path": "SINA_AUTOMATION_SPINE_AND_N8N_LOCKED_v1.md", "title": "Automation spine law", "desc": "Locked policy + starter test steps"},
    ...
    },
    {
        ...
        "items": [
            ...
            {
                "kind": "doc",
                "path": "SINAAI_PHASE1_STABILIZATION_ONLY_LOCKED_v1.md",
            ...
            {"kind": "doc", "path": "AUTO_CONFLICT_ENGINE_V3_LOCKED.md", "title": "ACE v3", "desc": "DESIGN / EXECUTION / DELIVERY"},
    ...
    },
    {
        ...
        "items": [
            ...
            {"kind": "doc", "path": "SINA_PERSONAL_DATABASE_LAYER_A_LOCKED_v1.md", "title": "Layer A law", "desc": "Frontmatter, access, ingestion — SSOT rules"},
            {"kind": "doc", "path": "SINA_COMMAND_CENTER_VISION_LOCKED_v1.md", "title": "Command vision", "desc": "Hub on top — Layer A wins conflicts"},
            {"kind": "doc", "path": "ASF_MASTER_ORDERS_ORGANIZED_LOCKED_v1.md", "title": "Master orders", "desc": "Active focus: build personal database"},
            {"kind": "doc", "path": "SINAAI_AGENTS_AND_AUTOMATION_UNIFIED_BLUEPRINT_LOCKED_v1.md", "title": "Agents blueprint", "desc": "PAIOS · Layer A binding · automation"},
        ],
    },
    {
        "id": "law",
        ...
        "items": [
            ...
            {"kind": "doc", "path": "SOURCE_A_DOCUMENT_SEQUENCE_REGISTRY_LOCKED_v1.md", "title": "Document registry", "desc": "Authority order"},
            {"kind": "doc", "path": "SINA_HUB_ESSENTIALS_LOCKED_v1.md", "title": "Hub Essentials law", "desc": "SSOT rules for this map"},
        ],
    },
    {
        "id": "system",
    ...
    items.append(
        {
            ...
            "priority": "P1",
            "required": False,
            "path": "SOURCE_A_DOCUMENT_SEQUENCE_REGISTRY_LOCKED_v1.md",
