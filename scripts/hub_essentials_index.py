...
_PILLAR_DEFS: list[dict[str, Any]] = [
    {
        ...
        "items": [
            ...
            {"kind": "tab", "tab": "goal1-auto-run", "title": "Cloud Forge Run log", "desc": "Batch log = truth · RUN INBOX when Brain routes"},
    ...
    },
    {
        ...
        "items": [
            {"kind": "tab", "tab": "goal1-auto-run", "title": "Cloud Forge Run log", "desc": "REGISTRY drain — Brain+Worker+broker PEV"},
...
QUICK_TILES: list[dict[str, str]] = [
    ...
    {"tab": "goal1-auto-run", "icon": "▶", "title": "Cloud Forge Run log", "desc": "Batch log · RUN INBOX when Brain routes", "accent": "gold"},
