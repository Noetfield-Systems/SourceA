...
bench = Path("archive/attachments/commercial/internal capability research archive")
for n in ("sourcea-layout-light.io", "notenic.ai", "fusegov.com", "witness.ai", "Overall", "Master scorecard"):
