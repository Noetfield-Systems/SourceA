#!/usr/bin/env bash
# validate-thread-room-h2-summary-t1-crossref-v1.sh — sa-0834 T1 dedup cross-ref → canonical sa-0809
set -euo pipefail
ROOT="$(cd "$(dirname "$0")/.." && pwd)"
cd "$ROOT/scripts"

fail() { echo "FAIL: validate-thread-room-h2-summary-t1-crossref-v1 — $*" >&2; exit 1; }

CROSS="$ROOT/archive/attachments/2026-06-15/sa-0834-thread-room-h2-summary-t1-crossref_LOCKED_v1.md"
CANONICAL="$ROOT/scripts/validate-thread-room-h2-summary-v1.sh"
RECEIPT="$ROOT/receipts/sa-0809-receipt.json"

[[ -f "$CROSS" ]] || fail "missing sa-0834 cross-ref doc"
...
cross = Path("../archive/attachments/2026-06-15/sa-0834-thread-room-h2-summary-t1-crossref_LOCKED_v1.md")
...
print("OK: sa-0834 cross-ref doc cites sa-0809 canonical")
PY

bash "$CANONICAL" >/dev/null || fail "canonical validate-thread-room-h2-summary-v1"

echo "OK: validate-thread-room-h2-summary-t1-crossref-v1 · canonical=sa-0809 · sa-0834"
