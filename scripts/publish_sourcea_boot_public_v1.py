#!/usr/bin/env python3
"""Publish packages/sourcea-boot to public GitHub repo Noetfield-Systems/sourcea-boot."""
...
from sourcea_public_github_ssot_v1 import boot_repo_slug  # noqa: E402

DEFAULT_REPO = boot_repo_slug()
