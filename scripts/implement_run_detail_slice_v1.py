...
def default_run_detail(plan_id: str, *, competitor: str = "Trigger.dev") -> dict[str, Any]:
    return {
        ...
        "plan_id": plan_id,
        "status": "completed",
        "competitor_pattern": f"{competitor} run dashboard",
    ...
    *,
    ...
    if path.is_file():
        try:
            ...
            pass
    row = default_run_detail(plan_id, competitor=competitor)
...
def ship_run_detail_for_plan(
    ...
    *,
    ...
    base = root or ROOT
    row = ensure_run_detail(plan_id, root=base, competitor=competitor, workstream=workstream)
