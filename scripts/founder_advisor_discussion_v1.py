...
_SUBJECTS: list[dict] = [
    ...
    {"n": 15, "topic": "S10 eternal law", "insight": "100 prompts audit factory forever — not run inbox", "action": "Read daily receipt logged", "file": "SOURCEA_S10_ETERNAL_SELF_HEAL_AUDIT_LOCKED_v1.md", "send_advisor": False, "repo_root": True},
