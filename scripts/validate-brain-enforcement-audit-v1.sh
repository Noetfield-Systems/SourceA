...
test -f scripts/brain_enforcement_audit_v1.py
test -f os/chat-handoffs/BRAIN_ENFORCEMENT_AUDIT_PROMPT_LOCKED_v1.md

python3 scripts/brain_enforcement_audit_v1.py --json --write 2>/dev/null | python3 -c "
import json, sys
