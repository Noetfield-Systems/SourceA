...
def mini_apps_catalog() -> list[dict]:
    ...
    return [
        ...
        },
        {
            "id": "worker-hub",
            "title": "Worker Hub",
            "subtitle": "Super Fast Hub H1 · stack · API Station",
            "type": "hub",
            "accent": "blue",
            "port": 13020,
            "open_url": hub,
            "hub_link": hub,
            "desktop": str(Path.home() / "Desktop/Worker Hub.app"),
            "launch": {
                "kind": "nohup",
                "cwd": str(SOURCE_A),
                "argv": ["bash", str(SOURCE_A / "scripts/sina-unified-launcher.sh"), "worker-hub"],
                "log": str(Path.home() / ".sina/worker-hub-launch.log"),
            },
        },
        {
            "id": "portfolio-mail",
            "title": "Portfolio Mail",
            "subtitle": "15 inboxes · Chat Unify · n8n wired",
            "type": "hub",
            "accent": "indigo",
            "port": 13020,
            "open_url": f"{hub}/mail-hub/",
            "hub_link": f"{hub}/mail-hub/",
            "desktop": str(Path.home() / "Desktop/Portfolio Mail.app"),
            "launch": {
                "kind": "nohup",
                "cwd": str(SOURCE_A),
                "argv": ["bash", str(SOURCE_A / "scripts/sina-unified-launcher.sh"), "portfolio-mail"],
                "log": str(Path.home() / ".sina/portfolio-mail-launch.log"),
            },
        },
        {
            "id": "mac-health-guard",
