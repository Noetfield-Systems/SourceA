#!/usr/bin/env bash
# validate-cursor-skills-index-v1.sh — master skills index + governed-autorun v3 wired (light)
set -euo pipefail
...
bash "$ROOT/scripts/validate-governed-autorun-skill-v1.sh"
...
for need in ('governed-autorun', 'signal-factory', 'hub-pro-master', 'skill-foundational-agentic-systems'):
