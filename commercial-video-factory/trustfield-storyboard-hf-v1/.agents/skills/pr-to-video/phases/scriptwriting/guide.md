...
| Evidence / metric / +N −M stats /  / test | `social_proof`      | Concrete grounding: a real number, a passing test, a perf delta.                 |
...
| **Evidence**         | +N/−M stat • Passing test / green check •  / perf delta • Causal chain (request → 5xx → retry → success)                                                       |
