...
**Authority:** SSOT v3.1 · Constellation v1 · Jun 2026  + NW1 + orchestrator partner corpus
...
| ** angle** | Who you beat / partner / lose to |
...
| B05  | 066–075 | `BRANCH_B05__PLAN_066_075_LOCKED_v1.md` |
...
Watch: Notenic · FuseGov · [agent-aispm-vendor] · AgentPEP · Microsoft Auth Fabric

### Noetfield lane (NW1 primary)

Beat on: **governance latency · board TLE · procurement ZIP · 4–6 week NF-RD**  
Lose on: **data estate breadth (Securiti) · agent inventory UI ([agent-aispm-vendor]) · Azure-only**  
