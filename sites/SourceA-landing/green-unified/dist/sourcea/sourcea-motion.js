(function () {
  ...
  function sandboxTheater() {
    ...
    const beats = [
      ...
      { who: "broker", act: "Act II · Context", verdict: "· FOUND", narrator: "Context arrives first. , prior threads, handoff notes — gathered before anyone prompts.", line: "Found your AB1 thread + . Handing to worker." },
