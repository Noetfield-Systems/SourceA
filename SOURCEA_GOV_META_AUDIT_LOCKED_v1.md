...
**Governance Specialist cannot claim fixed, PASS, or “not on disk” until governance meta-audit PASS — disk grep beats chat.**
...
- “Fixed” / “not on disk” without `governance-meta-audit-receipt-v1.json` **`ok: true`** attached
